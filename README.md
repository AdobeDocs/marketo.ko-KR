...
Adobe 커뮤니티에 소속되어 있고 새 문서를 만들거나 주요 변경 사항을 제출하려는 경우 Git 저장소의 문제 탭을 사용하여 문제를 제출하여 문서 팀과 대화를 시작하십시오. 변경/작성 계획에 동의하면 직원과의 협력을 통해 공개 및 비공개 저장소의 작업을 결합하여 새로운 콘텐츠를 제공할 수 있습니다.
