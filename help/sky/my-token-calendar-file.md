...
[!UICONTROL Calendar File] 토큰을 사용하면 Marketo 이메일 및 랜딩 페이지에 달력 이벤트(.ics) 링크를 추가할 수 있습니다. 다음은 프로그램 및 캠페인 폴더에 사용할 수 있도록 설정하는 방법입니다.
...
1. 연결된 링크를 입력하고 이벤트 미리 알림을 보낼 시기를 선택합니다. 선택적 설명을 입력할 수도 있습니다. 여기를 클릭하십시오 **[!UICONTROL Save]**.
