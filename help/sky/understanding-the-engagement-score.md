...
참여 점수를 통해 참여 프로그램의 컨텐츠가 얼마나 효과적인지 손쉽게 확인할 수 있습니다. 점수는 0부터 100까지입니다. 관여 대시보드 [를](https://docs.marketo.com/display/DOCS/The+Engagement+Dashboard) 확인하여 컨텐츠의 성과를 추적할 수 있는 방법을 확인하십시오.
...
>[!NOTE]
>
>프로그램이 스트림 컨텐츠로 사용되는 경우 참여 점수는 이메일 인터랙션(클릭, 열기, 가입 취소)이 아니라 프로그램 멤버십 및 성공 상태를 기반으로 합니다.
>
