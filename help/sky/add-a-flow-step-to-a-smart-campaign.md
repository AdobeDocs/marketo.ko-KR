...
1. [!UICONTROL Marketing Activities]에서 스마트 캠페인을 선택하고 **[!UICONTROL Flow]**&#x200B;을 클릭합니다.

   ![이미지 원](/help/sky/assets/smart-campaigns/add-a-flow-step-to-a-smart-campaign/add-a-flow-step-to-a-smart-campaign-1.png)

1. 흐름 단계를 검색할 항목을 입력한 다음 캔버스로 드래그하여 놓습니다. 여러 흐름 단계에 대해 반복합니다.
...
흐름 단계는 나열된 순서대로 실행됩니다. [흐름 단계를 ](https://docs.marketo.com/display/MER/Add+a+Flow+Step+to+a+Smart+Campaign#AddaFlowSteptoaSmartCampaign-ReorderFlowSteps) 다시 정렬하여 올바른 시퀀스에 있는지 확인합니다.

>[!TIP]
>
>잘못된 항목이 있을 경우 빨간색 선이 표시됩니다. 줄 위로 마우스를 가져가 수정 방법을 확인합니다.
>
>예약하거나 활성화하기 전에 [스마트 캠페인](https://docs.marketo.com/display/DOCS/Smart+Campaign+Checklist)을 검토하고 확인하십시오.
