...
캠페인 폴더 또는 프로그램의 [!UICONTROL My Tokens] 탭에서 편집할 토큰의 **[!UICONTROL Value]**&#x200B;을 클릭합니다. 그러면 편집기 창이 열립니다.
...
>[!NOTE]
>
>텍스트 토큰에는 별도의 편집기 창이 없습니다. **[!UICONTROL Value]**&#x200B;을 클릭하여 인라인 편집을 수행합니다.
...
1. 토큰을 마우스 오른쪽 단추로 클릭한 다음 **[!UICONTROL Delete]**&#x200B;을 선택합니다.
...
>[!NOTE]
>
>현재 자산에 사용되고 있는 내 토큰은 삭제할 수 없습니다. 해당 토큰을 삭제하려고 하면 토큰이 사용되는 위치를 나열하는 오류 메시지가 표시됩니다. 이러한 자산에서 토큰을 제거하고 다시 삭제하십시오.

## 토큰 복제

1. 내 토큰을 복제하려면 마우스 오른쪽 단추를 클릭하고 **[!UICONTROL Clone]**&#x200B;을 선택합니다.
...
1. 복제 토큰의 새 이름을 입력하고 필요한 경우 편집한 다음 **[!UICONTROL Save]**&#x200B;을 클릭합니다.
...
토큰의 이름을 클립보드로 복사하려면(예: `{{my.Event Calendar File}}`) 토큰을 마우스 오른쪽 단추로 클릭하고 **토큰 이름 복사**&#x200B;를 선택합니다.
