...
description: 릴리스 노트 -17년 봄 - Marketo 문서 - 제품 설명서
title: 릴리스 노트 -17년 봄
...
2017년 봄 릴리스에는 다음 기능이 포함됩니다. 기능을 사용할 수 있는지 Marketo 에디션을 확인하십시오.
...
[linkedIn Lead Gen ](https://business.linkedin.com/marketing-solutions/native-advertising/lead-gen-ads) Form은 기업에서 LinkedIn에서 리드 생성 캠페인을 실행하는 보다 직접적인 방법입니다. 사람들은 양식을 작성하여 제품 또는 서비스에 대한 관심을 표시함으로써 자동화된 후속 프로세스와 리드 전달 활동이 발생하는 Marketo에 개인 정보를 캡처하고 동기화할 수 있습니다.

LinkedIn Lead Gen Forms과 Marketo의 통합은 리드가 Lead Gen 양식 내에 제공하는 정보를 자동으로 캡처합니다. 그런 다음 새로운 **LinkedIn 리드 생성 양식 채우기** 트리거 및 필터를 사용하여 후속 작업과 알림을 자동화할 수 있습니다.
...
대량의 개인 및 활동 데이터를 Marketo에서 외부 시스템으로 손쉽게 전송할 수 있습니다.

## ABM 개선 사항 {#abm-enhancements}

**[ABM 명명 계정의 사용자 정의 필드](https://docs.marketo.com/x/1wnG)**

이제 Marketo ABM을 사용하여 지정된 계정에 최대 10개의 사용자 정의 필드를 만들 수 있습니다. 이러한 사용자 지정 필드를 CRM 계정 개체의 필드에 매핑할 수 있으며, Marketo ABM은 데이터를 동기화하여 ABM 명명 계정을 확장하고 마케팅을 촉진하는 데 도움이 됩니다.

**[ABM 명명 계정의 백분위수 점수](https://docs.marketo.com/display/docs/assets/abmpercentiles.png)**

지정된 계정 점수는 매우 다를 수 있습니다. Marketo ABM은 이제 각 점수에 대한 백분위수를 자동으로 계산하므로, 각 네임드 계정이 다른 네임드 계정 중 어느 위치에 있는지 한 눈에 볼 수 있습니다.
...
**[종료 의도를 기반으로 웹 캠페인](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/set-how-your-web-campaign-displays.md)**

방문자가 페이지를 닫기 전에 방문자의 주의를 캡처합니다. 방문자가 페이지를 떠나는 것을 마우스 제스처로 표시할 때만 개인화된 웹 캠페인이 표시되도록 설정합니다.

**[웹 캠페인을 위한 애니메이션 효과](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-dialog-web-campaign.md)**
...
**[대화 상자 닫기 단추 사용자 정의](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-dialog-web-campaign.md)**
...
**[현지화](/help/marketo/product-docs/administration/settings/select-your-language-locale-and-time-zone.md)**

웹 개인화는 이제 모든 Marketo 지원 언어(영어, 일본어, 독일어, 스페인어, 프랑스어 및 포르투갈어)로 제공됩니다.

## 예측 개선 사항 {#predictive-enhancements}

**[현지화](/help/marketo/product-docs/administration/settings/select-your-language-locale-and-time-zone.md)**

예측 컨텐츠는 이제 Marketo이 지원하는 모든 언어(영어, 일본어, 독일어, 스페인어, 프랑스어 및 포르투갈어)로 제공됩니다.
