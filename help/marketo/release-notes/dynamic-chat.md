...
이제 라이브 채팅이 끝난 후 채팅 대본의 .txt 파일을 다운로드할 수 있습니다. [추가 정보](https://experienceleague.adobe.com/ko/docs/marketo/using/product-docs/demand-generation/dynamic-chat/live-chat/agent-inbox#download-transcript){target="_blank"}
...
<tbody>
  ...
  <tr>
    ...
    <td>xyz</td>
    <td>기존 사용자와 다름</td>
    <td>이 시나리오는 기본적으로 새로운 익명 프로필로 간주되는 새 쿠키인 경우 불가능합니다.</td>
  </tr>
</tbody></table>
