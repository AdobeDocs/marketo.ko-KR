---
title: "2016"
description: 2016년 - Marketo 문서 - 제품 설명서
...
## 익명 필터임 {#is-anonymous-filter}

[익명 필터임](/help/marketo/product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website/next-generation-munchkin-tracking-faq.md)
...
[데이터베이스 대시보드](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/database-dashboard.md)

[!UICONTROL Lead Database]에 총 사용자 데이터베이스 크기, 마케팅 가능한 잠재 고객 수 및 상위 5개 소스별 잠재 고객 분류가 포함된 업데이트된 요약 대시보드가 있습니다.

![](assets/image2016-1-12-16-3a18-3a7.png)

## Microsoft Edge 브라우저 {#microsoft-edge-browser}

[Microsoft Edge 브라우저](/help/marketo/product-docs/administration/setup-administration/supported-browsers.md)
...
## 이메일 프로그램 헤드 시작 {#email-program-head-start}
...
## 모바일 마케팅 개선 사항 {#mobile-marketing-enhancements}

[모바일 마케팅 개선 사항](/help/marketo/product-docs/mobile-marketing/admin/add-a-mobile-app.md)
...
## 프로그램 API {#program-api}

[프로그램 API](https://developers.marketo.com/documentation/programs/)

REST API를 통해 프로그램을 만들고, 업데이트하고, 복제합니다. 프로그램 내에서 스마트 목록과 스마트 캠페인을 만들거나 업데이트하는 것은 여기에 포함되지 않습니다.

## Microsoft Dynamics 개선 사항 {#microsoft-dynamics-enhancements}

[Microsoft Dynamics 개선 사항](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/sync-status.md)
...
## 사용자 지정 개체 개선 사항 {#custom-objects-enhancements}

[사용자 지정 개체 개선 사항](/help/marketo/product-docs/administration/marketo-custom-objects/create-marketo-custom-objects.md)

이제 여러 링크 필드가 있는 중간 개체를 사용하여 리드/계정과 사용자 지정 개체 간의 다대다 관계를 만들 수 있습니다.

![](assets/image2016-1-11-12-3a59-3a59.png)

## Facebook 리드 광고 {#facebook-lead-ads}

[Facebook 리드 광고](/help/marketo/product-docs/demand-generation/facebook/set-up-facebook-lead-ads.md)
...
## 웹(실시간 Personalization) Campaign 스케줄러 {#web-real-time-personalization-campaign-scheduler}

[웹(실시간 Personalization) Campaign 스케줄러](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/schedule-a-web-campaign.md)
...
[이메일 인사이트](/help/marketo/product-docs/reporting/email-insights/email-insights-overview.md)
...
[이메일 템플릿 선택기](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-template-picker-overview.md)
...
## 이메일 편집—다시 상상하기 {#email-editing-re-imagined}

[이메일 편집—다시 상상하기](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-editor-v2-0-overview.md)
...
## 모바일 인앱 메시지 {#mobile-in-app-messages}

[모바일 인앱 메시지](/help/marketo/product-docs/mobile-marketing/in-app-messages/understanding-in-app-messages.md)
...
## 초안 코드 조각 없음 {#no-draft-snippets}

[초안 코드 조각 없음](/help/marketo/product-docs/administration/users-and-roles/enable-no-draft-for-snippets.md)
...
## 랜딩 페이지, 랜딩 페이지 템플릿 및 양식 API {#landing-page-landing-page-template-and-form-apis}

[랜딩 페이지, 랜딩 페이지 템플릿 및 양식 API](https://developers.marketo.com/blog/spring-2016-updates/)
...
## API 액세스용 IP 허용 목록에 추가 {#ip-allowlisting-for-api-access}

[API 액세스용 IP 허용 목록에 추가](/help/marketo/product-docs/administration/additional-integrations/create-an-allowlist-for-ip-based-api-access.md)
...
## 새로운 고속 Microsoft Dynamics 동기화 커넥터 {#new-high-speed-microsoft-dynamics-sync-connector}

[새로운 고속 Microsoft Dynamics 동기화 커넥터](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/sync-status.md)
...
## 친숙한 인스턴스 이름 {#friendly-instance-name}

[친숙한 인스턴스 이름](/help/marketo/product-docs/administration/settings/edit-subscription-settings.md)
...
## 사용자 지정 개체 격자 {#custom-objects-grid}

[사용자 지정 개체 격자](/help/marketo/product-docs/administration/marketo-custom-objects/understanding-marketo-custom-objects.md)
...
[계정 기반 마케팅](https://docs.marketo.com/display/docs/account+based+marketing)
...
[감사 추적](/help/marketo/product-docs/administration/audit-trail/audit-trail-overview.md)
...
## 이메일 2.0 개선 사항 {#email-enhancements}

[이메일 2.0 개선 사항](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-editor-v2-0-overview.md)
...
[프로그램 토큰](/help/marketo/product-docs/demand-generation/landing-pages/personalizing-landing-pages/tokens-overview.md)

프로그램에 대한 새 토큰 유형을 만들었습니다. 이제 에셋 및 스마트 캠페인 흐름 단계에서 프로그램 이름, 설명 및 ID를 렌더링할 수 있습니다.

![](assets/program-tokens.png)

## Enterprise 키 {#enterprise-key}

[Enterprise 키](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/authorize-the-marketo-outlook-plugin.md)
...
## 웹 Personalization 캠페인 {#web-personalization-campaigns}

[웹 Personalization 캠페인](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-dialog-web-campaign.md)

웹 캠페인이 웹 사이트에서 반응할 시간 지연을 지정합니다.

![](assets/dialog-campaign-delay.png)

## Content Analytics 및 권장 사항 내보내기 {#content-analytics-and-recommendations-export}

[Content Analytics 및 권장 사항 내보내기](/help/marketo/product-docs/web-personalization/understanding-web-personalization/understanding-content-analytics.md)

컨텐츠 분석 및 권장 사항 데이터를 오프라인으로 봅니다.

## 이메일 편집기 2.0에 대한 API 지원 {#api-support-for-email-editor}

[이메일 편집기 2.0에 대한 API 지원](https://developers.marketo.com/documentation/asset-api/)

이전에 v1.0 이메일 및 템플릿과만 호환되는 기존 에셋 API가 이제 v2.0 이메일 에셋에 대해 활성화됩니다.

## Marketo 개발자 사이트 {#marketo-developers-site}

[Marketo 개발자 사이트](https://developers.marketo.com/)

새로운 기능과 향상된 기능을 제공합니다.

## 개인 정보 설정 {#privacy-settings}

[개인 정보 설정](/help/marketo/product-docs/administration/settings/understanding-privacy-settings.md)
...
## Facebook 오프라인 전환 {#facebook-offline-conversions}

[Facebook 오프라인 전환](/help/marketo/product-docs/demand-generation/facebook/understanding-facebook-offline-conversions.md)
...
## 감사 추적 개선 사항 {#audit-trail-enhancements}

[감사 추적 개선 사항](/help/marketo/product-docs/administration/audit-trail/change-details-in-audit-trail.md)
...
## 모바일 푸시 알림용 사운드 {#sound-for-mobile-push-notifications}

[모바일 푸시 알림용 사운드](/help/marketo/product-docs/mobile-marketing/push-notifications/configure-mobile-push-notification.md)
...
## Salesforce 암호화와 호환되는 Sales Insight {#sales-insight-compatible-with-salesforce-encryption}

[Salesforce 암호화와 호환되는 Sales Insight](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md)
...
## 명명된 계정 API {#named-accounts-apis}

[명명된 계정 API](https://developers.marketo.com/rest-api/lead-database/named-accounts/)
...
## 이메일 편집기 v2.0 API 지원 {#email-editor-v-api-support}

[이메일 편집기 v2.0 API 지원](https://developers.marketo.com/rest-api/assets/emails/)

Marketo REST API를 사용하여 v2.0 형식의 전자 메일에 대한 변수 및 모듈을 관리합니다.

## Marketo Salesforce 동기화 변경 사항 {#changes-to-marketo-salesforce-sync}

[Marketo Salesforce 동기화 변경 사항](https://nation.marketo.com/docs/DOC-3840)
