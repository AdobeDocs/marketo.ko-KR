...
## 전자 메일 게재 기능 단일 사인온 {#email-deliverability-single-sign-on}

전자 메일 게재 기능 타일을 클릭하면 더 이상 로그인 자격 증명을 제공할 필요가 없습니다.

## 캠페인 우선 순위 지정 {#campaign-prioritization}

여러 개의 개인화된 RTP 캠페인을 설정하고 일부가 다른 캠페인과 겹칠 수 있다는 것을 알고 계십니까? 계속 진행하여 캠페인의 RTP가 다른 캠페인보다 우선하도록 설정합니다.
