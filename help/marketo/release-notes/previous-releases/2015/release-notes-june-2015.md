...
마케팅 활동에 제공하는 개인화 및 권장 콘텐츠 가치를 참조하십시오. [속성 이메일 보고서](/help/marketo/product-docs/web-personalization/reporting-for-web-personalization/email-reports.md)에는 RTP의 개인화 및 권장 콘텐츠 캠페인에서 파생된 직접 및 지원 리드가 표시됩니다. RTP의 사용자 설정 및 이메일 보고서에서 속성 이메일 보고서를 추가하여 월별 또는 분기별 이메일을 수신합니다.
