...
# 릴리스 정보: 2025년 10월 {#release-notes-oct-25}

아래에서 2025년 10월 릴리스에 포함된 모든 기능을 확인할 수 있습니다. 기능 가용성에 대해 Adobe Marketo Engage 에디션을 확인하십시오.
...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>릴리스됨</td>
   <td><a href="/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md" target="_blank">브랜드 테마</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
...
* **_친구에게 전달_ 기능** 사용 중단: 2025년 9월 29일부터 Marketo Engage 2.0 이메일(이전 이메일 편집기)의 _친구에게 전달_ 기능이 모든 구독에서 완전히 사용 중단되었습니다. 이는 이미 토큰을 사용하여 전송되었거나 전송될 예정이었던 이메일의 “친구에게 전달” 토큰과 “친구에게 전달” 링크에 영향을 주었습니다. [자세히 알아보기](https://nation.marketo.com/t5/product-blogs/deprecation-of-forward-to-a-friend/ba-p/358045#M2889){target="_blank"}
