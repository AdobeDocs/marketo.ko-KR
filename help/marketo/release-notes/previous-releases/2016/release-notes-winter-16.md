...
description: 릴리스 노트 - 겨울 '16 - Marketo 문서 - 제품 설명서
title: 릴리스 노트 - 2016년 겨울
...
다음 기능은 2016년 겨울 릴리스에 포함되어 있습니다. 각 기능에 대한 자세한 문서를 보려면 제목 링크를 클릭하십시오.
...
리드 데이터베이스에는 총 인력 데이터베이스 크기, 마케팅 가능한 리드 수, 상위 5개 소스별 리드 분류가 포함된 업데이트된 요약 대시보드가 있습니다.
...
전송 처리를 미리 수행해야 한다는 점을 나타내려면 헤드 시작 을 사용합니다. Head Start는 예정된 시간에 리드를 평가하고 이메일을 준비하는 대신 이러한 작업이 미리 완료되도록 합니다. 이렇게 하면 대상자가 예약된 시간에 이메일 수신을 시작합니다.

![](assets/image2016-1-11-15-3a38-3a3.png)

이 기능을 사용하려면 이메일 프로그램을 최소 12시간 전에 예약해야 하며 전송 12시간 전에 스마트 목록이 잠깁니다.

![](assets/image2016-1-11-15-3a35-3a55.png)

>[!NOTE]
>
>이 기능은 16년 겨울 릴리스 이후 일주일 동안 점진적으로 출시됩니다. 스마트 캠페인 또는 API에서는 사용할 수 없습니다.
...
REST API를 통해 프로그램을 생성, 업데이트 및 복제합니다. 프로그램 내에서 스마트 목록과 스마트 캠페인을 만들거나 업데이트하는 작업이 포함되지 않습니다.
...
**[동기화 상태](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/sync-status.md)**: 현재 처리량과 동기화 프로세스의 백로그를 계속 확인합니다. 개체별 삽입 및 업데이트 개수로 분류합니다.
...
## [사용자 정의 개체 개선 사항](/help/marketo/product-docs/administration/marketo-custom-objects/create-marketo-custom-objects.md) {#custom-objects-enhancements}

이제 여러 링크 필드가 있는 중간 개체를 사용하여 리드/계정과 사용자 지정 개체 간에 다대다 관계를 만들 수 있습니다.
...
## [웹(실시간 개인화) 캠페인 스케줄러](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/schedule-a-web-campaign.md) {#web-real-time-personalization-campaign-scheduler}

캠페인을 미리 예약합니다. 개인화된 웹 컨텐츠에 대한 시작 및 종료 날짜를 설정하고 특정 일 및 시간에 캠페인을 반복합니다. 웹 방문자의 시간 또는 선택한 시간대에 따라 캠페인을 표시하도록 일정을 개인화합니다.
