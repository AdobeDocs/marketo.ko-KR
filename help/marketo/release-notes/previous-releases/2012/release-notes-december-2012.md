...
12월 릴리스에는 많은 기대를 모았습니다 **친구에게 전달** 다른 여러 가지 물건들 뿐만 아니라 특징도 있습니다! 별표(&#42;)은 Select Edition 및 RCA(Revenue Cycle Analytics)에서만 사용할 수 있습니다.

## 친구에게 전달 {#forward-to-friend}

다음을 포함하여 다른 사용자와 컨텐츠 공유 활성화 **친구에게 전달** 링크를 클릭합니다. 새 필터 및 트리거를 추가하면 전달된 이메일과 받은 사용자를 식별하여 영향력 있는 사용자를 식별하는 데 도움이 됩니다.

다음을 포함합니다 **친구에게 전달** 전자 메일의 초대를 열고 편집기에서 열고 `{{system.forwardToFriendLink}}` 토큰.

![](assets/image2014-9-23-10-3a50-3a45.png)

해당 트리거 및 필터를 사용하여 **친구에게 전달** 링크를 클릭합니다.
...
마케팅 프로그램의 영향을 받는 회사의 파이프라인 및 매출 비율을 봅니다. in **매출 탐색기**&#x200B;이제 Opportunity Analysis에서 새로운 &#39;Marketing Instructed Opportunity&#39; 노란색 점을 사용하여 사용자 지정 보고서를 만들 수 있습니다. 표준 폴더에서 다음 두 개의 보고서를 사용할 수도 있습니다.
