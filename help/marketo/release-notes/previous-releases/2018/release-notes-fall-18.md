...
자세한 내용 및 업데이트를 보려면 [Sky 릴리스 노트](https://help.marketo.com)를 확인하십시오.
...
* **이제 Marketo Sky에서 기본 프로그램을 사용할 수 있습니다**. 이제 Marketo Sky에서 기본 프로그램을 지원합니다. 다양한 프로그램 스타일로 원하는 캠페인을 만들 수 있습니다.
* **이메일 프로그램 - 1단계**: 이제 Sky에서 이메일 프로그램을 볼 수 있습니다. 새로운 디자인을 살펴보고 [여러분의 생각을 알려주세요](https://go.marketo.com/NextGenUX---USA---Apr-2018-fcp_Landing-Page-Feedback.html).
...
* **활동별 참여 날짜**: 사용자는 활동 날짜 또는 비용 기간별 참여 지표를 표시하도록 선택할 수 있습니다.
