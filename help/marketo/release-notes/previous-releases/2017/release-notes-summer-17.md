...
**[Campaign 미리 보기 개선 사항](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/preview-and-test-a-web-campaign.md)**

이제 마케팅 실무자는 모든 디바이스에서 웹 캠페인이 멋진 것처럼 보일 수 있습니다 *다음 이전* 실행 중 이러한 향상된 기능을 통해 데스크탑, 모바일 디바이스 및 태블릿 간에 웹 캠페인이 어떻게 렌더링되는지 확인할 수 있습니다. Chrome용 새로운 플러그인은 또한 보다 일관되고 정확한 미리보기를 제공합니다.
