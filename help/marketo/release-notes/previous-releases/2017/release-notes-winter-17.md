...
description: 릴리스 노트 - 겨울 '17 - Marketo 문서 - 제품 설명서
...
다음 기능은 2017년 겨울 릴리스에 포함되어 있습니다. 기능을 사용할 수 있는지 Marketo 버전을 확인하십시오.

각 기능에 대한 자세한 문서를 보려면 제목 링크를 클릭하십시오.

>[!NOTE]
>
>항목에 여러 하위 제목이 있으면 링크가 해당 항목에 배치됩니다.
...
기본 일치에서는 이메일 주소만 사용하지만 새 고급 일치에서는 추가 7개의 필드를 사용하여 더 많은 전환을 위한 일치율을 높입니다.

![](assets/fb-custom-audiences-schebsches.png)

## [사용자 지정 개체 가져오기 API](https://developers.marketo.com/rest-api/lead-database/custom-objects/) {#custom-object-import-api}

이 API는 사용자 지정 개체를 Marketo에 동기화하는 더 빠른 인터페이스를 제공합니다. CSV, TSV 또는 SSV 스프레드시트 파일을 Marketo에 사용자 지정 개체로 가져올 수 있습니다.
...
명명된 계정 가져오기 옵션을 사용하여 CSV 업로드를 통해 여러 레코드를 한 번에 만들거나 업데이트합니다.

![](assets/inatwo.png)

**[이메일 통찰력 지원](/help/marketo/product-docs/reporting/email-insights/filtering-in-email-insights.md)**

이메일 인사이트에서 명명된 계정 또는 계정 목록을 차원으로 사용합니다.
...
특정 소스(이메일, 리치 미디어 또는 권장 사항 막대)에 대한 예측 컨텐츠 분석을 필터링합니다.

![](assets/predictive-content-analytics-by-source.png)

**Predictive Content Editor**

컨텐츠 준비를 소스(이메일, 리치 미디어 또는 권장 사항 막대)별로 분할하는 향상된 편집 환경과 레이아웃이 있습니다.

![](assets/predictive-content-editor.png)

**[Predictive Discovery용 컨텐츠 자동 검색](/help/marketo/product-docs/predictive-content/getting-started/enable-content-discovery.md)**
...
새 필터 옵션인 &quot;시각적 목록의 구성원&quot;을 사용하여 타깃팅을 개선합니다.
...
Marketo의 활동 API에 중요한 변경 사항이 제공됩니다. 준비됐니?
