...
* **영업 기회 사용자 지정 필드**: 영업 기회 사용자 지정 필드가 Marketo Engage에 표시되는 영업 기회 레코드에 대한 더 많은 통찰력을 얻으십시오. Salesforce CRM, Microsoft Dynamics 365 CRM, Sales 기본 통합 또는 기타 API 통합을 통해 영업 기회 사용자 정의 필드 데이터를 봅니다. 영업 기회 세부 정보 및 파이프라인에 대한 완전한 가시성을 통해 영업 팀과 협력하여 업무를 조정하고, 전환을 향상하고, 거래를 보다 신속하게 성사시킬 수 있습니다.
