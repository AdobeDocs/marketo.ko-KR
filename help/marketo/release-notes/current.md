...
<table style="table-layout:auto"> 
 ...
 <tr> 
  ...
  <tr> 
   <td><strong>이메일 Designer - 사용자 지정 CSS</strong>: 이제 이메일을 디자인할 때 이메일 Designer 내에 직접 사용자 지정 CSS를 추가할 수 있습니다.</td> 
   <td>배송됨</td>
  ...
  <tr> 
   <td><strong>이메일 Designer - SpamAssassin으로 스팸 감지</strong>: Marketo Engage에서 SpamAssassin을 사용하여 이메일 콘텐츠를 테스트하고 ISP/사서함 공급자가 스팸으로 표시할 가능성을 확인할 수 있습니다.</td> 
   <td>배송됨</td>
