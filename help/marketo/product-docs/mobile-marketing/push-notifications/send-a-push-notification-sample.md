...
1. 사용할 테스트 장치를 이미 설정한 경우에는 목록에서 선택하십시오.
   ...
   또는 **장치 추가**&#x200B;를 클릭하여 [새 테스트 장치 추가](/help/marketo/product-docs/mobile-marketing/push-notifications/adding-a-new-test-device.md)를 클릭하여 샘플을 보냅니다.

   ![](assets/image2015-7-13-11-3a34-3a21.png)

1. 장치를 앱에 연결하는 방법에는 두 가지가 있습니다.

   첫 번째 옵션을 사용하여 **장치를 사용하여 URL 방문** 단추를 클릭하고 필드에서 URL을 복사하여 전자 메일 또는 문자 메시지로 장치에 보냅니다. 장치에서 URL을 탭합니다. 상태에 연결이 표시되면 **보내기**&#x200B;를 클릭합니다.

   ![](assets/image2015-7-29-8-3a29-3a18.png)

   또는 두 번째 옵션을 사용하여 **장치로 QR 코드 스캔** 단추를 클릭하고 장치로 QR 코드를 스캔합니다. 상태에 연결이 표시되면 **보내기**&#x200B;를 클릭합니다.

   ![](assets/image2015-7-29-8-3a31-3a20.png)

   >[!TIP]
   >
   >테스트 장치를 추가했지만 **보내기** 필드에 테스트 장치가 나열되지 않습니까? 문제를 해결하려면 다음을 확인하십시오.
   >
