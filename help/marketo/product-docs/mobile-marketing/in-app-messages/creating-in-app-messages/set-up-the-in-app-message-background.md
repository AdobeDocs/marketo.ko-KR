...
1. 색상을 설정하려면 **색상**&#x200B;을 클릭한 다음 색상 선택 사각형을 선택합니다. 색상을 클릭하거나 색상 선택기에서 16진수 또는 RGB 코드를 입력하여 선택합니다.
...
1. 배경을 사용하려면 다음을 클릭합니다. **이미지** 그리고 **이미지 선택** 링크를 클릭합니다.
...
1. 선택적 이미지 테두리를 적용합니다. 기본 설정은 다음과 같습니다. **끔**. 먼저 색상을 클릭하거나 색상 선택기에서 16진수 또는 RGB 번호를 입력하여 선택합니다.
...
1. 배경 누르기 작업(기본적으로 끄기)을 설정하려면 상자를 선택합니다.
   ...
   >[!NOTE]
   >
   >배경에 대한 탭 동작의 경우 Apple 및 Android 플랫폼에 대해 서로 다른 동작을 설정할 수 있습니다. 예를 들어 딥링크는 Apple과 Android에서 다르게 처리됩니다. 메시지가 한 플랫폼 또는 다른 플랫폼으로만 이동하는 경우 다른 플랫폼은 기본 설정으로 유지하거나 을 선택합니다 **없음**.

   이 작업을 완료하려면 마지막 단계가 [닫기 단추 설정](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-dismiss-button-and-approve-the-message.md).
