...
인앱 메시지를 만든 후 [여기](/help/marketo/product-docs/mobile-marketing/in-app-messages/sending-your-in-app-message/send-your-in-app-message.md) 전송 방법을 확인하십시오.

1. 다음으로 이동 **마케팅 활동**.

   ![이미지 1](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/assets/create-an-in-app-message-1.png)
...
1. 인앱 메시지의 이름을 입력하고 선택적 설명을 입력한 다음 **만들기**.
...
다음, [레이아웃 선택](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/choose-a-layout-for-your-in-app-message.md) - 인앱 메시지.
