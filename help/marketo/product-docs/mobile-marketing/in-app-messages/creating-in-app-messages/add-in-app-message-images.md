...
1. 레이아웃 탭에서 6개의 템플릿 중 하나를 선택합니다. 세 개의 팝업과 세 개의 전체 화면 옵션이 있습니다.
   ...
   >[!TIP]
   >
   >템플릿과 템플릿의 차이점은 무엇입니까? 다음을 참조하십시오 [인앱 메시지의 레이아웃 선택](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/choose-a-layout-for-your-in-app-message.md) 시작하기 전에

   ![](assets/image2016-5-4-10-3a21-3a33.png)

1. 다음을 클릭합니다. **스타일** 을(를) 탭하고 템플릿의 이미지 영역을 클릭합니다.
...
1. 마음을 바꿔서 다른 이미지를 사용하고 싶으신가요? 문제 없습니다. 다음을 클릭합니다. **X** 이미지 파일 이름 옆에 있습니다.

   ![](assets/image2016-5-6-9-3a0-3a16.png)

1. 클릭 **제거**. 이제 다른 것을 고르세요.
...
1. 이미지 테두리를 적용할 수도 있습니다. 기본 설정은 다음과 같습니다. **끔**. 먼저 색상 선택기를 클릭하거나 색상 선택기에서 16진수 또는 RGB 번호를 입력하여 색상을 선택합니다.
...
1. 여백을 선택합니다(설정 또는 해제). **날짜** 는 기본 설정입니다.
...
1. 각 드롭다운을 클릭하여 옵션을 표시합니다. 하나를 선택하십시오.
   ...
   >[!NOTE]
   >
   >이미지, 단추 또는 배경에 대한 탭 동작의 경우 Apple 및 Android 플랫폼에 대해 서로 다른 동작을 설정할 수 있습니다. 예를 들어 딥링크는 Apple과 Android에서 다르게 처리됩니다. 메시지가 한 플랫폼 또는 다른 플랫폼으로만 이동하는 경우 다른 플랫폼은 기본 설정으로 유지하거나 을 선택합니다 **없음**.

훌륭합니다! 자, 이제 [인앱 메시지에 대한 텍스트 만들기](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/create-in-app-message-text.md).
