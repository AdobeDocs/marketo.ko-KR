...
그래픽, 텍스트 및 단추에 대한 모든 선택 항목이 자동으로 저장되었습니다. 이제 작업을 완료할 준비가 되었습니다.
...
1. 인앱 메시지에 만족하면 **[!UICONTROL Approve & Close]**&#x200B;을(를) 클릭합니다.
   ...
   >[!NOTE]
   >
   >[!UICONTROL Message Actions] 드롭다운에서 직접 **[!UICONTROL Approve & Close]**&#x200B;을(를) 선택할 수도 있습니다(1단계 참조). 하지만 안전을 위해 메시지를 먼저 미리 보는 것은 어떻습니까?
