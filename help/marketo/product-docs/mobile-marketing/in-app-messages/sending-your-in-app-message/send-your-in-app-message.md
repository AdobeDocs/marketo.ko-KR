...
>[!NOTE]
>
>[!UICONTROL App Open]에 의해 트리거된 인앱 메시지를 테스트하는 경우 앱을 휴대폰에 다운로드하고 열어 닫아야 합니다. 이렇게 하면 SDK 코드가 초기화됩니다. 다음에 앱을 열면 인앱 메시지가 표시됩니다. 사용자 지정 이벤트는 앱을 처음 열 때 트리거됩니다.

1. [!UICONTROL Marketing Activities]에서 프로그램을 저장할 폴더를 클릭하고 **[!UICONTROL New Program]**&#x200B;을(를) 선택합니다.
...
1. 드롭다운에서 인앱 프로그램 유형을 선택하고 **[!UICONTROL Create]**&#x200B;을(를) 클릭합니다.
...
1. [!UICONTROL Control Panel]을(를) 사용하여 인앱 메시지의 사용자, 내용, 시기를 정의하고, 완료되면 승인합니다. 각 단계마다 별도의 문서가 있습니다.
