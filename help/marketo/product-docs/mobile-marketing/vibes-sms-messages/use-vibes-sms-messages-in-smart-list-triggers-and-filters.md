...
이후 [Vibes SMS 메시지 만들기](/help/marketo/product-docs/mobile-marketing/vibes-sms-messages/create-a-vibes-sms-message.md), 스마트 캠페인 내의 스마트 목록 트리거 및 필터를 사용하여 이점을 얻고자 합니다. 방법은 다음과 같습니다.
...
SMS 메시지 반송 트리거는 SMS 메시지가 반송될 때 이메일 전송과 같은 플로우를 시작합니다.
...
그와 대조적으로 **바이브 목록 멤버** 필터 찾기 _모든 사용자_ 현재 Vibes를 구독하고 있으며 스마트 캠페인이나 목록에서 사용하기에 가장 적합합니다.
