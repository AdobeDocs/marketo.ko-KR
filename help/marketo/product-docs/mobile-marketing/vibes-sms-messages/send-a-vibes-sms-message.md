---
description: Vibes SMS 메시지 보내기 - Marketo 문서 - 제품 설명서
title: Vibes SMS 메시지 보내기
hide: true
hidefromtoc: true
...
# Vibes SMS 메시지 보내기 {#send-a-vibes-sms-message}

다음을 수행함: [이(가) Vibes SMS 메시지를 만들었습니다.](/help/marketo/product-docs/mobile-marketing/vibes-sms-messages/create-a-vibes-sms-message.md), 이제 전송할 때입니다. 일괄 처리 또는 트리거 캠페인을 통해 전송할 수 있습니다.
