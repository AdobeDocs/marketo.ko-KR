...
# 개발자 {#send-sdk-code-to-a-developer}에게 SDK 코드 보내기

인앱 메시지 또는 푸시 알림을 만들려면 먼저 개발자가 Android 및 iOS 플랫폼용 모바일 앱 SDK를 설정하고 초기화하도록 해야 합니다.

* [Android용 지침](https://developers.marketo.com/documentation/mobile/installation-instructions-on-android/)
* [iOS용 지침](https://developers.marketo.com/documentation/mobile/installation-instructions-on-ios/)

## 개발자 {#send-sdk-code-to-a-developer-1}에게 SDK 코드 보내기
