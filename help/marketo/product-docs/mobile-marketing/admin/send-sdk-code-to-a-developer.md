...
경우에 따라 관리자가 개발자에게 일부 SDK 코드를 보내야 합니다.
...
1. **[!UICONTROL Mobile App Actions]**&#x200B;을(를) 클릭하고 **[!UICONTROL Send to Developer]**&#x200B;을(를) 선택합니다.

   ![](assets/image2015-4-22-17-3a13-3a30.png)

1. 전자 메일 주소를 입력하고 **[!UICONTROL Send]**&#x200B;을(를) 클릭합니다.
