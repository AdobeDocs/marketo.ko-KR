...
1. **[!UICONTROL Push Access Type]**&#x200B;에서 **[!UICONTROL Android]**&#x200B;를 선택하고 **[!UICONTROL Configure]**&#x200B;를 클릭합니다.
...
1. [!UICONTROL Server API Key] 및 [!UICONTROL Project Number]을(를) 입력하십시오. **[!UICONTROL Save]**&#x200B;를 클릭합니다.
