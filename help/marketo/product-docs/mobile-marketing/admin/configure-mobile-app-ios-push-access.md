...
1. [!UICONTROL Push Access Type]에서 iOS을 선택하고 **[!UICONTROL Configure]**&#x200B;을(를) 클릭합니다.

   ![](assets/image2016-6-10-11-3a37-3a9.png)

   >[!NOTE]
   >
   >모바일 앱 개발자의 **[!UICONTROL Certificate]** 및 **[!UICONTROL Password]**&#x200B;이(가) 필요합니다. 개발자는 Apple 개발자 멤버 센터에 로그인하고 앱에 대한 푸시 알림 인증서를 설정 및 다운로드한 다음 콘텐츠를 내보내서 이러한 정보를 수신합니다. 개발자는 내보낼 때 암호를 설정합니다. **중요**: 사용 중인 환경 유형(샌드박스 또는 프로덕션)에 적합한 인증서여야 합니다. Marketo 관리자 또는 모바일 앱 개발자에게 확인하십시오.

1. [!UICONTROL Certificate]을(를) 선택하고 [!UICONTROL Password]을(를) 입력한 다음 **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
