...
>
>* Marketo AI [데이터 정보 시트](/help/marketo/product-docs/marketo-ai/data-information.md){target="_blank"}에서 데이터 범위, 거버넌스 제어 및 PII 고려 사항을 검토합니다.

## 액세스 방법 {#access}

내 Marketo 화면에서 **Marketo AI** 타일을 클릭합니다.
