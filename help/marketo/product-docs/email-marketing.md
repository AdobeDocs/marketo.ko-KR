...
**0&rbrace;일반 이메일 마케팅![일반 이메일 마케팅** ](assets/office-27.png)일반 이메일 마케팅 모든 항목 이메일. [ 우후!](https://docs.marketo.com/display/DOCS/General)     **1&rbrace;전자 메일 프로그램![전자 메일 프로그램** ](assets/chat-messages-10.png)전자 메일 프로그램 A/B를 테스트하고 간단한 4번 클릭 마법사로 실행합니다.[&#128279;](https://docs.marketo.com/display/DOCS/Email+Programs)     **&#x200B; ![점적 배양](assets/ecology-14.png)점적 배양** [점적 배양 강력한 참여 프로그램으로 콘텐츠 스트림과 케이던스를 설정합니다.](https://docs.marketo.com/display/DOCS/Drip+Nurturing)
