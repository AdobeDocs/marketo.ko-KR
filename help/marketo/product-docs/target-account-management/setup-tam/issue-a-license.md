...
description: Target 계정 관리를 사용할 수 있도록 사용자에게 TAM 라이선스를 발급하는 방법을 알아봅니다. 라이선스를 활성화 또는 제거합니다.
title: 라이선스 발급
...
1. **[!UICONTROL Users & Roles]**&#x200B;를 클릭합니다. 라이선스를 발급할 사용자를 선택하고 **[!UICONTROL Issue License]** 드롭다운을 클릭한 다음 **[!UICONTROL Target Account Management]**&#x200B;을(를) 선택합니다.
