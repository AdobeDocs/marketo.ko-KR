...
선택 사항이지만 자동 승격 확인란을 선택하면 작업 시간을 크게 절약할 수 있습니다. 그러나 각 계정을 통과하고 [수동으로 ](/help/marketo/product-docs/target-account-management/target/named-accounts/discover-accounts.md#discover-crm-accounts)추가하려는 경우, 상자를 선택 취소하기만 하면 됩니다.
...
내보내기 상자를 선택하면 지정된 계정 세부 사항 페이지에 ICP 표시기를 볼 수 있을 뿐만 아니라 선택한 ICP 표시기를 [명명된 계정 필터](/help/marketo/product-docs/target-account-management/engage/account-filters.md)에 있는 제한 사항으로 사용할 수 있습니다.
