...
>[!NOTE]
>
>[Web Personalization](/help/marketo/product-docs/web-personalization/using-web-segments/web-segments.md)에서 스마트 목록 및 웹 캠페인을 작성할 때 Marketo [!UICONTROL Target Account Management]에서 만든 계정 목록을 자동으로 사용할 수 있습니다.
