...
description: CSV 파일에서 TAM으로 명명된 계정을 가져오는 방법을 알아봅니다. 목록을 업로드하고 계정 이름 또는 도메인별로 중복 제거 모드를 선택한 다음 필드를 매핑합니다.
...
1. **[!UICONTROL Marketo Field]** 드롭다운을 두 번 클릭하고 적절한 필드를 선택하여 각 필드를 매핑합니다. 완료되면 **[!UICONTROL Next]**&#x200B;를 클릭합니다.
