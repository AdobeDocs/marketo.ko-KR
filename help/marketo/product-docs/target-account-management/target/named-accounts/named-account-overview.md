...
명명 계정은 타깃팅하는 회사의 직원을 보유합니다. 대시보드는 모든 명명된 계정에 대해 각 속성의 현재 데이터를 제공합니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td colspan="1"><strong>계정 스코어</strong></td> 
   <td colspan="1">여러 리드의 리드 점수를 집계하여 계정 수준에서 점수를 제공합니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>도시</strong></td> 
  ...
  <tr> 
   <td colspan="1"><strong>계정 팀원</strong></td> 
