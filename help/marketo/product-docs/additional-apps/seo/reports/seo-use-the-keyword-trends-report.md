...
1. **[!UICONTROL Keyword Rank Trends]**&#x200B;를 클릭합니다.
   ...
   **보고서 항목**
   ...
   | [!UICONTROL Avg. searches] | Google US 검색에서 설정한 범위(최근 30일) 동안 발생한 해당 키워드의 평균 검색 수입니다 |
...
1. [등급] 드롭다운을 클릭하여 키워드를 보려는 등급 범위를 선택합니다.
