...
description: 시간 경과에 따른 경쟁업체의 키워드 등급을 비교합니다.
...
이 보고서에서 사용자와 경쟁업체가 시간 경과에 따라 키워드에 어떻게 순위가 매겨지는지 확인하십시오.
...
지정된 범위에서 키워드의 순위가 몇 퍼센트인지 그리고 경쟁업체가 어떻게 비교하는지 확인하십시오.
...
| [!UICONTROL % in rank] | 설정한 범위에서 키워드가 순위 매겨지는 비율입니다. |
| [!UICONTROL Avg. searches] | 설정한 범위 동안 발생한 해당 키워드에 대한 평균 검색 횟수(Google US 검색에서 최근 30일) |
...
1. **[!UICONTROL Rank]** 드롭다운을 클릭하여 키워드를 보려는 순위 범위를 선택합니다.
