...
1. **[!UICONTROL 경쟁업체 KW 순위 트렌드]**&#x200B;를 클릭합니다.
...
| ] 순위의 [!UICONTROL % | 설정한 범위에서 키워드가 순위인 비율입니다. |
| [!UICONTROL 평균 검색] | 설정한 범위 동안 발생한 해당 키워드에 대한 평균 검색 수입니다(지난 30일 동안, Google 미국 검색 시) |
...
1. **[!UICONTROL 순위]** 드롭다운을 클릭하여 키워드를 볼 순위 범위를 선택합니다.
