...
1. URL을 입력합니다. **추가**&#x200B;를 클릭합니다.
   ...
   >[!TIP]
   >
   >새로 만들거나 기존 목록[에 인바운드 링크를 추가할 수 있다는 사실을 알고 계십니까? ](../../../../product-docs/additional-apps/seo/understanding-seo/seo-managing-lists.md) 확인!

   ![](assets/image2014-9-18-13-3a41-3a14.png)

어서! 이제 목록에 추가된 새 URL이 표시됩니다. 모든 데이터를 수집하는 데 시간이 걸릴 수 있습니다. 인내는 미덕이다.