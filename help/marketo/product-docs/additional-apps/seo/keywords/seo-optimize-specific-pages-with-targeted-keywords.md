...
description: 더 정확한 데이터와 더 나은 개선 권장 사항을 위해 타겟 키워드를 특정 페이지에 지정합니다.
title: SEO - 타기팅된 키워드로 특정 페이지 최적화
...
# SEO - 타기팅된 키워드로 특정 페이지 최적화 {#seo-optimize-specific-pages-with-targeted-keywords}
...
1. 페이지를 최적화하려는 키워드를 선택합니다. **[!UICONTROL Update]**&#x200B;를 클릭합니다.

   >[!TIP]
   >
   >페이지당 3개 이하의 키워드를 사용하는 것이 좋습니다. 이상적으로는, 딱 하나.
