...
목록을 사용하여 모든 키워드를 친절하고 구성할 수 있습니다. 이렇게 하면 특정 키워드에 대한 데이터를 빠르고 쉽게 찾을 수 있습니다.
...
1. 목록에 추가할 키워드 위로 마우스를 가져갑니다. 클릭 **목록에서 추가/제거**.
...
1. 목록에서 제거할 키워드 위로 마우스를 가져갑니다. 클릭 **목록에서 추가/제거**.
