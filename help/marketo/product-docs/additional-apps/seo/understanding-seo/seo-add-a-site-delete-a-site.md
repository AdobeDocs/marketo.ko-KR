...
1. 관리자 드롭다운을 클릭하고 **[!UICONTROL 관리자]**&#x200B;를 선택합니다.
...
1. **[!UICONTROL 사이트 추가]**&#x200B;를 클릭합니다.

   ![](assets/two.png)

1. **[!UICONTROL 이름], [!UICONTROL 웹 사이트 URL]**&#x200B;을 입력하고 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.

   >[!TIP]
   >
   >**[!UICONTROL 블로그 URL]**&#x200B;이 있으면 추가할 수도 있습니다.
...
1. **[!UICONTROL 삭제]**&#x200B;할 것인지 확인하십시오.

   ![](assets/image2014-9-17-21-3a21-3a22.png)

   >[!NOTE]
   >
   >사이트가 두 개 이상 있는 경우에만 삭제할 수 있습니다. 하나만 있는 경우 사이트를 선택하고 **[!UICONTROL 재설정]**&#x200B;을 클릭하여 재설정할 수 있습니다. 사이트를 재설정하면 _모든 사이트 데이터가 삭제_&#x200B;되고 사이트가 다시 만들어집니다.
