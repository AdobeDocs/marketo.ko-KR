...
Marketo 외부의 사용자와 해당 정보를 공유하려면 페이지 문제 데이터를 CSV 파일로 내보낼 수 있습니다. 방법은 다음과 같습니다.
...
1. 세부 정보를 보려는 페이지를 클릭합니다.
   ...
   페이지 세부 정보 드릴다운입니다. **[!UICONTROL Page Optimization Results]**&#x200B;은(는) 해당 특정 페이지의 모든 문제 목록입니다.
