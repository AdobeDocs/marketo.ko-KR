...
## 페이지 문제 섹션에서 메모 추가 {#adding-notes-in-page-issues-section}
...
>[!TIP]
>
>왼쪽 상단에 있는 작은 x를 클릭하여 노트를 삭제할 수 있습니다.

## 페이지 세부 사항 드릴다운에 메모 추가 {#add-notes-in-page-detail-drill-down}
...
1. 메모를 추가할 페이지 문제 위로 마우스를 가져간 후 [메모 추가]를 **클릭합니다**.

   ![](assets/image2014-9-18-13-3a13-3a46.png)

1. 메모를 입력합니다. 저장을 **클릭합니다**.
