...
1. 세그먼트를 드래그 앤 드롭하여 순서를 변경합니다. 완료되면 을(를) 클릭합니다 **만들기**.

   ![](assets/image2014-9-15-10-3a1-3a30.png)

   >[!NOTE]
   >
   >개인은 의 첫 번째 일치하는 세그먼트에 대한 자격을 갖습니다. [주문](/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/segmentation-order-priority.md) 정의됨.
