...
1. **새로 만들기**&#x200B;를 클릭한 다음 **새 세그멘테이션**&#x200B;을 클릭합니다.
...
1. 세그먼트를 드래그하여 놓아 순서를 변경합니다. 완료했으면 **만들기**&#x200B;를 클릭합니다.
   ...
   >[!NOTE]
   >
   >한 사람은 정의된 [주문](/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/segmentation-order-priority.md)에서 첫 번째 일치 세그먼트를 사용할 수 있습니다.
