...
# 세분화별 그룹 이메일 보고서 {#group-email-reports-by-segmentations}
...
1. **[!UICONTROL Email Performance]** 보고서를 선택하십시오.

   ![](assets/image2014-9-16-9-3a16-3a6.png)

1. **[!UICONTROL Setup]** 탭을 클릭하고 **[!UICONTROL Group by Segmentations]** 위로 끌어서 놓습니다.

   ![](assets/image2014-9-16-9-3a16-3a59.png)

1. 보고서를 그룹화하는 데 사용할 하나 또는 두 개의 세그먼트를 선택하십시오. **[!UICONTROL Apply]**&#x200B;를 클릭합니다.

   ![](assets/image2014-9-16-9-3a17-3a9.png)

1. 됐습니다. **[!UICONTROL Report]** 탭을 클릭합니다. 하나의 세그먼테이션을 사용하는 경우 보고서에는 각 세그먼트에 대해 하나의 행이 표시됩니다.
