...
세그먼테이션은 동적 컨텐츠에만 국한되지 않습니다. [이메일 성과 보고서](../../../../product-docs/email-marketing/email-programs/email-program-data/email-performance-report.md)를 [세그먼테이션](https://docs.marketo.com/display/docs/segmentation+and+snippets)별로 그룹화할 수도 있습니다.
