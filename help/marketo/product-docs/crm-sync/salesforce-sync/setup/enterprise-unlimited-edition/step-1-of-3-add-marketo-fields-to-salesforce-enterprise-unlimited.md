...
>[!PREREQUISITES]
>
>Marketo과 Salesforce 간에 동기화하려면 Salesforce API에 대한 액세스 권한이 있어야 합니다.
...
1. 적절한 필드 유형(점수 — 숫자, 획득 프로그램 — 텍스트, 획득 날짜 — 날짜/시간)을 선택합니다.
...
1. Enter 키를 누르지 않고 탐색 검색에 &quot;Fields&quot;를 입력합니다. 필드는 다른 개체 아래에 나타납니다. **필드** 잠재 고객 아래에

   ![](assets/image2016-5-26-16-3a36-3a32.png)

1. 리드 사용자 정의 필드 및 관계 섹션으로 이동한 다음 **리드 필드 매핑**.
