...
1. 왼쪽의 [작성] 메뉴에서 [사용자 정의]를 클릭하고 리드를 선택합니다. 필드를 클릭합니다.
...
1. 저장 및 새로 만들기를 클릭하여 뒤로 돌아가 다른 두 사용자 정의 필드를 각각 만듭니다. 3개 모두 완료하면 저장을 클릭합니다.

   ![](assets/image2016-5-23-15-3a8-3a43.png)

1. 왼쪽의 [작성] 메뉴에서 [사용자 정의]를 클릭하고 [연락처]를 선택합니다. 필드를 클릭합니다.
