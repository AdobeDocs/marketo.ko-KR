...
1. 데이터베이스 관리 메뉴에서 **[!UICONTROL Salesforce 개체 동기화]**.

   ![](assets/two-2.png)

1. 첫 번째 사용자 지정 개체인 경우 **[!UICONTROL 동기화 스키마]**. 그렇지 않으면 클릭 **[!UICONTROL 스키마 새로 고침]** 최신 버전을 확인합니다.

   ![](assets/image2014-12-10-10-3a14-3a44.png)

1. 전역 동기화가 실행 중인 경우 다음을 클릭하여 비활성화해야 합니다. **[!UICONTROL 전역 동기화 비활성화]**.
...
1. 동기화할 개체를 선택하고 **[!UICONTROL 동기화 활성화]**.
...
1. 로 돌아가기 **[!DNL Salesforce]** tab 키를 누른 다음 클릭 **[!UICONTROL 동기화 활성화]**.
...
1. 스마트 목록에서 **[!UICONTROL 영업 기회 있음]** 필터링 및 다음으로 설정 **[!UICONTROL true]**.
