...
다음 [Marketo 동기화 사용자](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md) salesforce 캠페인 동기화가 제대로 작동하려면 마케팅 사용자여야 합니다. 다음은 Salesforce에서 사용자를 마케팅 사용자로 만드는 방법입니다.

>[!NOTE]
>
>**관리자 권한 필요**

1. Salesforce에 로그인합니다. 왼쪽 검색 막대에서 사용자를 검색하고 **사용자** 아래에 **사용자 관리**.
