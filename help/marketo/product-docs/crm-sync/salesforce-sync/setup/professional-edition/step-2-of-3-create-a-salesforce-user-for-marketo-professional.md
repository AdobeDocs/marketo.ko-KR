...
1. **[!UICONTROL Enter]**&#x200B;을(를) 누르지 않고 탐색 검색 창에 &quot;[!UICONTROL page layouts]&quot;을(를) 입력한 다음 **[!UICONTROL Leads]** 아래의 **[!UICONTROL Page Layout]**&#x200B;을(를) 클릭합니다.
...
1. **[!UICONTROL Contact Page Layout]** 작업이 완료되면 **[!UICONTROL Save]**&#x200B;을(를) 클릭해야 합니다.
...
이제 Marketo에서 [!DNL Salesforce]에 연결하는 데 사용할 수 있는 계정이 있습니다.
