...
세 개의 사용자 정의 필드 각각에 대해 다음 단계를 수행하여 추가합니다. **[!UICONTROL 점수]**(으)로 시작합니다.

1. Salesforce에 로그인하고 **[!UICONTROL 설정]**&#x200B;을 클릭합니다.

   ![](assets/image2016-5-23-13-3a15-3a21.png)

1. 왼쪽의 빌드 메뉴에서 **[!UICONTROL 사용자 지정]**&#x200B;을 클릭하고 **[!UICONTROL 리드]**&#x200B;를 선택합니다. **[!UICONTROL 필드]**&#x200B;를 클릭합니다.
...
1. 적절한 필드 유형(점수 - **[!UICONTROL 숫자]**, 획득 프로그램 - **[!UICONTROL 텍스트]**, 획득 날짜 - **날짜/시간**)을 선택합니다.
...
1. 왼쪽의 빌드 메뉴에서 **[!UICONTROL 사용자 지정]**&#x200B;을 클릭하고 **[!UICONTROL 연락처]**&#x200B;를 선택합니다. **[!UICONTROL 필드]**&#x200B;를 클릭합니다.
...
1. Enter 키를 누르지 않고 탐색 검색에 &quot;[!UICONTROL 필드]&quot;을(를) 입력하십시오. 다른 개체에 필드가 표시됩니다. [리드]에서 **[!UICONTROL 필드]**&#x200B;를 클릭하세요.
