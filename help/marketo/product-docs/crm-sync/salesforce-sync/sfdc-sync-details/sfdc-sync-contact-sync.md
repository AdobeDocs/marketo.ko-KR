...
Marketo은 전체 데이터베이스를 [!DNL Salesforce]과(와) 동기화합니다. 동기화한 후 5분을 기다린 후 다시 매일 하루 종일 동기화합니다. 다음은 Marketo에서 [!DNL Salesforce] 연락처를 구체적으로 처리하는 방법에 대한 세부 정보입니다.
...
[!DNL Salesforce]이(가) 이기도록 하겠습니다. 이러한 데이터 충돌이 발생하는 경우는 거의 없습니다.
