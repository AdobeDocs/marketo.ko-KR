...
# Marketing To 동기화 {#hide-a-salesforce-field-from-the-marketo-sync}에서 Salesforce 필드 숨기기

>[!NOTE]
>
>**관리자 권한 필요**

Salesforce의 모든 필드가 마케팅에 유용한 것은 아닙니다. 필요한 필드만 포함하여 동기화 성능을 최적화할 수 있습니다. Marketing To에서 필드를 숨길 수 있는 방법은 다음과 같습니다.
...
1. 숨길 필드 옆에 있는 **Visible** 확인란의 선택을 취소합니다. **저장**&#x200B;을 클릭합니다.
   ...
   >[!NOTE]
   >
   >Salesforce에서 숨긴 필드가 이미 Marketing To와 동기화된 경우 사용하지 않으려면 Marketing To에서도 숨겨야 합니다.
