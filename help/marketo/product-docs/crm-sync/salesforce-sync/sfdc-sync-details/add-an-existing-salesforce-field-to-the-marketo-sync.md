...
description: 기존 Salesforce 필드를 Marketo 동기화에 추가하는 방법을 알아봅니다. 다음 주기에서 동기화되도록 Salesforce의 동기화 사용자에게 필드를 표시합니다.
...
1. 왼쪽 검색 창에 &quot;프로필&quot;을 입력하고 **[!UICONTROL Manage Users]** 아래의 **[!UICONTROL Profiles]**&#x200B;을(를) 클릭합니다.
