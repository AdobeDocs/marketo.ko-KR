...
description: 동기화하기 전에 Marketo 프로그램 상태를 Salesforce 캠페인 멤버 상태와 일치시키는 방법을 알아봅니다. 프로그램이 캠페인과 동기화되도록 오류를 수정하고 상태를 매핑합니다.
title: 동기화 전 프로그램 상태와 Salesforce 캠페인 상태를 일치시키는 방법
