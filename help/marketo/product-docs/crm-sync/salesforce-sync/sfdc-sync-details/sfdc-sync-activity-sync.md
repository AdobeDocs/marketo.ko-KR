...
description: Salesforce 활동 및 작업이 Marketo과 동기화되는 방법에 대해 알아봅니다. Marketo에서 작업을 만들고 스마트 캠페인에서 활동 트리거 및 필터를 사용합니다.
...
동기화는 [!DNL Salesforce]에서 Marketo으로 가는 한 가지 방법입니다. [작업 만들기](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/create-task.md) 흐름 단계 또는 [활동 동기화 사용자 지정](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/customize-activities-sync.md)을(를) [!DNL Salesforce]에 사용하여 [!DNL Salesforce]에서 작업을 만들 수 있습니다.
