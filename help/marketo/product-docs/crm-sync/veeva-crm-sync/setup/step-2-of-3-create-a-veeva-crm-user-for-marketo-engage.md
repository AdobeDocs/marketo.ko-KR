...
1. Enter 키를 누르지 않고 탐색 검색 막대에서 계정(개인 계정) 페이지 레이아웃을 클릭한 다음 **[!UICONTROL 페이지 레이아웃]** 연락처 아래에 있는 왼쪽 탐색 레일에 있는 왼쪽 탐색 레일에 있는 왼쪽 탐색 레일에 있는 왼쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 왼쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있는 오른쪽 탐색 레일에 있습니다.
...
1. 클릭 **[!UICONTROL HCP - 전문가]**.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-3.png)

1. 새 항목 클릭 및 드래그 **[!UICONTROL 섹션]** 를 페이지 레이아웃에 추가합니다.

1. 섹션 이름에 &quot;Marketo&quot;를 입력하고 클릭 **[!UICONTROL 확인]**.
...
1. HCP-Professional 레이아웃 작업을 마치면 **[!UICONTROL 저장]**.
...
1. 표준 사용자를 선택하고 프로필 이름을 &quot;Marketo-Salesforce Sync&quot;로 지정한 후 **[!UICONTROL 저장]**.
...
1. 관리 권한 섹션에서 다음을 확인하십시오 **[!UICONTROL API 활성화됨]** 이(가) 선택되어 있습니다.
...
1. 일반 사용자 권한 섹션에서 다음을 확인하십시오 **[!UICONTROL 이벤트 편집]** 및 **[!UICONTROL 작업 편집]** 이(가) 선택되어 있습니다.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-13.png)

1. 표준 객체 권한 섹션에서 다음을 확인합니다 **[!UICONTROL 읽기]**, **[!UICONTROL 만들기]**, **[!UICONTROL 편집]**, 및 **[!UICONTROL 삭제]** 계정 및 연락처에 대한 권한을 확인합니다.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-14.png)

1. 사용자 지정 개체 권한 섹션에서 읽기 권한이 선택되어 있는지 확인합니다 **[!UICONTROL 호출]**, **[!UICONTROL 호출 키 메시지]**&#x200B;및 기타 원하는 사용자 지정 개체.
...
1. 프로필 세부 사항 페이지에서 [!UICONTROL 필드 수준 보안] 섹션. 클릭 **[!UICONTROL 보기]** 연락처 및 계정 개체에 대한 액세스 가능성을 편집합니다.
...
1. 불필요한 필드를 찾아 읽기 액세스 및 편집 액세스 권한이 있는지 확인합니다. _선택되지 않음_. 클릭 **[!UICONTROL 저장]** 완료 시.
...
1. 모든 불필요한 필드 비활성화를 완료한 후 다음 개체 필드에 대해 읽기 액세스 및 액세스 편집 을 선택합니다. 클릭 **[!UICONTROL 저장]** 완료 시.
...
1. 탐색 검색 막대에 &quot;users&quot;를 입력하고 **[!UICONTROL 사용자]** 사용자 관리에서 참조할 수 있습니다.
...
1. 필수 필드를 입력하고 사용자 라이선스: Salesforce를 선택하고 프로필: Marketo 동기화 사용자를 설정한 다음 을 클릭합니다. **[!UICONTROL 저장]**.
