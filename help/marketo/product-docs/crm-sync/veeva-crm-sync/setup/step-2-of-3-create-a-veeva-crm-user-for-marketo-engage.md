---
description: Marketo Engage 동기화용 Veeva CRM 사용자를 만드는 방법을 알아봅니다. 페이지 레이아웃을 설정하고, 동기화 사용자를 만들고, 필드 업데이트에 대한 권한을 할당합니다.
...
1. Enter 키를 누르지 않고 탐색 검색 막대에서 **[!UICONTROL Account]**(개인 계정) 페이지 레이아웃을 클릭하고 [!UICONTROL Contacts] 아래의 **[!UICONTROL Page Layout]**&#x200B;을(를) 클릭합니다.
...
1. **[!UICONTROL HCP - Professional]**&#x200B;를 클릭합니다.
...
1. [!UICONTROL General User Permissions] 섹션에서 [!UICONTROL Edit Events] 및 [!UICONTROL Edit Tasks]이(가) 선택되었는지 확인합니다.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-13.png)

1. [!UICONTROL Standard Object Permissions] 섹션에서 [!UICONTROL Accounts] 및 [!UICONTROL Contacts]에 대해 [!UICONTROL Read], [!UICONTROL Create], [!UICONTROL Edit] 및 [!UICONTROL Delete] 권한을 검사했는지 확인하십시오.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-14.png)

1. [!UICONTROL Custom Object Permissions] 섹션에서 [!UICONTROL Call], [!UICONTROL Call Key Message] 및 기타 원하는 사용자 지정 개체에 대해 [!UICONTROL Read] 권한을 검사했는지 확인하십시오.
...
1. [!UICONTROL profile detail] 페이지에서 **[!UICONTROL Field-Level Security]** 섹션으로 이동합니다. [!UICONTROL Contact] 및 [!UICONTROL Account] 개체에 대한 액세스 가능성을 편집하려면 **[!UICONTROL View]**&#x200B;을(를) 클릭하십시오.
...
1. 탐색 검색 창에 &quot;사용자&quot;를 입력하고 [!UICONTROL Manage Users] 아래의 **[!UICONTROL Users]**&#x200B;을(를) 클릭합니다.
...
이제 Marketo Engage에서 [!DNL Veeva] CRM에 연결하는 데 사용할 수 있는 계정이 있습니다.
