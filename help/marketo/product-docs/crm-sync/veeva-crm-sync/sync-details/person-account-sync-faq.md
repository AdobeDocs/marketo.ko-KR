...
**두 시스템 모두에서 개인 계정의 연락처 필드를 동시에 변경하는 경우 어떻게 합니까?**

Veeva CRM이 이길 수 있도록 하겠습니다. 그러나 이러한 데이터 충돌이 발생하는 경우는 거의 없습니다.

**리드 또는 연락처 유형의 레코드가 Veeva CRM과 동기화됩니까?**
...
**Marketo은 Veeva 유효성 검사 규칙을 준수합니까?**
