...
1. 첫 번째 사용자 지정 개체인 경우 스키마 동기화를 클릭합니다. 그렇지 않은 경우 **스키마 새로 고침** 최신 버전을 확인합니다.

   ![](assets/enable-disable-custom-object-sync-2.png)

1. 전역 동기화가 실행 중인 경우 다음을 클릭하여 비활성화합니다. **전역 동기화 비활성화**.
...
1. Veeva 탭으로 돌아가서 를 클릭합니다. **동기화 활성화**.
...
1. 스마트 목록에서 &quot;Has Opportunity&quot; 필터 위로 끌어서 다음으로 설정합니다. **True**.
