...
[!DNL Veeva]과(와) Marketo Engage 간의 동기화는 개인 계정 개체의 연락처 필드에 대해서만 양방향입니다. 이러한 경우 [!DNL Veeva] 또는 Marketo Engage에서 변경할 때마다 업데이트가 두 시스템에 반영됩니다. 다른 모든 동기화는 [!DNL Veeva]에서 Marketo Engage으로만 동기화됩니다. 각각에 대한 자세한 내용을 보려면 아래 링크를 클릭하십시오.
...
* [사용자 정의 오브젝트](/help/marketo/product-docs/crm-sync/veeva-crm-sync/sync-details/custom-object-sync.md){target="_blank"}
