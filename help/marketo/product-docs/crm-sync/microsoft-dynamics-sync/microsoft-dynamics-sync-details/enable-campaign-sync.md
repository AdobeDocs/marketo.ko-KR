---
description: Microsoft Dynamics과 Marketo 간에 Campaign 동기화를 활성화하는 방법을 알아봅니다. Marketo 프로그램이 Dynamics 캠페인과 동기화되도록 관리에서 옵션을 설정합니다.
title: 캠페인 동기화 활성화
...
동기화에서 [!DNL Microsoft Dynamics]의 데이터를 가져올 시간을 지정하십시오.
