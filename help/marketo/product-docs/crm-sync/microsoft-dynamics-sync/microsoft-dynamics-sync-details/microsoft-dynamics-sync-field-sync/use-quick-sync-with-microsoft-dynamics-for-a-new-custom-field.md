...
1. 빠르게 동기화할 필드를 선택하고 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
1. **[!UICONTROL 고급 동기화]**&#x200B;를 클릭합니다.

   ![](assets/image2016-8-25-15-3a52-3a9.png)

1. **[!UICONTROL 업데이트됨]**&#x200B;을(를) 선택하고 날짜 선택기를 사용하여 날짜 범위를 선택하십시오. **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
1. 필드를 선택 취소하고 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.

   ![](assets/image2016-8-25-16-3a16-3a32-1.png)

1. 필드를 다시 선택하고 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
