...
Marketo에서 Dynamics로의 동기화 기능은 매우 강력합니다. 영업 기회 동기화에 대한 모든 세부 사항은 다음과 같습니다.

## 두 시스템 간에 영업 기회 세부 정보가 어떻게 동기화됩니까? {#how-are-opportunity-details-kept-in-sync-between-the-two-systems}

기회 동기화는 한 가지 방법입니다. Dynamics와 Marketo. Dynamics에서 기회를 변경하면 업데이트가 Marketo에 반영됩니다.

## Marketo을 사용하여 Dynamics에서 기회를 만들 수 있습니까? {#can-i-create-an-opportunity-in-dynamics-using-marketo}

아니요. Dynamics에서 기회를 만들어야 하며 이 기회가 자동으로 Marketo에 동기화됩니다.
