...
예, [사용자와 Microsoft 동기화](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md){target="_blank"} 흐름 액션을 사용하십시오. 잠재 고객이 없는 경우 Dynamics에서 잠재 고객이 생성됩니다. 잠재 고객이 존재하는 경우 흐름 단계에서 아무 작업도 수행되지 않습니다.
...
아니요. 자동화된 백그라운드 동기화는 Marketo과 Dynamics 간에 업데이트를 동기화하는 유일한 방법입니다. [사용자를 Microsoft에 동기화](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md){target="_blank"} 흐름 작업은 잠재 고객의 동기화를 강제하지 않습니다.
