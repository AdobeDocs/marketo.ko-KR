...
# Microsoft [!DNL Dynamics] 동기화: 사용자 동기화 {#microsoft-dynamics-sync-user-sync}
...
통합을 위해서는 전용 Microsoft [!DNL Dynamics] CRM 사용자가 필요합니다. 이 사용자를 동기화 사용자라고 합니다.

## 두 시스템 간에 사용자 세부 사항이 어떻게 동기화됩니까? {#how-are-user-details-kept-in-sync-between-the-two-systems}

사용자 동기화는 Marketo에 [!DNL Dynamics]하는 한 가지 방법입니다. [!DNL Dynamics]에서 사용자를 변경하면 변경 내용이 Marketo에 반영됩니다.

## Marketo을 사용하여 사용자를 만들 수 있습니까? {#can-i-create-an-user-using-marketo}

아니요. Marketo은 [!DNL Dynamics]에서 사용자를 만들 수 없습니다.
