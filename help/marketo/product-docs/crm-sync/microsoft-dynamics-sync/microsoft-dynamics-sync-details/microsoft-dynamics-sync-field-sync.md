...
[!DNL Dynamics]에 대한 Marketo 동기화가 강력합니다. 세부사항은 다음과 같습니다.
...
예, 동기화 사용자가 [!DNL Dynamics]에서 해당 필드에 액세스할 수 있는 한 [필드를 동기화](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-4-of-4-connect.md#select-fields-to-sync)할 수 있습니다.
