...
* [맞춤형 엔티티](microsoft-dynamics-sync-details/microsoft-dynamics-sync-custom-entity-sync.md)
...
Dynamics 동기화에 대한 많은 미묘한 차이와 기능이 있습니다. [Microsoft Dynamics 동기화 세부 정보 섹션](http://docs.marketo.com/display/docs/microsoft+dynamics+sync+details)에서 세부 정보를 확인하십시오.
...
>* [설정 동기화](http://docs.marketo.com/display/docs/sync+setup)
   >
   >
* [Microsoft Dynamics 동기화 세부 사항](http://docs.marketo.com/display/docs/microsoft+dynamics+sync+details)
