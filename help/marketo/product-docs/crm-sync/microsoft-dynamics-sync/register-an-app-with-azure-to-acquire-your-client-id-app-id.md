...
1. 관리자 권한이 있는 계정을 사용하여 Microsoft Azure 관리 포털에 [로그인](https://login.microsoftonline.com/){target="_blank"}합니다. 왼쪽 탐색 창에서 **[!UICONTROL Admin]** 항목을 확장하고 **[!UICONTROL Azure AD]**&#x200B;을(를) 선택하여 Office 365 관리 센터를 통해 Microsoft Azure 포털에 액세스할 수도 있습니다.
   ...
   >
   >
   >Azure 계정이 있지만 Azure 구독에서 [!DNL Office 365]을(를) 가진 [!DNL Microsoft Dynamics 365] 구독을 사용할 수 없는 경우 [다음 지침](https://msdn.microsoft.com/office/office365/howto/setup-development-environment#bk_CreateAzureSubscription){target="_blank"}에 따라 두 계정을 연결하세요.
