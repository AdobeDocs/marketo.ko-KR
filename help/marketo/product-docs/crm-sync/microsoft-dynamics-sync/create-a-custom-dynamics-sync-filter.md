...
>[!PREREQUISITES]
>
>최신 버전의 Marketo 플러그인(3.0.0.1 이상)을 설치합니다. Marketo > [!UICONTROL Admin] > [!DNL Microsoft Dynamics] > [!UICONTROL Download Marketo Solution]&#x200B;(으)로 이동합니다.
...
1. **[!UICONTROL Entities]** 옆에 있는 ![](assets/image2015-8-10-21-3a44-3a23.png)을(를) 클릭합니다.

   ![](assets/image2015-8-10-21-3a43-3a39.png)

1. **[!UICONTROL Lead]** 옆의 ![](assets/image2015-8-10-21-3a44-3a23.png)을(를) 클릭하고 **[!UICONTROL Fields]**&#x200B;을(를) 선택합니다. 그런 다음 **[!UICONTROL New]**&#x200B;를 클릭합니다.

   ![](assets/image2015-8-10-21-3a49-3a49.png)

1. **[!UICONTROL Display Name]** 필드에 **SyncToMkto**&#x200B;을(를) 입력하고 **[!UICONTROL Two Options]**&#x200B;을(를) **[!UICONTROL Data Type]**(으)로 선택합니다. 그런 다음 **[!UICONTROL Save and Close]**&#x200B;를 클릭합니다.
...
초기 동기화가 완료되었더라도 로 이동하여 Marketo과 동기화할 필드를 선택합니다.
...
이제 Marketo에 대한 동기화 필터를 활성화했습니다.

## 동기화 필터 값을 자동으로 할당할 [!DNL Dynamics] 워크플로를 만듭니다. {#create-a-dynamics-workflow-to-assign-sync-filter-values-automatically}

레코드의 SyncToMkto 필드에 값을 항상 수동으로 할당할 수 있습니다. 그러나 레코드를 만들거나 업데이트할 때 [!DNL Dynamics] 워크플로의 기능을 활용하고 SyncToMkto 필드에 값을 자동 할당하는 것은 어떻습니까?

>[!NOTE]
>
>데이터베이스 수준에서는 이 작업을 수행할 수 없습니다. CRM에서 수동으로 또는 워크플로우를 사용하여 수행해야 합니다.
>
>[!DNL Dynamics] 워크플로는 앞으로 만들어진 새 레코드에서만 작동하며 이전 데이터에서는 작동하지 않습니다. 배치 업데이트를 사용하여 기존 레코드로 이동합니다.
...
1. 워크플로 이름을 입력하고 **[!UICONTROL Workflow]**&#x200B;을(를) [!UICONTROL Category]&#x200B;(으)로, **[!UICONTROL Lead]**&#x200B;을(를) [!UICONTROL Entity]&#x200B;(으)로 선택합니다. **확인**&#x200B;을 클릭합니다.
...
1. 조직의 기본 설정에 따라 **SyncToMkto** 필드에 true 또는 false 값을 할당하는 규칙을 만듭니다. **[!UICONTROL Save and Close]**&#x200B;를 클릭합니다.
   ...
   >[!NOTE]
   >
   >**[!UICONTROL Add Step]**&#x200B;을(를) 클릭하여 Check Condition을 추가한 후에 Default Action을 정의합니다. **아니요**&#x200B;에 동기화하지 않으려는 레코드를 설정합니다. 그렇지 않으면 동기화됩니다.

1. 워크플로를 선택하고 **[!UICONTROL Activate]**&#x200B;을(를) 클릭합니다.
