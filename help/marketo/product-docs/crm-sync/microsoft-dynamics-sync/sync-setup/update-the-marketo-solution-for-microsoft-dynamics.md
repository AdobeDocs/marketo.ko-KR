...
>[!CAUTION]
>
>업데이트를 수행하려면 최신 Marketo 솔루션 _before_&#x200B;을(를) 다운로드해야 합니다.
...
1. [!DNL Microsoft Dynamics] 버전에 적합한 솔루션을 선택하십시오.
   ...
   이제 솔루션의 zip 파일이 장치에 다운로드됩니다. 설치 단계에 익숙하지 않은 경우 [!UICONTROL Dynamics] 관리자에게 문의하십시오.
...
>[!CAUTION]
>
>업데이트 대신 업그레이드를 선택하면 [!DNL Dynamics] 환경에서 데이터가 손상될 수 있습니다. [!UICONTROL Import Options]에서 **업데이트를 선택**&#x200B;합니다.
