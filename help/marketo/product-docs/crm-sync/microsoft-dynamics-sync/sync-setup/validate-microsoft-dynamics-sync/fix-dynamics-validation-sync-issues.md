...
## 동기화 사용자가 Marketo 동기화 사용자 역할 {#sync-user-is-assigned-to-the-marketo-sync-user-role}에 할당되었습니다.

여기에 ![—](assets/delete.png)이 있는 경우 Marketo 동기화 사용자 역할이 Microsoft Dynamics에서 선택되었는지 확인해야 합니다. Microsoft Dynamics 설치 설명서의 2단계를 참조하십시오.
...
1. Marketo 사용자 동기화 역할이 선택되어 있는지 확인합니다. 없는 경우 확인하고 **확인**&#x200B;을 클릭합니다.

   ![](assets/image2015-9-24-9-3a59-3a21.png)

## Marketo 솔루션이 {#marketo-solution-is-properly-installed}에 올바르게 설치됨

여기에 ![—](assets/delete.png)이 있는 경우 Microsoft Dynamics로 이동하여 Marketo 설치가 있는지 확인합니다. Microsoft Dynamics 설정 설명서의 1단계를 참조하십시오.
...
## 동기화 사용자가 Marketo 솔루션 {#sync-user-is-assigned-to-the-marketo-solution}에 할당되었습니다.

여기에 ![—](assets/delete.png)이 있는 경우 동기화 사용자가 Microsoft Dynamics의 Marketo 기본 페이지에 할당되었는지 확인하십시오.
...
여기에 ![—](assets/delete.png)가 있는 경우 Microsoft Dynamics의 Marketo 구성 기본 설정 단계에서 Marketo 사용자 필드에 적절한 동기화 사용자를 할당해야 합니다.
