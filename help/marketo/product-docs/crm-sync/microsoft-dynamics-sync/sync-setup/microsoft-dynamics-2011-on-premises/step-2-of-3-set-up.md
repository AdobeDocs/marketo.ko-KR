...
1. **설정**&#x200B;을 선택합니다. 그런 다음 트리에서 **Marketing Config **를 선택합니다.
   ...
   >[!NOTE]
   >
   >Marketing To 구성이 없는 경우 페이지를 새로 고쳐 보십시오. 문제가 지속되면 [Marketing 솔루션을 다시 게시하거나](step-1-of-3-install.md) 로그아웃했다가 다시 로그인합니다.
