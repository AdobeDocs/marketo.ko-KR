...
# 3단계 중 1단계:Marketo 솔루션 설치(2011 온-프레미스) {#step-of-install-the-marketo-solution-on-premises}
...
1. **찾아보기**&#x200B;를 클릭합니다. [다운로드한 Marketo 리드 관리 솔루션을 선택합니다](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). **다음**&#x200B;을 클릭합니다.
...
1. Marketo 리드 관리를 선택하고 **모든 사용자 지정 게시를 클릭합니다.**
