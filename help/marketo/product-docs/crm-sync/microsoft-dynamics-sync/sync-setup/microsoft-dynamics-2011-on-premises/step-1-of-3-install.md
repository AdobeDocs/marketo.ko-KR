...
title: 3단계 중 1단계 - Marketing Solution 설치(2011 온프레미스)
...
# 3단계 중 1단계:Marketing Solution(2011 온프레미스) 설치 {#step-of-install-the-marketo-solution-on-premises}
...
1. Dynamics **에**&#x200B;로그인한 다음 왼쪽 **하단** 메뉴에서 설정을 선택합니다.
...
1. 찾아보기를 **클릭합니다**. 다운로드한 Marketing To 리드 관리 솔루션을 [선택합니다](../../../../../product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). 다음을 **클릭합니다**.
...
1. SDK 메시지 옵션 확인란이 선택되어 있는지 확인합니다. 다음을 **클릭합니다**.
