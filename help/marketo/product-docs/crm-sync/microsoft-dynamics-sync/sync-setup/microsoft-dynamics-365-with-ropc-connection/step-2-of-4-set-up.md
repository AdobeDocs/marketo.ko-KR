...
1. Dynamics에 로그인합니다. 설정 아이콘을 클릭하고 다음을 선택합니다. **[!UICONTROL 고급 설정]**.
...
1. 클릭 **[!UICONTROL 사용자 추가 및 라이센스 부여]** 새 창에서 을 클릭합니다.

   ![](assets/five.png)

1. 새 탭이 열립니다. 클릭 **[!UICONTROL 관리자]** 을 클릭합니다.

   ![](assets/six.png)

1. 다른 새 탭이 열립니다. 클릭 **[!UICONTROL 사용자 추가]**.
...
1. 새 사용자 자격 증명을 받을 이메일을 입력하고 **[!UICONTROL 이메일 전송 및 닫기]**.
...
1. 로 돌아가기 **[!UICONTROL 활성화된 사용자]** 을 탭하고 사용자 목록을 새로 고칩니다.
...
1. 고급 설정 섹션으로 돌아가서 ![](assets/image2015-5-13-15-3a49-3a19.png) 아이콘을 클릭하고 **[!UICONTROL Marketo 구성]**.
   ...
   >[!NOTE]
   >
   >표시되지 않으면 **[!UICONTROL Marketo 구성]** 설정 메뉴에서 페이지를 새로 고칩니다. 그래도 안 되면 [Marketo 솔루션 게시](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-1-of-4-install.md){target="_blank"} 다시 로그인하거나 로그아웃했다가 다시 로그인합니다.
