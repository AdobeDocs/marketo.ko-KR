...
1. [!UICONTROL Advanced Settings] 섹션으로 돌아가서 [!UICONTROL Settings] 옆에 있는 ![](assets/image2015-5-13-15-3a49-3a19.png) 아이콘을 클릭하고 **[!UICONTROL Marketo Config]**&#x200B;을(를) 선택합니다.
   ...
   >[!NOTE]
   >
   >[!UICONTROL Settings] 메뉴에 **[!UICONTROL Marketo Config]**&#x200B;이(가) 없으면 페이지를 새로 고치세요. 그래도 작동하지 않으면 [Marketo 솔루션을 다시 게시](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-1-of-4-install.md)하거나 로그아웃했다가 다시 로그인하세요.
