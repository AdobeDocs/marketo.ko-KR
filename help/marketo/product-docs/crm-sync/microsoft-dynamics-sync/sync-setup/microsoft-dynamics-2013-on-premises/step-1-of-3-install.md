...
# 3단계 중 1단계:Dynamics(2013 온-프레미스) {#step-of-install-the-marketo-solution-in-dynamics-on-premises}에 Marketo 솔루션 설치
...
>
>[시작하기 전에 Marketo ](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md) 솔루션을 다운로드하십시오.
