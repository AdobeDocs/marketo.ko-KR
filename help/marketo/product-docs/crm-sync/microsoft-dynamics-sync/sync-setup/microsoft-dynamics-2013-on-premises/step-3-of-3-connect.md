...
1. 사용자 **이름**, 암호 **및 Microsoft Dynamics** URL을 **입력한 다음** ****&#x200B;저장클릭합니다.

   ![](assets/image2015-3-26-11-3a47-3a59.png)

   >[!NOTE]
   >
   >Marketing의 사용자 이름은 CRM의 동기화 사용자의 사용자 이름과 일치해야 합니다. 형식은 DOMAIN\ [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#631610061123070c0e020a0d4d000c0e) user일 수 있습니다.
