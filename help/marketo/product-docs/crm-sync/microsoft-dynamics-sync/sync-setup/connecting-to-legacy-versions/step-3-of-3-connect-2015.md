...
1. 다음을 입력합니다. **[!UICONTROL 사용자 이름]**, **[!UICONTROL 암호]** Microsoft Dynamics **[!UICONTROL URL]**, 및 **클라이언트 ID/암호**. 클릭 **[!UICONTROL 저장]** 완료 시.
   ...
   >[!TIP]
   >
   >URL을 모르십니까? 찾는 방법을 보여 드리겠습니다. [Dynamics 조직 서비스 URL](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/view-the-organization-service-url.md){target="_blank"} 여기.
