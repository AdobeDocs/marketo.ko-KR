...
>[!PREREQUISITES]
>
>[Microsoft Dynamics 2015용 Marketo 설치 온-프레미스 단계 1/3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md)
...
1. Marketo 동기화 사용자 를 확인하고 **확인**.
   ...
   >[!TIP]
   >
   >역할이 표시되지 않으면 다음으로 돌아가기 [1/3단계](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md) 솔루션을 가져옵니다.
...
1. 아래 **설정**, 클릭 **Marketo 구성**.
   ...
   >[!NOTE]
   >
   >Marketo 구성이 누락된 경우 페이지를 새로 고침해 보십시오. 문제가 지속되면, [Marketo 솔루션 게시](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md) 또는 로그아웃했다가 다시 로그인하십시오.
...
>[!MORELIKETHIS]
>
>[Microsoft Dynamics 2015용 Marketo 설치 온-프레미스 단계 3/3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2015.md)
