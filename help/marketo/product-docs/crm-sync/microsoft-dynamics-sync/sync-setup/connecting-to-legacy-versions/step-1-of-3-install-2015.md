...
description: Microsoft Dynamics 2015용 Marketo 설치 1/3 - Marketo 문서 - 제품 설명서
title: Microsoft Dynamics 2015 온-프레미스 3단계 1용 Marketo 설치
...
# 3단계 중 1단계: Marketo에 대한 동기화 사용자 구성(2015 On-Prem) {#step-of-configure-sync-user-for-marketo-on-premises-2015}

Microsoft Dynamics 2015 온-프레미스를 Marketo과 동기화하려면 먼저 Marketo 솔루션을 Dynamics에 설치해야 합니다.
...
1. Marketo 솔루션을 선택하고 을(를) 클릭합니다 **모든 사용자 지정 게시**.
   ...
   >[!MORELIKETHIS]
   >
   >[Microsoft Dynamics 2015 온-프레미스 2/3단계용 Marketo 설치](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-2-of-3-set-up-2015.md)
