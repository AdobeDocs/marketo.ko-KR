...
[!DNL Dynamics] 릴리스에 해당하는 [최신 플러그인을 다운로드합니다](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md).
...
<table>
 <tbody>
  ...
  <tr>
   <td>4.0.0.17</td>
   <td>4/8/16</td>
   <td>버그 수정: 잠재 고객에 동기화 필터가 아니오로 설정되어 있고 영업 기회 및 연락처에 동기화 필터가 없는 경우 잠재 고객이 자격이 되었을 때 연락처 및 영업 기회에 대한 생성 로그가 생성되지 않았습니다.</td>
  </tr>
  <tr>
   <td>4.0.0.16</td>
   <td>3/29/16</td>
