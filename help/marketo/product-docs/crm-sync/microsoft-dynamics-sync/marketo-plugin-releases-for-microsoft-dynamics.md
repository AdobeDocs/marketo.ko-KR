...
# Microsoft Dynamics {#marketo-plugin-releases-for-microsoft-dynamics}용 Marketing To 플러그인 릴리스
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">버그 수정:로그인 사용자에게 Marketing To 구성 권한이 없으므로 고객은 CRM에서 리드를 만들 수 없습니다.</td> 
  </tr> 
  <tr> 
