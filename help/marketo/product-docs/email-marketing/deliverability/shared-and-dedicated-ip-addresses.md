...
**좋은 룸메이트** - IP를 공유하는 보낸 사람이 전송 모범 사례를 따르는 경우 도움이 됩니다.
**메일링 빈도** - 전용 IP와 달리 공유 IP를 확인하는 데 필요한 최소 메일링 빈도가 없습니다.
**비용** - 공유 IP에서 보내는 추가 비용은 없습니다.

_단점_

**잘못된 룸메이트** - IP를 공유하는 보낸 사람이 잘못된 전송 방법에 참여하는 경우 전자 메일 캠페인이 영향을 받을 수 있습니다.
**제어** - 보낸 사람의 신뢰도를 훨씬 낮게 제어할 수 있습니다.
**문제 해결** - 공유 IP에서 전송할 때 문제를 해결하는 것이 더 어려울 수 있습니다.

>[!NOTE]
>
>결정을 내릴 때 고려해야 할 또 다른 중요한 요소가 있습니다. 전송 볼륨 한 달에 100,000개 미만의 이메일을 보내거나 한 달에 두 개 미만의 메일을 보내려는 경우 전용 IP의 혜택을 받지 못할 수 있습니다. 이러한 전송 번호는 낮은 것으로 간주되며, 전용 IP를 기본 ISP에서 안전한 것으로 간주할 만큼 &quot;따뜻한&quot; 상태로 유지하기 어려울 수 있습니다. 메일을 자주 보내지 않는 경우 ISP는 메일링이 갑자기 &quot;급증&quot;하는 활동으로 보고 스팸으로 의심되는 것으로 차단합니다.

질문이 있거나 전용 IP 설정에 관심이 있는 경우 Marketo 계정 담당자에게 문의하십시오.
