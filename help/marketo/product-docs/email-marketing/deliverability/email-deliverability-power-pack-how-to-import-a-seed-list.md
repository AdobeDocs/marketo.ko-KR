...
1. 내보내기가 끝나면 브라우저의 다운로드 폴더에 목록이 .txt 파일로 나타납니다. 검색하고 정적 목록으로 Marketo 인스턴스에 [가져오기](/help/marketo/getting-started/quick-wins/import-a-list-of-people.md)합니다.
   ...
   >[!CAUTION]
   >
   >이러한 받은 편지함 배치 캠페인은 한 달에 제한적으로 제공됩니다. 받는 사람 수를 보려면 [!DNL Everest]의 [!UICONTROL Account Settings] > [!UICONTROL Subscription] 아래의 [!UICONTROL Subscription] 섹션을 참조하십시오. 자세한 내용은 Marketo 영업 담당자에게 문의하십시오.
