...
네트워크 관리자에게 다음 줄을 DNS 항목에 추가하도록 요청하십시오. [domain]을 웹 사이트의 주 도메인으로(예: &quot;company.com&quot;), [corpIP]를 회사 이메일 서버의 IP 주소로(예: &quot;255.255.255.255&quot;). Marketo를 통해 여러 도메인에서 이메일을 보내는 경우 각 도메인(한 줄)에 이를 추가해야 합니다.
