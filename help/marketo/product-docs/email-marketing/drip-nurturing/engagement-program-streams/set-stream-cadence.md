...
1. 이제 케이던스를 매주 또는 간격을 두고 발생시키려면 선택합니다. 2주마다 고르세요.

   ![](assets/image2017-12-5-14-3a10-3a56.png)

1. 요일 을 결정합니다. 이 경우 화요일, 수요일 및 목요일을 선택합니다.
...
1. 케이던스 위로 마우스를 가져갑니다. 미래의 출연진이 등장할 것입니다.

   ![](assets/image2017-12-5-14-3a17-3a29.png)

   >[!NOTE]
   >
   >이 예에서는 이메일이 목요일에 발송됩니다. 다음 주는 건너뛰고 그 다음 주 화요일, 수요일, 목요일에 다시 이메일을 전송합니다. 그런 다음 사이클이 반복됩니다.
...
1. 매월 또는 그 이상의 간격을 두려면 선택합니다. 4개월마다 고르세요.
...
이제 스트림 케이던스를 설정하는 방법을 알 수 있습니다.
