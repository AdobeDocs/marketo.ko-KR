...
>[!NOTE]
>
>구독당 **활성** 참여 프로그램은 100개로 제한됩니다.

## 참여 프로그램 {#engagement-program}

**참여 프로그램**&#x200B;은 복잡한 육성을 쉽게 수행할 수 있는 프로그램 유형입니다.
...
**스트림**&#x200B;은 참여 프로그램에서 사용자를 육성하는 데 사용할 우선 순위가 지정된 콘텐츠 풀입니다.
...
참여 프로그램에는 스트림에 추가할 수 있는 두 가지 유형의 **콘텐츠**&#x200B;인 이메일과 프로그램이 있습니다. 이메일은 캐스트 시간에 사람들에게 전송됩니다.
...
>* [스트림 콘텐츠 우선순위 지정](/help/marketo/product-docs/email-marketing/drip-nurturing/using-stream-content/prioritize-stream-content.md)
...
>* [스트림 콘텐츠 보관 및 보관 취소](/help/marketo/product-docs/email-marketing/drip-nurturing/using-stream-content/archive-and-unarchive-stream-content.md)

## 캐스트 {#cast}

**캐스트**&#x200B;는 참여 프로그램에서 이메일을 보내는 이벤트입니다.
...
**스트림 케이던스**&#x200B;를 설정하여 캐스트가 수행되는 시점을 결정합니다. 이렇게 하여 정기적인 콘텐츠 전송을 예약합니다.
...
## 사용자 케이던스 {#person-cadence}

**사용자 케이던스**&#x200B;는 참여 프로그램에서 콘텐츠를 수신하는 기능을 정의한 상태입니다. **[!UICONTROL Change Engagement Program Cadence]** 흐름 단계를 사용하여 이를 [!UICONTROL Paused] 또는 [!UICONTROL Normal]로 변경할 수 있습니다.
...
>[!MORELIKETHIS]
>
>[콘텐츠를 소진한 사용자](/help/marketo/product-docs/email-marketing/drip-nurturing/using-engagement-programs/people-who-have-exhausted-content.md)

## 콘텐츠 참여 수준 {#content-engagement-level}

콘텐츠 참여 수준은 Marketo에서 콘텐츠에 제공하는 0~100점 범위의 점수입니다. 이 점수는 열람 수, 클릭 수, 구독 취소, 프로그램 성공 등을 사용하는 정교한 수식으로 결정됩니다.
