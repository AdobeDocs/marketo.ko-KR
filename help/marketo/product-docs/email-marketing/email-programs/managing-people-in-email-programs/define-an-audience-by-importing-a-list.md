...
1. 전자 메일 프로그램을 선택한 다음 **[!UICONTROL Audience]** 타일 아래의 **[!UICONTROL Import List]**&#x200B;을(를) 클릭합니다.
...
>
>**[!UICONTROL Audience]** 타일의 ![—](assets/image2014-10-23-16-3a32-3a36-1.png) 단추를 사용하여 스마트 목록 조건에 따라 전자 메일을 받을 자격이 있는 사람 수를 확인합니다. 사람 수에서 차단된 수를 빼면 이메일을 받을 총 사람 수를 가져옵니다.
