...
전자 메일 프로그램을 만든 후에는 전자 메일을 누구에게 보낼 것인지 알려 주어야 합니다. 다음을 통해 이 작업을 수행할 수 있습니다. [스마트 목록 만들기](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md) 또는 목록을 가져와서 목록을 가져와서 이렇게 하는 방법은 다음과 같습니다.
...
1. 목록 가져오기 창이 열리고 다음을 클릭합니다. **찾아보기** 가져올 파일을 선택합니다. 사용자 목록을 선택한 후 다음을 클릭합니다. **다음**.
...
1. 입력 **이름** 을 클릭하여 목록을 확인하십시오. **가져오기**.
...
>
>사용 ![—](assets/image2014-10-23-16-3a32-3a36-1.png) 단추 **대상자** 타일을 사용하여 스마트 목록 기준에 따라 이메일을 받을 자격이 있는 사람 수를 확인합니다. 사람 수에서 차단된 수를 빼면 이메일을 받을 총 사람 수를 가져옵니다.
