...
1. 전자 메일 프로그램을 선택한 다음 **[!UICONTROL Audience]** 타일 아래의 **[!UICONTROL Edit Smart List]**&#x200B;을(를) 클릭합니다.

   ![](assets/2017-05-22-09-46-37.png)

   >[!TIP]
   >
   >이 설정을 찾으려면 보기가 **[!UICONTROL Control Panel]**(으)로 설정되어 있는지 확인하십시오.
...
>
>**[!UICONTROL Audience]** 타일의 ![—](assets/image2014-10-23-16-3a32-3a36.png) 단추를 사용하여 얼마나 많은 사용자가 이메일을 수신하는지 확인하십시오.
