...
1. 이름을 입력하고 프로그램 **유형으로 [이메일** ]을 선택한 다음 [만들기]를 **클릭합니다**.

   ![](assets/three.png)

   >[!NOTE]
   >
   >[ **이메일** ]을 프로그램 유형으로 선택하면 채널은 자동으로 [이메일 보내기]로 **설정됩니다**. 원하시면 바꿔주시면 됩니다

   ![](assets/four.png)

좋아! 이제 해당 프로그램을 사용할 준비가 되었습니다. 다음 단계는 고객을 정의하는 것입니다. 아래의 마케팅 관련 문서를 참조하십시오.
