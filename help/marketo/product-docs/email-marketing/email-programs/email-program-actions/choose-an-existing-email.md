...
[이(가) 이메일 프로그램](/help/marketo/product-docs/email-marketing/email-programs/creating-an-email-program/create-an-email-program.md)을(를) 만들고 대상을 정의하면 어떤 이메일을 전송할지 결정해야 합니다. [이메일 프로그램](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/create-an-email-for-an-email-program.md)에 대한 이메일을 처음부터 만들거나 이미 존재하는 이메일을 선택할 수 있습니다. 이미 존재하는 것을 선택하는 방법은 다음과 같습니다.
...
1. **이메일** 타일 아래에서 보낼 이메일을 선택합니다.
   ...
   >[!NOTE]
   >
   >로컬 이메일만 선택할 수 있습니다. 하나의 프로그램에서 다른 프로그램으로 이메일을 이동해야 합니까? [여기에서](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/move-an-email.md) 자세히 알아보십시오.
