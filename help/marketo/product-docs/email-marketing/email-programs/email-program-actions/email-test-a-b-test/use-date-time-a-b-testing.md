...
이메일을 쉽게 A/B 테스트할 수 있습니다. 하나의 테스트는 **날짜/시간** 테스트. 이메일을 보내는 데 하루 또는 요일이 가장 적합한 시간을 테스트합니다. 설정 방법은 다음과 같습니다.
...
1. 아래 **이메일** 타일, 클릭 **A/B 테스트 추가**.

   ![](assets/image2014-9-12-15-3a41-3a3.png)

1. 새 창이 열립니다. 선택 **날짜/시간** 대상 **테스트 유형**.

   ![](assets/image2014-9-12-15-3a41-3a12.png)

1. 이전 테스트 정보(예: 주제 테스트)가 있는 경우 **테스트 재설정**.
...
1. 두 번째 날짜/시간에 대해서도 동일한 작업을 수행합니다.

   ![](assets/image2014-9-12-15-3a41-3a40.png)

1. 슬라이더를 사용하여 A/B 테스트에서 원하는 대상 비율을 선택하고 **다음**.

   ![](assets/image2014-9-12-15-3a41-3a53.png)

   >[!NOTE]
   >
   >다른 변형은 선택한 테스트 샘플 크기의 동일한 부분에 적용됩니다.
   ...
   좋아, 한 발짝 더 가까이 왔군 이제 다음을 수행해야 합니다. [A/B 테스트 승자 기준 정의](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/define-the-a-b-test-winner-criteria.md).
