...
1. 기본값 **우승자 기준** 옵션이 먼저 나열됩니다.
   ...
   <tr>
   <td><b>참여 점수</b></td>
   <td>다음 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/drip-nurturing/reports-and-notifications/understanding-the-engagement-score.html" target="_blank">참여 점수</a> 은 콘텐츠의 효과를 확인하는 데 도움이 됩니다.</td>
   </tr>
   </table>

   >[!TIP]
   >
   >참여 점수를 선택하면 테스트를 최소 24시간 실행해야 합니다. 자세히 알아보기 [참여 점수 이해](/help/marketo/product-docs/email-marketing/drip-nurturing/reports-and-notifications/understanding-the-engagement-score.md){target="_blank"}.
...
1. 사용 가능한 두 옵션 중 하나를 선택합니다.
   ...
   >[!NOTE]
   >
   >다음 작업을 수행하는 경우 **날짜/시간** A/B 테스트, 다음을 선택할 수만 있습니다. **수동**.

   A/B 테스트가 끝나면 Marketo에서 예약된 시간에 자동으로 우승 이메일을 보내거나 결과를 검토하고 언제 종료될지 결정할 수 있습니다.

1. 자동은 굉장하며 기본 옵션입니다. 그냥 클릭 **다음**.

   ![](assets/image2014-9-12-15-3a54-3a35.png)

   >[!TIP]
   >
   >선택 중 **수동** 은(는) 테스트를 발송하고 우승자를 선언할 때까지 기다립니다. 결과 보고서를 받게 됩니다.
