...
1. 새 창이 열립니다. **테스트 유형** 드롭다운을 클릭하고 **전체 전자 메일**&#x200B;을 선택합니다.
...
1. 두 번째 전자 메일을 적용하려면 **추가**&#x200B;를 클릭하세요. 슬라이더를 드래그하여 A/B 테스트를 받을 대상자의 백분율을 선택하고 **다음**&#x200B;을(를) 클릭합니다.

   [](assets/image2014-9-12-15-3a24-3a1.png)

   >[!NOTE]
   >
   >다른 변형은 선택한 **테스트 샘플 크기**&#x200B;의 동일한 부분에 전송됩니다.
