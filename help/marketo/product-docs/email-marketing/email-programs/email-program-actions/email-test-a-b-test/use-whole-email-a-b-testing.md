...
이메일을 쉽게 A/B 테스트할 수 있습니다. 한 가지 좋은 테스트는 **전체 이메일** 테스트. 설정 방법은 다음과 같습니다.
...
1. 이메일 타일 아래에서 이메일을 선택하고 **A/B 테스트 추가**.

![](assets/image2014-9-12-15-3a22-3a12.png)

1. 새 창이 열립니다. 다음을 클릭합니다. **테스트 유형** 드롭다운 및 선택 **전체 이메일**.
...
1. 클릭 **추가** 이메일을 적용합니다.
   ...
   >[!TIP]
   >
   >여러 이메일을 추가할 수 있습니다. 그러나 너무 많이 추가하면 테스트 프로세스가 느려질 수 있습니다.

1. 두 번째 이메일을 선택합니다.

   [](assets/image2014-9-12-15-3a23-3a49.png)

1. 클릭 **추가** 두 번째 이메일을 적용합니다. 슬라이더를 드래그하여 A/B 테스트를 수신할 대상자의 백분율을 선택하고 **다음**.

   [](assets/image2014-9-12-15-3a24-3a1.png)

   >[!NOTE]
   >
   >다른 변형은 선택한 항목의 동일한 부분에 전송됩니다. **테스트 샘플 크기**.
