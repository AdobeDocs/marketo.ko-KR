...
# &quot;[!UICONTROL From Address]&quot; A/B 테스트 사용 {#use-from-address-a-b-testing}

이메일을 쉽게 A/B 테스트할 수 있습니다. 흥미로운 테스트 중 하나는 **[!UICONTROL From Address]** 테스트입니다. 설정 방법은 다음과 같습니다.
...
1. **[!UICONTROL Email]** 타일 아래에서 전자 메일을 선택한 상태에서 **[!UICONTROL Add A/B Test]**&#x200B;을(를) 클릭합니다.
...
1. 테스트할 두 번째 **[!UICONTROL From Address]** 정보를 입력하십시오.
