...
description: 이메일 프로그램용 이메일을 만드는 방법을 알아봅니다. 새 이메일 에셋을 추가하고 템플릿 또는 기존 이메일을 선택합니다.
...
이메일 프로그램을 만들고 대상자를 정의하면 전송할 이메일을 결정할 수 있습니다. [기존 전자 메일을 선택](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/choose-an-existing-email.md)하거나 처음부터 만들 수 있습니다. 새 이메일을 만드는 방법은 다음과 같습니다.
