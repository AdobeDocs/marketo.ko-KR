...
product: marketo
title: 브랜드 확인
description: 브랜드 점수 검사기를 사용하여 브랜드 내 콘텐츠를 만들고, 검증하고, 관리하는 방법에 대해 알아봅니다.
...
1. 품질 점수에 대한 자세한 보기를 보려면 ![전체 화면 아이콘을 클릭하십시오.](assets/icon-fullscreen.svg "전체 화면") 아이콘을 클릭하십시오.
