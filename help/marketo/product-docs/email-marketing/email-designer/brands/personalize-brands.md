...
product: Marketo
title: 브랜드 개인화
description: 브랜드 지침을 개인화하는 방법을 알아봅니다.
role: User
...
**[!UICONTROL About the brand]** 탭을 사용하여 브랜드의 목적, 성격, 태그 및 기타 정의 특성을 요약하여 브랜드의 핵심 ID를 설정하십시오.
...
이제 브랜드를 추가로 개인화하거나 [브랜드를 게시](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit)할 수 있습니다.
