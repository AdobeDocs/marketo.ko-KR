...
description: 이메일 편집기 2.0과 새로운 이메일 Designer의 기능 차이점에 대해 알아봅니다. 기능의 가용성을 비교하려면 표를 사용합니다.
...
<tbody>
  ...
  <tr>
    <td>콘텐츠 생성</td>
    <td><a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md" target="_blank">생성 AI</a> 모델을 통해 제목 줄, 콘텐츠 일부 또는 전체 이메일을 생성하는 기능.</td>
    <td>사용할 수 없음</td>
    <td>사용 가능</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>이메일 내에서 섹션/모듈을 위 또는 아래로 이동하는 기능.</td>
    <td>사용 가능</td>
    <td>사용 가능</td>
  </tr>
  <tr>
