...
product: marketo
title: 조각
description: 조각을 재사용 가능한 이메일 구성 요소로 만들고 사용하는 방법을 알아봅니다. 이메일 및 템플릿에 시각적 콘텐츠 조각을 추가합니다.
...
>[!NOTE]
>
>조각은 이전 전자 메일 편집기의 [조각](/help/marketo/product-docs/personalization/segmentation-and-snippets/snippets/create-a-snippet.md){target="_blank"}과(와) 동일합니다.
...
시각적 조각에 액세스하려면 Marketo Engage의 **Design Studio**(으)로 이동하십시오. 왼쪽의 트리에서 **[!UICONTROL Fragments (New)]**&#x200B;을(를) 클릭합니다.
...
원하는 열을 선택하고 **[!UICONTROL Apply]**&#x200B;을(를) 클릭합니다.
...
1. 조각에 **[!UICONTROL Name]** 및 선택적 **[!UICONTROL Description]**&#x200B;을(를) 지정합니다.
...
1. _테마_ 아이콘을 클릭합니다.
   ...
   >[!INFO]
   >
   >[테마 설정](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md#settings){target="_blank"}에 대해 자세히 알아보세요.
...
시각적 콘텐츠 편집기에서 조각을 열려면 **[!UICONTROL Edit fragment]**&#x200B;을(를) 클릭하십시오.

왼쪽 상단의 _뒤로_ 화살표를 클릭하여 언제든지 보기를 종료하십시오. 그러면 _조각_ 목록 페이지로 돌아갑니다.

## 참조에서 사용하는 조각 보기 {#view-fragment-used-by-references}

조각 세부 사항 페이지에서 **[!UICONTROL Used By]** 탭을 클릭하여 Marketo Engage 내에서 조각이 사용되는 위치에 대한 세부 사항을 확인합니다.
...
1. 비주얼 디자이너에서 콘텐츠를 변경하려면 **[!UICONTROL Edit fragment]**&#x200B;을(를) 클릭합니다. 완료되면 **저장**&#x200B;을 클릭합니다.

1. 조각 세부 정보로 돌아가려면 **[!UICONTROL Save]** 또는 **[!UICONTROL Save & close]**&#x200B;을(를) 클릭하십시오.

1. 전자 메일 또는 전자 메일 템플릿에서 사용할 수 있는 조각을 만들려면 **[!UICONTROL Publish]**&#x200B;을(를) 클릭합니다.
...
* 조각 이름을 클릭하여 엽니다. 그런 다음 오른쪽 상단의 **[!UICONTROL Open draft version]**&#x200B;을(를) 클릭합니다.

오른쪽에 조각 세부 사항이 있는 초안 버전의 시각적 콘텐츠 미리보기가 표시됩니다.

콘텐츠를 업데이트하려면:

1. 오른쪽 상단의 **[!UICONTROL Edit fragment]**&#x200B;을(를) 클릭합니다. 완료되면 **저장**&#x200B;을 클릭합니다.
...
1. 콘텐츠를 조각으로 저장하려면 **[!UICONTROL More]**&#x200B;을(를) 클릭하고 **[!UICONTROL Save as Fragment]**&#x200B;을(를) 선택하십시오.
...
1. 콘텐츠를 선택한 상태에서 오른쪽 상단의 **[!UICONTROL Create]**&#x200B;을(를) 클릭합니다.

1. 대화 상자에서 조각의 이름과 선택적 설명을 입력하고 **[!UICONTROL Create]**&#x200B;을(를) 클릭합니다.
...
* **[!UICONTROL Delete]** - 현재 전자 메일 또는 전자 메일 템플릿 콘텐츠에서 조각을 제거합니다(조각 소스는 영향을 받지 않음).
* **[!UICONTROL Refresh]** - 현재 전자 메일 또는 전자 메일 템플릿의 조각 콘텐츠를 새로 고칩니다. 새로 고침은 이메일 또는 이메일 템플릿에 추가한 후 조각에 대한 최근 편집 내용을 반영하려는 경우에 유용합니다.
* **[!UICONTROL Duplicate]** - 편집기 내의 동일한 전자 메일 또는 전자 메일 템플릿에 있는 조각을 복제합니다. 복제된 조각은 원본 바로 아래에 추가됩니다.
* **[!UICONTROL Open Fragment]** - 조각 편집기 페이지와 세부 정보가 있는 새 브라우저 탭이 열립니다.
* **[!UICONTROL Break inheritance]** - 소스에서 조각의 상속(및 변경 내용)을 중단합니다. 이 작업을 사용하여 조각 콘텐츠를 이메일 또는 이메일 템플릿 내에서 독립적이고 편집 가능한 콘텐츠로 사용할 수 있도록 합니다. 이 작업은 원본 조각에 대한 _사용한 사람_ 참조에서 전자 메일 또는 전자 메일 템플릿도 제거합니다.

>[!NOTE]
>
>전자 메일에서 _HTML과 동기화_&#x200B;를 사용하지 않도록 설정한 경우, 변경 내용(상속 중단 포함)은 텍스트 콘텐츠에 반영되지 않습니다.
