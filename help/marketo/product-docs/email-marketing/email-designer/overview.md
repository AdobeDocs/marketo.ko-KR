...
* [HTML으로 이미지 변환](/help/marketo/product-docs/email-marketing/email-designer/feature-comparison.md){target="_blank"}: 전자 메일의 호환 PNG/JPEG 이미지 파일을 업로드하면 새 전자 메일 Designer에서 사용할 수 있도록 자동으로 HTML으로 변환됩니다.
...
* [템플릿 가져오기](/help/marketo/product-docs/email-marketing/email-designer/import-template.md){target="_blank"}: 클래식 전자 메일 편집기에서 전자 메일 템플릿을 가져와서 Design Studio의 새 전자 메일 Designer과 호환되는 템플릿을 만드십시오.

* [조건부 콘텐츠](/help/marketo/product-docs/email-marketing/email-designer/conditional-content.md){target="_blank"}: 새로운 이메일 Designer에 대한 패리티 기능으로 토큰을 넘어 이메일 개인화를 수행할 수 있습니다.
...
**기존 전자 메일 템플릿이 새 디자이너에서 작동합니까?**

예, 하지만 [가져와야 합니다](/help/marketo/product-docs/email-marketing/email-designer/import-template.md).
...
예! [브랜드 테마](/help/marketo/product-docs/email-marketing/email-designer/brand-themes.md)를 사용하여 브랜드 지침을 만들고 관리하세요.
...
WYSIWYG이므로 HTML 지식이 필요하지 않습니다. 디자이너에서 템플릿을 쉽게 만들 수 있으므로 외부 웹 개발자의 필요성을 줄일 수 있습니다. 하지만 여전히 CSS를 업데이트하고 HTML을 통해 개별 섹션을 편집할 수 있는 옵션이 있습니다.
