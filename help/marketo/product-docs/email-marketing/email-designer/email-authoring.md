---
description: 이메일 Designer에서 이메일을 만들고, 개인화하고, 미리 보는 방법에 대해 알아봅니다. Design Studio 또는 이메일 프로그램을 사용하여 이메일을 작성합니다.
title: 이메일 작성
...
1. 방금 만든 전자 메일에서 **전자 메일 콘텐츠 편집**&#x200B;을 클릭합니다.
...
1. 테마로 시작(권장)하거나 수동 스타일링으로 처음부터 빌드할지 선택합니다.

   >[!NOTE]
   >
   >수동 스타일링으로 만든 이메일은 테마로 만든 조각을 사용할 수 없습니다
