...
# 이메일에 링크로 시스템 토큰 추가 {#add-a-system-token-as-a-link-in-an-email}
...
>[!NOTE]
>
>이러한 토큰은 **not** 앵커 링크 내부에 있지 않은 경우 를 클릭할 수 있습니다. 또한, **not** 내 토큰에 삽입됩니다.
...
1. 토큰이 있는 링크로 변환할 텍스트를 강조 표시하고 **링크 삽입/편집** 버튼을 클릭합니다.

   ![](assets/three-1.png)

1. 링크 URL에 토큰을 입력하고 를 클릭합니다 **삽입**.
...
>[!IMPORTANT]
>
>이 접근 방식을 사용하여 &quot;viewAsWebpageLink&quot; 시스템 토큰을 추가하는 경우 다음을 수행할 수 있습니다 **not** 토큰을 사용하여 재정의합니다. 대신, [이메일에 웹 페이지로 보기 링크 추가](/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/add-a-view-as-web-page-link-to-an-email.md) 토큰을 사용하여 &quot;viewAsWebPageLink&quot;를 재정의할 수 있는 접근 방식입니다.
