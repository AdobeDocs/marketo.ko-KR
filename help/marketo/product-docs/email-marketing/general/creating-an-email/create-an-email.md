...
1. **새로 만들기** 드롭다운을 클릭하고 **새 전자 메일**&#x200B;을 선택합니다.
...
1. 전자 메일 이름을 지정하고 사용할 템플릿을 클릭한 다음 **만들기**&#x200B;를 클릭합니다.

   ![](assets/create-an-email-6.png)

   >[!NOTE]
   >
   >즉시 사용 가능한 응답형 전자 메일 서식 파일 컬렉션이나 **내 서식 파일**&#x200B;을(를) 선택하고 같은 단계를 따라 저장한 서식 파일 중에서 선택할 수 있습니다.
