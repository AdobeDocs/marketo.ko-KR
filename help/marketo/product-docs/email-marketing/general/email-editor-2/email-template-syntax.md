...
description: 이메일 편집기 2.0의 이메일 템플릿 구문에 대해 알아봅니다. 템플릿에 있는 모듈 및 편집 가능한 섹션에 올바른 구문을 사용하십시오.
title: 이메일 템플릿 구문
...
영역을 코드 조각으로 정의하면 최종 사용자는 이 영역에 삽입할 승인된 [코드 조각](/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email.md)을 선택할 수 있습니다. 이메일 편집기 내에서 리치 텍스트 요소를 스니펫으로 변환할 수 있지만, 영역을 특별히 스니펫으로 정의할 때에는 리치 텍스트로 변환할 수 없습니다. class=&quot;mktoSnippet&quot;인 `<div>`를 사용하여 스니펫 영역을 지정할 수 있습니다.
