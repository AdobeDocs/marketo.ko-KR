...
>[!IMPORTANT]
>
>정확한 날짜가 정해지지는 않았지만 클래식 이메일 편집기는 2026년에 사용 중단될 수 있습니다. 정확한 날짜가 정해지면 알려드리겠습니다. 고급 [이메일 디자이너](/help/marketo/product-docs/email-marketing/email-designer/overview.md){target="_blank"}는 클래식 편집기에서 사용할 수 없는 많은 기능을 포함하고 있으므로 채택을 시작할 것을 강력히 권장합니다.
