...
>[!IMPORTANT]
>
>정확한 날짜 설정이 없지만 클래식 이메일 편집기는 2027년에 더 이상 사용되지 않을 수 있습니다(정확한 날짜가 정해지면 알려드리겠습니다). 고급 [이메일 디자이너](/help/marketo/product-docs/email-marketing/email-designer/overview.md){target="_blank"}는 클래식 편집기에서 사용할 수 없는 많은 기능을 포함하고 있으므로 채택을 시작할 것을 강력히 권장합니다.

**이메일 템플릿 선택기**

새 이메일을 만들면 [이메일 템플릿 선택기](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-template-picker-overview.md)로 이동됩니다.
...
디자인 공간이 더 필요하십니까? 이메일 헤더는 [편집](/help/marketo/product-docs/email-marketing/general/creating-an-email/edit-your-email-header.md)을 마친 후에 숨길 수 있습니다. 이 아이콘을 클릭하면...
...
미리 보기를 더 크게 하려면 이메일의 오른쪽 상단에서 **[!UICONTROL Preview]**&#x200B;를 클릭합니다.
...
...모바일 디바이스에서 표시되는 모습도 확인할 수 있습니다. 텍스트 버전도 미리 볼 수 있습니다! 편집을 다시 시작하려면 오른쪽 상단의 **[!UICONTROL Edit Draft]**&#x200B;를 클릭하면 됩니다.
...
>[!CAUTION]
>
>이메일을 템플릿으로 저장할 때 변수 값은 이월되지 않습니다. 변수는 기본 템플릿에 지정된 기본값을 계속 사용합니다. 이메일에 있는 사용 가능한 모듈도 이메일 본문에 삽입하지 않으면 이월되지 않습니다.
...
>[!CAUTION]
>
>이메일 편집기를 사용할 때는 [!UICONTROL Preheader]에서 토큰이 작동하지 않습니다. [!UICONTROL Preheader]에서 토큰을 사용하려면 이메일 템플릿에서 자체 HTML을 사용해야 합니다.

멋지고 새로운 기능이 많이 있습니다! 즐겁게 사용해 보십시오!

>[!NOTE]
>
>더 자세히 알아보려면 이 [비디오](https://nation.marketo.com/videos/1463)를 확인하십시오.
