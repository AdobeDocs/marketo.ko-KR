...
Audience Manager, B2B CDP Marketo 커넥터, [!DNL Dynamic Chat] 등과 같은 Adobe 애플리케이션과 동기화하려면 먼저 Marketo Engage에 Adobe IMS 조직 자격 증명을 입력해야 합니다.
...
1. 통합에서 **[!UICONTROL 조직 매핑 Adobe]**&#x200B;을 클릭합니다.
...
1. Adobe IMS 조직 ID를 입력하고([여기](https://experienceleague.adobe.com/docs/control-panel/using/faq.html?lang=ko){target="_blank"}에서 찾는 방법 알아보기) **[!UICONTROL 확인]**&#x200B;을 클릭합니다.
