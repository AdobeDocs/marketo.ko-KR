...
1. 대상의 경우 기존 목록을 선택하거나 새 목록의 이름을 입력할 수 있습니다. 이 예제에서는 새 목록이 만들어집니다. 완료되면 **[!UICONTROL Sync]**&#x200B;를 클릭합니다.
...
ECID 쿠키 ID를 Marketo의 알려진 사용자에게 연결할 수 없는 경우 사용자도 다시 동기화되지 않습니다.
