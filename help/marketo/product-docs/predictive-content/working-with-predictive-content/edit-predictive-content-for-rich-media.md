...
description: 리치 미디어용 예측 컨텐츠 편집 - 마케팅 문서 - 제품 설명서
...
# 리치 미디어 {#edit-predictive-content-for-rich-media}에 대한 예측 컨텐츠 편집
...
1. **카테고리** 상자를 클릭하여 이미 설정한 [카테고리(선택 사항)를 선택/추가합니다.](/help/marketo/product-docs/predictive-content/getting-started/set-up-categories.md)

   ![](assets/image2017-10-3-9-3a55-3a57.png)

   >[!NOTE]
   >
   >특정 리치 미디어 권장 사항 템플릿에 대한 컨텐츠를 그룹화하는 카테고리를 사용합니다. 모든 권장 사항 템플릿에 컨텐츠를 적용하려면 카테고리를 비워 둡니다(권장).
   >
   >그러나 리치 미디어 템플릿에 대한 특정 컨텐츠만 권장하려면 컨텐츠 카테고리를 추가하고 해당 카테고리를 권장 사항 템플릿에 연결합니다.
   >
