...
* **전환**: 동일한 방문에서 콘텐츠 조각을 보고 양식을 완료한 방문자의 수입니다
* **전환율**: 직접 전환을 클릭으로 나눈 비율로 계산된 비율입니다
* **예측 승인**: 콘텐츠가 승인될 경우 아이콘이 표시됩니다
...
1. 다음에서 **모든 컨텐츠** 페이지에서 필터 아이콘을 클릭하고 아래에 있는 를 클릭합니다. **범주**, 하나 이상의 콘텐츠 범주를 선택합니다.
...
1. 특정 날짜 또는 날짜 범위에 대한 데이터를 표시하려면 달력 아이콘을 클릭한 다음 왼쪽 패널에서 를 선택합니다. 사용자 지정 날짜 범위의 경우 캘린더에서 날짜 범위의 첫 번째 날과 마지막 날을 클릭합니다(표시된 대로). 클릭 **적용**.
...
>* [컨텐츠 삭제](/help/marketo/product-docs/predictive-content/working-with-all-content/delete-content.md)
