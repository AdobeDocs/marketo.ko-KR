...
description: 새 컨텐츠 추가 - 마케팅 문서 - 제품 설명서
title: 새 컨텐츠 추가
...
1. 컨텐츠 **추가** 드롭다운을 클릭하고 컨텐츠 **추가를 선택합니다**.
...
1. 이제 새 제목이 **모든 컨텐츠** 페이지에 표시됩니다. 예측 컨텐츠에 대해서는 아직 승인되지 않았습니다.

   ![](assets/image2017-10-3-8-3a55-3a21.png)

1. 예측 컨텐츠에 추가하는 방법은 [다음과 같습니다](http://docs.marketo.com/x/Vbet).
