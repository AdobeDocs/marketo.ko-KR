...
1. 내 Marketo에서 **[!UICONTROL Coworker for Marketo Engage]** 타일을 클릭합니다.
...
Marketo Engage Assets를 만들거나 수정할 때 Marketo Engage용 동료가 따라야 하는 조직 지침 및 제약 조건을 정의합니다.
...
_이 탭은 UI에 표시될 수 있지만 아직 사용할 수 없습니다. 이 문서에서 업데이트_&#x200B;을(를) 확인하십시오.
