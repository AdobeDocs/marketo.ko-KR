...
1. **이메일 추가 기능** 탭에서 **문제 라이선스**&#x200B;를 클릭합니다.

   ![](assets/image2016-7-22-10-3a20-3a15.png)

1. 플러그 인 사용 권한이 필요한 영업 담당자의 전자 메일 주소를 입력하고 **Issue License**&#x200B;를 클릭합니다.
...
>* [등록 코드를 사용하여 Outlook용 Marketo 전자 메일 추가 기능 설치](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
