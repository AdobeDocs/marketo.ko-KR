...
1. 플러그 인을 사용할 수 있는 권한이 필요한 영업 담당자의 전자 메일 주소를 입력하고 **[!UICONTROL Issue License]**&#x200B;을(를) 클릭합니다. 여러 이메일 주소를 입력하려면 쉼표로 구분하십시오.
   ...
   >[!NOTE]
   >
   >* 플러그인을 원격으로 설치하려면 _등록 전자 메일 보내기_ 확인란을 선택하지 않고 IT 팀에 [Enterprise 키](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)를 보내십시오.
   >
   >* 영업 담당자가 해당 컴퓨터에 대한 관리자 액세스 권한을 보유하고 있다면 _등록 이메일 보내기_ 확인란을 선택하면 됩니다. 받는 사람이 만료되기 전에 전자 메일의 링크를 클릭할 수 있는 기간은 **30일**&#x200B;입니다.
