...
# 등록 코드 {#install-the-marketo-email-add-in-for-outlook-with-a-registration-code}과(와) 함께 Outlook용 Marketing To Email Add-in을 설치합니다.

사용자가 랩탑에서 관리 설정에 액세스할 수 있는 경우 등록 코드를 직접 해당 사용자에게 전송할 수 있습니다.
...
1. 설치 관리자를 실행합니다.
   ...
   >[!NOTE]
   >
   >보안 경고가 나타나면 걱정하지 마십시오! **실행**&#x200B;을 클릭하면 됩니다.
...
1. **다음**&#x200B;을 클릭합니다.
   ...
   >[!NOTE]
   >
   >알 수 없는 게시자에 대한 보안 메시지가 나타나면 **예**&#x200B;를 클릭합니다.

1. 설치가 이제 완료되었으므로 **닫기**&#x200B;를 클릭합니다.

   ![](assets/image2014-9-23-15-3a52-3a11.png)

1. 이제 Microsoft Outlook을 열고 Marketing To 단추를 봅니다.

   ![](assets/image2016-8-24-15-3a47-3a38.png)

   훌륭해! 이제 더 나은 위치에 마케팅 단추가 있습니다.
