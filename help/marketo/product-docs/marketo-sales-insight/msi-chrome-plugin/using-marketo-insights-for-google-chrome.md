...
description: Google Chrome용 Marketo Insights를 사용하는 방법을 알아봅니다. Gmail에서 전자 메일을 읽는 동안 개인 및 계정 정보와 활동을 봅니다.
...
# [!DNL Google Chrome]에 대해 Marketo Insights 사용 {#using-marketo-insights-for-google-chrome}

[!DNL Google Chrome]에 대한 Marketo Insights를 사용하여 모든 Google 이메일을 보내고 추적합니다.

>[!PREREQUISITES]
>
>[다음에 대한 Marketo Insights 설치 [!DNL Google Chrome]](/help/marketo/product-docs/marketo-sales-insight/msi-chrome-plugin/install-marketo-insights-for-google-chrome.md)
...
1. 게시된 Marketo 템플릿으로 전자 메일을 미리 채우려면 **추가 옵션**&#x200B;을 클릭하고 **[!UICONTROL Load Marketo Template]**&#x200B;을(를) 선택하십시오.

   ![](assets/image2015-10-5-15-3a6-3a50.png)

1. **[!UICONTROL Available template]**&#x200B;을(를) 선택하고 **[!UICONTROL Ok]**&#x200B;을(를) 클릭합니다.

   ![](assets/image2015-10-5-15-3a11-3a44.png)

1. 콘텐츠, 전자 메일 주소를 입력하고 **[!UICONTROL Send]**&#x200B;을(를) 클릭합니다.

   ![](assets/image2015-10-6-14-3a37-3a32.png)

   >[!NOTE]
   >
   >**[!UICONTROL Send]** 단추가 자주색인 경우에만 메시지가 추적됩니다.
...
1. Google Mail의 미리 보기 창에서 **[!UICONTROL Log with Marketo]**&#x200B;을(를) 클릭합니다.

   ![](assets/image2015-4-23-17-3a0-3a42.png)

1. 그게 다야! 전자 메일이 곧 [!DNL Marketo Sales Insight]에 나타납니다.
