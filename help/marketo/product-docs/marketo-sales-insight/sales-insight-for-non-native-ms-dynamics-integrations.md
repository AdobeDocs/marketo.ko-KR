   ...
   <table>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p>외부 MS <span class="dnl">Dynamics</span> 사용자 개체에 대한 Marketo 영업 담당자 레코드를 식별합니다.</p><p>다른 객체를 동기화하기 전에 먼저 영업 담당자를 동기화하여 적절한 관계를 만들어야 합니다.</p></td>
     </tr>
    </tbody>
   </table>
   ...
   <table>
    ...
    <tbody>
     ...
     <tr>
      <td>externalSalesPersonId</td>
        <td>MS <span class="dnl">Dynamics</span> Sales 사용자 대/소문자를 구분하지 않는 글로벌 고유 식별자</td>
        <td>이 잠재 고객/연락처를 담당하는 외부 MS <span class="dnl">Dynamics</span> 영업 사용자 개체를 식별합니다.<br><br>잠재 고객과 Marketo의 영업 담당자도 연결합니다. 영업 담당자를 먼저 올바르게 동기화해야 합니다.</td>
     </tr>
     <tr>
      <td>externalCompanyId</td>
        <td>MS <span class="dnl">Dynamics</span> 계정의 대/소문자를 구분하지 않는 전역 고유 식별자</td>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>해당 사항 없음. Marketo 리드 ID입니다.</td>
        <td>동기화된 MS <span class="dnl">Dynamics</span> 연락처의 Marketo 잠재 고객 ID입니다.<br><br>연락처가 Marketo에서 동기화되면 MS <span class="dnl">Dynamics</span> 연락처 대소문자를 구분하지 않는 전체 고유 식별자를 externalPersonId로 사용하고 Marketo REST API를 사용하여 Marketo 잠재 고객을 쿼리할 수 있습니다.</td>
     </tr>
     <tr>
      <td>역할</td>
   ...
   <table>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p>라벨: 마지막 흥미로운 순간 Source</p><p>이름: Last_Interest_Moment___c</p></td>
