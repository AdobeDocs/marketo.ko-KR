...
description: Microsoft Dynamics 365에서 Marketo Sales Insight을 설치하고 구성하는 방법에 대해 알아봅니다. 솔루션을 추가하고 Marketo에 연결합니다.
...
# [!DNL Microsoft Dynamics 365]에서 [!DNL Marketo Sales Insight] 설치 및 구성 {#install-and-configure-marketo-sales-insight-in-microsoft-dynamics}
...
1. [!DNL Microsoft Dynamics]로 돌아가서 [!UICONTROL Settings] 옆에 있는 ![](assets/image2015-5-13-15-3a49-3a19.png) 아이콘을 클릭한 다음 드롭다운에서 **[!UICONTROL Marketo API Config]**&#x200B;을(를) 선택합니다.
