...
description: Microsoft Dynamics Online에서 Marketo Sales Insight을 설치하고 구성하는 방법에 대해 알아봅니다. Dynamics Online용 솔루션을 설정합니다.
title: Microsoft Dynamics Online에 Marketo Sales Insight 설치 및 구성
...
# [!DNL Microsoft Dynamics Online]에서 [!DNL Marketo Sales Insight] 설치 및 구성 {#install-and-configure-marketo-sales-insight-in-microsoft-dynamics-online}
...
1. **[!UICONTROL Publish Customization]**&#x200B;를 클릭합니다.
...
Marketo 인스턴스를 [!DNL Dynamics]의 [!DNL Sales Insight]에 연결합니다. 방법은 다음과 같습니다.
...
1. 이후 단계에서 사용할 **[!UICONTROL Marketo Host]**, **[!UICONTROL API URL]** 및 **[!UICONTROL API User Id]**&#x200B;을(를) 복사합니다. 원하는 API 비밀 키를 입력하고 **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
   ...
   >[!NOTE]
   >
   >[!DNL Sales Insight]이(가) 작동하려면 _리드 및 연락처_&#x200B;에 대해 다음 필드를 Marketo과 동기화해야 합니다.
   >
   >* 우선순위
   >* 긴급도
   >* 상대 스코어
...
1. [!UICONTROL Field Sync Details] 옆에 있는 **[!UICONTROL Edit]**&#x200B;을(를) 클릭합니다.

   ![](assets/enable-four.png)

1. 이전에 비활성화된 MSI 필드([!UICONTROL Urgency], [!UICONTROL Relative Score] 및 [!UICONTROL Priority])를 _자동으로_&#x200B;선택합니다. 데이터 동기화를 시작하려면 **[!UICONTROL Save]**&#x200B;을(를) 클릭하면 됩니다.
...
1. **[!UICONTROL Settings]** 으로 이동합니다.

   ![](assets/image2014-12-12-9-3a8-3a34-1.png)

1. **[!UICONTROL Security]** 으로 이동합니다.
...
1. [!DNL Marketo Sales Insight] 역할을 선택하고 **[!UICONTROL OK]**&#x200B;을(를) 클릭합니다.
   ...
   그리고 넌 다 끝내야 해! 마지막으로 테스트하려면 [!DNL Marketo Sales Insight]에 액세스할 수 있는 사용자로 [!DNL Dynamics]에 로그인한 다음 잠재 고객 또는 연락처를 확인하십시오.
