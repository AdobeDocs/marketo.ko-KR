...
description: Microsoft Dynamics 2013에서 Marketo Sales Insight을 설치하고 구성하는 방법에 대해 알아봅니다. 솔루션을 추가하고 Marketo에 연결합니다.
...
# [!DNL Marketo Sales Insight]에서 [!DNL Microsoft Dynamics 2013] 설치 및 구성 {#install-and-configure-marketo-sales-insight-in-microsoft-dynamics}

[!DNL Marketo Sales Insight]은(는) 영업 팀에 마케팅 팀이 보유한 풍부한 데이터를 &quot;창&quot;으로 제공할 수 있는 환상적인 도구입니다. 설치 및 구성 방법은 다음과 같습니다.
...
이제 [!DNL Marketo Sales Insight] 솔루션을 [!DNL Microsoft Dynamics]&#x200B;(으)로 가져올 차례입니다.
...
Marketo 인스턴스를 [!DNL Sales Insight]의 [!DNL Dynamics]에 연결합니다.
...
마지막으로 특정 사용자에게 [!DNL Marketo Sales Insight]에 대한 액세스 권한을 부여할 수 있습니다.
...
1. Sales Insight에 대한 액세스 권한을 부여할 사용자를 선택하고 **[!UICONTROL Manage Roles]**&#x200B;을(를) 클릭합니다.
...
1. **[!UICONTROL Marketo Sales Insight]** 역할을 선택하고 **[!UICONTROL OK]**&#x200B;을(를) 클릭합니다.
   ...
   그리고 넌 다 끝내야 해! 마지막으로 테스트하려면 [!DNL Dynamics]에 액세스할 수 있는 사용자로 [!DNL Marketo Sales Insight]에 로그인하여 잠재 고객 또는 연락처를 확인하세요.
