...
# [!DNL Microsoft Dynamics 2013]에서 [!DNL Marketo Sales Insight] 설치 및 구성 {#install-and-configure-marketo-sales-insight-in-microsoft-dynamics}
...
Marketo 인스턴스를 [!DNL Dynamics]의 [!DNL Sales Insight]에 연결합니다.
...
1. **[!UICONTROL Marketo Sales Insight]** 역할을 선택하고 **[!UICONTROL OK]**&#x200B;을(를) 클릭합니다.
   ...
   그리고 넌 다 끝내야 해! 마지막으로 테스트하려면 [!DNL Marketo Sales Insight]에 액세스할 수 있는 사용자로 [!DNL Dynamics]에 로그인하여 잠재 고객 또는 연락처를 확인하세요.
