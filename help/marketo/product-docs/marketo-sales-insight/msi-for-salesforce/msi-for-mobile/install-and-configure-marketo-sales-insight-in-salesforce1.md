...
# [!DNL Salesforce1]에서 [!DNL Marketo Sales Insight] 설치 및 구성 {#install-and-configure-marketo-sales-insight-in-salesforce}
...
1. **[!UICONTROL Marketo]**&#x200B;을(를) 선택하고 **[!UICONTROL Selected]** 메뉴 항목에 **[!UICONTROL Add]**&#x200B;합니다.
...
휴! [!DNL Salesforce1]에 대한 [!DNL Marketo Sales Insight] 설치를 완료했습니다! 어서 허리를 쓰다듬어 봐.
