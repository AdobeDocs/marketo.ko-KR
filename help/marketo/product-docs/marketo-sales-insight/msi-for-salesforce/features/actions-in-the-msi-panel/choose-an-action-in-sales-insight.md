...
description: MSI 패널에서 Sales Insight의 작업을 선택하는 방법을 알아봅니다. 이메일을 보내거나, 캠페인에 추가하거나, 호출을 기록하거나, 작업을 추가합니다.
...
[!DNL Salesforce] Classic 및 Lightning의 [!DNL Sales Insight] 드롭다운에서 다음 작업을 사용할 수 있습니다.
