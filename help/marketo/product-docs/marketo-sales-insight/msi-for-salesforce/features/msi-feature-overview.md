...
* MSI 연락처 ID - 이 필드에 Salesforce 연락처를 추가하고 잠재 고객 레이아웃에 &quot;잠재 고객 연락처 브리지&quot; 패널을 포함하여 연락처의 MSI 패널을 확인합니다.
...
다음 기능은 다음과 같습니다 **사용할 수 없음** 계정 레이아웃 페이지에서:
...
다음 기능은 다음과 같습니다 **사용할 수 없음** Opportunity Layout 페이지에서
