...
1. **[!UICONTROL 관리자]** 영역으로 이동하여 **[!UICONTROL 판매 인사이트]**&#x200B;를 선택합니다.
...
1. 원격 사이트 이름을 입력하십시오(`MarketoSoapAPI`과(와) 비슷할 수 있습니다). Marketo Engage의 Soap API 구성 패널에서 Marketo 호스트 URL인 원격 사이트 URL을 입력합니다. **[!UICONTROL 저장]**&#x200B;을 클릭합니다. 이제 Soap API에 대한 원격 사이트 설정을 만들었습니다.
...
1. 원격 사이트 이름을 입력합니다(&quot;MarketoRestAPI&quot;와 같은 것일 수 있음). Marketo의 Rest API 구성 패널에서 API URL인 원격 사이트 URL을 입력합니다. **[!UICONTROL 저장]**&#x200B;을 클릭합니다. 이제 Rest API에 대한 원격 사이트 설정을 만들었습니다.
...
1. 왼쪽의 **[!UICONTROL Visualforce 페이지]**&#x200B;를 클릭합니다. **[!UICONTROL Section]**&#x200B;을(를) 사용자 지정 링크 섹션 아래의 레이아웃으로 드래그합니다.

   ![](assets/image2014-9-24-17-3a32-3a53.png)

1. **[!UICONTROL 섹션 이름]**(으)로 &quot;Marketo Sales Insight&quot;를 입력하십시오. **[!UICONTROL 1열]**&#x200B;을(를) 선택하고 **[!UICONTROL 확인]**&#x200B;을 클릭합니다.

   ![](assets/image2014-9-24-17-3a33-3a23.png)

1. **잠재 고객**&#x200B;을(를) 새 섹션으로 끌어다 놓습니다.
...
1. 높이를 450픽셀로 편집하고 **[!UICONTROL 확인]**&#x200B;을 클릭하세요.
...
1. 왼쪽의 **[!UICONTROL 필드]**&#x200B;를 클릭합니다. 그런 다음 **[!UICONTROL 참여]** 레이블을 검색하여 **[!UICONTROL Marketo Sales Insight]** 레이아웃으로 끌어서 놓습니다.
...
1. **[!UICONTROL 연락처]**, **[!UICONTROL 계정]** 및 **[!UICONTROL 기회]**&#x200B;에 대한 Visualforce 페이지 섹션을 추가하려면 5-7단계를 반복합니다.

1. **[!UICONTROL 연락처]**&#x200B;에 대한 Sales Insight 필드를 추가하려면 8~10단계를 반복합니다. 변경 사항이 있으면 저장하십시오.
...
1. Salesforce에서 탭 모음 끝에 있는 **+**&#x200B;을(를) 클릭하고 **[!UICONTROL Marketo Sales Insight 구성]**&#x200B;을 클릭합니다.
