...
# [!DNL Marketo Sales Insight] Professional Edition에서 [!DNL Salesforce] 구성 {#configure-marketo-sales-insight-in-salesforce-professional-edition}
...
>
>* [AppExchange [!DNL Marketo Sales Insight] 에서  [!DNL Salesforce] 패키지 설치](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md){target="_blank"}설치
...
1. 원격 사이트 이름을 입력하십시오(`MarketoSoapAPI`과(와) 비슷할 수 있습니다). Marketo Engage의 Soap API 구성 패널에서 Marketo 호스트 URL인 원격 사이트 URL을 입력합니다. **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다. 이제 Soap API에 대한 원격 사이트 설정을 만들었습니다.
...
1. 원격 사이트 이름을 입력합니다(&quot;MarketoRestAPI&quot;와 같은 것일 수 있음). Marketo의 Rest API 구성 패널에서 API URL인 원격 사이트 URL을 입력합니다. **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다. 이제 Rest API에 대한 원격 사이트 설정을 만들었습니다.
...
1. **[!UICONTROL Section Name]**(으)로 &quot;Marketo Sales Insight&quot;를 입력하십시오. **[!UICONTROL 1-Column]**&#x200B;을(를) 선택하고 **[!UICONTROL OK]**&#x200B;을(를) 클릭합니다.
