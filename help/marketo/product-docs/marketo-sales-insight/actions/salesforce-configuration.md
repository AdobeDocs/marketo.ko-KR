---
description: Salesforce 구성 - Marketo 문서 - 제품 설명서
title: Salesforce 구성
hide: true
hidefromtoc: true
...
## Salesforce 사용자 지정 패키지 제거(Classic) {#uninstall-salesforce-customization-package-classic}

MSI-Actions 패키지 사용을 시작하면 Salesforce 계정에서 Marketo Sales Connect 패키지를 제거합니다.

**페이지 레이아웃에서 판매 접속 필드 제거**
...
**Activity History 섹션에서 Sales Connect 필드 제거**

1. 페이지 하단으로 스크롤하여 활동 내역 관련 목록 섹션으로 이동한 다음 공구모양 아이콘을 클릭합니다.

   ![](assets/salesforce-configuration-10.png)

1. 그런 다음 선택한 필드 영역에서 영업 연결 필드를 선택하고 제거 화살표를 클릭합니다. 클릭 **확인** 완료 시.
