---
description: 영업 이메일 및 작업에 대한 명령 센터의 빠른 작업에 대해 알아봅니다. 작업을 사용하여 항목을 빠르게 회신, 완료 표시 또는 관리합니다.
...
이메일 빠른 작업은 보고 있는 이메일의 상태에 대해 가장 관련성이 높은 작업에 따라 동적이고 업데이트됩니다. 각 이메일 상태에 대해 최대 2개의 이메일 빠른 작업이 표시됩니다. 각 상태에 대해 사용할 수 있는 이메일 빠른 작업은 아래에서 확인할 수 있습니다.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><p>전자 메일을 삭제합니다.<br><strong>참고:</strong> 캠페인의 일부로 전송된 전자 메일은 삭제할 수 없습니다.</p></td>
  </tr>
 </tbody>
</table>
...
| InMail 보내기 | [!DNL LinkedIn]&#x200B;(으)로 리디렉션하여 해당 사용자에게 InMail 메시지를 보냅니다. |
