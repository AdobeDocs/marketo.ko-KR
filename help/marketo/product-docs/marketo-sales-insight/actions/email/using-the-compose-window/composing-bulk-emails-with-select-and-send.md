...
1. 다음을 클릭합니다. **이메일 선택됨** 단추를 클릭합니다.

   ![](assets/composing-bulk-emails-with-select-and-send-3.png)

1. 제목 줄을 입력하고 템플릿을 선택한 다음(또는 이메일을 처음부터 작성)/[예약](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md) 이메일.

   ![](assets/composing-bulk-emails-with-select-and-send-4.png)

   >[!NOTE]
   >
   >템플릿을 선택했는데 보내기 전에 모든 동적 필드가 올바르게 채워지는지 확인하려면 을(를) 클릭합니다. **동적 필드 미리 보기**. 벌크 사이드바의 모든 수신자가 모든 이메일을 미리 볼 수 있도록 선택되어 있는지 확인합니다. 이메일을 하나 선택하고 **동적 필드 미리 보기**, 해당 이메일만 미리 볼 수 있습니다.

## 이메일 편집 {#editing-emails}

**대량 편집**

1. 에서 1-3단계를 수행합니다. [이메일 전송 섹션](#sending-emails) 위.

   >[!NOTE]
   >
   >기본적으로 모든 수신자가 선택됩니다. 개인을 클릭하고 모든 사람을 다시 선택하려면 **모든 수신자**. 미리 알림은 일괄 편집하려면 모든 수신자를 선택해야 합니다.
...
1. 클릭 **보내기** (또는 [예약](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md))을 입력하여 벌크 이메일 업데이트로 모든 수신자에게 전송할 수 있습니다.
...
1. 에서 1-4단계를 수행합니다. [이메일 전송 섹션](#sending-emails).
...
1. 클릭 **보내기** (또는 [예약](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md))을 입력하여 벌크 이메일 업데이트로 모든 수신자에게 전송할 수 있습니다.
   ...
   >[!MORELIKETHIS]
   >
   >* [벌크 이메일 옵션](/help/marketo/product-docs/marketo-sales-insight/actions/email/using-the-compose-window/bulk-emailing-options.md)
