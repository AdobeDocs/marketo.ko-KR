...
1. [템플릿 선택](/help/marketo/product-docs/marketo-sales-insight/actions/email/using-the-compose-window/using-a-template-in-the-compose-window.md)또는 이메일을 입력합니다.
...
1. 원하는 수신자를 선택하고 을(를) 클릭합니다 **동적 필드 미리 보기**. 오른쪽에서 미리 보기를 봅니다.
