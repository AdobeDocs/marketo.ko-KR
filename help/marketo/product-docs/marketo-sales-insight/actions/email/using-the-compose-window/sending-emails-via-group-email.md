...
1. Group Actions 단추를 클릭하고 다음을 선택합니다. **이메일 그룹**.
...
1. 다음을 사용하여 그룹 이메일 만들기 [위의 1-3단계](#sending-a-group-email).

1. [템플릿 선택](/help/marketo/product-docs/marketo-sales-insight/actions/email/using-the-compose-window/using-a-template-in-the-compose-window.md)또는 이메일을 작성하십시오.
...
1. 원하는 수신자를 선택하고 **동적 필드 미리 보기**. 오른쪽의 미리보기를 봅니다.
