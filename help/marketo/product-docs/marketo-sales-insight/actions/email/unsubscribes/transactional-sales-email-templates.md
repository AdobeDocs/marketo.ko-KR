...
템플릿 설정에서 비상업적인 이메일 토글을 활성화합니다.

비상업적인 이메일 보내기

구독을 취소한 사람을 선택하면 주황색으로 강조 표시됩니다.

작성 창에서 보려는 비상업적 템플리트를 선택합니다.

사용자에게는 현재 비상업적인 이메일 템플릿을 선택했음을 보여 주는 배너가 표시됩니다.

보내기 를 클릭하면 구독을 취소한 경우에도 이메일이 계속 전송됩니다.
