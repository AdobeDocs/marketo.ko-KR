---
description: Sales Insight Actions 의 구독 취소 처리에 대해 알아봅니다. 구독 취소가 작동하는 방식을 이해하고 Marketo 및 Salesforce과 동기화합니다.
title: 구독 취소 개요
...
>[!NOTE]
>
>특정 시점에 해당 사용자가 _구독 취소_&#x200B;를 한 경우에만 [!UICONTROL Unsubscribe History] 카드가 있습니다.
