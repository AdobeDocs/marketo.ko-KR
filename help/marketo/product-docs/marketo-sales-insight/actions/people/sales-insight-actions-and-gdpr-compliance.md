---
description: Sales Insight 작업 및 GDPR 준수 - Marketo 문서 - 제품 설명서
title: Sales Insight 작업 및 GDPR 규정 준수
...
# Sales Insight 작업 및 GDPR 규정 준수 {#sales-insight-actions-and-gdpr-compliance}
...
당사는 당사의 전자책, 즉 Marketo 플랫폼 내에서 동의와 책임에 관한 광범위한 정보를 제공합니다. [GDPR 및 마케터](https://www.marketo.com/ebooks/the-gdpr-and-the-marketer/). 그러나 이 문서에서는 조직이 GDPR 규칙을 준수하는 데 도움이 되는 Sales Insight Actions 의 새로운 기능에 대해 자세히 살펴봅니다.

## Sales Insight Actions 의 GDPR 준수 {#gdpr-compliance-in-marketo-sales-connect}

Sales Insight Actions 는 Marketo Engagement Platform의 일부인 강력한 애플리케이션으로, 공동 작업을 통해 파이프라인을 보다 빠르게 이끌어낼 수 있도록 판매 및 마케팅을 위한 단일 워크플로우 및 뷰를 제공합니다. Sales Insight Actions 의 새로운 기능은 특히 GDPR 준수를 염두에 두고 만들어졌습니다. 세 가지 기능에 대해 모두 간략히 설명하고 이들 기능이 적절히 사용될 때 조직의 GDPR 준수 활동에 어떻게 도움이 되는지 설명합니다.

## 준수 카드 {#compliance-card}

Sales Insight Actions 에는 개인 세부 정보 보기에 규정 준수 카드가 포함되어 있어 연락처의 인증 유형과 소스 유형에 대한 주요 정보를 제공합니다. 이를 통해 사용자는 데이터 개인 정보에 중요한 정보를 쉽게 추가하고 추적할 수 있으며, 캠페인/지원 전략에 대해 보다 현명한 결정을 내리는 데 도움이 됩니다.

**연락처 인증 유형**

준수 카드 내에서 사용자는 권한 부여 드롭다운을 통해 연락처의 개인 데이터를 처리하는 법적 근거를 추적할 수 있습니다. 연락처의 인증 유형을 이해하면 Sales Insight Actions 사용자가 지원 방식에 대해 보다 현명한 결정을 내릴 수 있으므로, 각 캠페인이나 참여가 합법적이고 적절한지 확인할 수 있습니다.
...
새로운 규정 준수 카드에서 사용자는 연락처의 소스를 추적할 수 있습니다. 소스 유형은 Sales Insight Actions에 처음 업로드할 때 연락처 정보가 있었던 위치를 정의합니다. 연락처의 소스 유형을 이해하면 지원 방식에 대한 의사 결정뿐만 아니라 개인 데이터가 저장되는 다른 시스템 또는 위치를 파악하여 각 참여가 GDPR 법안과 일치하는지 확인하는 데 도움이 됩니다.
...
개인 세부 정보 보기가 열려 있으면 **편집** Compliance Card에서 사용할 수 있습니다.

![](assets/sales-insight-actions-and-gdpr-compliance-1.png)

인증 유형과 소스 유형, 이렇게 두 개의 드롭다운이 표시됩니다.
...
또한 Sales Insight Actions 을 사용하면 연락처의 인증 및 소스 유형을 일괄적으로 업데이트할 수 있으므로 규정 준수 프로세스에서 귀중한 시간을 절약할 수 있습니다.

인물 페이지에서 하나 이상의 연락처를 선택하면 오른쪽에 점 3개가 나타납니다. 클릭하면 Authorization 및 Source are options가 표시됩니다. 여러 연락처의 인증 또는 소스를 동시에 설정할 수 있습니다.
...
마찬가지로 소스 모달을 클릭하여 소스 유형도 일괄적으로 업데이트할 수 있습니다.

![](assets/sales-insight-actions-and-gdpr-compliance-8.png)

선택한 연락처에 대해 올바른 소스 유형을 선택하면 업데이트 성공을 확인하는 확인 창이 나타납니다.

![](assets/sales-insight-actions-and-gdpr-compliance-9.png)

## Sales Insight 작업에서 연락처 데이터 내보내기 {#exporting-contact-data-from-marketo-sales-connect}
...
연락처 정보를 내보내려면 개인 세부 정보 보기 헤더에서 세 개의 세로 점을 클릭하고 을 선택합니다 **내보내기**. .CSV 파일이 자동으로 다운로드됩니다.

![](assets/sales-insight-actions-and-gdpr-compliance-10.png)

>[!NOTE]
>
>GDPR에는 UI에서 연락처를 삭제하는 기능도 필요하지만 Sales Insight Actions에는 이미 이 기능이 있습니다.

## 구독 취소 {#unsubscribes}

GDPR의 일반적으로 잘못 이해된 영역 중 하나는 조직의 데이터베이스에서 구독을 취소하는 연락처와 관련되어 있습니다. 구독 취소를 선택하는 사용자의 데이터 보호에 대한 새로운 규칙을 준수하기 위해 Sales Insight Actions에 다음 기능이 포함되었습니다.

**구독 취소 링크:** 구독 취소 링크는 Sales Connect 웹 애플리케이션에서 보낸 모든 이메일에 자동으로 추가되어 연락처에서 옵트아웃에 액세스할 수 있는 방법이 제공됩니다.\
**동기화 구독 취소:** 사용자는 CRM(Salesforce)에서 구독 취소를 동기화하여 옵트아웃이 최신 상태인지 확인할 수 있습니다.\
**구독 취소 내역:** 사용자는 개인 세부 정보 보기에서 옵트아웃 및 옵트인 기록을 볼 수 있습니다.\
**제거 구독 취소:** 구독 취소한 연락처를 다시 옵트인하려면 사용자에게 관리자 권한이 있어야 하며, 연락처가 연락하는 데 새 동의를 제공했음을 입증해야 합니다.
...
우리는 규제 당국과 관련 법률이 발표한 적용 가능한 GDPR 지침을 계속 면밀히 추적할 것이다. 다음 위치에 있는 당사의 트러스트 센터에 업데이트가 게시됩니다. [trust.marketo.com](https://trust.marketo.com).
