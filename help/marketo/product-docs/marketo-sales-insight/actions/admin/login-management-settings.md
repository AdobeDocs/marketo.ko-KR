...
>[!NOTE]
>
>기본적으로 [!DNL Sales Insight Actions] 인스턴스에 대해 [!UICONTROL Salesforce Only] 옵션이 선택됩니다. 사용자가 [!DNL Salesforce]에서 [자동 로그인](/help/marketo/product-docs/marketo-sales-insight/actions/admin/auto-login-from-salesforce.md)할 수 있도록 이 설정을 사용하는 것이 좋습니다.
...
Salesforce은 사용자가 [!DNL Salesforce]에서 [!DNL Sales Insight Actions]을(를) 사용하기 위해서만 인증할 수 있음을 의미합니다. 이 옵션은 [!DNL Sales Insight Actions] 인스턴스에 대한 기본 선택이며, 사용자가 사용자 이름과 암호를 관리할 필요 없이 원활하게 인증할 수 있기 때문에 권장됩니다.
