...
Sales Campaigns 는 다음을 포함한 일련의 멀티채널 단계입니다. 이메일, 전화 통화, InMail 및 사용자 지정 작업. 이를 통해 잠재 고객 및 기존 고객과의 커뮤니케이션을 간소화할 수 있습니다.

영업 캠페인을 통해 다음을 수행할 수 있습니다.
...
1. 카테고리를 선택하고 **새 캠페인 만들기** 버튼을 클릭합니다.
...
1. 당신이 [이메일 사용 완료](/help/marketo/product-docs/marketo-sales-insight/actions/campaigns/sales-campaign-step-types-and-reminder-tasks.md#email){target=&quot;_blank&quot;}, **추가**.
...
1. 첫 번째 요일 및 단계를 만든 후 &quot;하루 추가&quot; 단추가 활성화되고 판매 프로세스에 필요한 일 및 단계를 추가할 수 있습니다.
   ...
   >[!NOTE]
   >
   >일 수는 작업 사이의 일 수가 아니라 시퀀스 내의 일입니다. 예를 들어 판매 캠페인이 7일 동안 지속되는 경우 &#39;3&#39;을 입력하면 7일 중 3일에 작업이 종료된다는 의미입니다. **not** 3일 후.

1. 다음을 방문하여 주말 건너뛰기와 같은 예약 및 회신 옵션을 사용자 지정했는지 확인합니다. **설정 탭** Sales Campaign에 사용할 수 있습니다.
