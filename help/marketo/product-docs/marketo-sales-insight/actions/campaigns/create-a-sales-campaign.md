...
1. 범주를 선택하고 **[!UICONTROL Create New Campaign]** 단추를 클릭합니다.
...
1. [전자 메일 사용 완료](/help/marketo/product-docs/marketo-sales-insight/actions/campaigns/sales-campaign-step-types-and-reminder-tasks.md#email){target="_blank"}가 되면 **[!UICONTROL Add]**&#x200B;을(를) 클릭합니다.
...
1. 판매 캠페인의 **[!UICONTROL Settings]탭**&#x200B;을(를) 방문하여 주말(멋진) 건너뛰기와 같이 예약 및 회신 옵션을 사용자 지정했는지 확인하십시오.
