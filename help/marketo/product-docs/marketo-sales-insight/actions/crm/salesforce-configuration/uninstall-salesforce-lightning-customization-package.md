...
# Salesforce Lightning 사용자 지정 패키지 제거 {#uninstall-salesforce-lightning-customization-package}
...
1. Salesforce Lightning에서 톱니바퀴 아이콘을 클릭하고 을 선택합니다 **설정**.
...
1. 목록 보기 옆의 화살표를 클릭하고 을 선택합니다 **편집**.

   ![](assets/uninstall-salesforce-lightning-customization-package-18.png)

1. 선택 **MSC Campaign에 추가**, **MSC를 사용하여 전자 메일 보내기**, 및 **MSC에 푸시**&#x200B;를 클릭하고 제거 화살표를 클릭합니다. 그런 다음 **저장**.
