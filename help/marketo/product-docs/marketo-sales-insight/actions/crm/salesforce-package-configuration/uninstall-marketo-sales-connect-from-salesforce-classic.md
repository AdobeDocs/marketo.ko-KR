...
1. 왼쪽 탐색 메뉴에서 빌드에서 맞춤화 를 확장 (하지만 클릭하지 않음)한 다음 리드 를 클릭합니다. 그런 다음 을 선택합니다. **페이지 레이아웃**.
...
1. 왼쪽 탐색 메뉴에서 빌드에서 맞춤화 를 확장 (하지만 클릭하지 않음)한 다음 리드 를 클릭합니다. 그런 다음 을 선택합니다. **레이아웃 검색**.
...
1. 선택 **MSC 캠페인에 추가(클래식)**, **MSC를 사용한 이메일(클래식)**, 및 **MSC로 푸시(클래식)**&#x200B;을 클릭하고 제거 화살표를 클릭합니다. 그런 다음 **저장**.
...
1. 왼쪽 탐색 메뉴에서 빌드에서 맞춤화 를 확장한 다음 (클릭하지 마십시오) 연락처 을 선택합니다. 그런 다음 을 선택합니다. **페이지 레이아웃**.
...
1. 왼쪽 탐색 메뉴의 빌드에서 맞춤화, Opportunities 를 차례로 확장합니다(클릭하면 안 됨). 그런 다음 을 선택합니다. **페이지 레이아웃**.

1. Opportunity 레이아웃 옆에 있는 **편집**.
...
1. 왼쪽 탐색 메뉴에서 빌드에서 맞춤화 를 확장 (하지만 클릭하지 않음)한 다음 계정 을 선택합니다. 그런 다음 을 선택합니다. **페이지 레이아웃**.
