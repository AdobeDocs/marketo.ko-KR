---
description: Salesforce에 Marketo 영업 계정 연결 - Marketo 문서 - 제품 설명서
...
# Salesforce에 Marketo 판매 계정 연결 {#connect-your-marketo-sales-account-to-salesforce}

다음 간단한 단계에 따라 Marketo Sales Connect를 Salesforce에 연결합니다.
