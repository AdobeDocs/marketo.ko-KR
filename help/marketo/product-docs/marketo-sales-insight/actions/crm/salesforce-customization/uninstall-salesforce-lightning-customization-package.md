...
1. 목록 보기 옆의 화살표를 클릭하고 **편집**&#x200B;을 선택합니다.

   ![](assets/uninstall-salesforce-lightning-customization-package-18.png)

1. **MSC 캠페인에 추가**, **MSC로 전자 메일 보내기**, **MSC로 푸시**&#x200B;를 선택하고 제거 화살표를 클릭합니다. 그런 다음 **저장**&#x200B;을 클릭합니다.
...
1. 아래로 스크롤하여 **기회**&#x200B;를 선택하십시오.

1. **페이지 레이아웃**&#x200B;을 클릭합니다.

1. **영업 기회 레이아웃**&#x200B;을 클릭합니다.
