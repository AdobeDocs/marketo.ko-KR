---
description: 추적 활동이 Salesforce 활동에 표시되지 않는 경우 문제를 해결합니다. 동기화 설정, API 로깅 및 권한을 확인합니다.
...
[!DNL Salesforce]의 [필드 수준 보안](https://help.salesforce.com/articleView?id=admin_fls.htm&type=5)에 대해 자세히 알아보세요.
