...
* Salesforce에 연결되어 있는지 확인합니다. 각 사용자는 Salesforce에 대한 이메일 및 호출을 기록하기 위해 연결이 있어야 합니다.
...
* Salesforce 관리자는 보안 제어 탭에서 필드 접근성을 볼 수 있습니다. 작업이 상호 작용하는 주요 객체는 가망 고객, 연락처, 계정, 기회 및 작업/활동입니다.
