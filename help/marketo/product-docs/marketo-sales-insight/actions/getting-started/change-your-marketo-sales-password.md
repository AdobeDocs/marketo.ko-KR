...
1. 내 프로필 페이지가 기본적으로 열립니다. 계정 세부 정보에서 **암호 변경** 확인란.

   ![](assets/change-your-marketo-sales-password-2.png)

1. 현재 암호를 입력합니다. 그런 다음 새 이름을 입력하고 일치하는지 다시 입력합니다. 클릭 **저장** 완료 시.
...
1. 다음 위치로 이동 [Sales Connect 로그인](https://toutapp.com/login) 페이지를 가리키도록 업데이트하는 중입니다. 이메일 주소를 입력하고 클릭 **로그인**.
...
1. 계정과 연결된 이메일 주소를 입력하고 **재설정 이메일 보내기**.

   ![](assets/change-your-marketo-sales-password-6.png)

1. 계정 소유자가 암호를 변경하고자 하는지 확인하기 위해 이메일을 보내드리겠습니다. 클릭 **암호 재설정**.
