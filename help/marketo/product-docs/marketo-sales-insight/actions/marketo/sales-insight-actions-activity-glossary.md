...
판매자가 다음 경우에 판매 통찰력 작업에서 다음을 수행합니다. 영업 캠페인에 리드를 추가하거나, 영업 이메일을 보내거나, 아웃바운드 판매 호출을 수행하면, 해당 리드에 대한 Marketo 활동 내역 아래에 기록됩니다. 또한 리드가 이메일, 열기, 클릭 및 답글에 참여하면 로그도 됩니다.

아래 활동은 Sales Insight Actions에서 Marketo에 기록됩니다.
...
<table> 
 ...
 <tr> 
  ...
  <tr> 
   ...
   <td>Sales Insight Actions의 Sales Campaign 자산에 대한 고유 ID입니다.</td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td>Sales Campaign에 대한 Sales Insight Actions URL입니다.</td> 
  </tr>
  <tr> 
   <td><strong>영업 이메일 제목</strong></td> 
   <td>이메일 제목란과 고유 ID(예: 내 제목 줄(SIA-12345678)</td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td>Sales Insight Actions의 이메일 템플릿 이름입니다.</td> 
  </tr>
  <tr> 
   <td><strong>영업 템플릿 URL</strong></td> 
   <td>이메일 템플릿에 대한 Sales Insight 작업 URL입니다.</td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td>활동의 소스. 는 10월 21일 릴리스 이전에 Sales Insight Actions 활동에 대해 "Tout"으로 설정됩니다. 10월 21일 릴리스 이후 Sales Insight Actions 활동에 대한 "Sales App"이 됩니다.</td>
  </tr> 
  <tr> 
   <td><strong>템플릿 ID</strong></td> 
   <td>소스가 Tout이면 템플릿 ID는 Marketo Sales Insight Actions 템플릿 ID입니다. 여러 템플릿에 있을 수 있는 제목 줄 대신 특정 템플릿을 타깃팅하려면 이 방법을 사용합니다.
</td> 
  </tr> 
 </tbody> 
</table>
