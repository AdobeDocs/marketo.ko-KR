...
>[!NOTE]
>
>Sales Insight Actions 을 프로비저닝하면 Marketo에서 자격 증명을 Actions에 자동으로 보내고 인스턴스를 Marketo에 연결합니다. 이 단계는 Sales Connect 인스턴스가 프로비저닝된 후 **연결이 설정되지 않은 경우에만**&#x200B;필요합니다. 연결이 설정되면 Marketo 관리 설정 페이지에 입력한 자격 증명과 연결 해제 옵션이 표시됩니다.
