...
1. 선택 **이름** 및 **범주** 이메일 템플릿에 대해 다음을 클릭합니다. **만들기**.

   ![](assets/manage-templates-3.png)

1. 템플릿 편집기에서 이메일의 제목 줄을 만들고 원하는 메시지를 입력합니다. 편집 도구 사용(글꼴, 텍스트 크기 등) 를 클릭하여 모양을 사용자 지정합니다. 클릭 **저장** 을 눌러 변경 사항을 완료합니다.
...
1. 다음을 클릭합니다. **공유** 단추를 클릭합니다.

   ![](assets/manage-templates-7.png)

   >[!NOTE]
   >
   >나와 공유된 템플릿이 아래 표시됩니다. **팀 템플릿** 템플릿 페이지의 왼쪽에 있는 머리말. 팀은 Premium 사용자만 사용할 수 있습니다.

1. 공유 대상 드롭다운을 클릭하고 공유할 팀을 선택합니다.

   ![](assets/manage-templates-8.png)

1. 템플릿을 현재 카테고리에 보관하거나 다른 카테고리로 이동할 수 있습니다. 이 예제에서는 현재 상태로 유지합니다. 클릭 **공유** 완료 시.
...
다음에서 **보기** 드롭다운에서 모든 템플릿, 템플릿, 즐겨찾기 템플릿, 공유 템플릿, 공유되지 않은 템플릿 또는 사용되지 않은 템플릿(지난 90일 동안 사용되지 않은 템플릿)을 표시하도록 선택할 수 있습니다.
