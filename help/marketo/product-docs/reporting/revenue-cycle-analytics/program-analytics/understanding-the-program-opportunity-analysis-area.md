...
분석에 사용할 수 있는 측정값은 일반적으로 숫자이며 파란색 점으로 표시됩니다. Dimension은 측정값에 대해 서로 다른 보기를 제공하는 속성으로, 노란색 점으로 표시됩니다.
...
## 프로그램 영업 기회 분석 Dimension(노란색 점) {#program-opportunity-analysis-dimensions-yellow-dots}
