...
1. 새 사용자 정의 분석기를 저장하려면 Analyzer 작업 드롭다운에서 **다른 이름으로 저장**&#x200B;을 선택합니다.

   ![](assets/image2016-10-31-15-3a5-3a8.png)

1. 저장 위치 및 폴더 드롭다운을 사용하여 사용자 지정 분석기를 저장할 위치를 선택합니다. 새 사용자 정의 분석기의 이름을 지정합니다. 설명은 선택 사항입니다. **저장**&#x200B;을 클릭합니다.
