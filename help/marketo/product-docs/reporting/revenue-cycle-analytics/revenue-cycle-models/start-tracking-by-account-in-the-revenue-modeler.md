...
1. 유용한 데이터를 수집할 시간이 충분히 지난 후 **내 Marketo 홈**&#x200B;에서 **[!UICONTROL Revenue Explorer]**&#x200B;을(를) 선택하십시오.
...
1. 이제 보고서에는 계정별로 추적하는 단계만 표시됩니다. 나중에 사용할 수 있도록 보고서를 저장해야 합니다. 이제 마케팅 활동의 성공을 측정하는 또 다른 기준으로 사용할 수 있습니다.
