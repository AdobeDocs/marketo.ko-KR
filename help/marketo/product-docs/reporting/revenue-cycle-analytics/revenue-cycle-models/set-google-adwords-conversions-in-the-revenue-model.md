...
>[!NOTE]
>
>Marketo에서 Google AdWords로의 푸시 통합입니다. 전환 데이터는 Google AdWords 포털에 _만_&#x200B;나타나며, Marketo UI에는 _나타나지 않습니다_.

[Google의 오프라인 전환 가져오기 기능](https://support.google.com/adwords/answer/2998031?hl=en)에 대해 자세히 알아보세요. AdWords 오프라인 전환을 매출 모델의 하나 이상의 단계에 매핑합니다. 매핑을 수행하는 방법에는 세 가지가 있습니다.
...
1. Marketo 단계에 매핑할 **AdWords 변환**&#x200B;을 선택합니다.
...
1. **AdWords 변환**&#x200B;을 선택합니다.

   ![](assets/image2015-2-26-16-3a54-3a47.png)

   **팁**: AdWords 변환이 없으면 **+새 변환**&#x200B;을 클릭하여 만드십시오.
...
1. 추적할 각 단계에 대해 원하는 **AdWords 변환**&#x200B;을 선택합니다.
