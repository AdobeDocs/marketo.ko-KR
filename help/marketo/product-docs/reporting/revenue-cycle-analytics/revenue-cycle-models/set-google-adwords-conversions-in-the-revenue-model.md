...
>[!NOTE]
>
>Marketo에서 [!DNL Google AdWords]&#x200B;(으)로의 푸시 통합입니다. 전환 데이터는 [!DNL Google AdWords] 포털에 _만_&#x200B;나타나며, _Marketo UI에는 표시되지 않습니다_.
...
**[!UICONTROL Stage Actions]**&#x200B;에서 [!UICONTROL AdWords Conversion]을(를) 매핑할 수도 있습니다.
...
[!DNL AdWords] 매핑을 사용하여 모든 모델 단계를 [!UICONTROL AdWords Conversion]과(와) 한 곳에서 연결할 수 있습니다.
