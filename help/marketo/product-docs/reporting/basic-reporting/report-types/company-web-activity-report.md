...
1. 보고서를 검토하여 사이트를 방문하는 회사를 확인합니다.
...
<table>
 ...
 <tbody>
  <tr>
   <td>회사</td>
   <td>방문자의 회사입니다.<br> 한 명 이상의 사용자가 <strong>굵게</strong> 이름을 회사 이름으로 확인했습니다.</td>
  </tr>
  <tr>
   <td>회사 또는 ISP 유추</td>
   <td>방문자의 IP 주소에서 추정한 회사. <br> <strong>굵게</strong> 이름은 ISP가 아닌 회사임을 나타냅니다. </td>
  </tr>
  <tr>
   <td>페이지 보기 횟수</td>
