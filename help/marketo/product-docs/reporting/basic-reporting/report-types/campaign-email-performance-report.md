...
1. 이제 보고서를 탐색하여 캠페인의 각 이메일이 어떻게 수행되었는지 확인하십시오.
   ...
   >[!NOTE]
   >
   >일반적으로 이러한 통계를 기록하기 위해 상식을 이용하고자 한다. 예를 들어, 누군가 이메일의 링크를 클릭한 경우 먼저 링크를 클릭한 것이 분명합니다. 따라야 할 특정 규칙을 보려면 [전자 메일 성능 보고서](/help/marketo/product-docs/email-marketing/email-programs/email-program-data/email-performance-report.md)를 참조하십시오.
