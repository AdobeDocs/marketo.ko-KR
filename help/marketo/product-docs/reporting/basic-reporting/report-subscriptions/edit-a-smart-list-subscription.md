...
description: 수신자, 빈도, 열, 최종 게재 날짜 및 형식을 업데이트하여 스마트 목록 구독을 편집하는 방법을 알아봅니다. 가입 탭에서 직접 변경합니다.
title: 스마트 목록 구독 편집
...
1. 종료 날짜를 편집하려면 **[!UICONTROL End Date]** 열을 클릭하십시오. **[!UICONTROL Never]** 또는&#x200B;**[!UICONTROL Date]**&#x200B;를 선택합니다. 날짜의 경우 해당 날짜를 입력하거나 달력에서 선택합니다. **[!UICONTROL Approve]**&#x200B;를 클릭합니다.
