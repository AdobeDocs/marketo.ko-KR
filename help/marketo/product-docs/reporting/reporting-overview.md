...
프로그램 내 또는 Analytics 영역에서 기본 보고서를 설정할 수 있습니다. 기본 보고서는 필터, 정렬 및 시간 간격을 유연하게 조정하는 다양한 유형의 기본 보고서로 구성됩니다.

## 이메일 통찰력 {#email-insights}

Analytics 및 Sends를 사용하여 이전 데이터에서 강력한 통찰력을 얻을 수 있습니다.

## 성능 통찰력 {#performance-insights}

Performance Insights는 참여, 파이프라인 및 매출 생성을 위한 채널 성능 및 프로그램 성능을 다룹니다.
...
마케팅 이니셔티브에서 ROI를 추적합니다. 이메일, 리드, 프로그램, 기회, 모델 성과 분석(회사) 및 모델 성과 분석(리드)을 분석합니다. BI Explorer를 사용하면 분석 영역 내에서 사용자 지정 보고서를 만들고 데이터를 사용하여 그래프, 차트, 피벗 및 대시보드를 만들 수 있습니다.
...
>[!NOTE]
>
>매출 주기 탐색기가 있는 모델 성과 분석(회사) 및 모델 성과 분석(리드)은 매출 주기 모델에 따라 다릅니다.
