...
description: 속성 설정, 프로그램 가시성, 기회 매핑, 설정 요구 사항 등 성능 인사이트에 대해 자주 묻는 질문에 대한 답변을 찾아보십시오. MPI가 CRM 및 분석과 작동하는 방식을 이해합니다.
title: 성과 인사이트 FAQ
...
MPI는 funnel의 최상위에서 매출 영향까지 프로그램 성능을 측정할 수 있도록 설계되었습니다. Opportunity 를 사용하지 않으면 다음과 같은 작업을 수행할 수 있습니다.
