...
[!DNL Highspot]과(와) [!DNL Sales Connect] 통합을 사용하려면 다음 항목이 필요합니다.

* **브라우저 - [!DNL Chrome] 및 [!DNL Safari], [!DNL Edge], IE 또는 Firefox의 최신 버전**

브라우저에서 [!DNL Sales Connect]에서 작업할 수 있을 뿐만 아니라 [!DNL Outlook .Net] 전자 메일 클라이언트에서도 [!DNL Highspot] 통합을 사용할 수 있습니다. 요구 사항은 다음과 같습니다.
...
활성화하면 [!DNL Sales Connect]에서 [!DNL Highspot] 콘텐츠에 액세스하는 방법에 대해 설명합니다.
