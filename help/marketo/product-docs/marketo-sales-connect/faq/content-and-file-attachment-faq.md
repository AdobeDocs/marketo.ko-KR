...
description: Sales Connect에서 컨텐츠 및 파일 첨부 관련 질문에 대한 답변을 받아 보십시오. 크기 제한, 추적 및 첨부 파일 옵션에 대해 알아봅니다.
...
**콘텐츠**&#x200B;는 파일(PPT, PDF, Word 문서 등)을 설명하는 데 사용하는 것입니다. [!DNL Sales Connect]이(가) 추적하는 것이 좋습니다.
