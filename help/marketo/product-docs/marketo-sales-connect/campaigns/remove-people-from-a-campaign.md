...
이를 설정하려면 캠페인을 만든 후 [!UICONTROL Campaigns] 탭의 [!UICONTROL Settings] 부분에서 [!UICONTROL Unsubscribe] 상자를 선택하면 됩니다. 이 두 옵션 모두 캠페인을 종료하며 수신자는 더 이상 귀하로부터 이메일을 받지 않습니다. 이 작업을 수행하려면 회신 추적이 있어야 합니다.
