...
다음 작업을 수행하는 경우 [csv 업로드](/help/marketo/product-docs/marketo-sales-connect/people/managing-contacts/import-contacts-via-csv.md) 파일을 Sales Connect로 가져오기가 수행되기 전에 모든 유사 연락처를 CSV에 병합합니다.
