...
1. 다음으로 이동 **설정** > **이메일 추적** > **관리**.

1. 클릭 **Gmail에서 연결 해제**.

1. 연결을 끊은 후 클릭 **Google에 연결**.

   다시 연결되면 Gmail로 돌아가서 페이지를 새로 고친 후 이메일을 다시 보내십시오. 그래도 작동이 안 되면 [티켓 제출](https://nation.marketo.com/t5/Support/ct-p/Support) 지원 팀에 문의하십시오.
