...
description: Gmail 사용자를 위한 이메일 연결 - 마케팅 문서 - 제품 설명서
...
>[!NOTE]
>
>Gmail은 자체 전송 제한을 시행합니다. [자세한 내용을 살펴보십시오](/help/marketo/product-docs/marketo-sales-connect/email/email-delivery/email-connection-throttling.md#email-provider-limits).
