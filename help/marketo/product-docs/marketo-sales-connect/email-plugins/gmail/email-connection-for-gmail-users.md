...
description: Sales Connect의 Gmail 사용자를 위한 이메일 연결에 대해 알아봅니다. Gmail을 연결하여 추적된 이메일을 보내고 활동을 Salesforce에 기록합니다.
...
>[!NOTE]
>
>Gmail은 자체 전송 제한을 적용합니다. [여기에서 자세히 알아보십시오](/help/marketo/product-docs/marketo-sales-connect/email/email-delivery/email-connection-throttling.md#email-provider-limits).
