...
description: 보조 Gmail 주소가 Sales Connect와 통합되지 않도록 하는 방법을 알아봅니다. 플러그인에 기본 이메일만 사용합니다.
...
다른 [!DNL Chrome]프로필을 만드는 방법을 보려면 [이 링크](https://support.google.com/chrome/answer/2364824?hl=en)를 클릭하십시오.
