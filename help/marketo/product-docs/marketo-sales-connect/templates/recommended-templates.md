...
1. 템플릿에 대한 권장 템플릿 기능을 활성화하려면 다음을 확인하십시오. **다음과 같은 경우 이 템플릿 자동 제안**.

## 모든 항목과 모든 항목 {#all-vs-any}

이제 기준 설정을 선택할 차례입니다. 선택 **모두** 모든 기준이 충족될 때 템플릿을 추천받고 싶은 경우. 선택 **임의** 기준 중 하나가 충족될 때 템플릿을 추천받으려면 다음을 수행하십시오.
