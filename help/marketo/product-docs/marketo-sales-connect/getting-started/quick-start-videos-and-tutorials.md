...
# 빠른 시작 비디오 및 Tutorials {#quick-start-videos-and-tutorials}

>[!NOTE]
>
>Marketing To Sales Engage는 최근 Marketing To Sales Connect로 이름이 변경되었습니다. 모든 비디오를 업데이트하는 중이지만 일부 비디오에 이전 이름이 표시될 수 있습니다.

## 마케팅 인사이트 활성화 {#enabling-marketing-insights}
...
## 이메일 설정 개요 {#email-settings-overview}
...
## Salesforce {#installing-customizations-in-salesforce}에 사용자 지정 설치
...
## Salesforce 개요 {#salesforce-overview}
