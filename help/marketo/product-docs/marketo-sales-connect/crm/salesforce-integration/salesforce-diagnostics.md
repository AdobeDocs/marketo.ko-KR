...
description: Sales Connect의 Salesforce 진단에 대해 알아봅니다. Sales Connect와 Salesforce 간의 연결 및 동기화 문제를 해결합니다.
title: Salesforce 진단
...
**범주:** 간헐적
**메시지:** 파일의 끝에 도달했습니다.
**현재 상황:** [!DNL Salesforce]의 성능 문제는 고객측의 최적 조건이 아닌 트리거로 인해 발생할 수 있습니다.
...
**진행 상황:** 작업의 상위 레코드에 대한 액세스 권한이 없습니다.
**문제 해결 단계:** 위의 내용을 참조하십시오.
...
**문제 해결 단계:** [!DNL Salesforce] 관리자가 IP를 관리해야 합니다. 사용자는 지원 팀에 연락하여 IP 주소를 받아야 합니다.
...
**진행 중인 작업:** [!DNL Salesforce]에서 처리되지 않은 예외.
