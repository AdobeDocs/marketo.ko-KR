...
description: Salesforce에 Sales Connect에 연결할 때 요청을 인증할 수 없습니다 오류 수정 도움말을 확인합니다. 인증 문제를 해결합니다.
...
1. [!DNL Sales Connect] 옆에 &quot;[!UICONTROL Block]&quot;이(가) 있는지 확인하십시오. &quot;[!UICONTROL Unblock]&quot;이(가) 표시되면 단추를 클릭하여 [!DNL Salesforce]에 대한 [!DNL Sales Connect]의 액세스를 차단 해제하십시오.
