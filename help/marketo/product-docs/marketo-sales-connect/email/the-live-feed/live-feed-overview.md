...
description: 라이브 피드 개요 - 마케팅 문서 - 제품 설명서
title: 라이브 피드 개요
...
라이브 피드는 웹 애플리케이션 또는 Gmail 플러그인에서 실행할 수 있는 부동 창으로, 잠재 고객 참여를 실시간으로 확인할 수 있습니다.
...
파란색 선으로 표시된 사람은 MSE를 통해 보낸 이메일의 참여를 나타냅니다.
...
라이브 피드에서 할 일 목록을 신속하게 확인할 수 있습니다.
