...
description: Sales Connect에서 추적된 이메일을 보내는 방법을 알아봅니다. 작성 창에서 전송하고 열기, 클릭 수 및 답글을 추적합니다.
title: 추적된 이메일 보내기
...
1. 각 필드에 참조 또는 숨은 참조를 추가할 수신자를 추가합니다.
   ...
   >[!NOTE]
   >
   >참조 또는 숨은 참조 역할을 했던 사람이 이메일을 열면 해당 열기가 **[!UICONTROL To]** 필드에 있는 사람의 레코드에 보기로 기록됩니다.
...
1. 편집기를 사용하여 이메일을 작성합니다. 완료되면 **[!UICONTROL Send]**(또는 원하는 경우 [일정](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md))을 클릭합니다.
   ...
   >* [템플릿](/help/marketo/product-docs/marketo-sales-connect/templates/manage-templates.md)
