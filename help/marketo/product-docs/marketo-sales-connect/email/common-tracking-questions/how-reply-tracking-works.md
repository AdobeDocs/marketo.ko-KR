...
>[!PREREQUISITES]
>
>**이메일 서버와의 연결:** Sales Connect가 받은 편지함에 연결되어 있어야 새 회신이 언제 도착했는지 알 수 있습니다. Sales Connect 계정이 있어야 합니다. [gmail에 연결됨](/help/marketo/product-docs/marketo-sales-connect/email-plugins/gmail/email-connection-for-gmail-users.md). Outlook을 사용하는 경우 과 통합해야 합니다. [exchange server](https://toutapp.com/next#settings/exchange_settings).
