...
>[!NOTE]
>
>* SMTP 서버 설정 외에도 [이메일 ID를 확인해야 합니다.](/help/marketo/product-docs/marketo-sales-connect/getting-started/email-settings/verify-your-email.md) 이메일을 보내기 전에
...
1. 여전히 이메일 설정에서 **주소 및 서명**.

   ![](assets/setting-up-a-custom-delivery-channel-5.png)

1. 게재 채널을 선택할 이메일 ID를 찾아 **게재 채널 선택**.
