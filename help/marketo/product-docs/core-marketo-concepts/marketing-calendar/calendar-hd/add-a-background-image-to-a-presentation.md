...
1. 프레젠테이션을 마우스 오른쪽 단추로 클릭하고 **[!UICONTROL 설정 보기]**.
...
1. 드래그 앤 드롭 **[!UICONTROL 배경 이미지]** 오른쪽 트리에서 캔버스로
...
1. 이미지 라이브러리에서 이미지를 선택합니다.
   ...
   >[!TIP]
   >
   >가장 깔끔한 모양에는 다음과 같은 이미지를 사용하십시오. **1920 x 1080** 또는 **1280 x 720**.

   ![](assets/image2015-3-24-14-3a47-3a57.png)

1. 클릭 **[!UICONTROL 미리 보기]** 확인할 수 있습니다.
