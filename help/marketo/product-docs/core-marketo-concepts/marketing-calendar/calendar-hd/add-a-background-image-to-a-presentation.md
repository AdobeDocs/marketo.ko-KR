...
description: 마케팅 달력 프레젠테이션에 배경 이미지를 추가하는 방법을 알아봅니다. 라이브러리에서 이미지를 선택하여 프레젠테이션을 사용자 지정합니다.
...
1. 이미지 라이브러리에서 이미지를 선택합니다.
   ...
   >[!TIP]
   >
   >가장 깔끔한 모양에는 **1920 x 1080** 또는 **1280 x 720** 이미지를 사용하십시오.

   ![](assets/image2015-3-24-14-3a47-3a57.png)

1. 미리 보려면 **[!UICONTROL Preview]**&#x200B;을(를) 클릭하십시오.
