...
>[!TIP]
>
>다음을 확인하십시오. _프레젠테이션 미리 보기_ 를 시작하기 전에

1. 클릭 **[!UICONTROL 시작]**.

   ![](assets/image2015-3-20-14-3a4-3a18.png)

1. 클릭 **[!UICONTROL 시작]** 한 번 더 이렇게 하면 프레젠테이션이 안전하게 표시될 수 있도록 Marketo에서 로그아웃됩니다.

   ![](assets/image2015-3-20-14-3a5-3a34.png)

   >[!TIP]
   >
   >프레젠테이션이 새 탭에서 실행됩니다. 필요한 경우 탭을 외부 모니터로 이동하여 표시하고 을(를) 클릭합니다 **[!UICONTROL 전체 화면]**.
