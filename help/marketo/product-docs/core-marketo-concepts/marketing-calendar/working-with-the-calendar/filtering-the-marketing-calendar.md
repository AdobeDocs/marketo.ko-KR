...
1. 필터에 표시할 추가 항목 유형을 선택합니다.
   ...
   >[!TIP]
   >
   >표준 항목 유형에 대한 설명은 [프로그램 일정 보기 항목 유형](/help/marketo/product-docs/core-marketo-concepts/programs/program-schedule-view/program-schedule-view-entry-types.md){target="_blank"}을 확인하세요.
