...
1. [스마트 캠페인 만들기](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/create-a-new-smart-campaign.md){target="_blank"}.

   >[!NOTE]
   >
   >웹후크는 트리거 캠페인에서만 사용할 수 있습니다.

1. 로 이동 **[!UICONTROL 플로우]** 탭에서 드래그 **[!UICONTROL Webhook 호출]** 흐름 작업.
...
1. 마지막으로,에서 웹후크를 사용할 수 있습니다. **[!UICONTROL 선택 항목 추가]** 흐름 단계에서.
