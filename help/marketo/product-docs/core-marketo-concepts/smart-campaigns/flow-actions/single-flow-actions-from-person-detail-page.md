...
1. 다음을 클릭합니다. **개인 작업** 드롭다운을 클릭하고 원하는 플로우 단계를 선택합니다. 이 예제에서는 를 [이메일 보내기](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/send-email.md).

   ![](assets/single-flow-actions-from-person-detail-page-3.png)

1. 원하는 이메일을 선택하고 **지금 실행**.

   ![](assets/single-flow-actions-from-person-detail-page-4.png)

>[!NOTE]
>
>인스턴스에 작업 공간/파티션이 포함되어 있고 작업 공간에 연결된 페이지/에셋이 아닌 개인 세부 정보 페이지로 직접 이동하는 경우(즉, 링크를 통해) 4단계에서도 작업 공간을 선택해야 합니다.
