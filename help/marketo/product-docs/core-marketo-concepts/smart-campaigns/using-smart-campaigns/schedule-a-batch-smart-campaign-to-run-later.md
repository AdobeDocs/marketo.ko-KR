...
1. 실행할 일괄 처리 스마트 캠페인을 선택하고 **[!UICONTROL 일정]** 탭으로 이동한 다음 **[!UICONTROL 한 번 실행]**&#x200B;을 클릭합니다.

   ![](assets/schedule-a-batch-smart-campaign-to-run-later-1.png)

1. **[!UICONTROL 나중에 실행]**&#x200B;을 클릭한 다음 달력 아이콘을 클릭하고 스마트 캠페인을 실행할 날짜를 선택합니다.
...
1. **[!UICONTROL 예약]** 탭에서 예약된 실행을 확인할 수 있습니다.
