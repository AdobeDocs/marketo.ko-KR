...
배치 캠페인 빌드가 완료되면 지금 실행하거나 나중에 실행하도록 선택할 수 있습니다.
...
1. **[!UICONTROL Run]**&#x200B;을(를) 한 번 더 클릭하여 확인합니다.
   ...
   원하는 경우 [나중에 실행 일정](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-batch-smart-campaign-to-run-later.md){target="_blank"}을 설정할 수도 있습니다.
