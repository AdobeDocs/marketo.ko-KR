...
1. **실행**&#x200B;을 한 번 더 클릭하여 확인합니다.
   ...
   쉬운 사람! 원할 경우 나중에 ](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-batch-smart-campaign-to-run-later.md)에 대해 [일정 실행을 수행할 수도 있습니다.

   >[!NOTE]
   >
   >* [나중에 실행하도록 일괄 스마트 캠페인 예약](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-batch-smart-campaign-to-run-later.md)
