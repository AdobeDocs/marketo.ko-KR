...
description: 자동 트리거 캠페인 정리에 대해 알아봅니다. Marketo이 이전 트리거 캠페인 실행을 정리하는 방법을 이해합니다.
title: 자동 트리거 캠페인 정리
...
1. **[!UICONTROL Notifications]** 아이콘을 클릭합니다.

   ![](assets/automatic-trigger-campaign-cleanup-1.png)

1. **[!UICONTROL Idle Trigger Campaign Cleanup Scheduled]**&#x200B;를 클릭합니다. **[!UICONTROL These Idle Trigger Campaigns will be deactivated]** 링크를 클릭합니다.
...
1. **[!UICONTROL Idle Trigger Campaign Cleanup Scheduled]** 알림을 선택하십시오. **[!UICONTROL These Idle Trigger Campaigns]** 링크를 클릭합니다.
