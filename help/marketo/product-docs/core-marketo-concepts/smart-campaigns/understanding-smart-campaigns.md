...
스마트 목록은 스마트 캠페인의 대상이 될 _사용자_&#x200B;를 정의하는 방법입니다. 스마트 목록에는 필터와 트리거가 있습니다.
...
<table>
 <tbody>
  ...
  <tr>
   <td>필터</td>
   <td>클릭한 링크</td>
   <td><p>현재 자격 있는 모든 사용자를 일괄적으로 수집합니다.</p></td>
  </tr>
  <tr>
   <td colspan="1">트리거</td>
   <td colspan="1">링크 클릭</td>
   <td colspan="1">누군가가 어떤 일을 하는 순간 즉각적으로 흐름을 발생시킵니다.</td>
  </tr>
 </tbody>
</table>

다양한 방법으로 필터를 결합할 수 있을 뿐만 아니라 트리거와 함께 사용할 수도 있습니다. 이것은 강력한 도구입니다. 실험해 보십시오.

## 흐름 {#flow}

흐름에는 대기 단계 및 분할 선택 사항을 포함하여 스마트 캠페인에서 수행할 단계가 포함됩니다.
...
>[!CAUTION]
>
>한 프로그램에서 다른 프로그램으로 스마트 캠페인을 이동하고 캠페인의 스마트 목록 또는 흐름 단계가 원래 프로그램을 참조하는 경우에는 새 프로그램을 반영하도록 정보를 수동으로 업데이트하여 자동 업데이트가 이루어지지 **않도록** 해야 합니다.
