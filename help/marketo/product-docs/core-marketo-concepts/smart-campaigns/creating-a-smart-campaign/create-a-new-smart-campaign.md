...
스마트 캠페인은 Marketing To에서 가장 중요한 도구입니다. 한 사람에 대해 트리거하고 작업을 수행하거나 수백만 명의 사람을 롤업하고 일련의 흐름 단계를 실행할 수 있습니다.

>[!NOTE]
>
>**딥 다이브**
>
>스마트한 캠페인 자세한 내용은 [여기를 참조하십시오](../../../../product-docs/core-marketo-concepts/smart-campaigns/understanding-smart-campaigns.md).

1. 마케팅 활동 **으로 이동합니다**.

   ![](assets/login-marketing-activities.png)

1. 프로그램 **을**&#x200B;선택한 다음 **새로 만들기** 아래에서 **새 로컬 자산**&#x200B;을클릭합니다.
...
1. 스마트 캠페인 이름을 입력하고 만들기를 **클릭합니다**.

   ![](assets/image2014-9-19-15-3a10-3a41.png)

   좋아! 다음으로 스마트 목록을 사용하여 스마트 캠페인을 통해 실행할 사람을 정의하는 방법을 알아봅니다.
