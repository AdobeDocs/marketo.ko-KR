...
Smart Campaign의 결과를 보는 방법을 알아봅니다.
...
1. 스마트 캠페인에서 **[!UICONTROL Results]**&#x200B;을(를) 클릭합니다.
   ...
   >[!TIP]
   >
   >활동 유형에 따라 결과를 필터링할 수도 있습니다. [스마트 캠페인 결과를 필터링](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/filter-smart-campaign-results.md){target="_blank"}하는 방법을 알아보세요.

1. 특정 활동에 대한 자세한 내용을 보려면 **[!UICONTROL ID]**&#x200B;을(를) 클릭하십시오.
   ...
   결과를 자세히 살펴보고 캠페인이 실제로 수행한 작업을 확인하거나 [스마트 캠페인 결과를 Excel로 내보내기](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/export-smart-campaign-results-to-excel.md){target="_blank"}하십시오.
