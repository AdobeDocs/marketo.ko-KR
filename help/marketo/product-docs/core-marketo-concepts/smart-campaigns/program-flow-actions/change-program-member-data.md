...
>[!NOTE]
>
>필드가 업데이트되지 않도록 차단할 수도 있습니다. 자세한 내용은 필드에 대한 블록 업데이트 를 참조하십시오.

1. 스마트 캠페인의 흐름 탭에서 을(를) 가져옵니다 **프로그램 멤버 데이터 변경** 흐름 단계를 수행하고 원하는 프로그램을 선택합니다.
...
>[!TIP]
>
>필드를 업데이트하는 대신 필드를 지우려면 &quot;NULL&quot;(따옴표 없음, 모두 대문자)을 새 값으로 입력할 수 있습니다.
