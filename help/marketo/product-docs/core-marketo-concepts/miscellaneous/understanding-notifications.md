...
1. 알림으로 이동한 다음 **[!UICONTROL Subscribe]**&#x200B;을(를) 클릭합니다.

   ![](assets/understanding-notifications-3.png)

1. 알림 유형을 선택하고 알림을 보낼 이메일 주소를 입력합니다(쉼표로 구분). 완료되면 **[!UICONTROL Subscribe]**&#x200B;을(를) 클릭합니다.

   ![](assets/understanding-notifications-4.png)

>[!NOTE]
>
>**[!UICONTROL send to]** 영역은 전자 메일을 입력할 수 있는 유일한 영역이며 기존 구독자 목록은 표시되지 않습니다.
...
>[!TIP]
>
>알림 이메일에서 구독을 취소하시겠습니까? 문제 없습니다. 전자 메일 하단의 **[!UICONTROL unsubscribe from Notifications]** 링크를 클릭하면 됩니다.
