...
* **[!DNL NZPA]** [Privacy Act 2020](https://www.privacy.org.nz/privacy-act-2020/privacy-act-2020/)은(는) 뉴질랜드에 대한 데이터 보호 요구 사항을 통합하고 현대화한 개인 정보 보호법입니다.

위의 모든 규정은 위에 언급된 각 지역 또는 국가(EU, 캘리포니아, 태국, 브라질, 뉴질랜드)에 거주하는 데이터 주체의 데이터를 보유하고 있는 Marketo Engage 고객에게 적용됩니다.

## 액세스 권한 및 잊혀질 권리 {#right-to-access-and-right-to-be-forgotten}

개인 정보 보호 준비를 용이하게 하기 위해 Marketo Engage을 사용하면 **액세스** 및 **삭제** 요청을 처리할 수 있습니다.
