...
Marketo 모먼트 를 사용하여 휴대폰 또는 iPad에서 이벤트 프로그램을 볼 수 있습니다.
...
* [이벤트를 즐겨찾기로 설정](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/creating-a-favorite.md)
* [이벤트를 완료로 표시](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/marking-it-done.md)
* [이벤트 순간 카드 공유](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/sharing-a-moment.md)

이벤트 카드가 두 개 있습니다. 다음 [!UICONTROL 갑판 위] 이벤트 몇 시간 전에 전송된 카드는 얼마나 많은 사람들이 등록되었는지 보여 줍니다. 다음 [!UICONTROL 결과] 나중에 전송된 카드에는 실제로 출석한 횟수가 표시됩니다.
