...
이메일이 전송되면 카드는 배달된 이메일 수, 수신자의 작업 및 캠페인에 사용된 스마트 목록에 대한 링크 등 다른 중요한 정보를 표시합니다.

![](assets/image2015-9-25-10-3a5-3a29.png)

## 이메일 카드 {#confirming-an-email-card} 확인
...
1. 확인된 이메일을 보내지 않으려면 3개의 점 메뉴를 누릅니다.
...
## 이메일 카드 {#rescheduling-an-email-card} 예약
...
1. 이메일을 다시 예약하려면 3개의 점 메뉴를 누릅니다.
...
1. 달력에서 날짜를 선택하고 **예약**&#x200B;을 누릅니다.
   ...
   무선 서비스가 있는 한 어디에서나 다시 예약할 수 있습니다!
...
이메일 캠페인을 볼 수 있습니다. 이제, 당신은 전문가입니다!
