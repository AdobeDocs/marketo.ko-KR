...
이제 Marketo의 힘이 여러분의 손에 달렸습니다. 휴대폰 또는 iPad에서 바로 이메일을 미리 보고 일정을 조정할 수 있습니다.
...
다음은 전화기의 Marketo Moments에 대한 내용입니다.
...
**[!UICONTROL Heart-beat]** - 통계를 포함하여 이 전자 메일이 현재 전달되고 있습니다. 팀과 공유합니다.

![](assets/image2015-7-17-11-3a27-3a22.png)

**[!UICONTROL Results]** - 전자 메일이 수행된 방식을 표시합니다. 이메일 실행이 완료되면 결과 카드에 참여 점수 및 기타 상태가 표시됩니다.
...
>**정의**
>
>* [!UICONTROL Favorite]: 항목을 즐겨찾기로 설정할 경우 가장 시기 적절하고 중요한 항목에 쉽게 주의를 기울일 수 있습니다.
>* [!UICONTROL Done]: 완료 를 선택하면 Marketo 모멘트 보기에서 제거됩니다(하지만 안전하고 안전한 Marketo에 둡니다).
>* [!UICONTROL Share]: 팀에 동기부여하거나 축하하기 위해 이미지를 보냅니다.
>* [!UICONTROL Send Sample]&#x200B;(전자 메일 전용): 이 옵션을 사용하여 전자 메일을 보내기 전에 다른 사용자가 전자 메일의 모양을 검토하도록 할 수 있습니다.
>* [!UICONTROL Preview Email]&#x200B;(전자 메일 전용): 전자 메일을 미리 검토하는 것이 좋습니다.
...
전자 메일 프로그램 카드는 점심 시간에 외출한 경우에도 일정, 대상자, 상태 및 기타 유용한 정보와 같은 주요 세부 정보를 보여 줍니다.

![](assets/image2015-6-29-15-3a31-3a57.png)

## 이벤트 카드 {#event-cards}

이벤트의 경우 카드에 총 멤버 수 및 상태가 표시됩니다.
