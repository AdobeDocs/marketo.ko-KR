...
>**정의**
>
>* 순간: 방금 실행되었거나 곧 실행될 모든 항목이 여기에 표시됩니다.
>* 즐겨찾기: 즐겨찾기에 추가한 모든 항목이 여기에 포함됩니다.
>* Later: 이 순간보다 늦게 일어나는 모든 일이 여기에 들어갑니다.
>* 완료: 실행이 완료되었거나 완료로 표시한 모든 항목이 여기에 표시됩니다.
...
**갑판 위** - 이 이메일이 곧 발송됩니다. 미리 보거나, 샘플을 보내거나, 취소해야 할 경우 취소할 수 있는 마지막 기회입니다.

![](assets/image2015-7-17-11-3a25-3a48.png)

**심장박동** - 이 이메일이 지금 배달되고 있습니다! 그리고 여기 통계도 있습니다. 공유하세요.

![](assets/image2015-7-17-11-3a27-3a22.png)

**결과** - 이메일이 발송된 방식은 다음과 같습니다. 이메일 실행이 완료되면 결과 카드에 참여 점수 및 기타 상태가 표시됩니다.

![](assets/image2015-7-17-11-3a43-3a28.png)

## 모멘트 스트림 {#moments-stream}

앱을 처음 열거나 탭할 때 **모멘트** 메뉴에는 관련 카드가 먼저 표시됩니다. 각 페이지에는 해당 특정 마케팅 이니셔티브와 전체 성능에 대한 정보가 포함되어 있습니다.
...
>**정의**
>
>* 즐겨찾기: 즐겨찾기로 설정할 경우 가장 시기 적절하고 중요한 항목에 쉽게 집중할 수 있습니다.
>* 완료: 완료 를 선택하면 Marketo 모멘트 보기에서 제거됩니다(단, 안전하고 사운드를 제공하는 Marketo에 둡니다).
>* 공유: 팀에 동기부여하거나 축하하기 위해 이미지를 전송하십시오.
>* 샘플 보내기(이메일 전용): 이 옵션을 사용하여 전자 메일을 보내기 전에 다른 사람이 전자 메일의 모양을 확인할 수 있습니다.
>* 이메일 미리 보기(이메일만): 이메일을 미리 확인하는 것이 좋습니다.
...
모든 단계에서 작업을 확인하거나 취소할 수 있습니다. 마음이 바뀌면 그냥 **신경 쓰지 마세요**.
