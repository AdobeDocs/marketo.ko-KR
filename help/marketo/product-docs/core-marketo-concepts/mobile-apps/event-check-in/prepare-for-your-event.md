...
Marketo에는 이벤트 체크인 앱에 대한 특수 사용자 역할이 있습니다. 모바일 응용 프로그램에 액세스할 수 있는 권한을 가진 [!DNL iPad] 또는 [!DNL Android] 사용자에 대해 [새 Marketo 역할을 만듭니다](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/grant-users-access-to-the-check-in-app.md).
...
1. **[!UICONTROL 미정]**&#x200B;을(를) **[!UICONTROL 확인]**(으)로 변경하려면 뒤로 이동하십시오.
...
_when_&#x200B;을(를) 알았으므로 이제 *who*&#x200B;을(를) 추가할 차례입니다.

1. 이미 사람 목록이 있는 경우 My Marketo에서 **[!UICONTROL 데이터베이스]** 타일을 클릭합니다.

   ![](assets/db.png)

1. 사람들이 있는 목록을 선택하고 **[!UICONTROL 사람]** 탭을 클릭합니다.

   ![](assets/four.png)

1. 목록에서 이벤트에 사용할 사람을 선택합니다. **[!UICONTROL Ctrl]**(또는 Mac의 **[!UICONTROL Command]**)을 사용하여 여러 사람을 클릭하거나 **[!UICONTROL 모두 선택]**&#x200B;하여 모두 표시합니다.

   ![](assets/five.png)

1. **[!UICONTROL 개인 작업]**&#x200B;을 클릭하고 **[!UICONTROL 프로그램]**&#x200B;을 마우스로 가리킨 다음 **[!UICONTROL 프로그램 상태 변경]**&#x200B;을 선택합니다.

   ![](assets/six.png)

1. **[!UICONTROL 프로그램]** 드롭다운 목록을 클릭하고 이벤트를 선택합니다.

   ![](assets/seven.png)

1. **[!UICONTROL 새 상태]** 드롭다운을 클릭하고 **[!UICONTROL 로드쇼] > [!UICONTROL 등록됨]**&#x200B;을 선택합니다. **[!UICONTROL 지금 실행]**&#x200B;을 클릭합니다.
