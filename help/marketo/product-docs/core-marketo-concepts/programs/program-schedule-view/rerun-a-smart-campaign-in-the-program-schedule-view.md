...
프로그램 일정 보기에서 직접 기존 스마트 캠페인의 새 실행을 쉽게 만들 수 있습니다.

1. 다음으로 이동 **마케팅 활동**.

   ![](assets/login-marketing-activities-3.png)

1. 스마트 캠페인이 포함된 프로그램을 선택하십시오.
...
붐! 이와 마찬가지로 해당 스마트 캠페인에 대한 다른 실행을 예약했습니다. 해당 스마트 캠페인에 이메일 보내기 단계가 포함되어 있는 경우 해당 단계도 표시됩니다.
