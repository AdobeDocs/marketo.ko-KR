...
프로그램 일정 보기에 표시되고 사용할 수 있는 8개의 기본 제공 시작 유형이 있습니다. 관리 섹션에서 사용자 [지정 항목 유형을](create-custom-entry-types.md) 만들 수도 있습니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1" rowspan="1">기본 입력 유형입니다. 자리 표시자 또는 메모로 사용합니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1" rowspan="1">이메일 사용 스마트 캠페인 <img alt="--" src="assets/image2014-9-24-10-3a5-3a14.png" data-linked-resource-id="3082717" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="1147243"></td> 
   <td colspan="1" rowspan="1"><p>이메일 전송 흐름 단계가 하나 이상 있는 예약된 스마트 캠페인.</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1">예약된 이메일 프로그램에서 이메일 테스트</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1">지원되는 웨비나 공급자에 연결된 이벤트 프로그램의 웨비나 날짜</td> 
  </tr> 
  <tr> 
