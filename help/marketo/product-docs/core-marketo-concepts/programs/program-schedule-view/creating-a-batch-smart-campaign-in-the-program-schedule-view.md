...
# 프로그램 일정 보기에서 배치 스마트 캠페인 만들기 {#creating-a-batch-smart-campaign-in-the-program-schedule-view}
...
1. **[!UICONTROL Type]** 드롭다운을 클릭하고 **[!UICONTROL Smart Campaign]**&#x200B;을(를) 선택합니다.
