...
1. 복제할 프로그램을 찾아 선택합니다. **[!UICONTROL 프로그램 작업]** 드롭다운에서 **[!UICONTROL 복제]**&#x200B;를 클릭합니다.
...
1. 선택적 설명을 추가한 다음 **[!UICONTROL 만들기]**&#x200B;를 클릭합니다. 준비가 완료된 모든 자산을 사용하여 새 프로그램을 얼마나 빨리 만들 수 있는지 살펴보십시오.
