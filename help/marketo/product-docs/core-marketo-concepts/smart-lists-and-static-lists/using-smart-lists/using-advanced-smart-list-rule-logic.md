...
1. 드롭다운에서 **[!UICONTROL Use Advanced filters]**&#x200B;을(를) 선택합니다.

   ![](assets/using-advanced-smart-list-rule-logic-1.png)

   >[!NOTE]
   >
   >**[!UICONTROL Advanced]** 필터를 사용하면 스마트 목록 필터를 사용하여 스마트 목록을 만들 필요가 줄어듭니다. 이렇게 하면 성능이 최적화됩니다.

1. **[!UICONTROL Advanced filters]** 텍스트 상자에 모든 필터 사이의 기본값으로 &quot;and&quot;가 표시됩니다.
