...
description: Marketo의 영업 기회 필터 및 트리거에 대해 알아봅니다. CRM 영업 기회 데이터를 세그먼트화하고 트리거합니다.
title: 기회 필터 및 트리거
...
Opportunity 필드(사용자 지정 또는 표준)를 찾는 경우 **Has Opportunity** 필터 또는 **Opportunity was`[Added/Removed/Updated]`** 필터 또는 트리거를 사용하십시오.
...
기준의 조합에 따라 영업 기회가 있는 잠재 고객을 찾으려면 **영업 기회 있음**, **영업 기회에 추가됨** 또는 **영업 기회에서 제거됨** 필터를 사용하십시오. 그들은 당신에게 말합니다:
