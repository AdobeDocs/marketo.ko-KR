...
1. 대상 입력 **이름** 및 선택적 설명. 개인 만들기 드롭다운을 클릭하고 &quot;Match Existing Marketo People and Create Missing People in Marketo&quot;을 선택합니다. _또는_ &quot;기존 Marketo 사용자만 일치&quot;(이 예에서는 이전 사용자를 선택합니다.) 또한 을(를) 선택해야 합니다 **작업 공간**.
