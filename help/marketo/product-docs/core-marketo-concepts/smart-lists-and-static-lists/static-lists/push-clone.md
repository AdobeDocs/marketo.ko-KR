...
1. 계정 유형에서 기존 계정을 선택하거나 **새 계정** 라디오 단추(이 예제에서는 선택 **새 계정**). Marketo 자격 증명을 입력합니다.
...
1. 개인 생성에서 &quot;기존 사용자만 일치&quot; 또는 &quot;Marketo에서 기존 사람 일치 및 실종된 사람 만들기&quot;를 선택합니다. 이 선택 사항에서는 후자를 선택합니다.
