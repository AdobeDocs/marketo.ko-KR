...
>[!CAUTION]
>
>가장 일반적인 실수 중 하나는 &quot;사람을 삭제&quot;하여 목록에서 사람을 제거 할 수 있다고 생각하는 것입니다. **잘못됨**. 사용자를 삭제하면 목록뿐만 아니라 **전체 데이터베이스**&#x200B;에서 삭제됩니다.

## 목록에서 사용자를 추가 또는 제거하는 방법 {#ways-to-add-remove-people-from-a-list}
