...
description: Adobe Experience Cloud에 목록을 보내는 방법을 알아봅니다. Experience Platform 또는 기타 솔루션과 Marketo 목록 멤버십을 공유합니다.
...
* 목록이 Marketo에서 Adobe Audience Manager으로 업로드된 후 Adobe Target에서 액세스할 수도 있습니다. Adobe Target[&#128279;](https://experienceleague.adobe.com/ko/docs/target/using/integrate/audience-manager-target-integration){target="_blank"}에서 해당 구성 을(를) 사용하도록 설정해야 합니다.
