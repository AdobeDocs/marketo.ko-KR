...
1. [스마트 목록에 필터 찾기 및 추가](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md)
...
여기에서 [스마트 목록 이름](/help/marketo/product-docs/core-marketo-concepts/miscellaneous/rename-a-marketo-asset.md)을 편집하고 스마트 목록에 대한 정보를 볼 수 있습니다.

![](assets/smartlist.png)

## 사람 탭 {#people-tab}

여기에서 여러분의 결과를 볼 수 있습니다.즉, 스마트 목록 탭에서 [을(를) 추가하고 정의한 필터의 자격을 갖춘 모든 사람](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md)
