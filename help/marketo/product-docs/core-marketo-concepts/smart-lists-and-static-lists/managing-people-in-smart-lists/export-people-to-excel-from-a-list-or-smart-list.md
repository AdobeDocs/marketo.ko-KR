...
1. 내보내기가 실행됩니다. 완료되면 **[!UICONTROL Download now]**&#x200B;을(를) 클릭하여 파일을 가져올 수 있습니다.
   ...
   >[!TIP]
   >
   >내보내기에 시간이 오래 걸리는 경우 언제든지 로그아웃했다가 나중에 다시 돌아올 수 있습니다. **[!UICONTROL List Actions]** 메뉴에서 **[!UICONTROL Show Export Status]**&#x200B;을(를) 선택하여 **[!UICONTROL Download now]** 링크에 액세스할 수 있으며 1주 동안 유효합니다.
