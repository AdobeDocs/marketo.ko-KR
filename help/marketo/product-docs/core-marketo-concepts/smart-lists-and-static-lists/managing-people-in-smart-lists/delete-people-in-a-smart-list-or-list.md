...
1. 삭제할 모든 사용자가 포함된 목록/스마트 목록을 선택하고 **[!UICONTROL People]** 탭으로 이동합니다.
...
1. Marketo에서 사용자를 완전히 제거하려면 **[!UICONTROL Delete Person]**&#x200B;을(를) 클릭합니다.

   ![](assets/four-1.png)

1. CRM에서도 레코드를 삭제하려면 **[!UICONTROL Remove from CRM]**&#x200B;을(를) **[!UICONTROL true]**(으)로 설정하십시오.
...
1. **[!UICONTROL Run Now]**&#x200B;를 클릭합니다.

   ![](assets/image2014-9-24-13-3a0-3a3.png)

1. 50명 이상을 삭제하는 경우 이 메시지가 표시됩니다. 삭제하려는 사람 수를 입력하고 **[!UICONTROL Cannot Undo]** 상자를 선택한 다음 **[!UICONTROL Delete]**&#x200B;을(를) 클릭합니다.
