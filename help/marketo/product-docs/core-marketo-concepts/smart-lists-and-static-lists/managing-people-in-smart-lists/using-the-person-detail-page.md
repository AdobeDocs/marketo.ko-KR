...
개인 세부 사항 페이지에는 개인에 대해 Marketing에서 알고 있는 모든 정보가 들어 있습니다. 이 페이지에서 직접 데이터를 편집할 수 있습니다.
...
특정 인물을 여는 방법에는 여러 가지가 있습니다. 다음은 몇 가지 예입니다.
...
많은 필드를 편집할 수 있습니다. 개인 정보를 업데이트하려면 새 값을 입력하고 필드 외부를 클릭하여 저장합니다.
...
| 청구 국가 | 청구 우편 번호 | 청구 상태 | 구/군/시 | 회사 이름 |
| 국가 | 만든 위치 | 생년월일 | 부서 | 전화 안 함 |
| 이유 호출 안 함 | 이유를 호출하지 않음 | 이메일 주소 | 이메일 잘못됨 | 이메일 잘못된 원인 |
| 외부 회사 ID | 외부 영업 사원 Id | 팩스 번호 | 이름 | 전체 이름 |
| 업계 | 유추 도시 | 유추 회사 | 유추 국가 | 유추 대도시 지역 |
| 유추 전화 영역 코드 | 유추 우편 번호 | 유추 주 지역 | 익명 여부 | 고객임 |
| 파트너임 | 직함 | 성 | 등급 | 점수 |
| 개인 출처 | 상태 | 기본 전화 | Marketing to Social Facebook 표시 이름 | Marketing To Social Facebook Id |
| Marketing To Social Facebook 사진 URL | Marketing To Social Facebook 프로필 URL | Marketing to Social Facebook 도달 | Marketing To Social Facebook 참조 등록 | Marketing to Social Facebook 방문자 |
...
| Marketing to Social 신디케이션 ID | Marketing To Social 총 참조 등록 | 마케팅 소셜 총 방문자 수 | Marketing to Social Twitter 표시 이름 | Marketing To Social Twitter ID |
| Marketing To Social Twitter 사진 URL | Marketing to Social Twitter 프로필 URL | Marketing to Social Twitter 도달 | Marketing To Social Twitter의 등록 참조 | Marketing To Social Twitter 방문자 |
...
>* 회사 정보
>* SFDC 담당자를 위한 기회
>* 만든 날짜 및 원래 소스 유형과 같은 특정 마케팅 관련 필드
>* 활동 로그
