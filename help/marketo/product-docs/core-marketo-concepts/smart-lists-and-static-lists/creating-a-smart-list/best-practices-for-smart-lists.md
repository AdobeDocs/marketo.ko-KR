...
description: 스마트 목록 모범 사례에 대한 도움말을 봅니다. 이러한 팁을 사용하여 보다 빠르고 정확한 목록을 작성하십시오.
...
구현을 쉽게 작업하고 성능을 최적화하기 위해 다음과 같은 모범 사례가 제공됩니다.

>[!NOTE]
>
>**모든 Marketo Engage 사용자가 다릅니다.** 데이터베이스가 클수록 더 많은 처리가 이루어집니다. 더 많은 활동을 저장할수록 활동을 검색하는 데 더 오래 걸립니다.
>
