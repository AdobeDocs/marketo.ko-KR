...
* 사전 사용자 마이그레이션: [Marketing Nation Community](https://nation.marketo.com/t5/support/ct-p/Support) 또는 이메일 `marketocares@adobe.com`의 파일 지원 사례.

* 사후 사용자 마이그레이션: [Marketing Nation Community](https://nation.marketo.com/t5/support/ct-p/Support) 또는 이메일 `marketocares@adobe.com`의 파일 지원 사례.
