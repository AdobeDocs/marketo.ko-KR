...
마이그레이션을 수행하는 관리자는 다음을 클릭하여 마이그레이션 확인을 완료해야 합니다. **마이그레이션 완료** 단추를 클릭합니다.
...
다음을 클릭하여 **만료 확장** 버튼의 경우, 날짜가 1주일 후로 업데이트됩니다. 관리자는 만료일을 최대 3회까지 연장할 수 있습니다.
...
을(를) 클릭하면 **모든 사용자 마이그레이션** 버튼을 누르면 관리자에게 모든 적격 사용자의 마이그레이션을 확인하라는 메시지가 표시됩니다. 관리자가 확인하면 사용자 마이그레이션이 가능한 한 빨리 처리를 시작합니다.
