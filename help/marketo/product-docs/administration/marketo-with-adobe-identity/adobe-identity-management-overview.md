...
>[!NOTE]
>
>SSO를 구현하지 않고 Single Sign-On을 구현하고 구독이 Adobe 조직에서 SSO를 구현하지 않고 Adobe ID에 온보딩되었다면 [Marketo 지원](https://nation.marketo.com/){target="_blank"}에 티켓을 제출하고 &quot;SSO를 구현하는 Admin Console의 Marketo&quot;로 주제를 지정하십시오.
