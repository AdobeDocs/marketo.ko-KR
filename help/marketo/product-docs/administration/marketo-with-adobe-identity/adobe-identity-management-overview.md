...
모든 새 Adobe Marketo Engage 구독(2023년 7월 31일 이상)은 Adobe Identity Management 시스템과 통합됩니다.

Adobe ID에 온보딩된 구독의 경우 사용자 관리에 Adobe Admin Console이 사용됩니다. SSO(Single Sign-On)와 같은 ID 관련 개념은 Admin Console에서도 관리됩니다.
...
>[!NOTE]
>
>SSO를 구현하지 않고 Single Sign-On을 구현하고 구독이 Adobe 조직에서 SSO를 구현하지 않고 Adobe ID에 온보딩되었다면 [Marketo 지원](https://nation.marketo.com/){target="_blank"}에 티켓을 제출하고 주제를 &quot;Admin Console에서 Marketo, SSO 구현&quot;으로 지정하십시오.
...
<table>
 ...
 <tr>
  ...
  <td>제품 프로필 내에서 사용자 관리를 담당합니다. 특정 프로필 이외의 사용자는 관리할 수 없습니다. 제품 프로필 관리자는 사용자로 제품 프로필에 추가되지 않으면 Marketo 애플리케이션에 액세스할 수 없습니다. 그들의 역할은 여전히 표준 사용자일 것입니다(둘 이상의 작업 영역이 있는 경우 기본 작업 영역).
</td>
 </tr>
 <tr>
...
>* [제품 관리자 추가 또는 제거](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-product-admin.md){target="_blank"}
>* [사용자 추가 또는 제거](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md){target="_blank"}
