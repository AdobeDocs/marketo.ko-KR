...
description: Chrome, Firefox, Safari 및 Marketo Engage을 포함하여 Adobe에 대해 지원되는 브라우저 및 버전 목록과 Edge Identity 사용자를 위한 참고 사항입니다.
title: 지원되는 브라우저
...
최상의 사용 환경을 위해 **브라우저를 업데이트한 상태로 유지**&#x200B;하세요.
