...
# 필드 이름 변경 {#rename-a-field}

>[!NOTE]
>
>Marketing To에서 사용자 정의 필드의 이름을 변경할 수 있지만 다음과 같은 경우가 있습니다.시스템 내에서 사용한 모든 것을 제거해야 합니다. 여기에는 양식, 스마트 목록 및 스마트 캠페인이 포함됩니다.
...
1. 이름을 변경할 필드를 찾아 선택한 다음 캔버스에서 필드 이름을 클릭합니다.
   ...
   >[!TIP]
   >
   >이 필드를 **참조하는** 자산을 찾으려면 사용됨 링크를 클릭합니다.
