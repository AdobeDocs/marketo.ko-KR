...
[태그](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-tags.md)은(는) 프로그램을 설명하는 데 사용됩니다. 각각 고유한 값을 사용하여 필요한 만큼 만들 수 있습니다. 아래 단계에서는 이러한 값을 관리하는 방법을 설명합니다.
...
1. **[!UICONTROL Value]**&#x200B;을(를) 입력하고 **[!UICONTROL Add Another]**&#x200B;을(를) 클릭합니다. 필요한 만큼 값을 추가할 수 있습니다.
