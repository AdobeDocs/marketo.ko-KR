...
description: 기본 작업 영역에서 세그먼트를 생성하기 위한 제한 사항 및 팁을 포함하여 작업 영역 및 분할 영역 간 세그먼트를 공유하기 위한 규칙 및 단계입니다.
...
Marketo은 프로그램 또는 스마트 캠페인에 적합한 사용자를 식별합니다. 그러나 보다 영구적인 가상 사용자는 세그먼테이션을 사용해야 합니다. Marketo에서 고급 동적 콘텐츠를 사용하는 데 필요합니다.
...
* 모든 파티션에 대한 가시성이 있는 **기본 작업 영역을 만들고 활용합니다**.
...
>[!NOTE]
>
>이러한 규칙 중 일부는 복잡합니다. 특정 사람들과 함께 테스트하는 것이 좋습니다. 필요에 따라 새 세그먼트를 만들고 이전 세그먼트를 삭제할 수 있습니다.
...
1. 작업 영역에서 공유할 폴더 이름을 지정하고(예: 세그먼트 공유) **[!UICONTROL Create]**&#x200B;을(를) 클릭합니다.
