...
1. 입력 **이름**&#x200B;을(를) 클릭하고 **개인 파티션** 을(를) 사용합니다. 선택 **기본 사용자 파티션**. 다음을 확인하십시오. [개인 분할 영역 생성](/help/marketo/product-docs/administration/workspaces-and-person-partitions/create-a-person-partition.md){target="_blank"} 아직 안왔으면

   ![](assets/create-a-new-workspace-4.png)

   >[!NOTE]
   >
   >* 다음 **모든 개인 파티션** 확인란은 이 작업 영역이 시스템의 모든 개인 분할 영역을 사용할 수 있음을 의미합니다.
   >
   >* 다음 **주 사용자 파티션** 는 기본값으로 작동하며 모든 사람에게 할당됩니다.
