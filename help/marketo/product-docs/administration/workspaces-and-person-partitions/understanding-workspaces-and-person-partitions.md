...
>[!CAUTION]
>
>작업 영역은 설정하기 복잡할 수 있습니다. [Marketo 지원 센터](https://nation.marketo.com/t5/Support/ct-p/Support)에 문의하여 올바른 지원인지 확인하십시오.
...
다음 단계에서는 작업 공간 간에 에셋을 공유하는 방법을 설명합니다. 공유하고자 하는 모든 것에 대해 동일하게 작동합니다. 이 예제는 세분화를 보여줍니다.
...
1. 폴더를 공유할 작업 영역을 선택하고 **[!UICONTROL Save]**&#x200B;을 클릭합니다. 폴더 공유 대화 상자에는 보기 권한이 있는 작업 영역만 표시됩니다.
   ...
   >[!NOTE]
   >
   >이제 원래 폴더에는 공유되었음을 나타내는 작은 녹색 화살표가 있습니다. 공유된 작업 영역에서는 폴더에 읽기 전용을 뜻하는 자물쇠가 표시됩니다.
...
템플릿이 아닌 에셋의 경우 프로그램 내에서 로컬 에셋으로 복제하는 것이 좋습니다. 적절한 액세스 수준을 사용하여 다음 에셋을 다른 작업 영역으로 끌어다 놓을 수 있습니다.
...
>[!NOTE]
>
>구성원이 포함된 프로그램은 한 작업 영역에서 다른 작업 영역으로 이동할 수 없습니다.
...
>개인 파티션을 사용해야 하는 이유:
>
>* 작업 공간에는 다른 자산이 있을 뿐만 아니라 다른 사람도 공유하지 않습니다.
