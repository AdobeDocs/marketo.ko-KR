...
description: "다운로드 [!DNL GoogleAdwords Activity Log] - Marketo 문서 - 제품 설명서"
...
# 다운로드 [!DNL Google Adwords] 활동 로그 {#download-googleadwords-activity-log}
...
1. 다음 항목 찾기 [!DNL Google AdWords] 서비스 및 클릭 **[!UICONTROL 활동 로그 다운로드]**.
