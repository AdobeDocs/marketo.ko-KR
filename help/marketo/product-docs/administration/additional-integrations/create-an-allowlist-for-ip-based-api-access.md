...
>[!CAUTION]
>
>이 기능을 사용하면 현재 [Marketo MCP 서버](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/mcp-server){target="_blank"}에 액세스할 수 없습니다. 이 문제는 향후 릴리스에서 해결될 것으로 예상됩니다.
