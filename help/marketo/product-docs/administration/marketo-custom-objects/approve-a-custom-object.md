...
새 사용자 지정 개체가 생성되었습니다. 승인하려면 아래 단계를 따르십시오.
...
1. 상태가 [!UICONTROL Approved]&#x200B;(으)로 변경됩니다.
   ...
   >
   >_다대다 구조_ **다대다 구조에서 사용되는 사용자 지정 개체는 승인할 때 연결 필드, 연결된 개체 이름 또는 연결된 필드 이름이 필요하지 않습니다**(매개 개체에 있기 때문).
   >
...
이제 캠페인에서 사용할 필터 및 트리거의 제약 조건에서 사용자 지정 개체를 선택할 수 있습니다.
