...
필드는 사용자 지정 개체에서 사용하는 특정 정보를 정의합니다. 링크 필드는 특정 목적(사용자 지정 개체 연결)으로 사용되며 [별도의 문서](/help/marketo/product-docs/administration/marketo-custom-objects/add-marketo-custom-object-link-fields.md)에서 다룹니다.
...
1. **[!UICONTROL Fields]** 탭을 클릭한 다음 **[!UICONTROL New Field]**&#x200B;을(를) 클릭합니다.

   ![](assets/add-marketo-custom-object-fields-4.png)

   >[!NOTE]
   >
   >위에 표시된 세 필드는 사용자 지정 개체를 만들 때 Marketo에 의해 자동으로 만들어집니다. Marketo은 이러한 필드를 자동으로 관리하며 편집하거나 삭제할 수 없습니다.

1. [!UICONTROL Display Name] 및 (선택 사항) [!UICONTROL Description]을(를) 입력하십시오.

   ![](assets/add-marketo-custom-object-fields-5.png)

   >[!NOTE]
   >
   >[!UICONTROL API Name]은(는) 승인되어야 편집할 수 있습니다.

1. 목록에서 적절한 [!UICONTROL Data Type]을(를) 선택하십시오.

   ![](assets/add-marketo-custom-object-fields-6.png)

1. 새 필드를 고유 식별자로 사용하려면 [!UICONTROL Dedupe] 슬라이더를 가져옵니다. **[!UICONTROL Save]**&#x200B;을(를) 클릭하여 완료합니다.
