...
1. [편집된 개체](/help/marketo/product-docs/administration/marketo-custom-objects/approve-a-custom-object.md)를 승인합니다.

## 사용자 지정 개체 삭제 {#delete-a-custom-object}

사용자 지정 개체를 삭제하려면 주의가 필요합니다. 사용자 지정 오브젝트는 다른 오브젝트 또는 스마트 리스트에 연결될 수 있습니다. Marketo에서 **[!UICONTROL Delete]**&#x200B;을(를) 클릭하기 전에 경고를 표시합니다.
...
1. 사용자 지정 개체가 아직 승인되지 않은 초안 양식인 경우 이 경고가 표시됩니다. 확실하면 **[!UICONTROL Delete]**&#x200B;을(를) 클릭합니다.

   ![](assets/edit-and-delete-a-marketo-custom-object-10.png)

1. 사용자 지정 개체가 이미 승인된 경우에는 삭제하면 더 큰 위험이 있습니다. 그러므로, 당신은 이 더 강한 경고를 받을 것입니다. **[!UICONTROL I understand]**&#x200B;을(를) 입력하고 **[!UICONTROL Cannot Undo]** 확인란을 선택한 다음 **[!UICONTROL Delete]**&#x200B;을(를) 클릭합니다.
