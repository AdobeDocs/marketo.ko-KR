...
사용자 지정 개체 구조를 만든 후 특정 사용자 지정 개체 데이터를 업로드할 때 사용자 지정 개체의 링크 필드를 사용하여 사용자 지정 개체가 데이터베이스의 사용자와 자동으로 연결됩니다. 개인 세부 정보 페이지의 [!UICONTROL Custom Objects] 탭에서 정보를 볼 수 있습니다.
...
회사에 연결된 사용자 지정 오브젝트는 CRM에서 회사를 동기화하거나 API를 사용하여 회사를 명시적으로 만드는 경우 가장 잘 작동합니다. 또한 Marketo에서는 회사 ID를 링크 필드로 사용할 것을 권장합니다.
