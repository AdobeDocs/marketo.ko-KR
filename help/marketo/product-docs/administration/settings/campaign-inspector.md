---
description: 에서 캠페인 관리자를 활성화하고 사용하여 모든 스마트 캠페인을 한 곳에서 보고 검색하는 방법.
title: 캠페인 검사기
...
Campaign Inspector를 사용하여 한 곳에서 모든 스마트 캠페인을 보고 검색할 수 있습니다.
...
1. **[!UICONTROL Enabled]** 확인란을 선택하고 **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
   ...
   >[!NOTE]
   >
   >Campaign Inspector 탭이 활성화된 후 이를 보려면 트리에서 원하는 작업 영역을 선택해야 합니다.
