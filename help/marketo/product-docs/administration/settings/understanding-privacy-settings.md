...
* [!DNL Munchkin]의 경우 [init 함수](https://experienceleague.adobe.com/ko/docs/marketo-developer/marketo/javascriptapi/leadtracking/configuration){target="_blank"}에 `{"anonymizeIP",true}`을(를) 추가하십시오.
