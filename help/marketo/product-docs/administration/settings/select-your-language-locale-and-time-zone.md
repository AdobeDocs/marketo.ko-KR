...
description: 언어, 로케일 및 시간대 - 마케팅 문서 - 제품 설명서 선택
...
# 언어, 로케일 및 표준 시간대 선택 {#select-your-language-locale-and-time-zone}

영어가 제1외국어가 아닌가요? 걱정하지 마십시오. 우리는 당신이 알아서 합니다. 언어, 로케일 및 표준 시간대를 변경하는 방법을 설명합니다.
...
잘했어! 브라우저가 새로 고쳐지고 변경 내용이 반영되어 표시됩니다.
