...
관리자가 기본 위치 설정을 변경하면 새로 만든 사용자가 이러한 설정을 상속합니다. 사용자는 개별 계정에서 [표준 시간대를 변경](/help/marketo/product-docs/administration/settings/change-time-zone.md)할 수 있습니다.
...
>[!MORELIKETHIS]
>
>* [표준 시간대 변경](/help/marketo/product-docs/administration/settings/change-time-zone.md)
