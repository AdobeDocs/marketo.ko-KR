...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>프로그램 스트림 수정</td> 
   <td>콘텐츠 비활성화<br>스트림 이름 "스트림 이름"<br>컨텐츠 이름 "전자 메일 이름" 또는 "프로그램 이름"</td> 
  </tr> 
  <tr> 
   <td>프로그램 스트림 수정</td> 
  ...
  <tr> 
   <td>복제</td> 
   <td>프로그램 "프로그램 이름"으로 복제됨 <br>복제된 자산 이름 "name"<br>또는<br>폴더 "폴더 이름"으로 클론되었습니다.<br>복제된 자산 이름 "name"</td> 
  </tr> 
  <tr> 
   <td>스마트 목록 설정 수정</td> 
