...
description: 자산 및 관리 작업에 대한 감사 추적 기록에서 변경 세부 사항을 참조합니다.
...
Audit Trail은 Marketo 구독에서 작업을 수행하는 사용자에게 많은 insight을 제공합니다.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td>프로그램 스트림 수정</td>
   <td>콘텐츠 추가<br>스트림 이름 "스트림 이름"<br>유형 "이메일" 또는 "프로그램"<br>이름 "이메일 이름" 또는 "프로그램 이름"<br>스마트 캠페인 "스마트 캠페인 이름"</td>
  </tr>
  <tr>
   <td>프로그램 스트림 수정</td>
  ...
  <tr>
   <td colspan="1">프로그램 설정 수정</td>
   <td colspan="1">이벤트 파트너 'partner_name' 추가됨</td>
  </tr>
  <tr>
   <td>내보내기</td>
   <td>N/A</td>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td>스마트 목록 보고서</td>
   <td>편집</td>
   <td>다운로드하기 위해 로그인하기 위해 편집된 스마트 목록: "true 또는 false"</td>
  </tr>
  <tr>
