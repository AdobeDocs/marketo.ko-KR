...
보트 활동을 확인하는 데는 두 가지 개별 방법이 사용됩니다.
...
* 이러한 속성이 도입되기 전에 발생한 활동의 &quot;보트 활동&quot;은 &quot; &quot;(비어 있음)으로, &quot;보트 활동 패턴&quot;은 &quot; &quot;(비어 있음)으로 표시됩니다.
...
1. **[!UICONTROL Match with Proximity Pattern]**&#x200B;을(를) 사용하도록 설정하는 경우 [!UICONTROL log bot activity] _을(를) 사용할지_ [!UICONTROL filter bot activity]을(를) 사용할지 선택하십시오. **활동 사이의 기간**&#x200B;에 대한 시간(초)을 설정할 수도 있습니다(기본값은 0, 최대값은 3).

   ![](assets/filtering-email-bot-activity-5.png)

>[!NOTE]
>
>**Duration Between Activities**&#x200B;이(가) 0초로 설정되면 전자 메일 활동이 정확히 같은 시간에 발생하는 것으로 식별됩니다. 지정된 시간(초) 내에 여러 개의 이메일 활동이 발생하는 경우 봇 활동으로 식별됩니다.

>[!IMPORTANT]
>
>* [!UICONTROL Filter Bot Activity]을(를) 선택하면 거짓 활동이 제거됨에 따라 전자 메일이 열리고 클릭이 감소할 수 있습니다.

**선택적 단계**: 두 기능을 비활성화하려면 해당 슬라이더를 선택 취소하십시오. 그렇게 하면 데이터가 재설정되지 않습니다.

>[!TIP]
>
>&quot;이메일에서 링크를 클릭함&quot; 및 &quot;이메일 열기&quot; 필터와 &quot;이메일에서 링크를 클릭함&quot; 및 &quot;이메일을 열림&quot; 트리거에서 &quot;보트 활동임&quot; 부울(예/아니요) 및 &quot;보트 활동 패턴&quot;을 통해 스마트 목록의 보트 활동 데이터를 사용합니다.

## IP 차단 목록 {#ip-blocklist}

Marketo은 수백만 개의 가짜 참여를 생성하는 IP 주소 목록을 컴파일했습니다. 따라서 다음 IP에서 받은 모든 계약은 자동으로 필터링되고 Marketo Engage 구독에 추가되지 않습니다. 이를 통해 이메일 열기, 클릭 수 및 기타 관련 활동이 감소할 수 있습니다. 아래 목록은 주기적으로 업데이트될 수 있습니다.
...
>[!NOTE]
>
>모든 IP 주소는 이 목록에 추가되기 전에 신중하게 검토되므로 가장 해로운 IP만 차단됩니다.
