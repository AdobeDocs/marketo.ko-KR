---
description: 구독에서 Adobe IMS를 사용하는 경우 Marketo Engage에서 API 전용 사용자를 만들고 관리하는 방법.
...
>[!NOTE]
>
>API Marketo Engage UI에서 생성된 사용자만 사용자 할당에 계산되지 않습니다.
...
1. API 전용 사용자에 대한 [!UICONTROL Email], [!UICONTROL First Name] 및 [!UICONTROL Last Name]을(를) 입력하십시오. 사용자에게 할당할 [!UICONTROL API Only] 역할을 선택하십시오. 완료되면 **[!UICONTROL Create API Only User]**&#x200B;를 클릭합니다.
