...
다음은 역할에 할당할 수 있는 사용 가능한 모든 권한 목록입니다. 권한은 일반적으로 Marketo 내의 특정 기능 영역과 연관되며, 사용자가 액세스할 수 있는 영역과 기능을 제어하는 데 도움이 됩니다.
...
* Marketo 사용자 지정 활동 액세스 - 관리자의 Marketo 사용자 지정 활동에 대한 액세스 권한을 사용자에게 제공합니다.
* Marketo 사용자 정의 개체 액세스 - 관리자의 Marketo 사용자 정의 개체에 대한 액세스 권한을 사용자에게 제공합니다.
