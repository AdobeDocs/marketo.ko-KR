...
* [!DNL Munchkin] 액세스 - 추적 코드 설정, 개인 추적 및 API 구성 활성화를 위해 사용자에게 관리자의 [!DNL Munchkin]에 대한 액세스 권한을 제공합니다.
...
* 웹후크 액세스 - 세부 정보 및 응답 매핑을 설정할 수 있도록, 관리자의 웹후크에 대한 액세스 권한을 사용자에게 제공합니다.
...
* 사용자 내보내기 - 데이터베이스 목록에서 스프레드시트 내보내기
* 사용자 지정 개체 가져오기
* 목록 가져오기
* 사람 병합
