...
* CRM 액세스 - 사용자에게 Salesforce 또는 Microsoft Dynamics와 같은 CRM에 대한 관리자 액세스 권한을 제공합니다.
...
* Munchkin 액세스 - 사용자가 추적 코드, 개인 추적을 설정하고 API 구성을 활성화하기 위해 관리자의 Munchkin에 액세스할 수 있도록 합니다.
