...
다음을 수행하는 경우 [역할 만들기 또는 편집](/help/marketo/product-docs/administration/users-and-roles/managing-user-roles-and-permissions.md)적절한 상자를 선택하여 다음 권한 중 해당 역할을 허용할 권한을 선택할 수 있습니다.
...
* Adobe Experience Manager 액세스&#42; - 사용자에게 Adobe Experience Manager 화면에 대한 액세스 권한을 부여합니다.
* Adobe 조직 매핑 액세스&#42; - 사용자에게 Adobe 조직 매핑 화면에 대한 액세스 권한을 제공합니다.
* 관리자 감사 추적 액세스&#42; - 사용자에게 관리자 감사 추적 화면에 대한 액세스 권한을 제공합니다.
* 액세스 액세스 감사 추적&#42; - 사용자에게 액세스 감사 추적에 대한 액세스 권한 부여
...
* CRM 액세스 - 사용자에게 다음과 같은 CRM에 대한 액세스 권한을 제공합니다. [!DNL Salesforce] 또는 [!DNL Microsoft Dynamics], 관리자
...
* 새 경험 액세스&#42; - 사용자에게 새 경험 화면에 대한 액세스 권한을 부여합니다.
...
* 액세스 [!DNL Munchkin] - GIves 사용자 액세스 대상: [!DNL Munchkin] 관리에서 추적 코드 설정, 개인 추적 및 API 구성 활성화
* 예측 대상 액세스&#42; - 사용자에게 Predictive Audiences 화면에 대한 액세스 권한을 제공합니다.
...
_&#42;기존 사용자가 중단되지 않도록 하기 위해 이 권한은 수동 모드로 도입되며 현재 표시되지만 액세스할 수 없습니다. 2024년 중반에 활성화될 때 구현 방법을 알려 드리겠습니다._

## 액세스 API  {#access-api}

사용자에게 다음을 제공합니다. **API만** **역할** 아래 나열된 개별 API에 액세스
...
* 보고서 만들기&#42; - 사용자에게 Analytics 및 마케팅 활동과 수익 주기 모델러 에셋에서 보고서 에셋을 생성, 복제, 읽기, 업데이트 및 이동할 수 있는 액세스 권한을 제공합니다.
...
* 전자 메일 액세스
   * 이메일 편집 - 사용자에게 이메일을 편집, 생성 및 복제할 수 있는 권한을 제공합니다.
      * 이메일을 작동 상태로 만들기 - 사용자에게 이메일을 작동 상태로 만들 수 있는 권한을 부여합니다. 다음을 참조하십시오. [이메일을 작동 상태로 만들기](/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)

      * 이메일 승인 - 사용자가 이메일을 승인할 수 있습니다.
      * 이메일 삭제 - 사용자가 이메일을 삭제할 수 있습니다.
      * 브랜드 도메인 설정 - 사용자가 브랜딩 도메인으로 작업할 수 있습니다. 다음을 참조하십시오. [추가 브랜딩 도메인 추가](/help/marketo/product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain.md)
...
* 목록 가져오기
* 사람 병합
* 단일 흐름 작업 실행 - 사용자가 실행할 수 있도록 설정 **데이터 값 변경** 데이터베이스에서 사람에 대한 흐름 단계
...
## 타겟팅 및 개인화 {#targeting-and-personalization}
...
* 특정 작업 공간에 대한 관리자 액세스 권한(작업 공간이 활성화된 경우에만)
