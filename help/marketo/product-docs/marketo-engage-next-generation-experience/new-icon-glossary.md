---
description: 새 아이콘 용어집 - Marketo 문서 - 제품 설명서
title: 새 아이콘 용어집
...
# 새 아이콘 용어집 {#new-icon-glossary}

다음은 새 Adobe Marketo Engage 인터페이스에 대한 새 아이콘입니다. 여전히 Marketo Classic을 실행 중이면 아이콘 용어집이 [여기에 있을 수 있습니다](/help/marketo/getting-started/icon-glossary.md).
