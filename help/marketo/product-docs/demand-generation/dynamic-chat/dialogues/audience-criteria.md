...
우선 순위는 리드가 두 개 이상 사용할 수 있는 경우 어떤 대화 상자를 수신하는지 결정합니다. 당신이 처음 [대화 상자 만들기](/help/marketo/product-docs/demand-generation/dynamic-chat/dialogues/create-a-dialogue.md){target=&quot;_blank&quot;}. 기존 대화 상자를 열고 이동하여 우선 순위를 변경할 수 있습니다 **대화 상자 세부 정보** 을 참조하십시오.
