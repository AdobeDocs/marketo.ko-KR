---
description: Marketo 인스턴스용 Dynamic Chat을 설정하는 방법을 알아봅니다. Admin Console에 액세스하고 사용자를 추가하고 Dynamic Chat을 Marketo에 연결합니다.
title: 초기 설정
...
1. Admin Console에 로그인한 후 수행할 작업은 사용자를 추가하는 것입니다. 해당 프로세스는 [여기에 설명되어 있습니다](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md#add-a-chat-user){target="_blank"}.
