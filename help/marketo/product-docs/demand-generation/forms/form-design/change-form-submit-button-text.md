...
# 양식 전송 단추 텍스트 변경 {#change-form-submit-button-text}
...
1. 버튼을 선택하고 **[!UICONTROL Label]**&#x200B;을(를) 변경합니다.

   ![](assets/image2014-9-15-12-3a42-3a41.png)

   >[!TIP]
   >
   >대기 중 레이블도 변경할 수 있습니다. 단추를 클릭한 후 양식 제출 작업이 완료되기 전에 표시됩니다.
