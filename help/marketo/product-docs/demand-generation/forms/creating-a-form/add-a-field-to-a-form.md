...
[양식을 만들고](/help/marketo/product-docs/demand-generation/forms/creating-a-form/create-a-form.md){target="_blank"} [테마를 선택하고](/help/marketo/product-docs/demand-generation/forms/creating-a-form/select-a-form-theme.md){target="_blank"}한 후에는 다른 사람이 작성할 필드를 추가할 수 있습니다.
...
>[!NOTE]
>
>양식 변경으로 인해 생성된 모든 랜딩 페이지 초안을 승인합니다.
