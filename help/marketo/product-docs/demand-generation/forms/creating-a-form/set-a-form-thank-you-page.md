...
1. **감사** **귀하** **페이지** 섹션으로 스크롤합니다.

## 페이지에서 유지 {#stay-on-page}

양식이 제출되면 방문자가 동일한 페이지를 방문하도록 합니다.

1. **** ****&#x200B;을(를) 사용하여 **** On **** Page **Follow&lt;a7/>** **With&lt;a11/>을 선택합니다.**
...
1. **Follow** **** With **에 대해** **URL**&#x200B;을 선택합니다.****
...
1. **Follow** **Up** **With** 유형에 해당하는 페이지를 선택합니다.
