...
먼저 [!DNL Level 3]에서 웨비나를 만듭니다. 도움이 필요하면 [[!DNL Level 3] 리소스 라이브러리](https://www.level3.com/en/resource-library/)를 참조하세요. [!DNL BrightTalk]과(와) 매우 유사합니다.  Marketo에서는 [!DNL Level 3] 필드의 작은 하위 집합을 사용합니다.
...
1. **[!UICONTROL Save]**&#x200B;를 클릭합니다.
   ...
   이제 이벤트가 [!DNL Level 3]에 연결되어 있습니다.
