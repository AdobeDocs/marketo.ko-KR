...
>[!CAUTION]
>
>이벤트 호스트로서 앱 내에서 가입하고 참석자에게 전송된 링크를 통해 **not**&#x200B;하세요.
...
1. 새 이벤트의 홈에서 **[!UICONTROL Event Actions]**&#x200B;을(를) 선택한 다음 **[!UICONTROL Event Settings]**&#x200B;을(를) 선택합니다.
   ...
   >[!NOTE]
   >
   >드롭다운에 **[!UICONTROL Event Settings]**&#x200B;이(가) 표시되지 않으면 이벤트의 채널에 &quot;[!UICONTROL Applies to]&quot;에서 선택한 **[!UICONTROL Event with Webinar]**&#x200B;이(가) 있는지 확인하십시오.
...
1. **[!UICONTROL Save]**&#x200B;를 클릭합니다.
   ...
   이제 Adobe Connect 이벤트가 Marketo 이벤트와 동기화됩니다.
