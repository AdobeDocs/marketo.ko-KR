...
등록되지 않고 [!UICONTROL Registration Error] 상태로 설정된 경우 복구해도 늦지 않습니다.
...
Marketo은 매일 밤 태평양 표준시 오후 약 11시에 출석 정보를 자동으로 가져옵니다. 참석 정보를 수동으로 업데이트하려면 **[!UICONTROL Event Actions]** 아래의 **[!UICONTROL Refresh from Webinar Provider]**&#x200B;을(를) 클릭합니다.
