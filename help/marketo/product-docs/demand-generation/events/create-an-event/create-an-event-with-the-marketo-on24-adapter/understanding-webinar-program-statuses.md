...
description: ON24 및 Marketo 통합에서 웨비나 프로그램 상태에 대해 알아봅니다. 등록, 출석 및 기타 상태 값을 파악합니다.
...
>[!NOTE]
>
>Marketo에서 표시 안 함 상태를 가져오려면 해당 사용자가 *Marketo*&#x200B;에 등록되어 있어야 합니다. On24 데이터 피드에서 가져오는 프로그램을 캡처할 수 없습니다.
