---
description: Marketo의 대화형 웨비나 모범 사례에 대한 도움말을 봅니다. 웨비나에 대한 참여, 전달 및 후속 작업을 개선합니다.
...
다음 모범 사례는 성공적이고 매력적인 웨비나를 계획, 디자인 및 제작하는 데 도움이 될 수 있습니다. 이 팁은 Adobe Connect에서 제공하는 대화형 웨비나를 최대한 활용하는 데 도움이 됩니다.
...
* 나중에 동일한 콘텐츠를 다시 제공하는 경우 Adobe Connect Room을 재사용합니다. [Pod] 메뉴에서 **Pod에서 콘텐츠 지우기**(으)로 이동하여 채팅 기록을 지우고 마지막 세션의 결과를 폴링/퀴즈합니다. 이렇게 하면 룸의 콘텐츠가 지워집니다. 이전 세션의 모든 데이터는 Marketo Engage에서 계속 사용할 수 있습니다.
...
* 팀원에게 역할을 할당합니다. 이들을 공동 호스트 및 발표자로 추가합니다. 진행자와 발표자는 참여자 이전에 회의실에 입장할 수 있다. 그러나 [대화형 웨비나를 디자인하세요](/help/marketo/product-docs/demand-generation/events/interactive-webinars/designing-interactive-webinars.md){target="_blank"} _이전_ 공동 호스트 및 발표자를 추가하세요.
