...
대시보드는 투표 응답, 채팅 활동 및 비디오 상호 작용을 포함한 다양한 지표를 추적하여 참가자의 선호도 및 행동에 대한 중요한 통찰력을 제공합니다. 참가자의 활동 및 참여 수준에 대한 포괄적인 개요를 제공하여 호스트가 실시간 출석, 참여 및 상호 작용을 모니터링할 수 있도록 합니다.
...
이 인터페이스에서는 이벤트의 라이브 세션 성능에 대한 개요를 제공합니다. 이 개요에는 주요 지표, 시간 경과에 따른 참여 및 참가자 상호 작용이 포함되어 있습니다. 이는 주최자가 이벤트의 성공을 평가하고 개선 영역을 식별하는 데 도움이 됩니다.

왼쪽 패널에서 참여 를 선택하여 라이브 세션의 성능을 확인합니다. 참여 요약(PDF)을 선택하여 라이브 세션의 성능 요약을 다운로드합니다. 개요는 다른 섹션으로 분류됩니다.

스크린샷

**주요 지표**

주요 지표에서 라이브 세션의 등록, 참석자 및 참여 수를 확인합니다.
...
참여 그래프에서 라이브 세션 중 시간 경과에 따른 평균 참여에 대해 알아봅니다. 호스트는 참여 수준의 변동을 모니터링하여 상호 작용이 높거나 낮은 중요한 순간을 식별할 수 있습니다. 다양한 레이아웃에서 참여 참여자가 얻은 평균 참여 점수가 얼마나 되는지 확인합니다.
...
* 해당 시간에 참여한 참석자 수.
* 해당 시점의 참여 레이아웃.
* 참여도가 높거나 낮은 기록에서 인스턴트 보기를 보려면 기록에서 인스턴트 보기 를 선택합니다.
...
설문 조사 응답, Q&amp;A 지표 및 세션 중 참석자의 반응을 보려면 [상호 작용으로 이동]을 선택하십시오. 아래 섹션에서 참석자가 인터랙션의 pod에서 어떻게 참여하는지를 확인하고 인터랙션 보고서를 다운로드합니다.

### 상호 작용 {#interactions}

참석자가 상호 작용에서 세션에 어떻게 상호 작용하고 참여하는지 확인합니다. 설문 조사에 대한 응답, Q&amp;A 지표, 참석자의 반응, 각 pod에서 링크 및 파일을 삭제했습니다. 호스트는 더 나은 분석을 위해 이러한 포드의 상호 작용 보고서를 다운로드할 수도 있습니다. 이러한 상호 작용을 분석하여 트렌드를 식별하고 전략을 조정하여 보다 대화형의 매력적인 환경을 조성합니다.

왼쪽 패널에서 상호 작용 을 선택하여 참석자가 pod에서 참여하는 방식을 확인합니다.

스크린샷

메뉴 표시줄에서 Polls 탭을 선택하여 투표에 추가된 질문 및 응답을 확인합니다. 이 탭에는 다음 정보가 표시됩니다.

* 투표 Pod의 상호 작용에 대한 보고서를 다운로드하려면 투표 보고서(CSV)를 선택합니다.
* 설문 조사 질문과 그 유형.
* 응답 수 및 투표 Pod가 열려 있고 참여 중인 기간.
* 대화 창에서 보려면 모든 `<number>` 응답 보기를 선택하십시오.

메뉴 표시줄에서 기타 상호 작용 탭을 선택하여 다른 Pod에서의 참여를 보고 해당 보고서를 다운로드합니다.

스크린샷

오른쪽 드롭다운에서 상호 작용 보고서 다운로드 를 선택하여 다양한 pod의 보고서를 다운로드합니다. 더 나은 추적을 위해 여기에서 QnA 보고서, 링크 및 파일 보고서 및 반응 보고서를 다운로드하십시오.
...
왼쪽 패널에서 온디맨드 활동 을 선택하여 녹음/녹화 요약을 확인합니다. 온디맨드 활동에 대한 보고서를 다운로드할 수도 있습니다.

스크린샷

온디맨드 활동에서 다음 지표를 확인합니다.

* 주문형 보고서(CSV)를 선택하여 주문형 지표를 다운로드합니다.
...
왼쪽 패널에서 참가자 활동을 선택하여 각 참석자의 참여 수준에 대한 통합 정보를 확인합니다. 참여자 참여 수준의 수준에서 이 참여를 분류하는 방법을 봅니다. 더 나은 추적을 위해 보고서를 다운로드하려면 사용자 활동 보고서 (CSV) 를 선택하십시오.
...
1. 왼쪽 패널에서 보고서 다운로드를 선택합니다.
1. 모든 활동 및 pod에 대한 보고서를 한 번에 다운로드하려면 모두 다운로드(.zip)를 선택합니다.

스크린샷

각 보고서 옆에 있는 아이콘을 선택하여 개별적으로 다운로드합니다.

## 참가자 참여 수준 {#participant-engagement-level}

조직에서는 Adobe Connect을 사용하여 고도로 맞춤화되고 브랜딩되며 참여도가 높은 웨비나를 제공합니다. 투표, 채팅, Q&amp;A 및 반응과 같은 대화형 도구는 참석자를 참여시키고 등록 및 참석 데이터 이상의 데이터를 수집하는 데 도움이 됩니다. 참석자가 이러한 대화형 기능에 참여하면 참여 데이터를 사용하여 참석자를 높음, 중간, 낮음의 세 가지 참여 수준으로 분류합니다. 마케터는 참여 수준을 사용하여 대상 세그먼트를 업데이트하고 잠재 고객 점수를 업데이트하며 판매를 경고할 수 있습니다.
