---
description: 대화형 웨비나 참여 대시보드에 대해 알아봅니다. 웨비나 중 및 후에 참석자 참여 지표 및 통찰력을 봅니다.
title: 참여 대시보드
...
* **온디맨드 세션**: 라이브 이벤트 녹화는 자체 이벤트로 사용할 수 있습니다. 신규 초대자는 등록하고 녹음을 볼 수 있습니다. 등록 후 이벤트 가입 링크를 받게 되며, 이 링크는 이벤트 종료 후 이벤트 기록으로 이동합니다. 라이브 이벤트에 등록된 참여자는 동일한 가입 링크를 사용하여 녹화를 볼 수도 있습니다.
