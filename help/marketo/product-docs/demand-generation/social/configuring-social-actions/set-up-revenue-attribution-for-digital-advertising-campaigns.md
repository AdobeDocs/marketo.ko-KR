...
1. 새로 **만들기** 를 클릭하고 **새 프로그램을 선택합니다**.

   ![](assets/image2016-3-14-15-52-0.png)

1. 이미 적절한 프로그램이 있는 경우 [복제할 수 있습니다](../../../../product-docs/core-marketo-concepts/programs/working-with-programs/clone-a-program.md).
...
1. 쿼리 문자열을 URL에 추가합니다.
   ...
   >    
   >    
   >    * **source** is a Person Source used as a channel identifier
   >    * **comment** 는 각 프로그램에 대해 생성된 고유한 식별자입니다.
   >    * **camp** is Facebook, LinkedIn 또는 Google
   >    * **k** 는 캡처할 키워드 또는 자산 이름입니다.
