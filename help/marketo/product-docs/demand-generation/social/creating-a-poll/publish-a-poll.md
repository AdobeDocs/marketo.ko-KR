...
description: Publish a Poll - Marketo 문서 - 제품 설명서
...
1. 오른쪽의 팔레트에서 **투표** 위로 끕니다.

   ![](assets/image2014-9-19-10-3a45-3a50.png)

1. 투표를 선택하고 **삽입**&#x200B;을 클릭하세요.
...
축하합니다! 랜딩 페이지를 승인하고 투표가 실시됩니다. [랜딩 페이지를 Facebook에 게시](/help/marketo/product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md)하거나 [웹 사이트에 투표](/help/marketo/product-docs/demand-generation/social/social-functions/deploy-social-on-your-website.md)할 수도 있습니다.
