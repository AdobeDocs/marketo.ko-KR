...
description: 광고 네트워크 통합이 Marketo 대상 데이터를 유료 미디어에 연결하는 방법에 대해 알아봅니다. 타겟팅된 캠페인을 실행하고, 광고의 리드를 수집하고, 오프라인 전환을 업로드합니다.
title: 광고 네트워크 통합 이해
...
* 알려진 잠재 고객을 개인화된 디스플레이 광고로 타겟팅하여 육성하거나 재활성화하기 위해 유료 미디어 시스템에 대상 보내기
