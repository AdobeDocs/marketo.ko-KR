...
1. 원하는 [!UICONTROL Push Type]을(를) 선택하고 **[!UICONTROL Update]**&#x200B;을(를) 클릭합니다.
   ...
   >[!NOTE]
   >
   >&quot;[!UICONTROL Enable continuous audience sync]&quot;을(를) 선택하면 Marketo 인스턴스에서 목록이 변경될 때 Marketo이 선택한 광고 네트워크에 목록을 최신 상태로 유지합니다. **및** 대상자가 정적 목록에 추가되거나 제거된 경우 대상자에서 제거합니다.

1. 종료하려면 **[!UICONTROL OK]**&#x200B;을(를) 클릭하십시오.
