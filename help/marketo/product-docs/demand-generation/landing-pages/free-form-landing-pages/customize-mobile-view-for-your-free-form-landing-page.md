...
자유 형식 랜딩 페이지의 모바일 보기는 대부분 자동이지만 사용자 정의할 수 있습니다.
...
>[!TIP]
>
>모바일에서 더 적은 것이 더 많습니다.

1. 요소를 숨기려면 모바일 열 아래에서 해당 확인란을 클릭합니다.

   ![](assets/image2015-5-21-15-3a28-3a17.png)

1. 해당 요소는 더 이상 모바일 보기에 표시되지 않습니다.
...
1. 데스크톱 버전과 모바일 버전을 동시에 비교하려면 **[!UICONTROL Side By Side]**&#x200B;을(를) 선택하십시오.
