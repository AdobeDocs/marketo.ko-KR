...
description: 자유 형식 랜딩 페이지에 사용자 지정 HTML 추가 - Marketing Docs - 제품 설명서
...
좋아! 원하는 스크립트나 CSS를 여기에 넣을 수 있습니다.
...
>[!CAUTION]
>
>사용자 지정 HTML이 렌더링되지 않는 경우(보이지 않는 JavaScript 함수 또는 CSS 등) 요소를 왼쪽 상단과 같은 기억할 만한 위치에 놓습니다. 요소 윤곽선은 해당 영역을 클릭할 때만 표시됩니다.
