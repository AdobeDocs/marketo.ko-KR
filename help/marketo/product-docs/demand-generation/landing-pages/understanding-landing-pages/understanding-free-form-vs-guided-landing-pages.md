...
description: Marketo의 자유 형식 및 안내식 랜딩 페이지에 대해 알아봅니다. 디자인 및 워크플로 요구 사항에 적합한 유형을 선택합니다.
title: 자유 형식 랜딩 페이지와 가이드 랜딩 페이지 이해
...
# 자유 형식 랜딩 페이지와 가이드 랜딩 페이지 이해 {#understanding-free-form-vs-guided-landing-pages}
...
* 템플릿이 [!DNL PowerPoint]의 [!DNL SlideMaster]과(와) 같습니다. 배경입니다.
