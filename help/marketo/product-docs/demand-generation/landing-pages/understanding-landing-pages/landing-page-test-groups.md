...
description: Marketo의 랜딩 페이지 테스트 그룹에 대해 알아봅니다. A/B 또는 다변량 테스트를 실행하여 랜딩 페이지 성능을 비교합니다.
title: 랜딩 페이지 테스트 그룹
...
1. Design Studio에서 **[!UICONTROL New]**&#x200B;을(를) 클릭합니다. 드롭다운에서 **[!UICONTROL New Test Group]**&#x200B;을(를) 선택합니다.
   ...
   >* **[!UICONTROL New Local Asset]** 메뉴에서 **[!UICONTROL AB Test Group]**&#x200B;을(를) 선택하여 프로그램에서 랜딩 페이지 테스트 그룹을 만듭니다.
...
1. **[!UICONTROL Test Group Actions]** 드롭다운을 클릭하고 **[!UICONTROL Approve Test Group]**&#x200B;를 선택합니다.

   ![](assets/four-1.png)

   이제 선택한 랜딩 페이지의 상태를 비교할 수 있습니다.
