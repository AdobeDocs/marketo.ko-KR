...
description: 템플릿 1D 안내 랜딩 페이지 템플릿에 대해 알아봅니다. 다운로드하여 Marketo 랜딩 페이지에 사용합니다.
title: 템플릿 1D
...
[템플릿 1D 다운로드](https://51837-micrositemarketo.adobeio-static.net/lp-templates/template-1d.html)를 마우스 오른쪽 단추로 클릭하고 **다른 이름으로 링크 저장...**&#x200B;을 선택합니다.
