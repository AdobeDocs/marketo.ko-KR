...
1. 폴더를 선택한 다음 템플릿에 이름을 지정합니다. 자유 양식이 기본 편집 모드이므로 템플릿 이름을 지정한 후 **만들기**&#x200B;를 클릭하세요.
...
1. 편집을 마쳤으면 **템플릿 작업**&#x200B;을(를) 클릭한 다음 **승인 및 닫기**&#x200B;를 선택합니다.
   ...
   >[!NOTE]
   >
   >양식을 미리 채우지 못하게 하거나 특정 페이지에서 웹 동작을 추적하지 않으려면 **Munchkin 추적 사용 안 함**&#x200B;을 선택하십시오.\
   >코드가 모바일 장치와 호환되는지 확인하려면 **모바일 호환성 유효성 검사**&#x200B;를 선택하십시오.
