...
템플릿을 변경하는 경우 **[!UICONTROL Template Actions]**&#x200B;을(를) 클릭하고 **[!UICONTROL Validate Mobile Compatibility]**&#x200B;을(를) 선택합니다.
...
이제 이 템플릿을 사용하는 모든 랜딩 페이지의 [모바일 보기를 사용자 지정](/help/marketo/product-docs/demand-generation/landing-pages/free-form-landing-pages/customize-mobile-view-for-your-free-form-landing-page.md)할 수 있습니다.
