...
## 템플릿 편집기 {#upgrade-from-the-template-editor}에서 업그레이드
...
1. **업그레이드**&#x200B;를 클릭합니다.
   ...
   >[!NOTE]
   >
   >업그레이드는 아무런 문제가 없지만 페이지에 불일치가 있는지 반드시 확인하십시오. 업그레이드하면 해당 템플릿을 사용하는 모든 랜딩 페이지의 초안이 만들어집니다.
...
문제가 발생하면 오류 메시지가 표시되고 복구를 클릭하여 문제를 수정하고 유효성 검사 과정을 반복합니다.

![](assets/image2015-1-22-20-3a43-3a20.png)

템플릿을 변경하는 경우 템플릿 작업을 클릭하고 모바일 호환성 유효성 검사를 선택합니다.

## 자유형 랜딩 페이지 편집기에서 템플릿 업그레이드 {#upgrading-a-template-from-the-free-form-landing-page-editor}

랜딩 페이지를 편집하고 모바일 탭을 클릭하면 템플릿이 업그레이드되지 않은 경우가 있습니다. 공포는 없다! 바로 여기에서 업그레이드할 수 있습니다.
