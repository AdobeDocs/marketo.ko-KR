...
사람들이 Facebook에서 사용자를 공유할 때 게시물을 사용자 정의합니다.

>[!AVAILABILITY]
>
>모든 고객이 이 기능을 구입하지는 않았습니다. 자세한 내용은 영업 담당자에게 문의하십시오.

Marketing To [소셜 앱](/help/marketo/product-docs/demand-generation/social/social-functions/add-a-social-button-on-a-landing-page.md)을 사용하면 리드가 랜딩 페이지를 Facebook, Twitter 등과 같은 소셜 네트워크의 연결과 공유할 수 있습니다. Facebook OpenGraph 태그(OG 태그)를 사용하면 랜딩 페이지에서 Facebook 게시물에 포함된 정보를 지정할 수 있습니다.
...
1. Facebook 메시지에 대해 다음 옵션 중에서 선택합니다.
   ...
   * 동적 컨텐츠 추가:소셜 앱은 랜딩 페이지의 `<TITLE>`, `<CAPTION>` 및 `<DESCRIPTION>` 태그를 사용하여 리치 게시물을 채울 수 있습니다.
   ...
   >[!NOTE]
   >
   >이러한 태그는 페이지 소스에 이미 있어야 하지만, 더 잘 제어하려면 랜딩 페이지에 특정 Facebook OG 태그를 추가할 수 있습니다.
