...
>* [!DNL Facebook] 계정 내에서 [사용자 지정 대상자 약관](https://www.facebook.com/ads/manage/customaudiences/tos.php){target="_blank"}에 동의 [!DNL Facebook]합니다.
...
1. **[!UICONTROL Audience Name]**&#x200B;을(를) 입력합니다. **[!UICONTROL Update]**&#x200B;를 클릭합니다.
   ...
   >[!TIP]
   >
   >새 대상을 현재 광고 집합 또는 그룹과 연결된 기존 대상으로 바꾸려면 **[!UICONTROL Replace an existing audience]** 확인란을 선택하십시오. 이 작업을 수행하면 교체되는 대상자가 **삭제되지**&#x200B;않습니다.

1. 완료되면 상태 대화 상자가 업데이트됩니다.

   ![](assets/create-a-custom-audience-in-facebook-6.png)

   Facebook에서는 **광고 관리자** > **대상**&#x200B;에서 새 대상을 볼 수 있습니다.
