...
1. Marketo에서 [!UICONTROL Facebook Lead Ads]을(를) 가져올 페이지를 선택하고 **[!UICONTROL Next]**&#x200B;을(를) 클릭합니다.
   ...
   >[!TIP]
   >
   >예상한 페이지가 표시되지 않으면 인증에 사용된 [!DNL Facebook] 계정이 [!DNL Facebook]의 페이지에 추가되었는지 확인하고 다시 시도하십시오.

   ![](assets/set-up-facebook-lead-ads-8.png)

1. Marketo 필드 매핑에 기본 [!DNL Facebook]을(를) 허용하려면 **[!UICONTROL Create]**&#x200B;을(를) 클릭합니다.
   ...
   [!DNL Facebook]개의 리드 광고 캠페인을 성공적으로 실행하면 리드가 Marketo으로 유입되기 시작합니다.
