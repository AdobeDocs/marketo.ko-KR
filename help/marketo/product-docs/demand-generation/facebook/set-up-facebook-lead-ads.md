...
Facebook에서 광고 캠페인을 실행하고 Marketing에 대한 리드를 생성하려면 [Facebook 리드 광고](https://www.facebook.com/business/a/lead-ads)를 사용합니다.
...
1. **LaunchPoint**&#x200B;로 이동하여 **새로 만들기,**&#x200B;을 클릭하고 **새 서비스**&#x200B;를 선택합니다.

   ![](assets/image2016-11-29-10-3a51-3a11.png)

1. 서비스에 대해 **표시 이름**&#x200B;을 입력하고 드롭다운에서 **Facebook 리드 광고** 서비스를 선택하고 **만들기**&#x200B;를 클릭합니다.
...
1. Facebook에 로그인한 후 마케팅으로 돌아가서 **승인**&#x200B;을 클릭합니다.
...
1. Marketing에서 Facebook 리드 광고를 가져올 페이지를 선택하고 **다음**&#x200B;을 클릭합니다.

   >[!TIP]
   >
   >원하는 페이지가 표시되지 않으면 인증에 사용된 Facebook 계정이 Facebook의 페이지에 추가되어 다시 시도하십시오.

   ![](assets/image2016-11-29-10-3a58-3a36.png)

1. 기본 Facebook과 MarketingTo 필드 매핑을 수락하려면 **만들기**&#x200B;를 클릭합니다.
   ...
   >[!CAUTION]
   >
   >Marketing To는 2개의 Facebook 필드를 단일 Marketing To 필드에 매핑하는 것을 지원하지 않습니다(1개에서 1개로). 2-1을 매핑하면 리드가 마케팅 시스템에 들어가지 못할 수 있습니다.

   ![](assets/image2016-11-29-11-3a0-3a2.png)

   잘했다! Facebook 리드 광고 캠페인을 성공적으로 실행하면 리드가 Marketing으로 이동하기 시작합니다.
