...
1. 모바일 장치에서 [!DNL Facebook] 모바일 앱에서 **[!UICONTROL Notifications]**&#x200B;을(를) 누릅니다.
...
1. 양식을 제출한 후 [프로그램의 일부로 또는 **[!UICONTROL Filled Out Facebook Lead Ads Form]** 필터를 사용하는 잠재 고객 데이터베이스에서 Marketo에 스마트 목록을 빌드](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md)합니다. 제출한 양식의 리드 광고 양식 이름을 삽입합니다.
