...
캠페인 설정 페이지에 있는 웹 개인화 리치 텍스트 편집기를 사용하면 텍스트 서식, 연결 및 이미지 삽입을 할 수 있습니다. 표준 워드 프로세서와 유사한 서식 옵션이 포함되어 있습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><em>이미지</em> 삽입/편집 <strong></strong> 아이콘을 클릭한 다음 Marketing To Design Studio에서 이미지를 선택하려면 이 아이콘을 사용합니다</td> 
  </tr> 
  <tr> 
