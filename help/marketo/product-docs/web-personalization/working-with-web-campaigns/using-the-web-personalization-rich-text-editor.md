...
# 웹 Personalization 리치 텍스트 편집기 사용 {#using-the-web-personalization-rich-text-editor}

![](assets/one.png)

캠페인 설정 페이지에 있는 웹 Personalization 리치 텍스트 편집기를 사용하여 텍스트 서식, 링크 및 이미지를 삽입할 수 있습니다. 여기에는 표준 워드 프로세서와 유사한 서식 지정 옵션이 포함되어 있습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><em><strong>이미지 삽입/편집</strong> 아이콘을 클릭한 후</em> 이 아이콘을 사용하여 Marketo Design Studio에서 이미지를 선택하십시오</td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>웹 토큰은 [계정 설정] > [데이터베이스]의 Web Personalization에서 관리되는 Marketo 데이터베이스의 [사람 데이터](/help/marketo/product-docs/web-personalization/using-web-segments/manage-person-data.md)를 사용합니다. 웹 토큰이 계정 설정 > 데이터베이스에 아직 없는 새 데이터베이스 필드인 경우 자동으로 추가되며 활성화하는 데 최대 24시간이 소요될 수 있습니다.
