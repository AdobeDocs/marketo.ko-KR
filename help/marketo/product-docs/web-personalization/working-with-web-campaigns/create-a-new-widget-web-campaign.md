...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1" rowspan="1">위젯 단추 자체를 사용자 지정합니다.<br>화살표: 오른쪽 드롭다운 메뉴에서 여러 아이콘을 선택할 수 있습니다. 왼쪽 드롭다운에 따라 색상이 결정됩니다.<br>사용자 지정: 호스팅된 이미지의 URL을 삽입합니다. 허용되는 파일 형식 - .JPEG, .GIF(애니메이션 포함), .PNG, .APNG, .SVG, .BMP.<br>텍스트: 위젯은 텍스트일 수 있으며 색상, 크기 및 글꼴을 사용자 지정합니다.</td>
  </tr>
  <tr>
...
>[!NOTE]
>
>**A/B에서 웹 캠페인을 테스트하시겠습니까?** 하나 이상의 웹 캠페인을 [A/B에서 최적의 결과를 테스트할 수 있습니다](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/ab-test-your-web-campaign.md). [!UICONTROL Auto Tune] 기능을 사용하면 플랫폼은 성과가 더 좋은 캠페인을 자동으로 인식하고 가장 높은 전환 캠페인을 계속 사용하며 다른 캠페인은 일시 중지합니다.
