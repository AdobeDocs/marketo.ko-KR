...
개인화된 캠페인을 A/B 테스트하려면 두 개 이상의 캠페인을 선택하고 동일한 **테스트 분할** 그룹에 연결한 다음 **자동 조정**&#x200B;을 선택하여 최상의 성과를 보이는 캠페인을 자동으로 계속할 수 있습니다.
...
1. A/B 테스트를 수행할 첫 번째 캠페인을 선택합니다. **편집**&#x200B;을 클릭합니다.

   ![](assets/image2016-11-4-13-3a46-3a37.png)

1. 캠페인 페이지에서 **테스트 분할**&#x200B;을 선택하고 **새로 만들기**&#x200B;를 클릭합니다.

   ![](assets/image2014-11-26-16-3a47-3a18.png)

1. **분할 테스트 그룹 이름**&#x200B;을(를) 입력하고 **만들기**&#x200B;를 클릭합니다. **자동 조정**&#x200B;을 선택합니다.
...
1. 캠페인을 **저장** 또는 **시작**&#x200B;합니다.
   ...
   >[!TIP]
   >
   >**자동 조정**&#x200B;을(를) 선택하면 웹 Personalization 플랫폼에서는 성능이 더 좋은 분할 테스트 캠페인을 자동으로 인식하고 다른 작업은 일시 중지한 채 가장 높은 전환 캠페인을 계속 진행할 수 있습니다.

1. 두 번째 캠페인으로 위의 프로세스를 반복합니다.

1. A/B 테스트를 수행할 두 번째 캠페인을 선택합니다. **편집**&#x200B;을 클릭합니다.

   ![](assets/image2016-11-4-13-3a51-3a39.png)

1. **캠페인 설정** 페이지에서 **테스트 분할**&#x200B;을 선택하고 드롭다운에서 **그룹**&#x200B;을 선택합니다. **자동 조정**&#x200B;을 선택합니다.
...
1. **웹 캠페인**&#x200B;에서 A/B 아이콘으로 표시되는 분할 테스트 캠페인을 볼 수 있습니다.
