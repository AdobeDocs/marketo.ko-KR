...
1. 드래그 **위치** 오른쪽 메뉴에서 세그먼트 편집기에 드롭합니다.

   ![](assets/location-drag-hand.jpg)

1. 드롭다운에서 추가할 국가를 선택합니다. 다음 항목 선택 **미국**.
...
1. 드래그 **업종** 오른쪽 메뉴에서 세그먼트 편집기에 드롭합니다.

   ![](assets/industries-hand.jpg)

1. 드롭다운에서 추가할 업종 을 선택합니다. 다음 항목 선택 **금융 서비스 산업**.

   ![](assets/segment-industries.png)

   이제 미국 및 금융 산업에서 웹 사이트를 방문하는 모든 잠재 고객을 위한 기본 세그먼트를 설정했습니다.

1. 클릭 **저장** 세그먼트를 저장하거나 **Campaign 저장 및 정의** 캠페인 페이지로 이동합니다.
