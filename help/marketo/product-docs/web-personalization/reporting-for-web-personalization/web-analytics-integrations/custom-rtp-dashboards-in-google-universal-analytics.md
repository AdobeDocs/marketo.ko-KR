...
업계, 매출액, 크기, 계정 기반 목록 및 타겟 세그먼트별로 방문 소스 및 사이트 동작과 같은 정보를 제공합니다.
...
<table> 
 <thead> 
  <tr> 
   ...
   <th> 
    <div> <strong>열 3 - 첫 번째 그래픽 드릴다운</strong> 
    </div></th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
   <td> 
    <ul> 
     ...
     <li>필터:<br>표시만 | 이벤트 카테고리(포함) RTP-세그먼트</li> 
  ...
  <tr> 
   ...
   <th> 
    <ul> 
     ...
     <li><strong>영역 선택:월드</strong></li> 
     <li><strong>필터:표시만 | 이벤트 카테고리(포함) RTP-세그먼트</strong></li> 
  ...
  <tr> 
   ...
   <th> 
    <ul> 
     ...
     <li>그룹화 기준:이벤트 작업</li> 
     <li>필터:표시만 | 이벤트 카테고리(포함) RTP-세그먼트</li> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <ul> 
     ...
     <li>필터:<br><strong>[show]만 이벤트 카테고리(포함):RTP-Campaigns</strong><br><strong>[표시 전용] 이벤트 작업(정확히 일치):노출</strong><strong>[표시 안 함] 이벤트 레이블(포함):#</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>유형:<strong>2.1 지표 </strong></li> 
     <li>다음 지표를 표시합니다.<strong>총 이벤트</strong></li> 
     <li>필터:<br><strong>[show]만 이벤트 카테고리(포함):RTP-Campaigns</strong><br><strong>[표시 전용] 이벤트 작업(정확히 일치):</strong><strong>[표시 안 함] 이벤트 레이블(포함)을 클릭합니다.#</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>다음 지표를 표시합니다.<strong>페이지 보기 횟수</strong></li> 
  ...
  <tr> 
   <td colspan="1"> 
    <ul> 
     ...
     <li>필터:<br><strong>[show]만 이벤트 카테고리(정확히 일치):RTP-Campaigns</strong><br><strong>[표시 전용] 이벤트 작업(정확히 일치):노출</strong><strong>[표시 안 함] 이벤트 레이블(포함):#</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     ...
     <li>유형:<strong>2.1 지표 </strong></li> 
     <li>다음 지표를 표시합니다.<strong>평균 세션 기간</strong></li> 
     <li>필터:<br><strong>[show]만 이벤트 카테고리(정확히 일치):RTP-Campaigns</strong><br><strong>[표시 전용] 이벤트 작업(정확히 일치):클릭</strong><strong>[표시 안 함] 이벤트 레이블(포함):#</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     <li>이름:<strong>CRE - 인기 권장 컨텐트</strong></li> 
     <li>유형:<strong>표</strong><br></li> 
     <li>다음 열을 표시합니다.<br><strong>페이지 제목 | 페이지 보기 횟수</strong><br></li> 
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>필터:<br><strong>[show]만 이벤트 카테고리(정확히 일치):RTP-Campaigns</strong></li> 
     <li><strong>[표시 전용] 이벤트 작업(정확히 일치):노출</strong></li> 
  ...
  <tr> 
   <td> 
    <ul> 
     <li>이름:<strong>CTA</strong>별 노출 횟수</li> 
   ...
   <td> 
    <ul> 
     <li>이름:<strong>CTA</strong>로 클릭스루</li> 
     <li>유형:<strong>표</strong></li> 
     <li>다음 열을 표시합니다.<strong>이벤트 레이블 | 총 이벤트 수 | 사용자</strong></li> 
     <li>필터:<br><strong>[show]만 이벤트 카테고리(정확히 일치):RTP-Campaigns</strong><br><strong>[표시 전용] 이벤트 작업(정확히 일치):클릭</strong></li> 
