...
이 문서를 사용하면 Marketo 실시간 Personalization(RTP) 및 Adobe Adobe Analytics 간의 통합을 사용할 수 있습니다. RTP의 데이터를 사용하면 사이트를 방문하는 모든 업계 세그먼트 및 조직의 트렌드를 감지하고 분석하고 RTP 캠페인의 효과를 측정하여 최적의 결과를 얻을 수 있는 통찰력과 분석을 제공할 수 있습니다.
...
1. AA 계정의 **관리 도구**(으)로 이동합니다.
1. 통합에 사용할 **보고서 세트**&#x200B;를 선택하십시오.
1. **설정 편집**&#x200B;에서 **전환**(으)로 이동하여 **[전환 변수](https://microsite.omniture.com/t2/help/en_US/reference/#Edit_conversion_variables)**&#x200B;를 선택합니다.\
   ...
   1. 상태를 _사용_(으)로 변경합니다.

      1. 이름을 **Industry** 및 **Organization**(으)로 변경하십시오. (이것이 보고서 세트에 표시되는 방식입니다.)

      1. 다음 시기 이후에 만료 필드를 **방문**(으)로 변경합니다.

1. **설정 편집**&#x200B;에서 **전환**(으)로 이동하여 **[성공 이벤트](https://microsite.omniture.com/t2/help/en_US/reference/#Configure_success_events)**&#x200B;를 선택합니다.
...
1. **설정 편집**&#x200B;에서 **[트래픽](https://microsite.omniture.com/t2/help/en_US/reference/#Traffic_Variable)**(으)로 이동하여 **[트래픽 변수](https://microsite.omniture.com/t2/help/en_US/reference/#Enable_traffic_variable_reports)**&#x200B;를 선택합니다.
   ...
   1. **사용**&#x200B;할 사용 필드를 선택하십시오.

   1. **사용**&#x200B;할 경로 보고서 필드를 선택하십시오.

## Marketo 실시간 Personalization(RTP)에서 설정 {#set-up-in-marketo-real-time-personalization-rtp}

1. RTP 플랫폼에서 **계정 설정**(으)로 이동합니다.

   ![](assets/image2014-11-29-11-3a27-3a7.png)

1. **계정 설정**&#x200B;에서 **도메인**&#x200B;을 클릭합니다.
1. **Analytics에서** **Adobe Analytics**&#x200B;을 클릭합니다.
1. 전환, 사용자 지정 및 트래픽 변수를 **켜기**&#x200B;로 전환합니다.
...
1. **사용자 지정 전환**(으)로 이동하여 **산업**&#x200B;을 클릭하세요.

1. 그래프를 **원형 차트**&#x200B;에 구성합니다.

1. **대시보드**&#x200B;를 클릭하고 **Reportlet**&#x200B;을(를) 추가합니다.
...
1. **사이트 지표**(으)로 이동합니다. **사용자 지정 이벤트**, **세그먼트**&#x200B;를 클릭합니다.
