...
description: Rtp Javascript 배포를 비롯하여 Marketo Engage에서의 rtp Javascript 배포에 대해 알아봅니다. 이 안내서를 사용하여 다음 단계를 완료하십시오.
...
1. RTP 계정에 로그인합니다. **[!UICONTROL Account Settings]** 으로 이동합니다.
