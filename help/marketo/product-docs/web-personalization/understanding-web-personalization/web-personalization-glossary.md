...
| 용어 | 정의 |
|---|---|
| **익명 방문자** | 웹 사이트에서 양식을 작성하거나 세부 정보를 남기지 않은 웹 방문자입니다. |
| **웹 캠페인** | 특정 세그먼트와 관련된 사용자 정의 반응입니다. 웹 Personalization을 사용하면 웹 캠페인에는 영역 및 위젯에 대화 상자가 포함됩니다. |
...
| **분할 테스트** | 두 개 이상의 변형으로 결과의 차이를 측정하는 테스트 실험입니다. 목표는 관심 있는 결과를 증가시키거나 극대화하는 웹 페이지 변경 사항을 식별하는 것입니다. |
