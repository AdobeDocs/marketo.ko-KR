...
컨텐츠 분석 페이지에는 웹 사이트에서 검색된 기존 컨텐츠(사례 연구, 블로그 게시물, 비디오, 보도 자료 등)가 표시됩니다. 또한 방문자가 해당 컨텐츠와 교류할 때 생성된 컨텐츠와 사람의 성과도 표시됩니다.
...
* 보기, 직접 전환 및 전환율에 대한 열 제목을 클릭하여 내림차순이나 오름차순으로 정렬합니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1" rowspan="1">디지털 콘텐츠 자산의 이름입니다. <strong>제목</strong>을 클릭하여 새 탭에서 콘텐트 URL을 엽니다.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">내용 조각이 <a href="#">컨텐트 Recommendations</a>에 추가되었는지 여부를 나타냅니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1"><p><strong>보기 횟수</strong></p></td> 
   <td colspan="1" rowspan="1"><p>컨텐츠 자산에 대한 웹 방문자의 보기 수입니다. 조회, 열기, 감시 또는 다운로드한 횟수입니다. 보기 열의 개수를 클릭하여 드릴다운하고 콘텐트를 본 사람을 확인합니다</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">콘텐츠 부분에 대한 더 많은 분석 보기</td> 
  </tr> 
  <tr> 
...
특정 컨텐츠 조각에 대한 추가 컨텐츠 분석 대화 상자가 열립니다.
...
컨텐츠 분석 페이지에서 삭제할 컨텐츠의 삭제 아이콘을 클릭합니다. 컨텐츠를 삭제할지 확인하는 메시지가 나타납니다.
