...
<tbody>
  <tr>
    ...
    <li>사용자에 대한 역할을 할당한 후 역할당 사용자 수를 검토하십시오.<br>간단한 문제 해결을 위해 각 API 사용자에 대해 고유한 역할을 구현합니다.</td>
  </tr>
  <tr>
    <td>사용자 가이드</td>
    <td><li>조직의 사용자 및 역할을 정의합니다.</li>
    <li>새 사용자/관리자를 추가하기 위한 프로세스를 정의합니다.</li></td>
  </tr>
  <tr>
    <td>샌드박스(해당되는 경우)</td>
    <td><li>샌드박스가 있는 경우 위의 범주를 검토하십시오.</li></td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    ...
    <li>각 작업 공간 및 파티션의 주요 목적을 정의합니다.<br>작업 영역과 파티션 간의 관계를 정의합니다.</li></td>
  </tr>
  <tr>
    <td>사용자 가이드</td>
...
<tbody>
  <tr>
    <td>이메일 기본값</td>
    <td><li>브랜딩 도메인에서 도메인을 선택하고 이메일 CNAME을 추가합니다. [EmailTrackingCNAME] 형식이어야 합니다.[CompanyDomain].com.</li>
    <li><a href="https://experienceleague.adobe.com/en/docs/customer-one/using/home#create-a-support-ticket-with-admin-console" target="_blank">Marketo 지원 문의</a> ssl 인증서 제공으로 보안을 유지합니다. 이 프로세스를 완료하는 데 영업일 기준으로 최대 3일이 소요될 수 있습니다.</li></td>
  </tr>
  <tr>
    <td>SPF/DKIM</td>
    <td><li><a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.html" target="_blank">SPF 및 DKIM 설정</a> 이메일 전달성.</li></td>
  </tr>
  <tr>
  </tr>
  <tr>
...
<tbody>
  <tr>
    <td>커뮤니케이션 제한</td>
    <td><li>위치 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/email-setup/enable-communication-limits.html" target="_blank" rel="noopener noreferrer">커뮤니케이션 제한</a>.</li>
...
<tbody>
  <tr>
    <td>채널</td>
    <td><li>사용 방법 정의 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/tags/create-a-program-channel.html" target="_blank" rel="noopener noreferrer">채널</a>.</li></td>
  </tr>
  <tr>
    <td>태그</td>
    <td><li>사용 방법 정의 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/tags/managing-tag-values.html" target="_blank" rel="noopener noreferrer">태그</a>.</li></td>
  </tr>
  <tr>
    <td>달력(해당되는 경우)</td>
    <td><li><a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/issue-revoke-a-marketing-calendar-license.html" target="_blank" rel="noopener noreferrer">마케팅 달력 시트 문제 해결</a> 액세스 권한이 필요한 사용자에게 <br>설정 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/navigating-the-marketing-calendar.html" target="_blank" rel="noopener noreferrer">달력.</a></li></td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    ...
    <li>API 호출을 수행할 모든 앱을 검토하고 API 호출에 대한 증가 또는 삭제가 필요한지 결정합니다.</li></td>
  </tr>
  <tr>
    <td>시작 지점</td>
    <td><li>설정 필요 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/additional-integrations/add-adobe-connect-as-a-launchpoint-service.html">시작 지점</a> 비즈니스를 위한 서비스. 각 LaunchPoint는 문제 해결을 지원하기 위해 고유한 API 사용자와 연결되어야 합니다.</li></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/marketo-sales-insight/actions/getting-started/sales-insight-actions-admin-setup-guide#set-up-marketo-sales-account">Sales Insight 작업 설정</a> Sales Insight&gt;Actions 구성에서 확인할 수 있습니다.</li>
    <li><a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/marketo-sales-insight/actions/getting-started/sales-insight-actions-admin-setup-guide.html#invite-individual-users-to-msi-actions">적절한 사용자에게 시트를 발행합니다.</a></li>
    ...
    <li><a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/priority-urgency-relative-score-and-best-bets.html">잠재 고객 점수를 사용자 지정합니다.</a></li></td>
  </tr>
  <tr>
