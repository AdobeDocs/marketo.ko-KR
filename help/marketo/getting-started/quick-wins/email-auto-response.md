...
## 임무:사람이 양식을 작성할 때 감사 인사 이메일을 보냅니다. {#mission-send-out-a-thank-you-email-when-a-person-fills-out-a-form}
...
1. 이메일 이름을 &quot;자동 응답 이메일&quot;으로 지정하고, 템플릿을 선택하고 만들기를 클릭합니다.
   ...
   이메일 편집기가 새 창이나 탭에 열립니다. 팝업이 차단된 경우 자산 요약 페이지에서 **초안** 편집을 클릭하여 이메일에 액세스합니다.
...
1. 스마트 **목록 탭으로** 이동합니다.
   ...
   사용자가 랜딩 페이지에서 만든 양식을 양식으로 작성할 때마다 [**이 캠페인을 실행하도록 설정합니다**](/help/marketo/getting-started/quick-wins/landing-page-with-a-form.md).
...
1. 내 **페이지를 선택합니다**. 이것은 양식 빠른 [승인과 함께 랜딩 페이지에서](/help/marketo/getting-started/quick-wins/landing-page-with-a-form.md) 만들어졌습니다.
