...
1. [이전 빠른 업데이트에서 만든** 학습* 폴더를 선택합니다](send-an-email.md).
...
1. 프로그램 **이름을 입력하고*** 채널**을 선택하고** 만들기**를 클릭합니다.
   ...
   >
   >
   >프로그램은 특정 마케팅 이니셔티브입니다. 이 **채널은 웨비나** , 스폰서 또는 온라인 광고와 같은 전달 메커니즘입니다. 드롭다운에 있는 채널 옵션마다 다른 옵션이 표시될 수 있습니다. 고유한 채널을 [만들 수도 있습니다.](../../product-docs/administration/tags/create-a-program-channel.md)

   ![](assets/image2014-9-8-17-3a46-3a47.png)

잘 했어! 프로그램을 만들었으므로 이제 컨텐츠를 만들어 보겠습니다.

## 2단계:양식 만들기 {#step-create-a-form}

1. 프로그램을 선택한 상태에서 새로 만들기 **를** 클릭한 다음* 새 로컬 자산**을 클릭합니다.
...
1. 양식 이름을 **입력하고** 만들기를 **클릭합니다**.
   ...
   >[!TIP]
   >
   >양식 편집기가 보이지 않습니까? 브라우저가 창을 차단했을 수 있습니다. 브라우저에서 [app.marketing.com](http://app.marketo.com/) 에서 팝업을 활성화하고 상단 메뉴 모음에서 초안 편집을 클릭합니다.
...
1. URL을 입력합니다.
   ...
   >**정의**
   >
   >후속 페이지는 양식을 작성한 후 방문자가 다시 이동하는 페이지입니다. 외부 URL은 하나의 옵션이지만 더 있습니다. 양식 [설정 감사 페이지를 참조하십시오](../../product-docs/demand-generation/forms/creating-a-form/set-a-form-thank-you-page.md).
...
1. 페이지** 이름**을 입력하고 템플릿을 선택하고 만들기를 **클릭합니다**.

   >[!NOTE]
   >
   >스크린샷에 나와 있는 것과 다른 템플릿이 있을 수 있습니다. 괜찮습니다. 하나만 선택하면 계속 진행합니다.
...
1. 모든 변경 사항이 자동으로 저장됩니다. 양식 편집기 탭/창을 닫습니다.
   ...
   잘했어! 이제 양식이 포함된 랜딩 페이지가 있습니다. 페이지를 라이브로 만들 수 있도록 승인합시다.
...
1. 랜딩 페이지를 선택하고 랜딩 페이지 작업 **에서** 승인을 **클릭합니다**.
   ...
   >
   >
   >랜딩 페이지를 승인하면 라이브되고 인터넷상에서 액세스할 수 있게 됩니다.
...
1. 고유한 정보가 포함된 양식을 작성하고 **제출을 클릭합니다**.
...
1. 양식을 작성할 때 사용한 고유한 이메일 주소를 검색합니다.
   ...
   저기 있다! 양식에 새 양식이 포함된 새 랜딩 페이지를 만들고 이 페이지를 사용하여 새 사람을 만들었습니다.
...
[간단한 ◄ 점수 부여](send-an-email.md) 이메일을 [보내라](simple-scoring.md)