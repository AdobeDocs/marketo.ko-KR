...
새로운 Marketo Engage UI 베타에 참여해 주셔서 감사합니다. 이 업데이트는 Marketo Engage의 스타일을 현대화하고 기능을 변경하지 않고 응답성을 개선합니다. Marketo Engage에 있는 대부분의 페이지의 오른쪽 상단 모서리에 표시되는 테마 선택기를 사용하여 새 UI에 액세스합니다.
