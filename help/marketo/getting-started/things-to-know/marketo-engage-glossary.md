...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1"><strong>프로그램</strong>과(와) 연결된 마케팅 활동 유형(예: 이메일, <strong>웨비나, </strong>트레이드쇼, 로드쇼, 온라인 광고 등). </td>
  </tr>
  <tr>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1">누구나 만들 수 있는 사용자 지정 변수입니다. <a href="/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md" rel="nofollow">캠페인 폴더</a> 또는 <strong>프로그램</strong>에서 <strong>만들어짐</strong>입니다.</td>
  </tr>
 </tbody>
</table>
