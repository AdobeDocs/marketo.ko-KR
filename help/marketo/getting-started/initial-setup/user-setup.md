...
## Adobe Identity Management의 Marketo Engage {#marketo-engage-on-adobe-identity-management}

새 Marketo Engage 구독이 [Adobe IMS(Identity Management System)](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.html)에 온보딩됩니다. Adobe Admin Console에서 다음 사용자 관리 검토를 진행합니다.
...
<tbody>
  <tr>
    ...
    <li>'Marketo Engage 제품 관리자' 초대를 수락하여 Adobe ID을 활성화하십시오. 역할이 Adobe Admin Console에 할당되면 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/admin-setup.html?lang=en#create-a-product-profile">환영 전자 메일</a>이 전송됩니다.</li></td>
  </tr>
  <tr>
    <td>제품 프로필</td>
  ...
  <tr>
    ...
    <td><li><a href="https://www.adobe.io/apis/experienceplatform/umapi-new.html">Adobe 사용자 관리 API</a>를 사용하여 사용자를 초대, 업데이트 및 삭제합니다.</li>
  ...
  <tr>
    ...
    <li>시스템 관리자로부터 사용자가 Marketo Engage 구독의 지원 관리자라는 이메일을 받았을 수 있습니다. 이 경우 전자 메일에서 <a href="https://experienceleague.adobe.com/en/docs/customer-one/using/home#assign-the-support-admin-role">'시작하기'</a>를 클릭하여 조직에 가입하십시오.</li>
    <li>하나 이상의 백업 담당자와 함께 적절한 담당자를 결정하고 그에 따라 시스템 관리자에게 제품 지원 관리자 역할을 할당하도록 합니다.</li></td>
  </tr>
</tbody>
</table>

## Adobe Identity Management의 Dynamic Chat 설정 {#dynamic-chat-on-adobe-identity-management}
...
<tbody>
  <tr>
    <td>구독 및 Dynamic Chat 제품 관리자(해당하는 경우)</td>
    <td><li>Adobe 조직 시스템 관리자가 Adobe 제품 관리자 역할을 부여했는지 확인합니다.</li>
    ...
    <li><a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/dynamic-chat/setup-and-configuration/initial-setup.html">'Dynamic Chat 제품 관리자'</a> 초대를 수락합니다. Dynamic Chat이 Marketo Engage 인스턴스에서 활성화되고 사용자가 시스템 관리자로 지정되면 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/demand-generation/dynamic-chat/setup-and-configuration/initial-setup.html">시작 이메일</a>이 전송됩니다.</li></td>
  </tr>
  <tr>
    <td>제품 프로필</td>
    ...
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/setup-and-configuration/permissions#edit-existing-permissions">Dynamic Chat에서 제품 프로필을 편집</a>하고 구독 내에서 사용할 수 있는 사용자 지정 <a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/setup-and-configuration/permissions#list-of-permissions">권한 집합</a>을 사용하여 사용자 지정 프로필을 만들 수 있습니다.</li></td>
  </tr>
  <tr>
    <td>사용자</td>
    <td><li>채팅 사용자를 추가 및 제거할 시기에 대한 정책을 만듭니다.</li>
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/setup-and-configuration/initial-setup#access-admin-console">Adobe Dynamic Chat 제품 관리자 권한이 있어야 하는 사용자에 대한 정책을 만듭니다.</a></li>
