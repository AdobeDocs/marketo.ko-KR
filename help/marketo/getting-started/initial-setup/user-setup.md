...
새 Marketo Engage 구독이 [Adobe IMS(Identity Management System)](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.html?lang=ko)에 온보딩됩니다. Adobe Admin Console에서 다음 사용자 관리 검토를 진행합니다.
...
<tbody>
  <tr>
    ...
    <li>'Marketo Engage 제품 관리자' 초대를 수락하여 Adobe ID을 활성화하십시오. 역할이 Adobe Admin Console에 할당되면 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/admin-setup.html?lang=ko#create-a-product-profile">환영 전자 메일</a>이 전송됩니다.</li></td>
  </tr>
  <tr>
    <td>제품 프로필</td>
  ...
  <tr>
    ...
    <li>시스템 관리자로부터 사용자가 Marketo Engage 구독의 지원 관리자라는 이메일을 받았을 수 있습니다. 이 경우 전자 메일에서 <a href="https://experienceleague.adobe.com/ko/docs/customer-one/using/home#assign-the-support-admin-role">'시작하기'</a>를 클릭하여 조직에 가입하십시오.</li>
...
<tbody>
  ...
  <tr>
    ...
    <li><a href="https://experienceleague.adobe.com/ko/docs/marketo/using/product-docs/demand-generation/dynamic-chat/setup-and-configuration/initial-setup#access-admin-console">Adobe Dynamic Chat 제품 관리자 권한이 있어야 하는 사용자에 대한 정책을 만듭니다.</a></li>
