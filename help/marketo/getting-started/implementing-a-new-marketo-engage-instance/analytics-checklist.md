...
<tbody>
  <tr>
    ...
    <li>표준 전자 메일 참여 및 게재 가능성 지표를 정확하게 보려면 보고서에 대한 <a href="https://experienceleague.adobe.com/ko/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame">관련 일정</a>(예: YTD, 최근 90일 등)을 사용하십시오.</li>
  ...
  <tr>
    <td>사용자 성과 보고서</td>
    <td><img src="assets/note-icon.png" alt="메모 아이콘"> 참고: 채널별로 인수한 사람과 마케팅 투자의 ROI를 추적할 수 있으려면 모든 Marketo Engage 구현에 대해 적절한 <a href="https://experienceleague.adobe.com/ko/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-tags">채널 및 태그 전략</a>을 사용하는 것이 좋습니다.
    <p>
