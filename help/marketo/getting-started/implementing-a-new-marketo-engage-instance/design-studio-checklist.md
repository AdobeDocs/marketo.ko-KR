---
description: 새 Marketo Engage 인스턴스를 위한 Design Studio 섹션을 설정합니다.
...
<tbody>
  <tr>
    <td>폴더 구조 </td>
    <td><li>각 에셋 유형에 대해 하위 폴더를 만들고 <a href="https://experienceleague.adobe.com/ko/docs/marketo/using/product-docs/demand-generation/images-and-files/organize-your-images-and-files-using-folders" target="_blank">전역 에셋을 구성</a>합니다(예: 대화 흐름, 전자 메일 템플릿, 전자 메일, 양식, 이미지 및 파일, 랜딩 페이지, 랜딩 페이지 템플릿, 코드 조각 등).</li></td>
  </tr>
</tbody>
</table>
