...
>[!TIP]
>
>만약 [이 검사 목록 인쇄](/help/marketo/getting-started/setup/setup-checklist.md){target="_blank"}를 채울 때 항목을 체크 아웃할 수 있습니다.

## 로그인 및 추가 Marketo 사용자 만들기 {#log-in-and-create-additional-marketo-users}

1. Marketo에 로그인 [여기](https://app.marketo.com/){target="_blank"} 전자 메일로 받은 자격 증명 사용.
...
랜딩 페이지 CNAME으로 대체할 Munchkin ID를 검색하려면 관리 영역으로 이동합니다.
...
&quot;지원 정보&quot;로 스크롤한 다음 Munchkin ID를 복사합니다.

![](assets/setup-steps-11.png)

이것은 `[Munchkin ID]`. 저장. 5단계에서 IT에 제공해야 합니다.
...
`1)` 랜딩 페이지의 경우, **[LandingPageCNAME]**.**[CompanyDomain]**.com, **[Munchkin ID]**.mktoweb.com
