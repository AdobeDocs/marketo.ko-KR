...
>[!TIP]
>
>새로운 Marketo Engage 사용자이고 많은 용어에 익숙하지 않은 경우 [Marketo Engage 용어집](/help/marketo/getting-started/things-to-know/marketo-engage-glossary.md){target="_blank"}을 확인하세요.
...
<br/>     그렇다면 'Adobe Admin Console 시스템 관리자'로부터 'Adobe Admin Console 제품 관리자' 역할이 부여되었습니까? 조직 내 콘솔 관리 권한을 가진 사람이 누구인지 모른다면 <a href="https://helpx.adobe.com/kr/contact.html" target="_blank">Adobe 고객 지원</a>에 문의하십시오.</li>
