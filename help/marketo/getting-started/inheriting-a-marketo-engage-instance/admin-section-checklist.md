...
<br/> 'Adobe Admin Console 시스템 관리자'가 'Adobe Admin Console 제품 관리자' 역할을 부여한 경우 조직의 콘솔 관리자 권한이 있는 사용자를 모를 경우 <a href="https://helpx.adobe.com/kr/contact.html" target="_blank">Adobe 고객 지원 센터</a>에 문의하십시오.</li>
<li>'Marketo Engage 제품 관리자' 초대를 수락했습니까? Adobe Admin Console에서 역할이 할당되면 이메일이 전송됩니다.
<br/> 그렇지 않으면 받은 편지함에서 <a href="/help/marketo/product-docs/administration/marketo-with-adobe-identity/admin-setup.md#initial-setup" target="_blank">환영 전자 메일</a>을 찾아 초대를 수락하여 Adobe ID을 활성화하세요.</li></td>
  </tr>
  <tr>
   <td>제품 프로필</td>
   <td><li>모든 적절한 사용자가 Adobe Admin Console에서 Marketo Engage의 제품 프로필에 할당됩니까?
<br/> 그렇지 않은 경우 Adobe Admin Console의 Marketo Engage 제품 프로필에서 <a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md" target="_blank">사용자를 추가 및/또는 제거</a>해야 합니다. 제품 프로필에 추가된 경우 Marketo Engage &gt; 관리자 &gt; 사용자 및 역할에서 사용자 역할을 할당할 수 없습니다.</li>
<p><img src="assets/note-icon.png" alt="메모 아이콘"> 참고: 원치 않는 사용자가 여러 제품 프로필에 추가되면 모든 제품 프로필에서 사용자를 제거해야 합니다. 그렇지 않으면 Marketo Engage에 계속 액세스할 수 있습니다.</td>
  </tr>
  <tr>
   <td>사용자 관리 API</td>
...
<table>
 <tbody>
  ...
  <tr>
   <td>사용자</td>
   <td><img src="assets/note-icon.png" alt="메모 아이콘"> 참고: 구독이 이미 Adobe IMS에 등록되어 있는 경우 Adobe Admin Console에서 다음 사용자 관리 검토를 계속 진행하십시오. 그렇지 않으면 Marketo Engage의 관리자 &gt; 사용자 및 역할 &gt; 사용자 로 이동합니다.
   <p>
   <li>사용자가 몇 명입니까?</li>
<li><a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user" target="_blank">제거</a>해야 하는 사용자가 있습니까?</li>
...
<li>그러한 사용자 중 <a href="/help/marketo/product-docs/administration/users-and-roles/managing-user-roles-and-permissions.md" target="_blank">다른 역할로 변경하시겠습니까?</a></li>
  ...
  <tr>
   <td>역할</td>
   <td><img src="assets/note-icon.png" alt="메모 아이콘"> 참고: Adobe ID와 함께 Marketo을 사용하든 사용하지 않든 관리 &gt; 사용자 및 역할 &gt; 역할 아래에서 Marketo Engage의 역할 권한 검토를 계속 진행하십시오.
...
<li>사용자 역할 및 권한이 규정 준수를 위해 회사 데이터 개인정보 처리방침(예: <a href="https://gdpr-info.eu/" target="_blank">GDPR</a>)과 일치합니까? 회사 데이터 <a href="/help/marketo/product-docs/core-marketo-concepts/miscellaneous/privacy-management.md" target="_blank">개인정보 처리방침</a>을 통해 사용자가 Marketo Engage 사용자 데이터를 다운로드하고 공유할 수 있습니까? 허가 업무가 필요합니까?</li></td>
  </tr>
  <tr>
   <td>사용자 지원</td>
...
<li>새 사용자/관리자를 추가하는 프로세스는 무엇입니까?</li></td>
  ...
  <tr>
   ...
   <br/> 이 경우 샌드박스에 대한 위의 범주를 검토하십시오.</li>
...
<li>Advanced Report Builder(Revenue Cycle Explorer/RCE)의 경우 채널 분석 비헤이비어가 기간 비용을 통합하는 프로그램 관행에 맞게 설정되었습니까?</li></td>
  </tr>
  <tr>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   <td>필드 관리</td>
   <td><li>몇 개의 필드가 있습니까?
   <br/> 필드, 사용자 지정 필드 및 API 이름 목록을 검토하려면 <a href="/help/marketo/product-docs/administration/field-management/export-a-list-of-all-marketo-api-field-names.md" target="_blank">필드 이름 내보내기</a>를 클릭합니다.</li>
...
<br/> 필드 작업 드롭다운에서 <a href="/help/marketo/product-docs/administration/field-management/export-used-by-data-for-a-field.md" target="_blank">Export Used By</a>를 선택하여 필드의 관련 에셋을 검토합니다.</li>
...
<br/> 그렇지 않으면 이 기능을 구현하는 것이 좋습니다.</li>
...
<br/> 이 경우 해당 이유를 알고 있어야 합니다.</li></td>
  </tr>
  <tr>
   <td>사용자 지정 활동</td>
...
<br/> 활동이 Marketo 양식, 전자 메일 또는 랜딩 페이지와 관련이 없는 경우 해당 활동을 클릭하여 이해합니다.</li></td>
  </tr>
  <tr>
   <td>사용자 정의 오브젝트</td>
...
<p><img src="assets/note-icon.png" alt="메모 아이콘"> 참고: Adobe 지원 센터에 문의하여 사용자 지정 동기화 필터를 식별하거나 사용자 지정 동기화 규칙을 구현하도록 요청하십시오.</li></td>
  </tr>
  <tr>
   <td>랜딩 페이지</td>
...
<br/> 랜딩 페이지 자산에 'http' URL이 있는지 확인합니다.</li></td>
  </tr>
  <tr>
   <td>Munchkin</td>
...
<br/> 이 경우 API 호출을 낮추려면 인스턴스를 늘리거나 감사하는 것이 좋습니다.</li></td>
  </tr>
  <tr>
...
<li>적격한 사용자에게 Dynamic Chat 제품 프로필이 Adobe ID에 추가되었는지 확인합니다. 제품 프로필에 추가된 경우 Marketo Engage &gt; 관리자 &gt; 사용자 및 역할에서 'Dynamic Chat 액세스' 역할을 할당할 수 없습니다.</li>
...
<li>Marketo Engage 인스턴스를 <a href="/help/marketo/product-docs/demand-generation/dynamic-chat/integrations/adobe-marketo-engage.md" target="_blank">연결했습니까</a>. Dynamic Chat에 연결했습니까?</li>
...
<br/><img src="assets/note-icon.png" alt="메모 아이콘"> 참고: '관리자' 및 '마케팅 사용자' 역할은 Dynamic Chat에 액세스할 수 있어야 합니다.</li>
</td>
  </tr>
...
<li><a href="/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/upgrading/upgrading-your-msi-package.md" target="_blank">최신 버전의 Sales Insight으로 업그레이드</a>했습니까?</li>
<li>Sales Insight 구성을 완료했습니까? <br/> Enterprise/Unlimited 사용자 <a href="/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/configuration/configure-marketo-sales-insight-in-salesforce-enterprise-unlimited.md" target="_blank">여기를 클릭</a>, 전문 사용자 <a href="/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/configuration/configure-marketo-sales-insight-in-salesforce-professional-edition.md" target="_blank">여기를 클릭</a>.</li>
