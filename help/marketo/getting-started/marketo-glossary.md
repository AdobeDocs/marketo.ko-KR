...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>주요 계정/조직 이름 목록. 계정 기반 마케팅(<strong>ABM</strong>) 목록이라고도 합니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">사람을 취득하는 데 책임이 있는 프로그램. 이 사람은 익명으로 확인되었을 수 있으며 이 프로그램은 이 사람을 알려진 사람으로 변환한 책임을 집니다. 첫 번째 터치 속성을 설정하는 데 도움이 됩니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">트랜잭션 관련 이메일을 수신하도록 지정한 사람에게 알리는 데 사용되는 알림</td> 
  </tr> 
  <tr> 
   <td><strong>익명의 방문자</strong></td> 
   <td>양식을 채우지 않았거나 웹 사이트에 세부 사항을 빠뜨린 웹 방문자.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>자산</strong>이(가) 소비될 준비가 되었을 때를 확인하는 데 사용됩니다. 자산은 승인되기 전까지는 공개적으로 볼 수 없습니다.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>필터 또는 목록 멤버십을 사용하여 자격이 있는 멤버를 타깃팅하는 <strong>캠페인</strong>. 일괄 캠페인은 특정 시간에 실행되며 특정 사람 집합에 한 번에 모두 영향을 줍니다. 일괄 캠페인을 다시 실행하거나 한 번 실행할 수 있습니다.<br></p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>스팸</strong>을(를) 전송하는 것과 연결된 IP 주소 또는 도메인의 목록.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>스마트 캠페인</strong>의 성과를 보여주는 보고서 유형입니다.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1"><strong>스마트 캠페인</strong>으로 그룹화된 이메일 성과 지표를 보여주는 보고서 유형입니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>프로그램</strong>과 연관된 마케팅 활동 유형(예: 이메일, <strong>웨비나, </strong>무역 과정, 로드쇼, 온라인 광고 등). </td> 
  </tr> 
  <tr> 
   <td><strong>클릭하여 % 열기</strong></td> 
   <td>이메일에서 열렸고 링크를 클릭한 이메일의 비율입니다. 고유한 클릭 수를 고유 열기 횟수로 나눈 다음 100을 곱하여 백분율로 표시함으로써 이메일의 관련성 및 컨텍스트를 측정합니다.</td> 
  </tr> 
  <tr> 
   <td><strong>클릭 수</strong></td> 
   <td>기본적으로 이메일에 포함된 링크는 링크를 클릭한 사람, 클릭한 총 링크의 수 등을 볼 수 있도록 이메일에 포함된 추적을 포함합니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">URL의 첫 부분. 한 단어(더하기 YourCompany.com)를 CNAME이라고 합니다(예: <em>info</em>.YourCompany.com/).</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">스마트 목록 <strong>filters</strong>/<strong>트리거 </strong>를 추가하여 검색 범위를 좁힐 수 있는 추가 조건입니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>컨텐츠</strong></td> 
   <td colspan="1"><strong>이메일</strong> 또는 <strong>랜딩 페이지</strong>와 같이 <strong>자산</strong>에 추가된 정보 정보입니다. <strong>참여 프로그램</strong>에는 스트림</a>에 <a href="/help/marketo/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/understanding-engagement-programs.md#content" rel="nofollow">추가할 수 있는 두 가지 유형의 컨텐츠가 있습니다. 이메일 및 <strong>프로그램</strong>.</a></td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>ContentAI</strong></td> 
   <td colspan="1">( <strong><a href="#predictivecontent">예측 컨텐츠</a></strong> 참조)</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">웹 사이트에서 검색된 기존 콘텐츠와 콘텐츠 성능을 표시하는 <strong>웹 개인화</strong>의 영역입니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"><span>쿠키는 경험을 개인화하기 위해(로그인 정보, 환경 설정 등을 기억함) 웹 사이트에서 사용자의 웹 브라우저에 전송되는 작은 데이터 조각입니다. </span></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">특정 요구 사항을 충족하기 위해 사용자가 만드는 비표준 필드입니다. 사용자 지정 필드 유형 <a href="/help/marketo/product-docs/administration/field-management/custom-field-type-glossary.md" rel="nofollow">에는 고유한 용어집</a>이 있습니다.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">받는 사람의 받은 편지함에 도달하는 이메일 메시지 기능으로서, <strong>스팸</strong> 및 클라이언트측 필터에 의해 영향을 받을 수 있습니다. 받는 사람 서버에 전자 메일이 전달되었음을 나타내는 "배달됨"과 다릅니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">직책, 매출 크기 또는 대상 산업 등 개인의 특정 속성을 기반으로 할당되는 포인트 값. 일반적으로 제품 또는 회사에 맞는 사람의 건강을 측정하는 데 사용됩니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>SPF</strong> 및 <strong>DKIM</strong>의 작업 및 해석을 표준화하는 DNS 기반 이메일 보안 정책으로서, 사서함 공급자가 해당 도메인의 유효한 소스에서 온 메일 클레임을 확인할 수 있습니다. 또한 유효성 검사에 실패한 메일을 처리할 방법을 발신자가 지정할 수 있습니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md" rel="nofollow">도메인 키가 식별된 메일</a> (DKIM)</strong></td> 
   <td colspan="1">보낸 도메인을 보호하는 인증 메커니즘으로, 보낸 사람이 보낸 사람 주소의 도메인 이름을 특정 이메일 메시지와 연결할 수 있습니다. 이렇게 하면 수신자가 도메인의 소유자가 정상적으로 이메일을 보냈음을 알 수 있습니다. 보낸 사람이 메시지 머리글에 디지털 서명을 사용하여 전자 메일에 서명합니다. 수신자는 도메인 소유자가 정상적으로 메일을 보낸 것을 확인하기 위해 DNS에 게시된 공개 키를 사용하여 해당 서명을 해독할 수 있습니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>초안</strong></td> 
   <td colspan="1"><p>아직 <strong>승인된</strong>이 아닌 <strong>이메일</strong> 또는 <strong>랜딩 페이지</strong>입니다. 초안이 승인될 때까지 공개로 볼 수 없습니다. 초안을 테스트 이메일(샘플)으로 보낼 수 있지만 어떠한 분석 기능도 기록되지 않습니다. <br></p></td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>드립 캠페인</strong></td> 
   <td colspan="1"><span>오랜 기간 동안 고객/잠재 고객에게 일련의 메시지를 보내는 다이렉트 마케팅 방법입니다.</span></td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1"><strong>가입되지 않은 </strong> 사용자가 제거 및 다시 작성되었는지 또는 가입되지 않은 기존 동일한 이메일 주소로 새 레코드가 만들어진 경우 해당 레코드는 가입되지 않은 상태로 유지됩니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/understanding-dynamic-content.md" rel="nofollow">동적 컨텐츠</a></strong></td> 
   <td colspan="1">컨텐트(예: 이미지, 조각, 텍스트 등) 지정한 기준에 따라 <strong>이메일</strong> 또는 <strong>랜딩 페이지</strong>에 입력되어 독자에 대한 경험을 개인화할 수 있습니다. </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>하드 바운스</strong>가 발생한 후 24시간 동안 이메일의 수신을 차단하는 상태 24시간 후에, 그 사람은 다시 편지를 받을 수 있게 된다. </td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
  ...
  <tr> 
   ...
   <td>고려되는 독점 알고리즘을 기반으로 한 점수:참여 비헤이비어(<strong>열기</strong>, <strong>클릭</strong>, 프로그램 성공) 및 참여되지 않은 동작(가입 해지).</td> 
  </tr> 
  <tr> 
   ...
   <td>고객 및 잠재 고객과 커뮤니케이션하기 위해 발생하는 문제입니다. 오프라인 이벤트는 보통 모임이나 무역식으로 구성되며 온라인 이벤트는 대개 <strong>웨비나</strong>입니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/demand-generation/events/understanding-events/launchpoint-event-partners.md" rel="nofollow">이벤트 파트너</a></strong></td> 
   <td colspan="1">온라인 이벤트를 자동화하는 제3자 통합</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
  ...
  <tr> 
   ...
   <td colspan="1">사용자가 관여 스트림의 모든 컨텐츠를 수신한 경우. 소진된 것으로 표시된 사람은 <strong>content</strong>이 추가로 추가될 때까지 이렇게 유지됩니다.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>사용자 범위를 좁힐 수 있도록 해주는 <strong>스마트 목록</strong>에 사용되는 도구입니다(예: 캘리포니아에 거주하는 사용자 데이터베이스의 모든 사람). 필터는 <strong>일괄 처리</strong> 및 <strong>트리거 캠페인</strong>에서 모두 사용할 수 있습니다.</td> 
  </tr> 
  <tr> 
   <td><strong>흐름</strong></td> 
   <td><p><strong>스마트 목록</strong>에 설정된 기준을 통해 선택한 사람에게 발생하는 상황을 결정하는 <strong>스마트 캠페인</strong>의 영역입니다. 흐름은 하나 이상의 <strong>흐름 단계</strong>로 구성됩니다.</p></td> 
  </tr> 
  <tr> 
   ...
   <td>흐름 동작이라고도 합니다.선택한 사람/사람에게 수행되는 작업(<strong>스마트 캠페인</strong>의 일부, <strong><a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md" rel="nofollow">스마트 목록</a></strong>의 단일 흐름 작업 또는 한 사람에 대한 단일 흐름 작업).</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>자유형 랜딩 페이지</strong></td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td><a href="/help/marketo/product-docs/marketo-sales-connect/people/sales-connect-and-gdpr-compliance.md" rel="nofollow"><strong>개인 정보 보호 규정(GDPR)</strong></a></td> 
   <td><p>2018년 5월 25일부터 시행된 유럽연합 법률안은 EU 시민에게 그들의 개인 정보에 대한 더 많은 통제권을 주기 위한 것이다.</p></td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">데이터베이스의 이전 이름(<a href="#d"><strong>데이터베이스</strong></a> 참조).</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
  ...
  <tr> 
   ...
   <td><strong></strong> 특정  <strong>프로그램</strong> 내에서 할당</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">마케팅 작업 및 워크플로우를 간소화, 자동화 및 측정하고 운영 효율성을 높이고 매출을 보다 신속하게 향상시킬 수 있는 기술 부문입니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>MQL(마케팅 적격 리드)</strong></td> 
   <td colspan="1">고객 세그먼트를 육성한 후, 일부 개인은 마케팅 공인 리드가 될 수 있습니다. 즉, 후속 작업을 위해 영업 조직에 전달하기 위해 고객의 성공 기준을 충족하는 행동과 특성을 표시했습니다.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p><strong>ABM</strong>에서 사용자가 결정한 계정은 추적하려는 대상 계정입니다.</p></td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"> <strong>가입이 취소됨</strong> 및 <strong>마케팅 일시 중단됨</strong> 상태를 무시하는 이메일. 중요한 이메일이나 자동 응답 이메일에 사용하도록 설계되었습니다. 마케팅을 위한 것이 아닙니다. <strong>차단 목록에 추가된</strong> 또는 <strong>전자 메일 잘못된 이메일</strong> 상태인 사람에게 운영 이메일이 전송되지 않습니다. <br></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>( <a href="#u"><strong>가입 해지</strong></a> 참조)</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><strong>프로그램</strong>에서 특정 월에 지출하는 비용.</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
  ...
  <tr> 
   ...
   <td colspan="1">마케팅 이니셔티브를 수행하는 데 필요한 모든 것을 포함하는 컨테이너입니다. 다음과 같은 4가지 유형이 있습니다.<strong>이벤트 프로그램</strong>, <strong>참여 프로그램</strong>, <strong>이메일 프로그램</strong> 및 <strong>기본 프로그램</strong>)</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>프로그램 월</strong></td> 
   <td colspan="1"> <strong>program</strong>의 <strong>기간 비용</strong>과 연관된 월입니다.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>사용자가 <strong>스마트 캠페인</strong>에서 미리 결정된 기준을 충족하면 자격을 얻게 됩니다. 자격 규칙을 설정하여 해당 스마트 캠페인의 <strong>flow</strong>에서 실행할 수 있는 횟수를 결정할 수 있습니다.</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1"><p>여러 가지 신호 및/또는 데이터 포인트로 구성된 시간에 따른 성과 점수입니다. 신뢰성은 보낸 사람의 도메인 <strong>content</strong> 또는 IP 주소에 연결되어 있고 <strong>수신 가능성</strong>에 영향을 줄 수 있습니다.</p></td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>반환 경로 주소</strong></td> 
   <td colspan="1">메시지가 시작된 실제 이메일 주소는 "보낸 사람" 필드의 이메일과 다릅니다. </td> 
  </tr> 
  <tr> 
   <td><strong>RCA(Revenue Cycle Analytics)</strong></td> 
   <td>추가 기능에는 인스턴스 전체의 보고를 향상시키는 데 도움이 되는 다양한 도구가 포함되어 있습니다.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">일련의 단계를 사용하는 <strong>RCA)</strong>에 사용된 도구로서, 전환하려는 동안 <strong>리드</strong>이(가) 지정된 시점에 있는 위치를 추적할 수 있습니다.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">고객에게 보내기 전에 본인(및/또는 다른 사람)에게 보내는 테스트 <strong>이메일</strong>을 참조하십시오. 샘플을 사용하여 <strong>동적 컨텐트</strong>를 테스트할 수도 있습니다.</td> 
  </tr> 
  <tr> 
   ...
   <td>세그멘테이션 내의 카테고리(<strong>세그멘테이션</strong> 참조).</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">지정한 <strong>스마트 목록</strong> 규칙에 따라 <strong>데이터베이스</strong>에 있는 사람들을 그룹화합니다. 예를 들어 업계라는 세그먼테이션을 가질 수 있으며 그 안에 있는 카테고리는 다음과 같습니다.의료, 기술, 재정 등 세그먼테이션을 사용하면 선택한 인구 통계에 따라 전체 사용자 그룹을 마케팅할 수 있습니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/personalization/segmentation-and-snippets/snippets/create-a-snippet.md" rel="nofollow">코드 단편</a></strong></td> 
   <td colspan="1">미리 만들어 <strong>랜딩 페이지</strong>/<strong>이메일</strong>에 빠르게 삽입할 수 있는 <strong>content</strong>(텍스트, 이미지) 블록.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">요청하지 않은 이메일의 가장 일반적인 용어입니다.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>스팸 트랩</strong></td> 
   <td colspan="1">ISP와 이메일 보안 제공업체가 스팸자를 트랩하도록 특별히 모니터링하는 이메일 주소. 여기에는 사용되지 않은 주소, 오타 도메인 및 만료된 도메인이 포함될 수 있습니다. 다양한 유형의 스팸 트랩은 구매 목록(본래 스팸 트랩)을 통해 양식을 올바르게 유지 관리하지 않거나 잘못된 주소(만료된 도메인 스팸 트랩)를 제거하거나 권한이 없는 주소(만료된 도메인 스팸 트랩)를 제거하는 등 양식 문제(일반적인 스팸 트랩)를 통해 획득 문제가 서로 다를 수 있습니다. 이러한 주소로 보낸 모든 메일은 <strong>스팸</strong>으로 표시됩니다.</td> 
  </tr> 
  <tr> 
   <td><strong>분할 테스트</strong></td> 
   <td>두 개 이상의 변형이 있는 테스트 실험을 통해 결과의 차이를 측정할 수 있습니다. 목표는 관심 결과를 높이거나 최대화하는 웹 페이지의 변경 사항을 파악하는 것입니다.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">사용자를 양성하기 위해 <strong>참여 프로그램</strong>에서 사용되는 <strong>content</strong>의 우선 순위를 적용한 모음입니다. <a href="/help/marketo/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/add-content-to-a-stream.md" rel="nofollow"></a> 지정한 순서로 배포된 컨텐츠</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><strong>프로그램</strong>을 설명하는 데 사용되는 식별자.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>해당 이벤트가 발생할 때 트리거 캠페인</a>의 <a href="/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/define-smart-list-for-smart-campaign-trigger.md" rel="nofollow">흐름 단계를 활성화하는 활동 또는 이벤트(예: 누군가 웹 페이지를 방문하거나 이메일에 있는 링크를 클릭하는 등). </a></td> 
  </tr> 
  <tr> 
   <td> 
    <div> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>특정 상호 작용을 허용하는 응용 프로그램의 작은 그래픽 요소입니다. 위젯은 Marketo Sky에서만 사용할 수 있습니다(<a href="/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-widget-web-campaign.md" rel="nofollow">위젯 웹 캠페인과 다름)</a></td> 
  </tr> 
  <tr> 
   <td><strong>와일드카드</strong></td> 
   <td>문자열의 다른 문자를 대체하기 위해 문자열 앞이나 뒤에 사용되는 문자(*)는 <strong>웹 개인화</strong>)에 사용됩니다.</td> 
  </tr> 
  <tr> 
