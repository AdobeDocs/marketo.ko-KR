...
## 로그인 및 추가 마케팅 사용자 {#log-in-and-create-additional-marketo-users} 만들기
...
이메일이 가능한 한 많은 사람에게 도달하도록 하기 위해 몇 가지 조치를 취할 수 있습니다.
    ...
    1. **SPF 및 DKIM을 설정합니다.** 이러한 기술은 수신자에게 마케팅 이메일이 스팸이 아님을 보장합니다. 받는 사람의 스팸 필터가 마케팅 메시지를 거부하는 것을 방지할 수 있도록 하려면 다음 단계에 따라 [SPF 및 DKIM for Your Email Delivery](/help/marketo/product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md)을 설정합니다.
...
## {#complete-your-marketo-setup-after-it-finishes}이(가) 완료된 후 마케팅 설정을 완료하십시오.
...
회사에서 사용하는 CRM에 따라 다음 중 하나를 선택합니다.
    ...
    * [Marketing To를 Salesforce.com과 통합](/help/marketo/product-docs/crm-sync/salesforce-sync/understanding-the-salesforce-sync.md)
    * [Marketing To와 Microsoft Dynamics 통합](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/understanding-the-microsoft-dynamics-sync.md)
