...
* [Marketo용 프로토콜 구성](/help/marketo/getting-started/setup-steps/configure-protocols-for-marketo.md)

* [Marketo 용어집](/help/marketo/getting-started/marketo-glossary.md)

## 인기 있는 문서

* [Salesforce 동기화 이해](/help/marketo/product-docs/crm-sync/salesforce-sync/understanding-the-salesforce-sync.md)

* [Microsoft Dynamics Sync 이해](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/understanding-the-microsoft-dynamics-sync.md)

* [스마트 캠페인 이해](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/understanding-smart-campaigns.md)

* [Adobe Marketo Engage 차세대 UX 경험 개요](/help/marketo/product-docs/marketo-engage-next-generation-experience/overview.md)