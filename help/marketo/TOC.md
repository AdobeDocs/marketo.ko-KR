...
+ 제품 문서 {#product-docs}
   ...
   + 관리 {#administration}
      ...
      + 설정 {#settings}
         ...
         + [캠페인 관리자](product-docs/administration/settings/campaign-inspector.md)
         ...
         + [CNAME을 사용하여 랜딩 페이지 URL 사용자 지정](product-docs/administration/settings/customize-your-landing-page-urls-with-a-cname.md)
      ...
      + 사용자 및 역할 {#users-and-roles}
         ...
         + [코드 조각에 초안 없음 사용](product-docs/administration/users-and-roles/enable-no-draft-for-snippets.md)
      + 작업 공간 및 개인 분할 영역 {#workspaces-and-person-partitions}
   ...
   + CRM 동기화 {#crm-sync}
      + Microsoft Dynamics 동기화 {#microsoft-dynamics}
         ...
         + 동기화 설정 {#sync-setup}
            ...
            + [Dynamics 인증 메서드 다시 구성](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/reconfigure-dynamics-authentication-method.md)
            ...
            + Microsoft Dynamics 2016/Dynamics 365 온-프레미스  {#microsoft-dynamics-2016-dynamics-365-on-premises}
               + [3단계 중 1단계: Marketo 솔루션 설치 - 2015 온-프레미스/2016 Dynamics 365 온-프레미스](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-1-of-3-install.md)
               + [3단계 중 2단계: Dynamics 2015 온-프레미스/2016 Dynamics 365 온-프레미스에서 Marketo 동기화 사용자 설정](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md)
            ...
            + Microsoft Dynamics 365(ROPC 연결 포함){#microsoft-dynamics-365-with-ropc-connection}
               ...
               + [4단계 중 4단계: ROPC 연결을 통해 Marketo 솔루션 연결](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-4-of-4-connect.md)
            ...
            + 이전 버전에 연결 {#connecting-to-legacy-versions}
               ...
               + [3단계 중 1단계: Dynamics(2015 온프레미스)에 Marketo 솔루션 설치](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md)
               + [3단계 중 2단계: Marketo에 대한 동기화 사용자 설정(2015 온프레미스)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-2-of-3-set-up-2015.md)
               + [3단계 중 3단계: Marketo 및 Dynamics 연결(2015 온-프레미스)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2015.md)
   ...
   + 수요 생성 {#demand-generation}
      ...
      + 이벤트 {#events}
         ...
         + 대화형 웨비나 {#interactive-webinars}
            ...
            + [대화형 웨비나 사용자 관리](product-docs/demand-generation/events/interactive-webinars/interactive-webinars-user-management.md)
            ...
            + [대화형 웨비나 편집 또는 삭제](product-docs/demand-generation/events/interactive-webinars/edit-or-delete-an-interactive-webinar.md)
      ...
      + 랜딩 페이지 {#landing-pages}
         ...
         + 무형식 랜딩 페이지 {#free-form-landing-pages}
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      + 액션 {#actions}
         ...
         + 캠페인 {#campaigns}
            ...
            + [이메일 단계에 대한 영업 캠페인 전송 옵션 이해](product-docs/marketo-sales-insight/actions/campaigns/understanding-sales-campaign-send-options-for-email-steps.md)
         ...
         + CRM {#crm}
            ...
            + Salesforce 통합 {#salesforce-integration}
               ...
               + [Salesforce에 Sales Insight Actions 계정 연결](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/connect-your-sales-insight-actions-account-to-salesforce.md)
         ...
         + FAQ {#faq}
            ...
            + [Sales Insight Actions는 어떤 브라우저를 지원합니까?](product-docs/marketo-sales-insight/actions/faq/which-browsers-does-sales-insight-actions-support.md)
      ...
      + Salesforce용 MSI {#msi-for-salesforce}
         ...
         + 구성 {#configuration}
            ...
            + [프로필에 Sales Insight Access 추가](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/add-sales-insight-access-to-profiles.md)
      ...
      + [비네이티브 MS Dynamics 통합을 위한 Sales Insight](product-docs/marketo-sales-insight/sales-insight-for-non-native-ms-dynamics-integrations.md)
