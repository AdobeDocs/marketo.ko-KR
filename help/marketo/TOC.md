...
+ Marketing 시작하기 {#getting-started-with-marketo}
   ...
   + [마케팅 용어집](getting-started/marketo-glossary.md)
   ...
   + 설정 {#setup}
      ...
      + [Marketing용 프로토콜 구성](getting-started/setup-steps/configure-protocols-for-marketo.md)
   + 빠른 성공 {#quick-wins}
      ...
      + [드립, 드립, 양육](getting-started/quick-wins/drip-drip-nurture.md)
   ...
   + 마케팅 인스턴스 상속 {#inheriting-a-marketo-instance}
      + [도와주세요! 기존 마케팅 인스턴스를 상속했습니다.](getting-started/inheriting-a-marketo-instance/help-ive-inherited-an-existing-marketo-instance.md)
      ...
      + [도움말 보기](getting-started/inheriting-a-marketo-instance/ways-to-get-help.md)
   + [실행 팩 이해 및 사용](getting-started/understanding-and-using-the-launch-pack.md)
   + [마케팅 용어 업데이트](getting-started/updates-to-marketo-terminology.md)
+ 제품 문서 {#product-docs}
   + 계정 기반 마케팅 {#account-based-marketing}
      ...
      + Target {#target}
         + 지정된 계정 {#named-accounts}
            ...
            + [지정된 계정 가져오기](product-docs/account-based-marketing/target/named-accounts/import-named-accounts.md)
            ...
            + [지정된 계정에 사람 추가](product-docs/account-based-marketing/target/named-accounts/add-people-to-a-named-account.md)
            ...
            + [지정된 계정 삭제](product-docs/account-based-marketing/target/named-accounts/delete-a-named-account.md)
   ...
   + 측정 {#measure}
      ...
      + [ABM 영업 보고서](product-docs/account-based-marketing/measure/abm-sales-report.md)
   ...
   + 추가 앱 {#additional-apps}
      + SEO {#seo}
         ...
         + 키워드 {#keywords}
            ...
            + [SEO - 필터 키워드 결과](product-docs/additional-apps/seo/keywords/seo-filter-keyword-results.md)
   ...
   + 관리 {#administration}
      + 설정 {#setup}
         ...
         + [문치킨](product-docs/administration/setup-administration/munchkin.md)
      ...
      + 추가 통합 {#additional-integrations}
         ...
         + [LaunchPoint 서비스로 수준 3 웹 회의 추가](product-docs/administration/additional-integrations/add-level-3-web-meeting-as-a-launchpoint-service.md)
         ...
         + [LaunchPoint 서비스로 Facebook별 작업 공간 추가](product-docs/administration/additional-integrations/add-workplace-by-facebook-as-a-launchpoint-service.md)
         ...
         + [IP 기반 허용 목록에 추가하다 API 액세스에 대한 만들기](product-docs/administration/additional-integrations/create-an-allowlist-for-ip-based-api-access.md)
      ...
      + 감사 추적 {#audit-trail}
         ...
         + [감사 추적 사용](product-docs/administration/audit-trail/enable-audit-trail.md)
      ...
      + 이메일 설정 {#email-setup}
         ...
         + [언어를 지원하는 구독 취소 메시지를 동적으로 만들기](product-docs/administration/email-setup/edit-the-unsubscribe-message/make-your-unsubscribe-message-dynamic-for-languages.md)
         ...
         + [스마트 캠페인에 대한 사용자 제한 활성화](product-docs/administration/email-setup/enable-person-restrictions-for-smart-campaigns.md)
      ...
      + 필드 관리 {#field-management}
         ...
         + [필드의 업데이트 차단](product-docs/administration/field-management/block-updates-to-a-field.md)
         + [마케팅 사용자 지정 필드의 유형 변경](product-docs/administration/field-management/change-the-type-of-a-marketo-custom-field.md)
         ...
         + [사용자 지정 필드 유형 용어집](product-docs/administration/field-management/custom-field-type-glossary.md)
         + [Marketing To에서 사용자 지정 필드 삭제](product-docs/administration/field-management/delete-a-custom-field-in-marketo.md)
         ...
         + [필드 이름 변경](product-docs/administration/field-management/rename-a-field.md)
         + [시스템 관리 필드 이해](product-docs/administration/field-management/understanding-system-managed-fields.md)
         + [Marketing과 Salesforce 간 필드 매핑 보기](product-docs/administration/field-management/view-field-mappings-between-marketo-and-salesforce.md)
      ...
      + Marketing To 사용자 지정 개체 {#marketo-custom-objects}
         ...
         + [마케팅 사용자 지정 개체 필드 추가](product-docs/administration/marketo-custom-objects/add-marketo-custom-object-fields.md)
         + [Marketing to 사용자 지정 개체 링크 필드 추가](product-docs/administration/marketo-custom-objects/add-marketo-custom-object-link-fields.md)
         + [사용자 지정 개체 승인](product-docs/administration/marketo-custom-objects/approve-a-custom-object.md)
         + [마케팅 사용자 지정 개체 만들기](product-docs/administration/marketo-custom-objects/create-marketo-custom-objects.md)
      ...
      + 설정 {#settings}
         ...
         + [보물상자 기능 활성화 또는 비활성화](product-docs/administration/settings/enable-or-disable-treasure-chest-features.md)
      ...
      + 작업 영역 및 개인 파티션 {#workspaces-and-person-partitions}
         ...
         + [작업 영역에 개인 파티션 지정](product-docs/administration/workspaces-and-person-partitions/assign-person-partitions-to-workspaces.md)
         ...
         + [작업 영역 및 분할 영역 간 세그먼트 공유](product-docs/administration/workspaces-and-person-partitions/share-segmentations-across-workspaces-and-partitions.md)
   + 핵심 마케팅 개념 {#core-marketo-concepts}
      + 스마트 캠페인 {#smart-campaigns}
         ...
         + 스마트 캠페인 만들기 {#creating-a-smart-campaign}
            ...
            + [스마트 캠페인 검사 목록](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.md)
         + 스마트 캠페인 사용 {#using-smart-campaigns}
            ...
            + [트리거 스마트 캠페인 활성화 | 예약 탭](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/activate-a-trigger-smart-campaign-schedule-tab.md)
            ...
            + [나중에 실행할 배치 스마트 캠페인 예약](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-batch-smart-campaign-to-run-later.md)
            ...
            + [&quot;캠페인이 요청됨&quot;을 사용하여 판매에 대한 트리거 스마트 캠페인 설정](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/setting-up-a-trigger-smart-campaign-for-sales-using-campaign-is-requested.md)
         ...
         + 흐름 동작 {#flow-actions}
            ...
            + [Webhook 전화 문의](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/call-webhook.md)
            ...
            + [개인 전환](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/convert-person.md)
         ...
         + Salesforce Flow Actions {#salesforce-flow-actions}
            ...
            + [SFDC에서 사람 삭제](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/delete-person-from-sfdc.md)
      ...
      + 스마트 목록 및 정적 목록 {#smart-lists-and-static-lists}
         ...
         + 스마트 목록에서 사용자 관리 {#managing-people-in-smart-lists}
            ...
            + [수익 단계에서 모든 사람 찾기](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-all-people-in-a-revenue-stage.md)
            ...
            + [사용자 지정 로직을 사용하여 중복 사용자 찾기](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-duplicate-people-with-custom-logic.md)
         ...
         + 정적 목록 {#static-lists}
            ...
            + [정적 목록을 Adobe Experience Cloud으로 내보내기](product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/export-a-static-list-to-adobe-experience-cloud.md)
      ...
      + 프로그램 {#programs}
         ...
         + 프로그램 작업 {#working-with-programs}
            ...
            + [스프레드시트의 멤버를 프로그램으로 가져오기](product-docs/core-marketo-concepts/programs/working-with-programs/import-members-from-a-spreadsheet-into-a-program.md)
         ...
         + 프로그램 예약 보기 {#program-schedule-view}
            ...
            + [사용자 지정 항목 유형 숨기기 및 숨김 취소](product-docs/core-marketo-concepts/programs/program-schedule-view/hiding-and-unhiding-custom-entry-types.md)
            ...
            + [프로그램 스케줄 뷰 입력 유형](product-docs/core-marketo-concepts/programs/program-schedule-view/program-schedule-view-entry-types.md)
            ...
            + [전역 오버레이 사용](product-docs/core-marketo-concepts/programs/program-schedule-view/using-a-global-overlay.md)
         + 토큰 {#tokens}
      ...
      + 마케팅 달력 {#marketing-calendar}
         + 달력 이해 {#understanding-the-calendar}
            ...
            + [응모 세부 사항 보기](product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/view-entry-details.md)
         + 달력 사용 {#working-with-the-calendar}
         ...
         + 달력 HD {#calendar-hd}
            ...
            + [프레젠테이션 실행](product-docs/core-marketo-concepts/marketing-calendar/calendar-hd/launch-a-presentation.md)
      + 모바일 앱 {#mobile-apps}
         + 이벤트 체크 인 {#event-check-in}
            ...
            + [태블릿에서 이벤트 확인](product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md)
            + [사용자에게 체크 인 앱에 대한 액세스 권한 부여](product-docs/core-marketo-concepts/mobile-apps/event-check-in/grant-users-access-to-the-check-in-app.md)
         ...
         + 마케팅 모멘트 {#marketo-moments}
            ...
            + 순간과 함께 작업 {#working-with-moments}
               + [즐겨찾기 만들기](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/creating-a-favorite.md)
               + [마케팅 모멘트 다운로드](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/downloading-marketo-moments.md)
         ...
         + 기타 {#miscellaneous}
            ...
            + [Adobe Experience Manager에서 자산 가져오기](product-docs/core-marketo-concepts/miscellaneous/importing-assets-with-adobe-experience-manager.md)
            + [키보드 단축키 용어집](product-docs/core-marketo-concepts/miscellaneous/keyboard-shortcuts-glossary.md)
            + [마케팅 샌드박스](product-docs/core-marketo-concepts/miscellaneous/marketo-sandbox.md)
            + [마케팅 자산 이름 변경](product-docs/core-marketo-concepts/miscellaneous/rename-a-marketo-asset.md)
   ...
   + CRM 동기화 {#crm-sync}
      + Microsoft Dynamics Sync {#microsoft-dynamics}
         ...
         + 설정 동기화 {#sync-setup}
            ...
            + Microsoft Dynamics 2011 온-프레미스 {#microsoft-dynamics-2011-on-premises}
               + [3단계 중 1단계:Marketing Solution(2011 온프레미스) 설치](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-1-of-3-install.md)
            ...
            + Microsoft Dynamics 2013 온-프레미스 {#microsoft-dynamics-2013-on-premises}
               + [3단계 중 1단계:Dynamics에서 Marketing Solution 설치(2013 온프레미스)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-1-of-3-install.md)
               + [3단계 중 2단계:Marketing(2013 온-프레미스)용 사용자 동기화 구성](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-2-of-3-configure.md)
            ...
            + Microsoft Dynamics 2015 온-프레미스/2016 Dynamics 365 온-프레미스 {#microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises}
               + [3단계 중 1단계:Marketing To Solution - 2015 온-프레미스 / 2016 Dynamics 365 온-프레미스 설치](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-1-of-3-install.md)
               ...
               + [3단계 중 3단계:2016 Dynamics 365 온-프레미스/2015년 Connect Markto 및 Dynamics 2015](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-3-of-3-connect.md)
            + Microsoft Dynamics 365 {#microsoft-dynamics-365}
               ...
               + [3단계 중 2단계:Dynamics에서 Marketing To 동기화 사용자 설정](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-2-of-3-set-up.md)
               + [3단계 중 3단계:Microsoft Dynamics와 Marketing(온라인) 연결](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-3-of-3-connect.md)
         + Microsoft Dynamics 동기화 세부 정보 {#microsoft-dynamics-sync-details}
            ...
            + [Microsoft Dynamics와 빠른 동기화를 사용하여 새 사용자 지정 필드 사용](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-field-sync/use-quick-sync-with-microsoft-dynamics-for-a-new-custom-field.md)
         ...
         + 사용자 지정 Dynamics 동기화 필터 세부 사항 {#custom-dynmaics-sync-filter-details}
            ...
            + [기본 사용자 지정 필드 접두사 설정](product-docs/crm-sync/microsoft-dynamics-sync/create-a-custom-dynamics-sync-filter/set-a-default-custom-field-prefix.md)
      ...
      + 설정 {#setup}
         ...
         + Professional Edition {#professional-edition}
            ...
            + [3단계 중 2단계:Marketing(Professional)용 Salesforce 사용자 만들기](product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-2-of-3-create-a-salesforce-user-for-marketo-professional.md)
         ...
         + 선택적 단계 {#optional-steps}
            ...
            + [영어 이외의 사용자 지정 개체 동기화 사용](product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-non-english-custom-object-sync.md)
            ...
            + [이메일 알림 끄기를 통해 소유자 주도](product-docs/crm-sync/salesforce-sync/setup/optional-steps/turn-off-email-notifications-to-lead-owner.md)
         + SFDC 동기화 세부 정보 {#sfdc-sync-details}
            + [동기화되기 전에 프로그램 상태 및 Salesforce 캠페인 상태를 일치시키는 방법](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-errors/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md)
            ...
            + [Marketing To Sync에서 Salesforce 필드 숨기기](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-field-sync/hide-a-salesforce-field-from-the-marketo-sync.md)
            ...
            + [SFDC 동기화:리드/연락처/사람 병합](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-merging-a-lead-contact-person.md)
         ...
         + [묵시적 Salesforce 작업](product-docs/crm-sync/salesforce-sync/implied-salesforce-actions.md)
   + 수요 생성 {#demand-generation}
      ...
      + 이벤트 {#events}
         ...
         + 이벤트 만들기 {#create-an-event}
            + [Adobe Connect을 사용하여 이벤트 만들기](product-docs/demand-generation/events/create-an-event/create-an-event-with-adobe-connect.md)
            ...
            + [Marketing에서 이벤트 만들기](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/create-an-event-in-marketo.md)
            ...
            + [Marketing To에 ON24 자격 증명 입력](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/enter-your-on24-credentials-in-marketo.md)
      ...
      + Facebook {#facebook}
         ...
         + [Marketing To와 데스크탑 통합을 위한 Facebook 리드 광고 테스트](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-desktop-integration-with-marketo.md)
         + [Marketing To와 모바일 통합을 위한 Facebook 리드 광고 테스트](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-mobile-integration-with-marketo.md)
      ...
      + Forms {#forms}
         + 양식 만들기 {#creating-a-form}
            ...
            + [양식 필드 만들기 필요](product-docs/demand-generation/forms/creating-a-form/make-a-form-field-required.md)
            ...
            + [양식 감사 페이지 설정](product-docs/demand-generation/forms/creating-a-form/set-a-form-thank-you-page.md)
         + 양식 작업 {#form-actions}
         ...
         + 양식 필드 {#form-fields}
            ...
            + [양식에서 필드 순서 변경](product-docs/demand-generation/forms/form-fields/reorder-fields-in-a-form.md)
      ...
      + 랜딩 페이지 {#landing-pages}
         ...
         + 자유형 랜딩 페이지 {#free-form-landing-pages}
            + [자유로운 형식의 랜딩 페이지 이미지에 링크 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-a-free-form-landing-page-image.md)
            + [자유로운 형식의 랜딩 페이지에서 이미지에 링크 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-an-image-in-a-free-form-landing-page.md)
            ...
            + [자유로운 형식의 랜딩 페이지에 소셜 단추 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-social-button-to-a-free-form-landing-page.md)
            + [자유로운 형식의 랜딩 페이지에 비디오 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-video-to-a-free-form-landing-page.md)
            ...
            + [자유 형식의 랜딩 페이지 디자인을 위한 가이드 사용](product-docs/demand-generation/landing-pages/free-form-landing-pages/use-guides-for-free-form-landing-page-design.md)
         ...
         + 랜딩 페이지 템플릿 {#landing-page-templates}
            ...
            + [안내 템플릿의 요소 및 변수 이해](product-docs/demand-generation/landing-pages/landing-page-templates/understanding-elements-and-variables-in-guided-templates.md)
            + 안내 랜딩 페이지 템플릿 {#guided-landing-page-templates}
               ...
               + [템플릿 3-D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3-d.md)
      ...
      + 소셜 {#social}
         + 소셜 작업 구성 {#configuring-social-actions}
            ...
            + [참조 오퍼에 대한 추적 진행률 흐름 구성](product-docs/demand-generation/social/configuring-social-actions/configure-track-progress-flow-for-a-referral-offer.md)
         ...
         + 소셜 함수 {#social-functions}
            ...
            + [소셜 앱에 개인정보 보호 정책 추가](product-docs/demand-generation/social/social-functions/add-your-privacy-policy-to-a-social-app.md)
            ...
            + [오퍼 이행을 위한 프로모션 코드 사용](product-docs/demand-generation/social/social-functions/use-promo-codes-for-offer-fulfillment.md)
   ...
   + 이메일 마케팅 {#email-marketing}
      + 전달 능력 {#deliverability}
         + [지속적인 구독 취소](product-docs/email-marketing/deliverability/durable-unsubscribe.md)
         + [이메일 배달 기능 전원 팩:세부 목록을 가져오는 방법](product-docs/email-marketing/deliverability/email-deliverability-power-pack-how-to-import-a-seedlist.md)
         + [이메일 전달 기능 도구](product-docs/email-marketing/deliverability/email-deliverability-tool.md)
         ...
         + [이메일 전달 기능에 대해 SPF 및 DKIM 설정](product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md)
         ...
         + [전용 IP 주소를 사용하여 이메일 전송](product-docs/email-marketing/deliverability/use-your-dedicated-ip-addresses-to-send-emails.md)
      + 드립 트레이닝 {#drip-nurturing}
         ...
         + 참여 프로그램 사용 {#using-engagement-programs}
            ...
            + [참여 프로그램에서 사람 일시 중지](product-docs/email-marketing/drip-nurturing/using-engagement-programs/pause-people-in-an-engagement-program.md)
            ...
            + [참여 프로그램 멤버 참조](product-docs/email-marketing/drip-nurturing/using-engagement-programs/see-members-of-an-engagement-program.md)
      ...
      + 이메일 프로그램 {#email-programs}
         ...
         + 이메일 프로그램 작업 {#email-program-actions}
            ...
            + 이메일 테스트 - A/B 테스트 {#email-test-a-b-test}
               ...
               + [&quot;제목&quot; A/B 테스트 사용](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/use-subject-line-a-b-testing.md)
            ...
            + 받는 사람 시간대와 예약 {#scheduling-with-recipient-time-zone}
               ...
               + [받는 사람 시간대에서 이메일 프로그램 예약](product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md)
         ...
         + 이메일 프로그램에서 사람 관리 {#managing-people-in-email-programs}
      ...
      + 일반 {#general}
         ...
         + 이메일 만들기 {#creating-an-email}
            ...
            + [텍스트만 이메일 만들기](product-docs/email-marketing/general/creating-an-email/create-a-text-only-email.md)
         ...
         + 편집기의 함수 {#functions-in-the-editor}
            ...
            + [이메일 사용](product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)
            ...
            + [이메일 템플릿에 편집 가능한 섹션 추가 v1.0](product-docs/email-marketing/general/functions-in-the-editor/add-editable-sections-to-email-templates-v1-0.md)
         ...
         + 토큰 사용 {#using-tokens}
            + [이메일에 링크로 시스템 토큰 추가](product-docs/email-marketing/general/using-tokens/add-a-system-token-as-a-link-in-an-email.md)
            ...
            + [알림 정보 토큰 보내기](product-docs/email-marketing/general/using-tokens/use-the-send-alert-info-token.md)
   ...
   + Marketing To Sales Connect {#marketo-sales-connect}
      ...
      + CRM {#crm}
         + Salesforce 사용자 정의 {#salesforce-customization}
            ...
            + [Salesforce 샌드박스에서 사용자 정의 설치 방법](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-install-customizations-in-your-salesforce-sandbox.md)
         ...
         + Salesforce 통합 {#salesforce-integration}
            + [Salesforce에 Sales Connect 계정 연결](product-docs/marketo-sales-connect/crm/salesforce-integration/connect-your-sales-connect-account-to-salesforce.md)
      ...
      + 이메일 플러그인 {#email-plugins}
         + Gmail {#gmail}
            ...
            + [Gmail 사용자를 위한 이메일 연결 탭](product-docs/marketo-sales-connect/email-plugins/gmail/email-connection-tab-for-gmail-users.md)
            + [Gmail, Sales Connect Signature 인수](product-docs/marketo-sales-connect/email-plugins/gmail/gmail-not-pulling-in-sales-connect-signature.md)
            ...
            + [Sales Connect와 보조 Gmail 주소 통합 방지](product-docs/marketo-sales-connect/email-plugins/gmail/preventing-secondary-gmail-address-from-integrating-with-sales-connect.md)
            + [Gmail로 표시되지 않는 Sales Connect 플러그인](product-docs/marketo-sales-connect/email-plugins/gmail/sales-connect-plugin-not-showing-up-in-gmail.md)
         ...
         + Outlook용 MSC {#msc-for-outlook}
            + [Outlook 사용자를 위한 이메일 연결 탭](product-docs/marketo-sales-connect/email-plugins/msc-for-outlook/email-connection-tab-for-outlook-users.md)
            + .NET 기존 Add-in {#net-legacy-add-in}
      ...
      + 이메일 {#email}
         ...
         + 일반적인 추적 질문 {#common-tracking-questions}
            ...
            + [사용자 지정 도메인 추적을 설정하는 방법](product-docs/marketo-sales-connect/email/common-tracking-questions/how-to-set-up-custom-domain-tracking.md)
            + [이메일 첨부 파일 추적 방법](product-docs/marketo-sales-connect/email/common-tracking-questions/how-to-track-your-email-attachments.md)
            ...
            + [본 것으로 표시되지 않는 테스트 이메일](product-docs/marketo-sales-connect/email/common-tracking-questions/test-email-not-showed-as-viewed.md)
         + 이메일 배달 {#email-delivery}
            + [전달 채널 개요](product-docs/marketo-sales-connect/email/email-delivery/delivery-channel-overview.md)
            + [Sales Connect를 사용하여 Outlook365 SMTP 서버를 설정하는 방법](product-docs/marketo-sales-connect/email/email-delivery/how-to-set-up-your-outlook365-smtp-server-with-sales-connect.md)
         ...
         + 세일즈 이메일 보내기 {#send-a-sales-email}
            ...
            + [이메일 예약 방법](product-docs/marketo-sales-connect/email/send-a-sales-email/how-to-schedule-an-email.md)
            + [그룹 이메일을 보내는 방법](product-docs/marketo-sales-connect/email/send-a-sales-email/how-to-send-a-group-email.md)
            + [세일즈 참여에서 이메일을 보내는 방법](product-docs/marketo-sales-connect/email/send-a-sales-email/how-to-send-an-email-from-sales-engage.md)
         ...
         + 구독 취소 {#unsubscribes}
            ...
            + [구독 취소 재가입](product-docs/marketo-sales-connect/email/unsubscribes/resubscribing-an-unsubscribe.md)
            + [Salesforce와 가입 취소 동기화](product-docs/marketo-sales-connect/email/unsubscribes/syncing-unsubscribes-with-salesforce.md)
            + [가입 해지 그룹](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-group.md)
         ...
         + 작성 창 사용 {#using-the-compose-window}
            ...
            + [선택 및 전송을 사용하여 일괄 이메일 구성](product-docs/marketo-sales-connect/email/using-the-compose-window/composing-bulk-emails-with-select-and-send.md)
      ...
      + FAQ {#faq}
         ...
         + [내 서버에서 허용 목록에 추가하다 Sales Connect를할 수 있습니까?](product-docs/marketo-sales-connect/faq/how-can-i-allowlist-sales-connect-on-my-server.md)
         + [내 계좌에서 잠겼어요. 어떻게 해야 합니까?](product-docs/marketo-sales-connect/faq/i-got-locked-out-of-my-account-what-do-i-do.md)
         ...
         + [최신 클라이언트 버전이란?](product-docs/marketo-sales-connect/faq/what-are-the-latest-client-versions.md)
         + [Sales Connect 서비스 약관이란?](product-docs/marketo-sales-connect/faq/what-are-the-sales-connect-terms-of-service.md)
      ...
      + 통합 {#integrations}
         + [이메일을 다른 CRM에 기록하는 방법.](product-docs/marketo-sales-connect/integrations/how-to-log-emails-to-other-crms.md)
      + Marketing {#marketo}
      ...
      + 사람 {#people}
         ...
         + 연락처 관리 {#managing-contacts}
            ...
            + [마케팅 리드와 세일즈 연결 리드](product-docs/marketo-sales-connect/people/managing-contacts/connect-your-marketo-leads-with-sales-connect-leads.md)
            ...
            + [자동 구독의 서식을 지정하는 방법](product-docs/marketo-sales-connect/people/managing-contacts/how-to-format-auto-unsubscribes.md)
      ...
      + 전화 {#phone}
         + [Salesforce에 로그인이 아닌 호출](product-docs/marketo-sales-connect/phone/calls-arent-logging-to-salesforce.md)
         + [활동 기록에 로그인하지 않았습니다.](product-docs/marketo-sales-connect/phone/didnt-log-to-activity-history.md)
         + [Salesforce에 로그인 안 됨](product-docs/marketo-sales-connect/phone/didnt-log-to-salesforce.md)
         ...
         + [세일즈 폰에서 통화 결과를 사용자 지정하는 방법](product-docs/marketo-sales-connect/phone/how-to-customize-the-call-outcome-in-sales-phone.md)
         + [Sales Phone International Call](product-docs/marketo-sales-connect/phone/sales-phone-international-calling.md)
      ...
      + 템플릿 {#templates}
         ...
         + 동적 필드 {#dynamic-fields}
            ...
            + [동적 필드 삽입 방법](product-docs/marketo-sales-connect/templates/dynamic-fields/how-to-insert-dynamic-fields.md)
            + [내 동적 필드가 채워지지 않음](product-docs/marketo-sales-connect/templates/dynamic-fields/my-dynamic-fields-arent-filling-out.md)
            + [동적 필드에서 자신을 참조하기](product-docs/marketo-sales-connect/templates/dynamic-fields/reference-yourself-in-a-dynamic-field.md)
   + Marketing To Sales Insight {#marketo-sales-insight}
      ...
      + Microsoft Dynamics용 MSI {#msi-for-microsoft-dynamics}
         ...
         + 제거 {#uninstalling}
            + [전역 MS Dynamics 동기화 비활성화](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/uninstalling/disable-global-ms-dynamics-sync.md)
      ...
      + Salesforce용 MSI {#msi-for-salesforce}
         ...
         + 기능 {#features}
            ...
            + 일괄 작업 {#bulk-actions}
               ...
               + [Marketing to Sales Insight의 여러 레코드로 이메일 전송](product-docs/marketo-sales-insight/msi-for-salesforce/features/bulk-actions/send-an-email-to-multiple-records-in-marketo-sales-insight.md)
            ...
            + 언어 지원 {#language-support}
               + [Salesforce의 다양한 언어 지원을 위한 세일즈 인사이트 준비](product-docs/marketo-sales-insight/msi-for-salesforce/features/language-support/prepare-sales-insight-for-multi-lingual-support-in-salesforce.md)
            + 마케팅 탭 {#marketo-tab}
            ...
            + MSI 구성 탭 {#msi-configuration-tab}
               + [Sales Insight용 RSS 사용](product-docs/marketo-sales-insight/msi-for-salesforce/features/msi-configuration-tab/enable-rss-for-sales-insight.md)
            ...
            + 별과 불꽃 {#stars-and-flames}
               ...
               + [Sales Insight의 스타 및 화염에 사용할 점수 필드 설정](product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/set-score-fields-to-be-used-for-stars-and-flames-in-sales-insight.md)
            + MSI 패널의 탭 {#tabs-in-the-msi-panel}
               + 흥미로운 순간 {#interesting-moments}
                  + [관심 영역 개요](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/interesting-moments-overview.md)
                  + [흥미로운 순간을 위한 토큰](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/tokens-for-interesting-moments.md)
                  + [흥미로운 순간 사용](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/using-interesting-moments.md)
         + 모바일용 MSI {#msi-for-mobile}
            + [Salesforce의 최고의 솔루션1](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/best-bets-in-salesforce1.md)
            ...
            + [Salesforce1에서 Marketing To 이메일 및 캠페인 및 Watchlist 동작 보내기](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/send-marketo-email-and-campaign-and-watchlist-actions-in-salesforce1.md)
         + 업그레이드 {#upgrading}
      ...
      + MSI Outlook 플러그인 {#msi-outlook-plugin}
         ...
         + [등록 코드가 있는 Outlook용 Marketing To Email 추가 기능 설치](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
         ...
         + [Outlook용 Marketing To Email 추가 기능 업그레이드](product-docs/marketo-sales-insight/msi-outlook-plugin/upgrade-your-marketo-email-add-in-for-outlook.md)
      + [네이티브 Salesforce 통합을 위한 세일즈 인사이트](product-docs/marketo-sales-insight/sales-insight-for-non-native-salesforce-integrations.md)
   + Marketo Sky {#marketo-sky}
      + [Marketo Sky에 역할 활성화](product-docs/marketo-sky/enabling-roles-for-marketo-sky.md)
   + 모바일 마케팅 {#mobile-marketing}
      + 관리 {#admin}
         ...
         + [푸시 알림 및 인앱 메시지를 만들기 전](product-docs/mobile-marketing/admin/before-you-create-push-notifications-and-in-app-messages.md)
      ...
      + Vibes SMS 메시지 {#vibes-sms-messages}
         ...
         + [스마트 목록 트리거 및 필터에서 Vibes SMS 메시지 사용](product-docs/mobile-marketing/vibes-sms-messages/use-vibes-sms-messages-in-smart-list-triggers-and-filters.md)
   + 개인화 {#personalization}
      + 세그멘테이션 및 조각 {#segmentation-and-snippets}
         + 세분화 {#segmentation}
         ...
         + 코드 조각 {#snippets}
            + [코드 조각에 컨텐츠 추가](product-docs/personalization/segmentation-and-snippets/snippets/add-content-to-a-snippet.md)
   ...
   + 예측 컨텐츠 {#predictive-content}
      ...
      + 모든 컨텐츠 작업 {#working-with-all-content}
         ...
         + [예측 컨텐츠에 대한 제목 승인](product-docs/predictive-content/working-with-all-content/approve-a-title-for-predictive-content.md)
         + [콘텐트 삭제](product-docs/predictive-content/working-with-all-content/delete-content.md)
         + [컨텐츠 편집](product-docs/predictive-content/working-with-all-content/edit-content.md)
         + [예측 컨텐츠에 대한 제목 승인 취소](product-docs/predictive-content/working-with-all-content/unapprove-a-title-for-predictive-content.md)
      ...
      + 예측 컨텐츠 사용 {#working-with-predictive-content}
   ...
   + 보고 {#reporting}
      + 기본 보고 {#basic-reporting}
         ...
         + 보고서 활동 {#report-activity}
            + [모바일 플랫폼 열을 사용하여 사용자 성능 보고서 작성](product-docs/reporting/basic-reporting/report-activity/build-a-people-performance-report-with-mobile-platform-columns.md)
            + [보고서 이메일의 URL에 대한 만료 시간 변경](product-docs/reporting/basic-reporting/report-activity/change-the-expiration-time-for-urls-in-report-emails.md)
            ...
            + [사람 성과 보고서에서 드릴다운합니다.](product-docs/reporting/basic-reporting/report-activity/drill-down-in-a-people-performance-report.md)
         ...
         + 보고서 구독 {#report-subscriptions}
            ...
            + [구독 관리 설정 보호](product-docs/reporting/basic-reporting/report-subscriptions/secure-the-subscription-admin-setting.md)
      ...
      + 이메일 인사이트 {#email-insights}
         ...
         + [이메일 인사이트를 위한 맞춤형 Dimension](product-docs/reporting/email-insights/custom-dimensions-for-email-insights.md)
         ...
         + [이메일 인사이트를 통한 개요](product-docs/reporting/email-insights/email-insights-sends-overview.md)
      ...
      + 성과 통찰력 {#performance-insights}
         ...
         + [성과 인사이트의 필터링](product-docs/reporting/performance-insights/filtering-in-performance-insights.md)
      ...
      + 매출 주기 분석 {#revenue-cycle-analytics}
         ...
         + 수익 주기 모델 {#revenue-cycle-models}
            ...
            + [단계 승인 및 리드 할당 결과 매출 모델](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/approving-stages-and-assigning-leads-to-a-revenue-model.md)
            ...
            + [모델 성능 분석에 대한 사용자 지정 필드 그룹 활성화(리드)](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/enable-custom-field-groups-for-model-performance-analysis-leads.md)
            ...
            + [매출 모델러의 두 단계 병합](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/merging-two-stages-in-the-revenue-modeler.md)
            + [매출 모델 보고서](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/report-on-your-revenue-model.md)
         ...
         + 매출 탐색기 {#revenue-explorer}
            ...
            + [매출 탐색기에서 결과 그래프 작성](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/graphing-results-from-revenue-explorer.md)
   ...
   + 웹 개인화 {#web-personalization}
      ...
      + RTP 태그 구현 {#rtp-tag-implementation}
         ...
         + [Teum Tag Manager를 사용하여 RTP 구현](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-using-tealium-tag-manager.md)
      + 웹 개인화 보고 {#reporting-for-web-personalization}
         ...
         + 웹 분석 통합 {#web-analytics-integrations}
            ...
            + [Google Universal Analytics와 RTP 통합](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-universal-analytics.md)
      ...
      + 웹 세그먼트 사용 {#using-web-segments}
         ...
         + [알려진 사람 데이터를 사용하여 세그먼트 만들기](product-docs/web-personalization/using-web-segments/create-a-segment-using-known-person-data.md)
      ...
      + 웹 사이트 리타겟팅 {#website-retargeting}
...
+ 릴리스 노트 {#release-notes}
   ...
   + 2020 {#2020}
      + [릴리스 노트:2020년 2월](release-notes/2020/release-notes-feb-20.md)
      + [릴리스 노트:2010년 1월](release-notes/2020/release-notes-jan-20.md)
      + [릴리스 노트:2020년 7월](release-notes/2020/release-notes-july-20.md)
      + [릴리스 노트:2020년 6월](release-notes/2020/release-notes-june-20.md)
   + 2019 {#2019}
      + [릴리스 노트:1908년 8월](release-notes/2019/release-notes-august-19.md)
      + [릴리스 노트:19년 6월](release-notes/2019/release-notes-june-19.md)
   ...
   + 2017 {#2017}
      + [릴리스 노트:2017년 4월 ABM 개선 사항](release-notes/2017/release-notes-april-17-abm-enhancements.md)
      + [릴리스 노트:2017년 8월 ABM 개선 사항](release-notes/2017/release-notes-august-17-abm-enhancements.md)
   ...
   + 2012 {#2012}
      ...
      + [릴리스 노트:2012년 1월](release-notes/2012/release-notes-jan-feb-2012.md)
