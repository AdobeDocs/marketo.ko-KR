...
+ Marketo 시작하기 {#getting-started-with-marketo}
   ...
   + 빠른 승리 {#quick-wins}
      ...
      + [단순 점수 책정](getting-started/quick-wins/simple-scoring.md)
      ...
      + [드립, 드립, 배양](getting-started/quick-wins/drip-drip-nurture.md)
...
+ 제품 문서 {#product-docs}
   ...
   + 추가 앱 {#additional-apps}
      + SEO {#seo}
         + SEO {#understanding-seo} 이해
            ...
            + [SEO - 경쟁 제품 추가](product-docs/additional-apps/seo/understanding-seo/seo-add-competitors.md)
            ...
            + [SEO - 이메일 경고 환경 설정 지정](product-docs/additional-apps/seo/understanding-seo/seo-set-your-email-alert-preferences.md)
         + 키워드 {#keywords}
            ...
            + [SEO - 타깃팅된 키워드로 특정 페이지 최적화](product-docs/additional-apps/seo/keywords/seo-optimize-specific-pages-with-targeted-keywords.md)
   ...
   + 관리 {#administration}
      ...
      + 전자 메일 설정 {#email-setup}
         + 여러 브랜딩 도메인 추가 {#add-multiple-branding-domains}
            + [작업 공간을 사용하여 추가 브랜딩 도메인 추가](product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain-with-workspaces.md)
            ...
            + [작업 공간에서 기본 브랜딩 도메인 편집](product-docs/administration/email-setup/add-multiple-branding-domains/edit-your-default-branding-domain-with-workspaces.md)
            + [기본 브랜딩 도메인 편집](product-docs/administration/email-setup/add-multiple-branding-domains/edit-your-default-branding-domain.md)
            + [이메일에 대한 주 도메인 덮어쓰기](product-docs/administration/email-setup/add-multiple-branding-domains/overwrite-primary-domain-for-emails.md)
         + [속도 스크립팅에서 사용자 지정 개체 검색 제한 변경](product-docs/administration/email-setup/change-custom-object-retrieval-limits-in-velocity-scripting.md)
         ...
         + [언어를 위해 구독 취소 메시지를 동적으로 만들기](product-docs/administration/email-setup/edit-the-unsubscribe-message/make-your-unsubscribe-message-dynamic-for-languages.md)
         ...
         + [전자 메일 보트 활동 필터링](product-docs/administration/email-setup/filtering-email-bot-activity.md)
      ...
      + 필드 관리 {#field-management}
         + [신뢰할 수 없는 원본에서 목록을 가져오는 동안 차단 필드 업데이트](product-docs/administration/field-management/block-field-updates-during-list-import-from-untrusted-sources.md)
         + [필드 업데이트 차단](product-docs/administration/field-management/block-updates-to-a-field.md)
         + [Marketo 사용자 지정 필드의 유형 변경](product-docs/administration/field-management/change-the-type-of-a-marketo-custom-field.md)
         + [Marketo에서 사용자 지정 필드 만들기](product-docs/administration/field-management/create-a-custom-field-in-marketo.md)
         ...
         + [Marketo에서 사용자 지정 필드 삭제](product-docs/administration/field-management/delete-a-custom-field-in-marketo.md)
      ...
      + 설정 {#settings}
         ...
         + [개인 세부 정보 페이지에 대한 사용자 지정 탭 생성](product-docs/administration/settings/creating-a-custom-tab-for-the-person-detail-page.md)
         + [CNAME(관리)을 사용하여 랜딩 페이지 URL을 사용자 지정합니다](product-docs/administration/settings/customize-your-landing-page-urls-with-a-cname-administration.md)
         ...
         + [구독에 대한 기본 위치 설정 설정](product-docs/administration/settings/set-default-location-settings-for-a-subscription.md)
      ...
      + 사용자 및 역할 {#users-and-roles}
         ...
         + [역할에 대한 고급 목록 가져오기 사용 권한 활성화](product-docs/administration/users-and-roles/enable-the-advanced-list-import-permission-on-a-role.md)
         ...
         + [코드 조각에 초안 없음 사용](product-docs/administration/users-and-roles/managing-user-roles-and-permissions/enable-no-draft-for-snippets.md)
      + 작업 공간 및 개인 파티션 {#workspaces-and-person-partitions}
         ...
         + [작업 공간에 개인 파티션 할당](product-docs/administration/workspaces-and-person-partitions/assign-person-partitions-to-workspaces.md)
         + [할당 규칙을 사용하여 개인 분할 영역 지정](product-docs/administration/workspaces-and-person-partitions/assigning-person-partitions-with-assignment-rules.md)
   ...
   + 코어 Marketo 개념 {#core-marketo-concepts}
      + 스마트 캠페인 {#smart-campaigns}
         ...
         + 스마트 캠페인 만들기 {#creating-a-smart-campaign}
            ...
            + [Smart Campaign 체크리스트](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.md)
         + 스마트 캠페인 사용 {#using-smart-campaigns}
            ...
            + [&quot;Campaign is Requested&quot;를 사용하여 영업을 위한 Smart Campaign 트리거 설정](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/setting-up-a-trigger-smart-campaign-for-sales-using-campaign-is-requested.md)
         ...
         + 흐름 작업 {#flow-actions}
            ...
            + [스마트 캠페인에서 흐름 단계 순서 조정](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/add-a-flow-step-to-a-smart-campaign/reorder-the-flow-steps-in-a-smart-campaign.md)
         ...
         + Microsoft Dynamics 흐름 작업 {#microsoft-dynamics-flow-actions}
            ...
            + [Microsoft에 개인 동기화](product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md)
         + Salesforce 흐름 작업 {#salesforce-flow-actions}
            + [SFDC Campaign에 추가](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/add-to-sfdc-campaign.md)
            ...
            + [SFDC에서 개인 삭제](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/delete-person-from-sfdc.md)
            + [SFDC Campaign에서 제거](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/remove-from-sfdc-campaign.md)
      ...
      + 스마트 목록 및 정적 목록 {#smart-lists-and-static-lists}
         ...
         + 스마트 목록 사용 {#using-smart-lists}
            ...
            + [작업 공간에서 목록 또는 스마트 목록 참조](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/reference-a-list-or-smart-list-across-workspaces.md)
            ...
            + [스마트 목록에서 변경된 데이터 값 필터 사용](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/use-the-data-value-changed-filter-in-a-smart-list.md)
         ...
         + 스마트 목록의 사람 관리 {#managing-people-in-smart-lists}
            + [에 차단 목록에 추가하다 개인 추가](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/add-person-to-blocklist.md)
            + [수동으로 개인 생성](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/create-a-person-manually.md)
            ...
            + [중복 사람 찾기 및 병합](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-and-merge-duplicate-people.md)
            + [사용자 지정 논리를 사용하여 중복 사람 찾기](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-duplicate-people-with-custom-logic.md)
      ...
      + 프로그램 {#programs}
         ...
         + 프로그램 작업 {#working-with-programs}
            + [우수 사례: 프로그램 구성 방법](product-docs/core-marketo-concepts/programs/working-with-programs/best-practice-how-to-organize-your-programs.md)
         ...
         + 프로그램 예약 보기 {#program-schedule-view}
            + [사용자 지정 시작 유형 만들기](product-docs/core-marketo-concepts/programs/program-schedule-view/create-custom-entry-types.md)
            + [프로그램 예약 보기에서 배치 스마트 캠페인 만들기](product-docs/core-marketo-concepts/programs/program-schedule-view/creating-a-batch-smart-campaign-in-the-program-schedule-view.md)
            ...
            + [프로그램 스케줄 뷰에서 항목 편집](product-docs/core-marketo-concepts/programs/program-schedule-view/editing-entries-in-the-program-schedule-view.md)
            ...
            + [프로그램 예약 보기에서 Smart Campaign 재실행](product-docs/core-marketo-concepts/programs/program-schedule-view/rerun-a-smart-campaign-in-the-program-schedule-view.md)
            + [프로그램 스케줄 보기에서 배치 Smart Campaign의 스케줄 조정](product-docs/core-marketo-concepts/programs/program-schedule-view/reschedule-a-batch-smart-campaign-in-the-program-schedule-view.md)
            ...
            + [미정/확정 날짜 이해](product-docs/core-marketo-concepts/programs/program-schedule-view/understanding-tentative-confirmed-dates.md)
         ...
         + 토큰 {#tokens}
            ...
            + [프로그램 구성원 사용자 지정 필드 토큰](product-docs/core-marketo-concepts/programs/tokens/program-member-custom-field-tokens.md)
      + 마케팅 달력 {#marketing-calendar}
         + 달력 {#understanding-the-calendar} 이해
            ...
            + [시작 세부 정보 보기](product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/view-entry-details.md)
         + 달력 작업 {#working-with-the-calendar}
            ...
            + [Workspace별 마케팅 달력 필터링](product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/filtering-the-marketing-calendar-by-workspace.md)
            ...
            + [마케팅 달력에 필터 정의 저장](product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/saving-a-filter-definition-in-the-marketing-calendar.md)
      ...
      + 모바일 앱 {#mobile-apps}
         + 이벤트 체크인 {#event-check-in}
            ...
            + [태블릿에서 사용자 이벤트 확인](product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md)
         ...
         + Marketo 모멘트 {#marketo-moments}
            ...
            + {#working-with-moments} 모멘트를 사용한 작업
               + [즐겨찾기 만들기](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/creating-a-favorite.md)
               + [Marketo 모멘츠 다운로드](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/downloading-marketo-moments.md)
   ...
   + CRM 동기화 {#crm-sync}
      + Microsoft Dynamics 동기화 {#microsoft-dynamics}
         ...
         + Microsoft Dynamics 동기화 세부 정보 {#microsoft-dynamics-sync-details}
            ...
            + [Microsoft Dynamics 동기화: 사용자 지정 엔터티 동기화](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/microsoft-dynamics-sync-custom-entity-sync.md)
         ...
         + 사용자 지정 Dynamics 동기화 필터 세부 정보 {#custom-dynmaics-sync-filter-details}
            ...
            + [Microsoft Dynamics 동기화 필터: 자격 부여](product-docs/crm-sync/microsoft-dynamics-sync/create-a-custom-dynamics-sync-filter/microsoft-dynamics-sync-filter-qualify.md)
      ...
      + Salesforce 동기화 {#salesforce-sync}
         ...
         + SFDC 동기화 세부 정보 {#sfdc-sync-details}
            ...
            + [동기화 전에 프로그램 상태 및 Salesforce 캠페인 상태를 일치시키는 방법](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md)
   ...
   + 수요 생성 {#demand-generation}
      ...
      + Facebook {#facebook}
         ...
         + [Marketo과 데스크탑 통합을 위해 Facebook 리드 광고 테스트](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-desktop-integration-with-marketo.md)
         + [Marketo과 모바일 통합을 위해 Facebook 리드 광고 테스트](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-mobile-integration-with-marketo.md)
         + [facebook 오프라인 전환 이해](product-docs/demand-generation/facebook/understanding-facebook-offline-conversions.md)
         + [Smart Campaign에서 리드 광고 필터 및 트리거 사용](product-docs/demand-generation/facebook/use-lead-ads-filters-and-triggers-in-a-smart-campaign.md)
      + Forms {#forms}
         + 양식 만들기 {#creating-a-form}
            ...
            + [필요한 양식 필드 만들기](product-docs/demand-generation/forms/creating-a-form/make-a-form-field-required.md)
         ...
         + 양식 작업 {#form-actions}
            ...
            + [알려진 사용자에 대한 사용자 지정 HTML 양식 표시](product-docs/demand-generation/forms/form-actions/show-custom-html-form-for-known-people.md)
         ...
         + 양식 디자인 {#form-design}
            ...
            + [양식 글꼴 패밀리 변경](product-docs/demand-generation/forms/form-design/change-the-form-font-family.md)
         ...
         + 양식 필드 {#form-fields}
            + [FieldSet을 양식에 추가](product-docs/demand-generation/forms/form-fields/add-a-fieldset-to-a-form.md)
            + [양식 필드에 힌트 텍스트 추가](product-docs/demand-generation/forms/form-fields/add-hint-text-to-a-form-field.md)
            + [양식 필드에 도구 설명 지침 추가](product-docs/demand-generation/forms/form-fields/add-tooltip-instructions-to-a-form-field.md)
            ...
            + [양식 필드의 표시 여부를 동적으로 전환](product-docs/demand-generation/forms/form-fields/dynamically-toggle-visibility-of-a-form-field.md)
            + [양식에서 필드 순서 조정](product-docs/demand-generation/forms/form-fields/reorder-fields-in-a-form.md)
      ...
      + 랜딩 페이지 {#landing-pages}
         + 랜딩 페이지 이해 {#understanding-landing-pages}
            + [랜딩 페이지 승인, 비승인 또는 삭제](product-docs/demand-generation/landing-pages/understanding-landing-pages/approve-unapprove-or-delete-a-landing-page.md)
            ...
            + [무형식 페이지와 안내가 있는 랜딩 페이지 이해](product-docs/demand-generation/landing-pages/understanding-landing-pages/understanding-free-form-vs-guided-landing-pages.md)
         + 자유 형식 랜딩 페이지 {#free-form-landing-pages}
            + [무형식 랜딩 페이지 이미지에 링크 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-a-free-form-landing-page-image.md)
            + [무형식 랜딩 페이지에서 이미지에 대한 링크 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-an-image-in-a-free-form-landing-page.md)
            + [무형식 랜딩 페이지에 대한 모바일 보기 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-mobile-view-for-your-free-form-landing-page.md)
            + [무형식 랜딩 페이지에 새 양식 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-new-form-to-a-free-form-landing-page.md)
            + [무형식 랜딩 페이지에 소셜 단추 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-social-button-to-a-free-form-landing-page.md)
            + [무형식 랜딩 페이지에 비디오 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-video-to-a-free-form-landing-page.md)
            + [무형식 랜딩 페이지에 이미지 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-an-image-to-a-free-form-landing-page.md)
            + [무형식 랜딩 페이지에 사각형 추가](product-docs/demand-generation/landing-pages/free-form-landing-pages/adding-a-rectangle-to-a-free-form-landing-page.md)
            ...
            + [무형식 랜딩 페이지 만들기](product-docs/demand-generation/landing-pages/free-form-landing-pages/create-a-free-form-landing-page.md)
         ...
         + 안내 랜딩 페이지 {#guided-landing-pages}
            + [안내식 랜딩 페이지에 양식 추가](product-docs/demand-generation/landing-pages/guided-landing-pages/add-a-form-to-a-guided-landing-page.md)
            + [안내가 있는 랜딩 페이지에 이미지 추가](product-docs/demand-generation/landing-pages/guided-landing-pages/add-an-image-to-a-guided-landing-page.md)
         ...
         + 랜딩 페이지 작업 {#landing-page-actions}
            ...
            + [CNAME을 사용하여 랜딩 페이지 URL 사용자 지정](product-docs/demand-generation/landing-pages/landing-page-actions/customize-your-landing-page-urls-with-a-cname.md)
            ...
            + [다이내믹 콘텐츠를 사용한 랜딩 페이지 미리 보기](product-docs/demand-generation/landing-pages/landing-page-actions/preview-a-landing-page-with-dynamic-content.md)
         ...
         + 랜딩 페이지 템플릿 {#landing-page-templates}
            + [무형식 랜딩 페이지 템플릿 만들기](product-docs/demand-generation/landing-pages/landing-page-templates/create-a-free-form-landing-page-template.md)
            ...
            + [기존 자유 형식 랜딩 페이지 템플릿 모바일 호환 만들기](product-docs/demand-generation/landing-pages/landing-page-templates/make-an-existing-free-form-landing-page-template-mobile-compatible.md)
            + [안내가 있는 템플릿의 요소 및 변수 이해](product-docs/demand-generation/landing-pages/landing-page-templates/understanding-elements-and-variables-in-guided-templates.md)
         ...
         + 랜딩 페이지 개인화 {#personalizing-landing-pages}
            ...
            + [개인화된 URL로 목록 내보내기](product-docs/demand-generation/landing-pages/personalizing-landing-pages/export-a-list-with-personalized-urls.md)
      ...
      + 소셜 {#social}
         + 소셜 작업 구성 {#configuring-social-actions}
            ...
            + [이메일 다시 공유 구성 및 소셜 앱에 대한 프롬프트](product-docs/demand-generation/social/configuring-social-actions/configure-re-share-email-and-prompt-for-a-social-app.md)
            ...
            + [소셜 단추가 열릴 때 구성](product-docs/demand-generation/social/configuring-social-actions/configure-when-social-button-opens.md)
            + [소셜 앱 사용자 지정 단추](product-docs/demand-generation/social/configuring-social-actions/customize-social-app-button.md)
            + [비디오 공유 흐름 사용자 지정](product-docs/demand-generation/social/configuring-social-actions/customize-video-share-flow.md)
            + [디지털 광고 캠페인에 대한 매출 기여도 분석 설정](product-docs/demand-generation/social/configuring-social-actions/set-up-revenue-attribution-for-digital-advertising-campaigns.md)
         + 폴링 {#creating-a-poll} 만들기
            + [투표 만들기](product-docs/demand-generation/social/creating-a-poll/create-a-poll.md)
            + [폴링 설정 사용자 지정](product-docs/demand-generation/social/creating-a-poll/customize-poll-settings.md)
         ...
         + 참조 오퍼 {#referral-offers}
            ...
            + [추천 오퍼 이행 전자 메일 보내기](product-docs/demand-generation/social/referral-offers/send-referral-offer-fulfillment-email.md)
         ...
         + 소셜 함수 {#social-functions}
            ...
            + [오퍼 이행에 프로모션 코드 사용](product-docs/demand-generation/social/social-functions/use-promo-codes-for-offer-fulfillment.md)
         ...
         + 경품 추첨 {#sweepstakes}
            ...
            + [경품 스타일 사용자 지정](product-docs/demand-generation/social/sweepstakes/customize-sweepstakes-styles.md)
            + [경품 게시](product-docs/demand-generation/social/sweepstakes/publish-a-sweepstakes.md)
            + [경품 승자 선택](product-docs/demand-generation/social/sweepstakes/select-sweepstakes-winners.md)
   + 이메일 마케팅 {#email-marketing}
      + 게재 가능성 {#deliverability}
         + [내구성 구독 취소](product-docs/email-marketing/deliverability/durable-unsubscribe.md)
         + [전자 메일 게재 기능 팩: 시드 목록을 가져오는 방법](product-docs/email-marketing/deliverability/email-deliverability-power-pack-how-to-import-a-seedlist.md)
      ...
      + 점적 학습 {#drip-nurturing}
         ...
         + 참여 프로그램 스트림 {#engagement-program-streams}
            ...
            + [스트림 간격 설정](product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence.md)
         ...
         + 참여 프로그램 사용 {#using-engagement-programs}
            ...
            + [참여 프로그램에서 사람 일시 정지](product-docs/email-marketing/drip-nurturing/using-engagement-programs/pause-people-in-an-engagement-program.md)
            + [콘텐츠가 모두 소진된 사람](product-docs/email-marketing/drip-nurturing/using-engagement-programs/people-who-have-exhausted-content.md)
            ...
            + [참여 프로그램 멤버 를 참조하십시오](product-docs/email-marketing/drip-nurturing/using-engagement-programs/see-members-of-an-engagement-program.md)
      ...
      + 전자 메일 프로그램 {#email-programs}
         ...
         + 전자 메일 프로그램 작업 {#email-program-actions}
            ...
            + 받는 사람 시간대 {#scheduling-with-recipient-time-zone} 를 사용하여 예약
         ...
         + 전자 메일 프로그램 데이터 {#email-program-data}
            + [이메일 링크 성과 보고서](product-docs/email-marketing/email-programs/email-program-data/email-link-performance-report.md)
            + [전자 메일 성과 보고서](product-docs/email-marketing/email-programs/email-program-data/email-performance-report.md)
         ...
         + 이메일 프로그램의 사람 관리 {#managing-people-in-email-programs}
      ...
      + 일반 {#general}
         ...
         + 이메일 편집기 2 {#email-editor-2}
            ...
            + [전자 메일 템플릿 선택기 개요](product-docs/email-marketing/general/email-editor-2/email-template-picker-overview.md)
         ...
         + 편집기의 함수 {#functions-in-the-editor}
            ...
            + [이메일 운영](product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)
            + [다이내믹 콘텐츠를 사용한 이메일 미리 보기](product-docs/email-marketing/general/functions-in-the-editor/preview-an-email-with-dynamic-content.md)
            ...
            + [전자 메일에 코드 조각 추가](product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email.md)
   ...
   + Marketo Sales Connect {#marketo-sales-connect}
      ...
      + CRM {#crm}
         + Salesforce 사용자 지정 {#salesforce-customization}
            ...
            + [Salesforce 샌드박스에 판매 연결 방법](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-connect-sales-connect-to-your-salesforce-sandbox.md)
            + [Salesforce 샌드박스에 사용자 지정 기능을 설치하는 방법](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-install-customizations-in-your-salesforce-sandbox.md)
            + [Salesforce에서 영업 연결 단추를 설치하는 방법](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-install-sales-connect-buttons-in-salesforce.md)
            ...
            + [Activity History에 Sales Connect 이벤트 필드 설치](product-docs/marketo-sales-connect/crm/salesforce-customization/install-sales-connect-event-fields-on-activity-history.md)
            ...
            + [Salesforce에서 대시보드 보고](product-docs/marketo-sales-connect/crm/salesforce-customization/reporting-dashboards-in-salesforce.md)
      ...
      + 이메일 플러그인 {#email-plugins}
         + Gmail {#gmail}
            ...
            + [ToutApp 브라우저 확장 설치 방법](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-install-the-toutapp-browser-extension.md)
            + [Gmail에서 이메일을 보내는 방법](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-send-an-email-from-gmail.md)
            + [Gmail에서 Sales Connect 제거 방법](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-uninstall-sales-connect-from-gmail.md)
            ...
            + [나중 날짜로 이메일 예약](product-docs/marketo-sales-connect/email-plugins/gmail/schedule-an-email-for-a-later-date.md)
            + [Sales Connect 도구 모음](product-docs/marketo-sales-connect/email-plugins/gmail/the-sales-connect-tool-bar.md)
            + [Gmail에 예기치 않은 오류가 있습니다.](product-docs/marketo-sales-connect/email-plugins/gmail/unexpected-error-in-gmail.md)
         + Outlook용 MSC {#msc-for-outlook}
            ...
            + .NET 기존 추가 기능 {#net-legacy-add-in}
               ...
               + [Outlook에서 Sales Connect 제거 방법](product-docs/marketo-sales-connect/email-plugins/msc-for-outlook/net-legacy-add-in/how-to-uninstall-sales-connect-from-outlook.md)
            + Office 365 추가 기능 {#office-365-add-in}
               + [Salesforce에 전자 메일 추가(Office 365)](product-docs/marketo-sales-connect/email-plugins/msc-for-outlook/office-365-add-in/add-email-to-salesforce-office-365.md)
      ...
      + 이메일 {#email}
         + 명령 센터 {#command-center}
            ...
            + [팀 구성원에게 작업 할당](product-docs/marketo-sales-connect/email/command-center/assigning-tasks-to-team-members.md)
            + [이메일 열 및 이메일 페이지 레이아웃](product-docs/marketo-sales-connect/email/command-center/email-columns-and-email-page-layout.md)
            + [빠른 작업을 사용하여 워크플로우 속도 향상](product-docs/marketo-sales-connect/email/command-center/using-quick-actions-to-speed-up-your-workflow.md)
         + 일반적인 추적 질문 {#common-tracking-questions}
            ...
            + [전자 메일 첨부 파일을 추적하는 방법](product-docs/marketo-sales-connect/email/common-tracking-questions/how-to-track-your-email-attachments.md)
            ...
            + [표시된 대로 표시되지 않은 테스트 이메일](product-docs/marketo-sales-connect/email/common-tracking-questions/test-email-not-showed-as-viewed.md)
         + 전자 메일 게재 {#email-delivery}
         ...
         + {#unsubscribes} 가입 해지 취소
            ...
            + [Salesforce와 가입 해지 동기화](product-docs/marketo-sales-connect/email/unsubscribes/syncing-unsubscribes-with-salesforce.md)
            + [그룹 가입 해지](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-group.md)
            + [기록 카드 가입 해지](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-history-card.md)
            + [링크 랜딩 페이지 구독 취소](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-link-landing-page.md)
         ...
         + 작성 창 사용 {#using-the-compose-window}
            ...
            + [이메일에 강조 표시된 컨텐츠 추가](product-docs/marketo-sales-connect/email/using-the-compose-window/adding-highspot-content-to-your-email.md)
      ...
      + FAQ {#faq}
         ...
         + [내 서버에서 Sales Connect를 허용 목록에 추가하다 세그먼트화하려면 어떻게 해야 합니까?](product-docs/marketo-sales-connect/faq/how-can-i-allowlist-sales-connect-on-my-server.md)
         + [내 계좌에서 잠겨버렸다. 어떻게 해야 합니까?](product-docs/marketo-sales-connect/faq/i-got-locked-out-of-my-account-what-do-i-do.md)
         ...
         + [내 연락처가 Sales Connect에 푸시되지 않는 이유는 무엇입니까?](product-docs/marketo-sales-connect/faq/why-arent-any-of-my-contacts-getting-pushed-to-sales-connect.md)
         + [연락처를 삭제할 수 없는 이유](product-docs/marketo-sales-connect/faq/why-cant-i-delete-a-contact.md)
         + [내 연락처 모두가 Sales Connect에 푸시되지 않은 이유는 무엇입니까?](product-docs/marketo-sales-connect/faq/why-didnt-all-of-my-contacts-get-pushed-to-sales-connect.md)
      + 통합 {#integrations}
   ...
   + Marketo 영업 통찰력 {#marketo-sales-insight}
      + MSI {#using-msi} 사용
      ...
      + Microsoft Dynamics용 MSI {#msi-for-microsoft-dynamics}
         ...
         + {#uninstalling} 제거
            + [글로벌 MS Dynamics 동기화 사용 안 함](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/uninstalling/disable-global-ms-dynamics-sync.md)
         ...
         + {#updating} 업데이트 중
            + [Microsoft Dynamics용 Marketo Sales Insight Solution 업그레이드](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/updating/upgrade-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
      + Salesforce용 MSI {#msi-for-salesforce}
         ...
         + 기능 {#features}
            ...
            + Marketo 탭 {#marketo-tab}
               + [최고의 선택](product-docs/marketo-sales-insight/msi-for-salesforce/features/marketo-tab/best-bets.md)
            ...
            + 별 및 불꽃은 {#stars-and-flames}
               + [별과 화염을 사용자 지정하는 방법](product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/customize-stars-and-flames.md)
               + [우선 순위, 긴급성, 상대적인 점수 및 최상의 선택](product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/priority-urgency-relative-score-and-best-bets.md)
               + [Sales Insight에서 별 및 불꽃에 사용할 점수 필드 설정](product-docs/marketo-sales-insight/msi-for-salesforce/features/stars-and-flames/set-score-fields-to-be-used-for-stars-and-flames-in-sales-insight.md)
            + MSI 패널 {#tabs-in-the-msi-panel} 탭
               ...
               + 흥미로운 순간 {#interesting-moments}
                  + [재미있는 모먼트 개요](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/interesting-moments-overview.md)
         ...
         + 모바일용 MSI {#msi-for-mobile}
            + [Salesforce에서 최고의 선택1](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/best-bets-in-salesforce1.md)
   ...
   + 모바일 마케팅 {#mobile-marketing}
      ...
      + SMS 메시지 {#vibes-sms-messages} 보기
         + [비디오 SMS 메시지 만들기](product-docs/mobile-marketing/vibes-sms-messages/create-a-vibes-sms-message.md)
         ...
         + [스마트 목록 트리거 및 필터에서 시각적 SMS 메시지 사용](product-docs/mobile-marketing/vibes-sms-messages/use-vibes-sms-messages-in-smart-list-triggers-and-filters.md)
   + 개인화 {#personalization}
      + 세그먼테이션 및 코드 조각 {#segmentation-and-snippets}
         + 세그먼테이션 {#segmentation}
            ...
            + [세그먼테이션별로 이메일 보고서 그룹화](product-docs/personalization/segmentation-and-snippets/segmentation/group-email-reports-by-segmentations.md)
         ...
         + 코드 조각 {#snippets}
            ...
            + [초안이 없는 코드 조각 승인](product-docs/personalization/segmentation-and-snippets/snippets/approve-a-snippet-with-no-draft.md)
   ...
   + 예측 컨텐츠 {#predictive-content}
      ...
      + 예측 컨텐츠 활성화 {#enabling-predictive-content}
         + [웹 리치 미디어용 Predictive Content 활성화](product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-for-web-rich-media.md)
         + [이메일에서 예측 컨텐츠 활성화](product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-in-emails.md)
   ...
   + 보고 {#reporting}
      + 기본 보고 {#basic-reporting}
         ...
         + 보고서 편집 {#editing-reports}
            + [개인 보고서에 사용자 지정 열 추가](product-docs/reporting/basic-reporting/editing-reports/add-custom-columns-to-a-person-report.md)
            ...
            + [스마트 목록을 사용하여 보고서에서 사람 필터링](product-docs/reporting/basic-reporting/editing-reports/filter-people-in-a-report-with-a-smart-list.md)
            + [보고서 열 순서 조정](product-docs/reporting/basic-reporting/editing-reports/reorder-report-columns.md)
         ...
         + 보고서 활동 {#report-activity}
            + [모바일 플랫폼 열로 사람 성과 보고서 작성](product-docs/reporting/basic-reporting/report-activity/build-a-people-performance-report-with-mobile-platform-columns.md)
            ...
            + [보고서 복제 를 그룹 보고서에 복제](product-docs/reporting/basic-reporting/report-activity/clone-a-report-to-group-reports.md)
            ...
            + [사람 성과 보고서에서 드릴 다운](product-docs/reporting/basic-reporting/report-activity/drill-down-in-a-people-performance-report.md)
            ...
            + [작업 공간 간 이메일, 캠페인 성과 보고](product-docs/reporting/basic-reporting/report-activity/report-email-campaign-performance-across-workspaces.md)
            + [작업 공간에서 모델 공유](product-docs/reporting/basic-reporting/report-activity/share-a-model-across-workspaces.md)
         ...
         + 보고서 구독 {#report-subscriptions}
            ...
            + [Subscription Admin 설정 보안](product-docs/reporting/basic-reporting/report-subscriptions/secure-the-subscription-admin-setting.md)
            + [기본 보고서 구독](product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-basic-report.md)
            + [스마트 목록에 가입](product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-smart-list.md)
         + 보고서 유형 {#report-types}
      ...
      + 이메일 인사이트 {#email-insights}
         ...
         + [이메일 통찰력 FAQ](product-docs/reporting/email-insights/email-insights-faq.md)
         + [이메일 통찰력 빠른 차트](product-docs/reporting/email-insights/email-insights-quick-charts.md)
         + [Email Insights 전송 개요](product-docs/reporting/email-insights/email-insights-sends-overview.md)
         + [이메일 인사이트에서 필터링](product-docs/reporting/email-insights/filtering-in-email-insights.md)
      + 성능 통찰력 {#performance-insights}
         + [성능 통찰력 개요](product-docs/reporting/performance-insights/performance-insights-overview.md)
         + [성능 통찰력에서 필터링](product-docs/reporting/performance-insights/filtering-in-performance-insights.md)
         ...
         + [성능 통찰력 트렌드 개요](product-docs/reporting/performance-insights/performance-insights-trend-overview.md)
         + [성능 통찰력 설정](product-docs/reporting/performance-insights/setting-up-performance-insights.md)
         + [사용자 지정 필드를 성능 인사이트에 동기화](product-docs/reporting/performance-insights/sync-custom-fields-to-performance-insights.md)
      + 매출 주기 분석 {#revenue-cycle-analytics}
         ...
         + 기회 영향 분석기 {#opportunity-influence-analyzer}
            ...
            + [영업 기회 영향 분석기로 마케팅 사례 설명](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/tell-the-marketing-story-with-an-opportunity-influence-analyzer.md)
         + 프로그램 분석 {#program-analytics}
            ...
            + [프로그램 수준에서 Analytics 동작 무시](product-docs/reporting/revenue-cycle-analytics/program-analytics/override-analytics-behavior-at-the-program-level.md)
         ...
         + 매출 주기 모델 {#revenue-cycle-models}
            ...
            + [모델 성능 분석에 대한 사용자 지정 필드 그룹 사용(리드)](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/enable-custom-field-groups-for-model-performance-analysis-leads.md)
         ...
         + 매출 탐색기 {#revenue-explorer}
            + [매출 탐색기 보고서에 사용자 지정 측정 추가](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/adding-custom-measures-to-a-revenue-explorer-report.md)
            ...
            + [매출 탐색기 보고서의 필드 삭제](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/deleting-a-field-in-a-revenue-explorer-report.md)
            ...
            + [사용자 지정 필드를 매출 탐색기에 동기화](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/sync-custom-fields-to-the-revenue-explorer.md)
            + [Revenue Explorer의 Opportunity Analysis 이해](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/understanding-opportunity-analysis-in-revenue-explorer.md)
         ...
         + 매출 도구 {#revenue-tools}
            ...
            + [Revenue Cycle Analytics에 대한 사용자 지정 필드 동기화 활성화](product-docs/reporting/revenue-cycle-analytics/revenue-tools/enabling-custom-field-sync-for-revenue-cycle-analytics.md)
            + [매출 단계 보고서별 사람](product-docs/reporting/revenue-cycle-analytics/revenue-tools/people-by-revenue-stage-report.md)
            + 속성 {#attribution}
   ...
   + 웹 개인화 {#web-personalization}
      ...
      + 시작하기 {#getting-started}
         ...
         + [추적되지 않도록 웹 개인화 설정](product-docs/web-personalization/getting-started/setting-web-personalization-to-do-not-track.md)
         + [사용자 설정](product-docs/web-personalization/getting-started/user-settings.md)
         + [웹 개인화의 작업 공간](product-docs/web-personalization/getting-started/workspaces-in-web-personalization.md)
      ...
      + 웹 개인화 보고 {#reporting-for-web-personalization}
         ...
         + [특정 IP가 추적되지 않도록 제외](product-docs/web-personalization/reporting-for-web-personalization/exclude-specific-ips-from-being-tracked.md)
      ...
      + 웹 캠페인 작업 {#working-with-web-campaigns}
         ...
         + [영역 웹 캠페인에서 새 만들기](product-docs/web-personalization/working-with-web-campaigns/create-a-new-in-zone-web-campaign.md)
...
+ 릴리스 노트 {#release-notes}
   ...
   + 이전 릴리스 {#previous-releases}
      + 2021 {#2021}
         + [릴리스 노트: 2021년 1월](previous-releases/release-notes/2021/release-notes-jan-21.md)
         + [릴리스 노트: 2021년 5월](previous-releases/release-notes/2021/release-notes-may-21.md)
      + 2020 {#2020}
         + [릴리스 노트: 2020년 1월](previous-releases/release-notes/2020/release-notes-jan-20.md)
         + [릴리스 노트: 2월 20일](previous-releases/release-notes/2020/release-notes-feb-20.md)
         + [릴리스 노트: 2020년 6월](previous-releases/release-notes/2020/release-notes-june-20.md)
         + [릴리스 노트: 2020년 7월](previous-releases/release-notes/2020/release-notes-july-20.md)
         + [릴리스 노트: 10월 20일](previous-releases/release-notes/2020/release-notes-oct-20.md)
      + 2019 {#2019}
         + [릴리스 노트: 19월 8일](previous-releases/release-notes/2019/release-notes-august-19.md)
         + [릴리스 노트: 1919년 6월](previous-releases/release-notes/2019/release-notes-june-19.md)
         + [릴리스 노트: 19년 봄](previous-releases/release-notes/2019/release-notes-spring-19.md)
         + [릴리스 노트: 19년 겨울](previous-releases/release-notes/2019/release-notes-winter-19.md)
      + 2018 {#2018}
         + [릴리스 노트: 18년 가을](previous-releases/release-notes/2018/release-notes-fall-18.md)
         + [릴리스 노트: 18년 봄](previous-releases/release-notes/2018/release-notes-spring-18.md)
         + [릴리스 노트: 18년 겨울](previous-releases/release-notes/2018/release-notes-winter-18.md)
      + 2017 {#2017}
         + [릴리스 노트: 2017년 4월 ABM 개선 사항](previous-releases/release-notes/2017/release-notes-april-17-abm-enhancements.md)
         + [릴리스 노트: 2017년 8월 ABM 개선 사항](previous-releases/release-notes/2017/release-notes-august-17-abm-enhancements.md)
         + [릴리스 노트: 17년 가을](previous-releases/release-notes/2017/release-notes-fall-17.md)
         + [릴리스 노트: 17년 봄](previous-releases/release-notes/2017/release-notes-spring-17.md)
         + [릴리스 노트: 17년 여름](previous-releases/release-notes/2017/release-notes-summer-17.md)
         + [릴리스 노트: 17년 겨울](previous-releases/release-notes/2017/release-notes-winter-17.md)
      + 2016 {#2016}
         + [릴리스 노트: 16년 가을](previous-releases/release-notes/2016/release-notes-fall-16.md)
         + [릴리스 노트: 16년 봄](previous-releases/release-notes/2016/release-notes-spring-16.md)
         + [릴리스 노트: 16년 여름](previous-releases/release-notes/2016/release-notes-summer-16.md)
         + [릴리스 노트: 16년 겨울](previous-releases/release-notes/2016/release-notes-winter-16.md)
      + 2015 {#2015}
         + [릴리스 노트: 2015년 4월](previous-releases/release-notes/2015/release-notes-april-2015.md)
         + [릴리스 노트: 15년 가을](previous-releases/release-notes/2015/release-notes-fall-15.md)
         + [릴리스 노트: 2015년 2월](previous-releases/release-notes/2015/release-notes-february-2015.md)
         + [릴리스 노트: 2015년 1월](previous-releases/release-notes/2015/release-notes-january-2015.md)
         + [릴리스 노트: 2015년 7월](previous-releases/release-notes/2015/release-notes-july-2015.md)
         + [릴리스 노트: 2015년 6월](previous-releases/release-notes/2015/release-notes-june-2015.md)
         + [릴리스 노트: 2015년 3월](previous-releases/release-notes/2015/release-notes-march-2015.md)
         + [릴리스 노트: 2015년 5월](previous-releases/release-notes/2015/release-notes-may-2015.md)
      + 2014 {#2014}
         + [릴리스 노트: 2014년 8월](previous-releases/release-notes/2014/release-notes-august-2014.md)
         + [릴리스 노트: 2014년 12월](previous-releases/release-notes/2014/release-notes-december-2014.md)
         + [릴리스 노트: 2014년 2월](previous-releases/release-notes/2014/release-notes-february-2014.md)
         + [릴리스 노트: 2014년 1월](previous-releases/release-notes/2014/release-notes-january-2014.md)
         + [릴리스 노트: 2014년 7월](previous-releases/release-notes/2014/release-notes-july-2014.md)
         + [릴리스 노트: 2014년 6월](previous-releases/release-notes/2014/release-notes-june-2014.md)
         + [릴리스 노트: 2014년 3월](previous-releases/release-notes/2014/release-notes-march-2014.md)
         + [릴리스 노트: 2014년 5월](previous-releases/release-notes/2014/release-notes-may-2014.md)
         + [릴리스 노트: 2014년 10월 일](previous-releases/release-notes/2014/release-notes-october-2014.md)
      + 2013 {#2013}
         + [릴리스 노트: 2013년 4월](previous-releases/release-notes/2013/release-notes-april-2013.md)
         + [릴리스 노트: 2013년 8월](previous-releases/release-notes/2013/release-notes-august-2013.md)
         + [릴리스 노트: 2013년 12월](previous-releases/release-notes/2013/release-notes-december-2013.md)
         + [릴리스 노트: 2013년 2월](previous-releases/release-notes/2013/release-notes-february-2013.md)
         + [릴리스 노트: 2013년 1월](previous-releases/release-notes/2013/release-notes-january-2013.md)
         + [릴리스 노트: 2013년 7월](previous-releases/release-notes/2013/release-notes-july-2013.md)
         + [릴리스 노트: 2013년 6월](previous-releases/release-notes/2013/release-notes-june-2013.md)
         + [릴리스 노트: 2013년 3월](previous-releases/release-notes/2013/release-notes-march-2013.md)
         + [릴리스 노트: 2013년 5월](previous-releases/release-notes/2013/release-notes-may-2013.md)
         + [릴리스 노트: 2013년 10월 일](previous-releases/release-notes/2013/release-notes-october-2013.md)
         + [릴리스 노트: 2013년 9월](previous-releases/release-notes/2013/release-notes-september-2013.md)
      + 2012 {#2012}
         + [릴리스 노트: 2012년 4월](previous-releases/release-notes/2012/release-notes-april-2012.md)
         + [릴리스 노트: 2012년 12월](previous-releases/release-notes/2012/release-notes-december-2012.md)
         + [릴리스 노트: 2012년 1월/2월](previous-releases/release-notes/2012/release-notes-jan-feb-2012.md)
         + [릴리스 노트: 2012년 6월](previous-releases/release-notes/2012/release-notes-june-2012.md)
         + [릴리스 노트: 2012년 3월](previous-releases/release-notes/2012/release-notes-march-2012.md)
         + [릴리스 노트: 2012년 5월](previous-releases/release-notes/2012/release-notes-may-2012.md)
         + [릴리스 노트: 2012년 10월 일](previous-releases/release-notes/2012/release-notes-october-2012.md)
         + [릴리스 노트: 2012년 9월](previous-releases/release-notes/2012/release-notes-september-2012.md)
      + [2010년-2011년](previous-releases/release-notes/2010-2011.md)
      + [2007년-2009년](previous-releases/release-notes/2007-2009.md)
