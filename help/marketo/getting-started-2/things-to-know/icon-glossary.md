...
다음은 현재 Adobe Marketo Engage 인터페이스의 아이콘입니다. Marketo Classic 아이콘을 참조해야 하는 경우 다음과 같을 수 있습니다. [여기에서 찾음](/help/marketo/getting-started-2/classic-icon-glossary.md).
