...
<tbody>
  <tr>
    <td>커뮤니케이션 제한</td>
    <td><li>시작 <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/email-setup/enable-communication-limits.html" target="_blank">커뮤니케이션 제한</a>.</li>
